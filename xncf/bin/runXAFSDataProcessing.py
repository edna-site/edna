...
from EDApplicationXAFSDataProcessing import EDApplicationXAFSDataProcessing

edApplicationXAFSDataProcessing = EDApplicationXAFSDataProcessing(_strPluginName="EDPluginControlXAFSDataProcessingv0_1", \
                                                    _strConfigurationFileName=strConfigurationFilePath)
edApplicationXAFSDataProcessing.execute()
