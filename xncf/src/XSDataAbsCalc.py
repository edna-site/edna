...
#
# Generated Wed Feb 16 17:52:28 2011 by EDGenerateDS.py.
#
...
class XSDataInputAbsCalc(XSDataInput):
    subclass = None
    def __init__(self, configuration=None, numCompounds=None, compoundList=None, buffer=None, edge=None, transAfterEdge=None, diameterDisk=None, thicknessDisk=None):
        XSDataInput.__init__(self, configuration)
        self.numCompounds = numCompounds
        ...
        self.buffer = buffer
        self.edge = edge
        self.transAfterEdge = transAfterEdge
        self.diameterDisk = diameterDisk
        self.thicknessDisk = thicknessDisk
    def factory(*args_, **kwargs_):
        if XSDataInputAbsCalc.subclass:
            return XSDataInputAbsCalc.subclass(*args_, **kwargs_)
        else:
            return XSDataInputAbsCalc(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getNumCompounds(self): return self.numCompounds
    def setNumCompounds(self, numCompounds): self.numCompounds = numCompounds
    def getCompoundList(self): return self.compoundList
    def setCompoundList(self, compoundList): self.compoundList = compoundList
    def addCompoundList(self, value): self.compoundList.append(value)
    def insertCompoundList(self, index, value): self.compoundList[index] = value
    def getBuffer(self): return self.buffer
    def setBuffer(self, buffer): self.buffer = buffer
    def getEdge(self): return self.edge
    def setEdge(self, edge): self.edge = edge
    def getTransAfterEdge(self): return self.transAfterEdge
    def setTransAfterEdge(self, transAfterEdge): self.transAfterEdge = transAfterEdge
    def getDiameterDisk(self): return self.diameterDisk
    def setDiameterDisk(self, diameterDisk): self.diameterDisk = diameterDisk
    def getThicknessDisk(self): return self.thicknessDisk
    def setThicknessDisk(self, thicknessDisk): self.thicknessDisk = thicknessDisk
    def export(self, outfile, level, name_='XSDataInputAbsCalc'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputAbsCalc'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputAbsCalc')
    def exportChildren(self, outfile, level, name_='XSDataInputAbsCalc'):
        if self.numCompounds:
            self.numCompounds.export(outfile, level, name_='numCompounds')
        for compoundList_ in self.getCompoundList():
            compoundList_.export(outfile, level, name_='compoundList')
        if self.buffer:
            self.buffer.export(outfile, level, name_='buffer')
        if self.edge:
            self.edge.export(outfile, level, name_='edge')
        if self.getTransAfterEdge() != None :
            if self.transAfterEdge:
                self.transAfterEdge.export(outfile, level, name_='transAfterEdge')
        if self.diameterDisk:
            self.diameterDisk.export(outfile, level, name_='diameterDisk')
        if self.getThicknessDisk() != None :
            if self.thicknessDisk:
                self.thicknessDisk.export(outfile, level, name_='thicknessDisk')
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataInputAbsCalc' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputAbsCalc.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataInputAbsCalc" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataInputAbsCalc'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.numCompounds:
            showIndent(outfile, level)
            outfile.write('numCompounds=XSDataInteger(\n')
            self.numCompounds.exportLiteral(outfile, level, name_='numCompounds')
            showIndent(outfile, level)
            outfile.write('),\n')
        showIndent(outfile, level)
        outfile.write('compoundList=[\n')
        level += 1
        for compoundList in self.compoundList:
            showIndent(outfile, level)
            outfile.write('XSDataCompound(\n')
            compoundList.exportLiteral(outfile, level, name_='compoundList')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        ...
        if self.buffer:
            showIndent(outfile, level)
            outfile.write('buffer=XSDataCompound(\n')
        ...
        if self.transAfterEdge:
            showIndent(outfile, level)
            outfile.write('transAfterEdge=XSDataFloat(\n')
            self.transAfterEdge.exportLiteral(outfile, level, name_='transAfterEdge')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.diameterDisk:
            showIndent(outfile, level)
            outfile.write('diameterDisk=XSDataFloat(\n')
            self.diameterDisk.exportLiteral(outfile, level, name_='diameterDisk')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.thicknessDisk:
            showIndent(outfile, level)
            outfile.write('thicknessDisk=XSDataFloat(\n')
            self.thicknessDisk.exportLiteral(outfile, level, name_='thicknessDisk')
            showIndent(outfile, level)
            outfile.write('),\n')
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'numCompounds':
            obj_ = XSDataInteger.factory()
            obj_.build(child_)
            self.setNumCompounds(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'compoundList':
            obj_ = XSDataCompound.factory()
            obj_.build(child_)
            self.compoundList.append(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'buffer':
            obj_ = XSDataCompound.factory()
            obj_.build(child_)
            ...
            nodeName_ == 'transAfterEdge':
            obj_ = XSDataFloat.factory()
            obj_.build(child_)
            self.setTransAfterEdge(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'diameterDisk':
            obj_ = XSDataFloat.factory()
            obj_.build(child_)
            self.setDiameterDisk(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'thicknessDisk':
            obj_ = XSDataFloat.factory()
            obj_.build(child_)
            self.setThicknessDisk(obj_)
        XSDataInput.buildChildren(self, child_, nodeName_)
# end class XSDataInputAbsCalc


class XSDataResultAbsCalc(XSDataResult):
    subclass = None
    def __init__(self, densitySample=None, weightSample=None, compoundList=None, buffer=None, transBeforeEdge=None, transAfterEdge=None, thicknessDisk=None, radiusDisk=None):
        XSDataResult.__init__(self)
        self.densitySample = densitySample
        self.weightSample = weightSample
        if compoundList is None:
            self.compoundList = []
        else:
            self.compoundList = compoundList
        self.buffer = buffer
        self.transBeforeEdge = transBeforeEdge
        self.transAfterEdge = transAfterEdge
        self.thicknessDisk = thicknessDisk
        self.radiusDisk = radiusDisk
    def factory(*args_, **kwargs_):
        if XSDataResultAbsCalc.subclass:
            return XSDataResultAbsCalc.subclass(*args_, **kwargs_)
        else:
            return XSDataResultAbsCalc(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getDensitySample(self): return self.densitySample
    def setDensitySample(self, densitySample): self.densitySample = densitySample
    def getWeightSample(self): return self.weightSample
    def setWeightSample(self, weightSample): self.weightSample = weightSample
    def getCompoundList(self): return self.compoundList
    def setCompoundList(self, compoundList): self.compoundList = compoundList
    def addCompoundList(self, value): self.compoundList.append(value)
    def insertCompoundList(self, index, value): self.compoundList[index] = value
    def getBuffer(self): return self.buffer
    def setBuffer(self, buffer): self.buffer = buffer
    def getTransBeforeEdge(self): return self.transBeforeEdge
    def setTransBeforeEdge(self, transBeforeEdge): self.transBeforeEdge = transBeforeEdge
    def getTransAfterEdge(self): return self.transAfterEdge
    def setTransAfterEdge(self, transAfterEdge): self.transAfterEdge = transAfterEdge
    def getThicknessDisk(self): return self.thicknessDisk
    def setThicknessDisk(self, thicknessDisk): self.thicknessDisk = thicknessDisk
    def getRadiusDisk(self): return self.radiusDisk
    def setRadiusDisk(self, radiusDisk): self.radiusDisk = radiusDisk
    def export(self, outfile, level, name_='XSDataResultAbsCalc'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultAbsCalc'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultAbsCalc')
    def exportChildren(self, outfile, level, name_='XSDataResultAbsCalc'):
        if self.densitySample:
            self.densitySample.export(outfile, level, name_='densitySample')
        if self.weightSample:
            self.weightSample.export(outfile, level, name_='weightSample')
        for compoundList_ in self.getCompoundList():
            compoundList_.export(outfile, level, name_='compoundList')
        if self.getBuffer() != None :
            if self.buffer:
                self.buffer.export(outfile, level, name_='buffer')
        if self.transBeforeEdge:
            self.transBeforeEdge.export(outfile, level, name_='transBeforeEdge')
        if self.transAfterEdge:
            self.transAfterEdge.export(outfile, level, name_='transAfterEdge')
        if self.thicknessDisk:
            self.thicknessDisk.export(outfile, level, name_='thicknessDisk')
        if self.radiusDisk:
            self.radiusDisk.export(outfile, level, name_='radiusDisk')
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataResultAbsCalc' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultAbsCalc.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataResultAbsCalc" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataResultAbsCalc'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.densitySample:
            showIndent(outfile, level)
            outfile.write('densitySample=XSDataFloat(\n')
            self.densitySample.exportLiteral(outfile, level, name_='densitySample')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.weightSample:
            showIndent(outfile, level)
            outfile.write('weightSample=XSDataFloat(\n')
            self.weightSample.exportLiteral(outfile, level, name_='weightSample')
            showIndent(outfile, level)
            outfile.write('),\n')
        showIndent(outfile, level)
        outfile.write('compoundList=[\n')
        ...
        if self.transBeforeEdge:
            showIndent(outfile, level)
            outfile.write('transBeforeEdge=XSDataFloat(\n')
            self.transBeforeEdge.exportLiteral(outfile, level, name_='transBeforeEdge')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.transAfterEdge:
            showIndent(outfile, level)
        ...
        if self.radiusDisk:
            showIndent(outfile, level)
            outfile.write('radiusDisk=XSDataFloat(\n')
            self.radiusDisk.exportLiteral(outfile, level, name_='radiusDisk')
            showIndent(outfile, level)
            outfile.write('),\n')
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'densitySample':
            obj_ = XSDataFloat.factory()
            obj_.build(child_)
            self.setDensitySample(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'weightSample':
            obj_ = XSDataFloat.factory()
            obj_.build(child_)
            self.setWeightSample(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'compoundList':
            obj_ = XSDataCompound.factory()
            obj_.build(child_)
            ...
            nodeName_ == 'transBeforeEdge':
            obj_ = XSDataFloat.factory()
            obj_.build(child_)
            self.setTransBeforeEdge(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'transAfterEdge':
            obj_ = XSDataFloat.factory()
            obj_.build(child_)
            ...
            nodeName_ == 'radiusDisk':
            obj_ = XSDataFloat.factory()
            obj_.build(child_)
            self.setRadiusDisk(obj_)
# end class XSDataResultAbsCalc


class XSDataCompound(XSData):
    subclass = None
    def __init__(self, formula=None, fraction=None, density=None, weight=None):
        XSData.__init__(self)
        ...
        self.weight = weight
    def factory(*args_, **kwargs_):
        if XSDataCompound.subclass:
            return XSDataCompound.subclass(*args_, **kwargs_)
        else:
            return XSDataCompound(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getFormula(self): return self.formula
    def setFormula(self, formula): self.formula = formula
    ...
    def export(self, outfile, level, name_='XSDataCompound'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataCompound'):
        XSData.exportAttributes(self, outfile, level, name_='XSDataCompound')
    def exportChildren(self, outfile, level, name_='XSDataCompound'):
        if self.formula:
            self.formula.export(outfile, level, name_='formula')
        if self.getFraction() != None :
            if self.fraction:
                self.fraction.export(outfile, level, name_='fraction')
        if self.density:
            self.density.export(outfile, level, name_='density')
        if self.getWeight() != None :
            if self.weight:
                self.weight.export(outfile, level, name_='weight')
        XSData.exportChildren(self, outfile, level, name_)
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataCompound' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataCompound.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataCompound" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataCompound'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.formula:
            showIndent(outfile, level)
            outfile.write('formula=XSDataString(\n')
            self.formula.exportLiteral(outfile, level, name_='formula')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.fraction:
            showIndent(outfile, level)
            outfile.write('fraction=XSDataFloat(\n')
            self.fraction.exportLiteral(outfile, level, name_='fraction')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.density:
            showIndent(outfile, level)
            outfile.write('density=XSDataFloat(\n')
            self.density.exportLiteral(outfile, level, name_='density')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.weight:
            showIndent(outfile, level)
            outfile.write('weight=XSDataFloat(\n')
            self.weight.exportLiteral(outfile, level, name_='weight')
            showIndent(outfile, level)
            outfile.write('),\n')
        XSData.exportLiteralChildren(self, outfile, level, name_)
    def build(self, node_):
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            obj_ = XSDataString.factory()
            obj_.build(child_)
            self.setFormula(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'fraction':
            obj_ = XSDataFloat.factory()
            obj_.build(child_)
            self.setFraction(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'density':
            obj_ = XSDataFloat.factory()
            obj_.build(child_)
            self.setDensity(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'weight':
            obj_ = XSDataFloat.factory()
            obj_.build(child_)
            self.setWeight(obj_)
# end class XSDataCompound


class XSDataInputAbsorption(XSDataInput):
    subclass = None
    def __init__(self, configuration=None, deltaMuT=None, absCalcReference=None):
        XSDataInput.__init__(self, configuration)
        self.deltaMuT = deltaMuT
        self.absCalcReference = absCalcReference
    def factory(*args_, **kwargs_):
        if XSDataInputAbsorption.subclass:
            return XSDataInputAbsorption.subclass(*args_, **kwargs_)
        else:
            return XSDataInputAbsorption(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getDeltaMuT(self): return self.deltaMuT
    def setDeltaMuT(self, deltaMuT): self.deltaMuT = deltaMuT
    def getAbsCalcReference(self): return self.absCalcReference
    def setAbsCalcReference(self, absCalcReference): self.absCalcReference = absCalcReference
    def export(self, outfile, level, name_='XSDataInputAbsorption'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputAbsorption'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputAbsorption')
    def exportChildren(self, outfile, level, name_='XSDataInputAbsorption'):
        if self.getDeltaMuT() != None :
            if self.deltaMuT:
                self.deltaMuT.export(outfile, level, name_='deltaMuT')
        if self.absCalcReference:
            self.absCalcReference.export(outfile, level, name_='absCalcReference')
        XSDataInput.exportChildren(self, outfile, level, name_)
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataInputAbsorption' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputAbsorption.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataInputAbsorption" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataInputAbsorption'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.deltaMuT:
            showIndent(outfile, level)
            outfile.write('deltaMuT=XSDataFloat(\n')
            self.deltaMuT.exportLiteral(outfile, level, name_='deltaMuT')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.absCalcReference:
            showIndent(outfile, level)
            outfile.write('absCalcReference=XSDataInputAbsCalc(\n')
            self.absCalcReference.exportLiteral(outfile, level, name_='absCalcReference')
            showIndent(outfile, level)
            outfile.write('),\n')
        XSDataInput.exportLiteralChildren(self, outfile, level, name_)
    def build(self, node_):
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            obj_ = XSDataFloat.factory()
            obj_.build(child_)
            self.setDeltaMuT(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'absCalcReference':
            obj_ = XSDataInputAbsCalc.factory()
            obj_.build(child_)
            self.setAbsCalcReference(obj_)
        XSDataInput.buildChildren(self, child_, nodeName_)
# end class XSDataInputAbsorption


class XSDataResultAbsorption(XSDataResult):
    subclass = None
    def __init__(self, compound=None):
        XSDataResult.__init__(self)
        self.compound = compound
    def factory(*args_, **kwargs_):
        if XSDataResultAbsorption.subclass:
            return XSDataResultAbsorption.subclass(*args_, **kwargs_)
        else:
            return XSDataResultAbsorption(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getCompound(self): return self.compound
    def setCompound(self, compound): self.compound = compound
    def export(self, outfile, level, name_='XSDataResultAbsorption'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultAbsorption'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultAbsorption')
    def exportChildren(self, outfile, level, name_='XSDataResultAbsorption'):
        if self.compound:
            self.compound.export(outfile, level, name_='compound')
        XSDataResult.exportChildren(self, outfile, level, name_)
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataResultAbsorption' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultAbsorption.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataResultAbsorption" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataResultAbsorption'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.compound:
            showIndent(outfile, level)
            outfile.write('compound=XSDataResultAbsCalc(\n')
            self.compound.exportLiteral(outfile, level, name_='compound')
            showIndent(outfile, level)
            outfile.write('),\n')
        XSDataResult.exportLiteralChildren(self, outfile, level, name_)
    def build(self, node_):
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'compound':
            obj_ = XSDataResultAbsCalc.factory()
            obj_.build(child_)
            self.setCompound(obj_)
# end class XSDataResultAbsorption
...
class SaxXSConfigurationHandler(handler.ContentHandler):
    ...
    def startElement(self, name, attrs):
        ...
        elif name == 'numCompounds':
            obj = XSDataInteger.factory()
            stackObj = SaxStackElement('numCompounds', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'compoundList':
            obj = XSDataCompound.factory()
            stackObj = SaxStackElement('compoundList', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'buffer':
            obj = XSDataCompound.factory()
            stackObj = SaxStackElement('buffer', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'edge':
            obj = XSDataString.factory()
        ...
        elif name == 'transAfterEdge':
            obj = XSDataFloat.factory()
            stackObj = SaxStackElement('transAfterEdge', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'diameterDisk':
            obj = XSDataFloat.factory()
            stackObj = SaxStackElement('diameterDisk', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'thicknessDisk':
            obj = XSDataFloat.factory()
            stackObj = SaxStackElement('thicknessDisk', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'densitySample':
            obj = XSDataFloat.factory()
            stackObj = SaxStackElement('densitySample', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'weightSample':
            obj = XSDataFloat.factory()
            stackObj = SaxStackElement('weightSample', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'transBeforeEdge':
            obj = XSDataFloat.factory()
            stackObj = SaxStackElement('transBeforeEdge', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'radiusDisk':
            obj = XSDataFloat.factory()
            stackObj = SaxStackElement('radiusDisk', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'formula':
            obj = XSDataString.factory()
            stackObj = SaxStackElement('formula', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'fraction':
            obj = XSDataFloat.factory()
            stackObj = SaxStackElement('fraction', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'density':
            obj = XSDataFloat.factory()
            stackObj = SaxStackElement('density', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'weight':
            obj = XSDataFloat.factory()
            stackObj = SaxStackElement('weight', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'deltaMuT':
            obj = XSDataFloat.factory()
            stackObj = SaxStackElement('deltaMuT', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'absCalcReference':
            obj = XSDataInputAbsCalc.factory()
            stackObj = SaxStackElement('absCalcReference', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'compound':
            obj = XSDataResultAbsCalc.factory()
    ...
    def endElement(self, name):
        ...
        if name == 'XSConfiguration':
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setNumCompounds(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'compoundList':
            if len(self.stack) >= 2:
                self.stack[-2].obj.addCompoundList(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'buffer':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setBuffer(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'edge':
            if len(self.stack) >= 2:
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setTransAfterEdge(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'diameterDisk':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setDiameterDisk(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'thicknessDisk':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setThicknessDisk(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'densitySample':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setDensitySample(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'weightSample':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setWeightSample(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'transBeforeEdge':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setTransBeforeEdge(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'radiusDisk':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setRadiusDisk(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'formula':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setFormula(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'fraction':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setFraction(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'density':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setDensity(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'weight':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setWeight(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'deltaMuT':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setDeltaMuT(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'absCalcReference':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setAbsCalcReference(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'compound':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setCompound(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        if not done:
            self.reportError('"%s" element not allowed here.' % name)
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('from XSDataAbsCalc import *\n\n')
