...
export EDNA_HOME=`dirname "$full_path" | sed 's/\/diffractionCTv1\/datamodel$//'`

xsDataBaseName=XSDataDiffractionCTv1
xsdHomeDir=${EDNA_HOME}/diffractionCTv1/datamodel
pyHomeDir=${EDNA_HOME}/diffractionCTv1/src
