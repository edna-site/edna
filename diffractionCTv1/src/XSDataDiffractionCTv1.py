...
#
# Generated Mon Nov  8 12:30:39 2010 by EDGenerateDS.py.
#
...
class XSDataDiffractionCTInstrument:
    subclass = None
    def __init__(self, _diffrn_radiation_wavelength=None, _pd_instr_dist_spec_detc=None, _pd_meas_2theta_range_inc=None, _pd_meas_2theta_range_max=None, _pd_meas_2theta_range_min=None, _synchrotron_photon_flux=None, _synchrotron_ring_intensity=None, _tomo_scan_ampl=None, _tomo_scan_type=None, _tomo_spec_displ_rotation=None, _tomo_spec_displ_rotation_inc=None, _tomo_spec_displ_x=None, _tomo_spec_displ_x_inc=None, _tomo_spec_displ_x_max=None, _tomo_spec_displ_x_min=None, _tomo_spec_displ_z=None, _tomo_spec_displ_z_inc=None, _tomo_spec_displ_z_max=None, _tomo_spec_displ_z_min=None):
        self._diffrn_radiation_wavelength = _diffrn_radiation_wavelength
        self._pd_instr_dist_spec_detc = _pd_instr_dist_spec_detc
        self._pd_meas_2theta_range_inc = _pd_meas_2theta_range_inc
        self._pd_meas_2theta_range_max = _pd_meas_2theta_range_max
        self._pd_meas_2theta_range_min = _pd_meas_2theta_range_min
        self._synchrotron_photon_flux = _synchrotron_photon_flux
        self._synchrotron_ring_intensity = _synchrotron_ring_intensity
        self._tomo_scan_ampl = _tomo_scan_ampl
        self._tomo_scan_type = _tomo_scan_type
        self._tomo_spec_displ_rotation = _tomo_spec_displ_rotation
        self._tomo_spec_displ_rotation_inc = _tomo_spec_displ_rotation_inc
        self._tomo_spec_displ_x = _tomo_spec_displ_x
        self._tomo_spec_displ_x_inc = _tomo_spec_displ_x_inc
        self._tomo_spec_displ_x_max = _tomo_spec_displ_x_max
        self._tomo_spec_displ_x_min = _tomo_spec_displ_x_min
        self._tomo_spec_displ_z = _tomo_spec_displ_z
        self._tomo_spec_displ_z_inc = _tomo_spec_displ_z_inc
        self._tomo_spec_displ_z_max = _tomo_spec_displ_z_max
        self._tomo_spec_displ_z_min = _tomo_spec_displ_z_min
    def factory(*args_, **kwargs_):
        if XSDataDiffractionCTInstrument.subclass:
            return XSDataDiffractionCTInstrument.subclass(*args_, **kwargs_)
        else:
            return XSDataDiffractionCTInstrument(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_diffrn_radiation_wavelength(self): return self._diffrn_radiation_wavelength
    def set_diffrn_radiation_wavelength(self, _diffrn_radiation_wavelength): self._diffrn_radiation_wavelength = _diffrn_radiation_wavelength
    def get_pd_instr_dist_spec_detc(self): return self._pd_instr_dist_spec_detc
    def set_pd_instr_dist_spec_detc(self, _pd_instr_dist_spec_detc): self._pd_instr_dist_spec_detc = _pd_instr_dist_spec_detc
    def get_pd_meas_2theta_range_inc(self): return self._pd_meas_2theta_range_inc
    def set_pd_meas_2theta_range_inc(self, _pd_meas_2theta_range_inc): self._pd_meas_2theta_range_inc = _pd_meas_2theta_range_inc
    def get_pd_meas_2theta_range_max(self): return self._pd_meas_2theta_range_max
    def set_pd_meas_2theta_range_max(self, _pd_meas_2theta_range_max): self._pd_meas_2theta_range_max = _pd_meas_2theta_range_max
    def get_pd_meas_2theta_range_min(self): return self._pd_meas_2theta_range_min
    def set_pd_meas_2theta_range_min(self, _pd_meas_2theta_range_min): self._pd_meas_2theta_range_min = _pd_meas_2theta_range_min
    def get_synchrotron_photon_flux(self): return self._synchrotron_photon_flux
    def set_synchrotron_photon_flux(self, _synchrotron_photon_flux): self._synchrotron_photon_flux = _synchrotron_photon_flux
    def get_synchrotron_ring_intensity(self): return self._synchrotron_ring_intensity
    def set_synchrotron_ring_intensity(self, _synchrotron_ring_intensity): self._synchrotron_ring_intensity = _synchrotron_ring_intensity
    def get_tomo_scan_ampl(self): return self._tomo_scan_ampl
    def set_tomo_scan_ampl(self, _tomo_scan_ampl): self._tomo_scan_ampl = _tomo_scan_ampl
    def get_tomo_scan_type(self): return self._tomo_scan_type
    def set_tomo_scan_type(self, _tomo_scan_type): self._tomo_scan_type = _tomo_scan_type
    def get_tomo_spec_displ_rotation(self): return self._tomo_spec_displ_rotation
    def set_tomo_spec_displ_rotation(self, _tomo_spec_displ_rotation): self._tomo_spec_displ_rotation = _tomo_spec_displ_rotation
    def get_tomo_spec_displ_rotation_inc(self): return self._tomo_spec_displ_rotation_inc
    def set_tomo_spec_displ_rotation_inc(self, _tomo_spec_displ_rotation_inc): self._tomo_spec_displ_rotation_inc = _tomo_spec_displ_rotation_inc
    def get_tomo_spec_displ_x(self): return self._tomo_spec_displ_x
    def set_tomo_spec_displ_x(self, _tomo_spec_displ_x): self._tomo_spec_displ_x = _tomo_spec_displ_x
    def get_tomo_spec_displ_x_inc(self): return self._tomo_spec_displ_x_inc
    def set_tomo_spec_displ_x_inc(self, _tomo_spec_displ_x_inc): self._tomo_spec_displ_x_inc = _tomo_spec_displ_x_inc
    def get_tomo_spec_displ_x_max(self): return self._tomo_spec_displ_x_max
    def set_tomo_spec_displ_x_max(self, _tomo_spec_displ_x_max): self._tomo_spec_displ_x_max = _tomo_spec_displ_x_max
    def get_tomo_spec_displ_x_min(self): return self._tomo_spec_displ_x_min
    def set_tomo_spec_displ_x_min(self, _tomo_spec_displ_x_min): self._tomo_spec_displ_x_min = _tomo_spec_displ_x_min
    def get_tomo_spec_displ_z(self): return self._tomo_spec_displ_z
    def set_tomo_spec_displ_z(self, _tomo_spec_displ_z): self._tomo_spec_displ_z = _tomo_spec_displ_z
    def get_tomo_spec_displ_z_inc(self): return self._tomo_spec_displ_z_inc
    def set_tomo_spec_displ_z_inc(self, _tomo_spec_displ_z_inc): self._tomo_spec_displ_z_inc = _tomo_spec_displ_z_inc
    def get_tomo_spec_displ_z_max(self): return self._tomo_spec_displ_z_max
    def set_tomo_spec_displ_z_max(self, _tomo_spec_displ_z_max): self._tomo_spec_displ_z_max = _tomo_spec_displ_z_max
    def get_tomo_spec_displ_z_min(self): return self._tomo_spec_displ_z_min
    def set_tomo_spec_displ_z_min(self, _tomo_spec_displ_z_min): self._tomo_spec_displ_z_min = _tomo_spec_displ_z_min
    def export(self, outfile, level, name_='XSDataDiffractionCTInstrument'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataDiffractionCTInstrument'):
        pass
    def exportChildren(self, outfile, level, name_='XSDataDiffractionCTInstrument'):
        if self.get_diffrn_radiation_wavelength() != None :
            if self._diffrn_radiation_wavelength:
                self._diffrn_radiation_wavelength.export(outfile, level, name_='_diffrn_radiation_wavelength')
        if self.get_pd_instr_dist_spec_detc() != None :
            if self._pd_instr_dist_spec_detc:
                self._pd_instr_dist_spec_detc.export(outfile, level, name_='_pd_instr_dist_spec_detc')
        if self.get_pd_meas_2theta_range_inc() != None :
            if self._pd_meas_2theta_range_inc:
                self._pd_meas_2theta_range_inc.export(outfile, level, name_='_pd_meas_2theta_range_inc')
        if self.get_pd_meas_2theta_range_max() != None :
            if self._pd_meas_2theta_range_max:
                self._pd_meas_2theta_range_max.export(outfile, level, name_='_pd_meas_2theta_range_max')
        if self.get_pd_meas_2theta_range_min() != None :
            if self._pd_meas_2theta_range_min:
                self._pd_meas_2theta_range_min.export(outfile, level, name_='_pd_meas_2theta_range_min')
        if self._synchrotron_photon_flux:
            self._synchrotron_photon_flux.export(outfile, level, name_='_synchrotron_photon_flux')
        if self.get_synchrotron_ring_intensity() != None :
            if self._synchrotron_ring_intensity:
                self._synchrotron_ring_intensity.export(outfile, level, name_='_synchrotron_ring_intensity')
        if self.get_tomo_scan_ampl() != None :
            if self._tomo_scan_ampl:
                self._tomo_scan_ampl.export(outfile, level, name_='_tomo_scan_ampl')
        if self.get_tomo_scan_type() != None :
            if self._tomo_scan_type:
                self._tomo_scan_type.export(outfile, level, name_='_tomo_scan_type')
        if self.get_tomo_spec_displ_rotation() != None :
            if self._tomo_spec_displ_rotation:
                self._tomo_spec_displ_rotation.export(outfile, level, name_='_tomo_spec_displ_rotation')
        if self.get_tomo_spec_displ_rotation_inc() != None :
            if self._tomo_spec_displ_rotation_inc:
                self._tomo_spec_displ_rotation_inc.export(outfile, level, name_='_tomo_spec_displ_rotation_inc')
        if self.get_tomo_spec_displ_x() != None :
            if self._tomo_spec_displ_x:
                self._tomo_spec_displ_x.export(outfile, level, name_='_tomo_spec_displ_x')
        if self.get_tomo_spec_displ_x_inc() != None :
            if self._tomo_spec_displ_x_inc:
                self._tomo_spec_displ_x_inc.export(outfile, level, name_='_tomo_spec_displ_x_inc')
        if self.get_tomo_spec_displ_x_max() != None :
            if self._tomo_spec_displ_x_max:
                self._tomo_spec_displ_x_max.export(outfile, level, name_='_tomo_spec_displ_x_max')
        if self.get_tomo_spec_displ_x_min() != None :
            if self._tomo_spec_displ_x_min:
                self._tomo_spec_displ_x_min.export(outfile, level, name_='_tomo_spec_displ_x_min')
        if self.get_tomo_spec_displ_z() != None :
            if self._tomo_spec_displ_z:
                self._tomo_spec_displ_z.export(outfile, level, name_='_tomo_spec_displ_z')
        if self.get_tomo_spec_displ_z_inc() != None :
            if self._tomo_spec_displ_z_inc:
                self._tomo_spec_displ_z_inc.export(outfile, level, name_='_tomo_spec_displ_z_inc')
        if self.get_tomo_spec_displ_z_max() != None :
            if self._tomo_spec_displ_z_max:
                self._tomo_spec_displ_z_max.export(outfile, level, name_='_tomo_spec_displ_z_max')
        if self.get_tomo_spec_displ_z_min() != None :
            if self._tomo_spec_displ_z_min:
                self._tomo_spec_displ_z_min.export(outfile, level, name_='_tomo_spec_displ_z_min')

    #Only to export the entire XML tree to a file stream on disk
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataDiffractionCTInstrument' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataDiffractionCTInstrument.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataDiffractionCTInstrument" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataDiffractionCTInstrument'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self._diffrn_radiation_wavelength:
            showIndent(outfile, level)
            outfile.write('_diffrn_radiation_wavelength=XSDataWavelength(\n')
            self._diffrn_radiation_wavelength.exportLiteral(outfile, level, name_='_diffrn_radiation_wavelength')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self._pd_instr_dist_spec_detc:
            showIndent(outfile, level)
            outfile.write('_pd_instr_dist_spec_detc=XSDataLength(\n')
            self._pd_instr_dist_spec_detc.exportLiteral(outfile, level, name_='_pd_instr_dist_spec_detc')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self._pd_meas_2theta_range_inc:
            showIndent(outfile, level)
            outfile.write('_pd_meas_2theta_range_inc=XSDataAngle(\n')
            self._pd_meas_2theta_range_inc.exportLiteral(outfile, level, name_='_pd_meas_2theta_range_inc')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self._pd_meas_2theta_range_max:
            showIndent(outfile, level)
            outfile.write('_pd_meas_2theta_range_max=XSDataAngle(\n')
            self._pd_meas_2theta_range_max.exportLiteral(outfile, level, name_='_pd_meas_2theta_range_max')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self._pd_meas_2theta_range_min:
            showIndent(outfile, level)
            outfile.write('_pd_meas_2theta_range_min=XSDataAngle(\n')
            self._pd_meas_2theta_range_min.exportLiteral(outfile, level, name_='_pd_meas_2theta_range_min')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self._synchrotron_photon_flux:
            showIndent(outfile, level)
            outfile.write('_synchrotron_photon_flux=XSDataFlux(\n')
            self._synchrotron_photon_flux.exportLiteral(outfile, level, name_='_synchrotron_photon_flux')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self._synchrotron_ring_intensity:
            showIndent(outfile, level)
            outfile.write('_synchrotron_ring_intensity=XSDataDouble(\n')
            self._synchrotron_ring_intensity.exportLiteral(outfile, level, name_='_synchrotron_ring_intensity')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self._tomo_scan_ampl:
            showIndent(outfile, level)
            outfile.write('_tomo_scan_ampl=XSDataAngle(\n')
            self._tomo_scan_ampl.exportLiteral(outfile, level, name_='_tomo_scan_ampl')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self._tomo_scan_type:
            showIndent(outfile, level)
            outfile.write('_tomo_scan_type=XSDataString(\n')
            self._tomo_scan_type.exportLiteral(outfile, level, name_='_tomo_scan_type')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self._tomo_spec_displ_rotation:
            showIndent(outfile, level)
            outfile.write('_tomo_spec_displ_rotation=XSDataAngle(\n')
            self._tomo_spec_displ_rotation.exportLiteral(outfile, level, name_='_tomo_spec_displ_rotation')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self._tomo_spec_displ_rotation_inc:
            showIndent(outfile, level)
            outfile.write('_tomo_spec_displ_rotation_inc=XSDataAngle(\n')
            self._tomo_spec_displ_rotation_inc.exportLiteral(outfile, level, name_='_tomo_spec_displ_rotation_inc')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self._tomo_spec_displ_x:
            showIndent(outfile, level)
            outfile.write('_tomo_spec_displ_x=XSDataLength(\n')
            self._tomo_spec_displ_x.exportLiteral(outfile, level, name_='_tomo_spec_displ_x')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self._tomo_spec_displ_x_inc:
            showIndent(outfile, level)
            outfile.write('_tomo_spec_displ_x_inc=XSDataLength(\n')
            self._tomo_spec_displ_x_inc.exportLiteral(outfile, level, name_='_tomo_spec_displ_x_inc')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self._tomo_spec_displ_x_max:
            showIndent(outfile, level)
            outfile.write('_tomo_spec_displ_x_max=XSDataLength(\n')
            self._tomo_spec_displ_x_max.exportLiteral(outfile, level, name_='_tomo_spec_displ_x_max')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self._tomo_spec_displ_x_min:
            showIndent(outfile, level)
            outfile.write('_tomo_spec_displ_x_min=XSDataLength(\n')
            self._tomo_spec_displ_x_min.exportLiteral(outfile, level, name_='_tomo_spec_displ_x_min')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self._tomo_spec_displ_z:
            showIndent(outfile, level)
            outfile.write('_tomo_spec_displ_z=XSDataLength(\n')
            self._tomo_spec_displ_z.exportLiteral(outfile, level, name_='_tomo_spec_displ_z')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self._tomo_spec_displ_z_inc:
            showIndent(outfile, level)
            outfile.write('_tomo_spec_displ_z_inc=XSDataLength(\n')
            self._tomo_spec_displ_z_inc.exportLiteral(outfile, level, name_='_tomo_spec_displ_z_inc')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self._tomo_spec_displ_z_max:
            showIndent(outfile, level)
            outfile.write('_tomo_spec_displ_z_max=XSDataLength(\n')
            self._tomo_spec_displ_z_max.exportLiteral(outfile, level, name_='_tomo_spec_displ_z_max')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self._tomo_spec_displ_z_min:
            showIndent(outfile, level)
            outfile.write('_tomo_spec_displ_z_min=XSDataLength(\n')
            self._tomo_spec_displ_z_min.exportLiteral(outfile, level, name_='_tomo_spec_displ_z_min')
            showIndent(outfile, level)
            outfile.write('),\n')
    def build(self, node_):
        attrs = node_.attributes
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == '_diffrn_radiation_wavelength':
            obj_ = XSDataWavelength.factory()
            obj_.build(child_)
            self.set_diffrn_radiation_wavelength(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == '_pd_instr_dist_spec_detc':
            obj_ = XSDataLength.factory()
            obj_.build(child_)
            self.set_pd_instr_dist_spec_detc(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == '_pd_meas_2theta_range_inc':
            obj_ = XSDataAngle.factory()
            obj_.build(child_)
            self.set_pd_meas_2theta_range_inc(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == '_pd_meas_2theta_range_max':
            obj_ = XSDataAngle.factory()
            obj_.build(child_)
            self.set_pd_meas_2theta_range_max(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == '_pd_meas_2theta_range_min':
            obj_ = XSDataAngle.factory()
            obj_.build(child_)
            self.set_pd_meas_2theta_range_min(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == '_synchrotron_photon_flux':
            obj_ = XSDataFlux.factory()
            obj_.build(child_)
            self.set_synchrotron_photon_flux(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == '_synchrotron_ring_intensity':
            obj_ = XSDataDouble.factory()
            obj_.build(child_)
            self.set_synchrotron_ring_intensity(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == '_tomo_scan_ampl':
            obj_ = XSDataAngle.factory()
            obj_.build(child_)
            self.set_tomo_scan_ampl(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == '_tomo_scan_type':
            obj_ = XSDataString.factory()
            obj_.build(child_)
            self.set_tomo_scan_type(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == '_tomo_spec_displ_rotation':
            obj_ = XSDataAngle.factory()
            obj_.build(child_)
            self.set_tomo_spec_displ_rotation(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == '_tomo_spec_displ_rotation_inc':
            obj_ = XSDataAngle.factory()
            obj_.build(child_)
            self.set_tomo_spec_displ_rotation_inc(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == '_tomo_spec_displ_x':
            obj_ = XSDataLength.factory()
            obj_.build(child_)
            self.set_tomo_spec_displ_x(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == '_tomo_spec_displ_x_inc':
            obj_ = XSDataLength.factory()
            obj_.build(child_)
            self.set_tomo_spec_displ_x_inc(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == '_tomo_spec_displ_x_max':
            obj_ = XSDataLength.factory()
            obj_.build(child_)
            self.set_tomo_spec_displ_x_max(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == '_tomo_spec_displ_x_min':
            obj_ = XSDataLength.factory()
            obj_.build(child_)
            self.set_tomo_spec_displ_x_min(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == '_tomo_spec_displ_z':
            obj_ = XSDataLength.factory()
            obj_.build(child_)
            self.set_tomo_spec_displ_z(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == '_tomo_spec_displ_z_inc':
            obj_ = XSDataLength.factory()
            obj_.build(child_)
            self.set_tomo_spec_displ_z_inc(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == '_tomo_spec_displ_z_max':
            obj_ = XSDataLength.factory()
            obj_.build(child_)
            self.set_tomo_spec_displ_z_max(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == '_tomo_spec_displ_z_min':
            obj_ = XSDataLength.factory()
            obj_.build(child_)
            self.set_tomo_spec_displ_z_min(obj_)
# end class XSDataDiffractionCTInstrument


class XSDataDiffractionCTImage:
    subclass = None
    def __init__(self, _array_element_size_1=None, _array_element_size_2=None, _diffrn_detector_element_center_2=None, _diffrn_detector_element_center_1=None, _file_correction_image_dark_current=None, _file_correction_image_flat_field=None, _file_correction_image_mask=None, _file_correction_spline_spatial_distortion=None, _pd_instr_special_details_tilt_angle=None, _pd_instr_special_details_tilt_rotation=None):
        self._array_element_size_1 = _array_element_size_1
        self._array_element_size_2 = _array_element_size_2
        self._diffrn_detector_element_center_2 = _diffrn_detector_element_center_2
        self._diffrn_detector_element_center_1 = _diffrn_detector_element_center_1
        self._file_correction_image_dark_current = _file_correction_image_dark_current
        self._file_correction_image_flat_field = _file_correction_image_flat_field
        self._file_correction_image_mask = _file_correction_image_mask
        self._file_correction_spline_spatial_distortion = _file_correction_spline_spatial_distortion
        self._pd_instr_special_details_tilt_angle = _pd_instr_special_details_tilt_angle
        self._pd_instr_special_details_tilt_rotation = _pd_instr_special_details_tilt_rotation
    def factory(*args_, **kwargs_):
        if XSDataDiffractionCTImage.subclass:
            return XSDataDiffractionCTImage.subclass(*args_, **kwargs_)
        else:
            return XSDataDiffractionCTImage(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_array_element_size_1(self): return self._array_element_size_1
    def set_array_element_size_1(self, _array_element_size_1): self._array_element_size_1 = _array_element_size_1
    def get_array_element_size_2(self): return self._array_element_size_2
    def set_array_element_size_2(self, _array_element_size_2): self._array_element_size_2 = _array_element_size_2
    def get_diffrn_detector_element_center_2(self): return self._diffrn_detector_element_center_2
    def set_diffrn_detector_element_center_2(self, _diffrn_detector_element_center_2): self._diffrn_detector_element_center_2 = _diffrn_detector_element_center_2
    def get_diffrn_detector_element_center_1(self): return self._diffrn_detector_element_center_1
    def set_diffrn_detector_element_center_1(self, _diffrn_detector_element_center_1): self._diffrn_detector_element_center_1 = _diffrn_detector_element_center_1
    def get_file_correction_image_dark_current(self): return self._file_correction_image_dark_current
    def set_file_correction_image_dark_current(self, _file_correction_image_dark_current): self._file_correction_image_dark_current = _file_correction_image_dark_current
    def get_file_correction_image_flat_field(self): return self._file_correction_image_flat_field
    def set_file_correction_image_flat_field(self, _file_correction_image_flat_field): self._file_correction_image_flat_field = _file_correction_image_flat_field
    def get_file_correction_image_mask(self): return self._file_correction_image_mask
    def set_file_correction_image_mask(self, _file_correction_image_mask): self._file_correction_image_mask = _file_correction_image_mask
    def get_file_correction_spline_spatial_distortion(self): return self._file_correction_spline_spatial_distortion
    def set_file_correction_spline_spatial_distortion(self, _file_correction_spline_spatial_distortion): self._file_correction_spline_spatial_distortion = _file_correction_spline_spatial_distortion
    def get_pd_instr_special_details_tilt_angle(self): return self._pd_instr_special_details_tilt_angle
    def set_pd_instr_special_details_tilt_angle(self, _pd_instr_special_details_tilt_angle): self._pd_instr_special_details_tilt_angle = _pd_instr_special_details_tilt_angle
    def get_pd_instr_special_details_tilt_rotation(self): return self._pd_instr_special_details_tilt_rotation
    def set_pd_instr_special_details_tilt_rotation(self, _pd_instr_special_details_tilt_rotation): self._pd_instr_special_details_tilt_rotation = _pd_instr_special_details_tilt_rotation
    def export(self, outfile, level, name_='XSDataDiffractionCTImage'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataDiffractionCTImage'):
        pass
    def exportChildren(self, outfile, level, name_='XSDataDiffractionCTImage'):
        if self.get_array_element_size_1() != None :
            if self._array_element_size_1:
                self._array_element_size_1.export(outfile, level, name_='_array_element_size_1')
        if self.get_array_element_size_2() != None :
            if self._array_element_size_2:
                self._array_element_size_2.export(outfile, level, name_='_array_element_size_2')
        if self.get_diffrn_detector_element_center_2() != None :
            if self._diffrn_detector_element_center_2:
                self._diffrn_detector_element_center_2.export(outfile, level, name_='_diffrn_detector_element_center_2')
        if self.get_diffrn_detector_element_center_1() != None :
            if self._diffrn_detector_element_center_1:
                self._diffrn_detector_element_center_1.export(outfile, level, name_='_diffrn_detector_element_center_1')
        if self.get_file_correction_image_dark_current() != None :
            if self._file_correction_image_dark_current:
                self._file_correction_image_dark_current.export(outfile, level, name_='_file_correction_image_dark_current')
        if self.get_file_correction_image_flat_field() != None :
            if self._file_correction_image_flat_field:
                self._file_correction_image_flat_field.export(outfile, level, name_='_file_correction_image_flat_field')
        if self.get_file_correction_image_mask() != None :
            if self._file_correction_image_mask:
                self._file_correction_image_mask.export(outfile, level, name_='_file_correction_image_mask')
        if self.get_file_correction_spline_spatial_distortion() != None :
            if self._file_correction_spline_spatial_distortion:
                self._file_correction_spline_spatial_distortion.export(outfile, level, name_='_file_correction_spline_spatial_distortion')
        if self.get_pd_instr_special_details_tilt_angle() != None :
            if self._pd_instr_special_details_tilt_angle:
                self._pd_instr_special_details_tilt_angle.export(outfile, level, name_='_pd_instr_special_details_tilt_angle')
        if self.get_pd_instr_special_details_tilt_rotation() != None :
            if self._pd_instr_special_details_tilt_rotation:
                self._pd_instr_special_details_tilt_rotation.export(outfile, level, name_='_pd_instr_special_details_tilt_rotation')

    #Only to export the entire XML tree to a file stream on disk
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataDiffractionCTImage' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataDiffractionCTImage.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataDiffractionCTImage" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataDiffractionCTImage'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self._array_element_size_1:
            showIndent(outfile, level)
            outfile.write('_array_element_size_1=XSDataLength(\n')
            self._array_element_size_1.exportLiteral(outfile, level, name_='_array_element_size_1')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self._array_element_size_2:
            showIndent(outfile, level)
            outfile.write('_array_element_size_2=XSDataLength(\n')
            self._array_element_size_2.exportLiteral(outfile, level, name_='_array_element_size_2')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self._diffrn_detector_element_center_2:
            showIndent(outfile, level)
            outfile.write('_diffrn_detector_element_center_2=XSDataLength(\n')
            self._diffrn_detector_element_center_2.exportLiteral(outfile, level, name_='_diffrn_detector_element_center_2')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self._diffrn_detector_element_center_1:
            showIndent(outfile, level)
            outfile.write('_diffrn_detector_element_center_1=XSDataLength(\n')
            self._diffrn_detector_element_center_1.exportLiteral(outfile, level, name_='_diffrn_detector_element_center_1')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self._file_correction_image_dark_current:
            showIndent(outfile, level)
            outfile.write('_file_correction_image_dark_current=XSDataFile(\n')
            self._file_correction_image_dark_current.exportLiteral(outfile, level, name_='_file_correction_image_dark_current')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self._file_correction_image_flat_field:
            showIndent(outfile, level)
            outfile.write('_file_correction_image_flat_field=XSDataFile(\n')
            self._file_correction_image_flat_field.exportLiteral(outfile, level, name_='_file_correction_image_flat_field')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self._file_correction_image_mask:
            showIndent(outfile, level)
            outfile.write('_file_correction_image_mask=XSDataFile(\n')
            self._file_correction_image_mask.exportLiteral(outfile, level, name_='_file_correction_image_mask')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self._file_correction_spline_spatial_distortion:
            showIndent(outfile, level)
            outfile.write('_file_correction_spline_spatial_distortion=XSDataFile(\n')
            self._file_correction_spline_spatial_distortion.exportLiteral(outfile, level, name_='_file_correction_spline_spatial_distortion')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self._pd_instr_special_details_tilt_angle:
            showIndent(outfile, level)
            outfile.write('_pd_instr_special_details_tilt_angle=XSDataAngle(\n')
            self._pd_instr_special_details_tilt_angle.exportLiteral(outfile, level, name_='_pd_instr_special_details_tilt_angle')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self._pd_instr_special_details_tilt_rotation:
            showIndent(outfile, level)
            outfile.write('_pd_instr_special_details_tilt_rotation=XSDataAngle(\n')
            self._pd_instr_special_details_tilt_rotation.exportLiteral(outfile, level, name_='_pd_instr_special_details_tilt_rotation')
            showIndent(outfile, level)
            outfile.write('),\n')
    def build(self, node_):
        attrs = node_.attributes
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == '_array_element_size_1':
            obj_ = XSDataLength.factory()
            obj_.build(child_)
            self.set_array_element_size_1(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == '_array_element_size_2':
            obj_ = XSDataLength.factory()
            obj_.build(child_)
            self.set_array_element_size_2(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == '_diffrn_detector_element_center_2':
            obj_ = XSDataLength.factory()
            obj_.build(child_)
            self.set_diffrn_detector_element_center_2(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == '_diffrn_detector_element_center_1':
            obj_ = XSDataLength.factory()
            obj_.build(child_)
            self.set_diffrn_detector_element_center_1(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == '_file_correction_image_dark_current':
            obj_ = XSDataFile.factory()
            obj_.build(child_)
            self.set_file_correction_image_dark_current(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == '_file_correction_image_flat_field':
            obj_ = XSDataFile.factory()
            obj_.build(child_)
            self.set_file_correction_image_flat_field(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == '_file_correction_image_mask':
            obj_ = XSDataFile.factory()
            obj_.build(child_)
            self.set_file_correction_image_mask(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == '_file_correction_spline_spatial_distortion':
            obj_ = XSDataFile.factory()
            obj_.build(child_)
            self.set_file_correction_spline_spatial_distortion(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == '_pd_instr_special_details_tilt_angle':
            obj_ = XSDataAngle.factory()
            obj_.build(child_)
            self.set_pd_instr_special_details_tilt_angle(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == '_pd_instr_special_details_tilt_rotation':
            obj_ = XSDataAngle.factory()
            obj_.build(child_)
            self.set_pd_instr_special_details_tilt_rotation(obj_)
# end class XSDataDiffractionCTImage


class XSDataInputDiffractionCT:
    subclass = None
    def __init__(self, destinationDirectory=None, image=None, sinogramFileNamePrefix=None, powderDiffractionSubdirectory=None, powderDiffractionFormat=None, overrideImageParam=None, overrideScanParam=None):
        self.destinationDirectory = destinationDirectory
        self.image = image
        self.sinogramFileNamePrefix = sinogramFileNamePrefix
        self.powderDiffractionSubdirectory = powderDiffractionSubdirectory
        self.powderDiffractionFormat = powderDiffractionFormat
        self.overrideImageParam = overrideImageParam
        self.overrideScanParam = overrideScanParam
    def factory(*args_, **kwargs_):
        if XSDataInputDiffractionCT.subclass:
            return XSDataInputDiffractionCT.subclass(*args_, **kwargs_)
        else:
            return XSDataInputDiffractionCT(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getDestinationDirectory(self): return self.destinationDirectory
    def setDestinationDirectory(self, destinationDirectory): self.destinationDirectory = destinationDirectory
    def getImage(self): return self.image
    def setImage(self, image): self.image = image
    def getSinogramFileNamePrefix(self): return self.sinogramFileNamePrefix
    def setSinogramFileNamePrefix(self, sinogramFileNamePrefix): self.sinogramFileNamePrefix = sinogramFileNamePrefix
    def getPowderDiffractionSubdirectory(self): return self.powderDiffractionSubdirectory
    def setPowderDiffractionSubdirectory(self, powderDiffractionSubdirectory): self.powderDiffractionSubdirectory = powderDiffractionSubdirectory
    def getPowderDiffractionFormat(self): return self.powderDiffractionFormat
    def setPowderDiffractionFormat(self, powderDiffractionFormat): self.powderDiffractionFormat = powderDiffractionFormat
    def getOverrideImageParam(self): return self.overrideImageParam
    def setOverrideImageParam(self, overrideImageParam): self.overrideImageParam = overrideImageParam
    def getOverrideScanParam(self): return self.overrideScanParam
    def setOverrideScanParam(self, overrideScanParam): self.overrideScanParam = overrideScanParam
    def export(self, outfile, level, name_='XSDataInputDiffractionCT'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputDiffractionCT'):
        pass
    def exportChildren(self, outfile, level, name_='XSDataInputDiffractionCT'):
        ...
        if self.sinogramFileNamePrefix:
            self.sinogramFileNamePrefix.export(outfile, level, name_='sinogramFileNamePrefix')
        if self.powderDiffractionSubdirectory:
            self.powderDiffractionSubdirectory.export(outfile, level, name_='powderDiffractionSubdirectory')
        if self.getPowderDiffractionFormat() != None :
            if self.powderDiffractionFormat:
                self.powderDiffractionFormat.export(outfile, level, name_='powderDiffractionFormat')
        if self.getOverrideImageParam() != None :
            if self.overrideImageParam:
                self.overrideImageParam.export(outfile, level, name_='overrideImageParam')
        if self.getOverrideScanParam() != None :
            if self.overrideScanParam:
                self.overrideScanParam.export(outfile, level, name_='overrideScanParam')

    #Only to export the entire XML tree to a file stream on disk
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataInputDiffractionCT' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputDiffractionCT.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataInputDiffractionCT" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataInputDiffractionCT'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.destinationDirectory:
            showIndent(outfile, level)
            outfile.write('destinationDirectory=XSDataFile(\n')
            self.destinationDirectory.exportLiteral(outfile, level, name_='destinationDirectory')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.image:
            showIndent(outfile, level)
        ...
        if self.sinogramFileNamePrefix:
            showIndent(outfile, level)
            outfile.write('sinogramFileNamePrefix=XSDataString(\n')
            self.sinogramFileNamePrefix.exportLiteral(outfile, level, name_='sinogramFileNamePrefix')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.powderDiffractionSubdirectory:
            showIndent(outfile, level)
            outfile.write('powderDiffractionSubdirectory=XSDataString(\n')
            self.powderDiffractionSubdirectory.exportLiteral(outfile, level, name_='powderDiffractionSubdirectory')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.powderDiffractionFormat:
            showIndent(outfile, level)
            outfile.write('powderDiffractionFormat=XSDataString(\n')
            self.powderDiffractionFormat.exportLiteral(outfile, level, name_='powderDiffractionFormat')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.overrideImageParam:
            showIndent(outfile, level)
            outfile.write('overrideImageParam=XSDataDiffractionCTImage(\n')
            self.overrideImageParam.exportLiteral(outfile, level, name_='overrideImageParam')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.overrideScanParam:
            showIndent(outfile, level)
            outfile.write('overrideScanParam=XSDataDiffractionCTInstrument(\n')
            self.overrideScanParam.exportLiteral(outfile, level, name_='overrideScanParam')
            showIndent(outfile, level)
            outfile.write('),\n')
    def build(self, node_):
        attrs = node_.attributes
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            nodeName_ == 'sinogramFileNamePrefix':
            obj_ = XSDataString.factory()
            obj_.build(child_)
            self.setSinogramFileNamePrefix(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'powderDiffractionSubdirectory':
            obj_ = XSDataString.factory()
            obj_.build(child_)
            self.setPowderDiffractionSubdirectory(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'powderDiffractionFormat':
            obj_ = XSDataString.factory()
            obj_.build(child_)
            self.setPowderDiffractionFormat(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'overrideImageParam':
            obj_ = XSDataDiffractionCTImage.factory()
            obj_.build(child_)
            self.setOverrideImageParam(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'overrideScanParam':
            obj_ = XSDataDiffractionCTInstrument.factory()
            obj_.build(child_)
            self.setOverrideScanParam(obj_)
# end class XSDataInputDiffractionCT


class XSDataResultDiffractionCT(XSDataResult):
    subclass = None
    def __init__(self, integratedIntensities=None, sinogramFile=None, status=None):
        XSDataResult.__init__(self, status)
        self.integratedIntensities = integratedIntensities
        if sinogramFile is None:
            self.sinogramFile = []
        else:
            self.sinogramFile = sinogramFile
    def factory(*args_, **kwargs_):
        if XSDataResultDiffractionCT.subclass:
            return XSDataResultDiffractionCT.subclass(*args_, **kwargs_)
        else:
            return XSDataResultDiffractionCT(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getIntegratedIntensities(self): return self.integratedIntensities
    def setIntegratedIntensities(self, integratedIntensities): self.integratedIntensities = integratedIntensities
    def getSinogramFile(self): return self.sinogramFile
    def setSinogramFile(self, sinogramFile): self.sinogramFile = sinogramFile
    def addSinogramFile(self, value): self.sinogramFile.append(value)
    def insertSinogramFile(self, index, value): self.sinogramFile[index] = value
    def export(self, outfile, level, name_='XSDataResultDiffractionCT'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultDiffractionCT'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultDiffractionCT')
    def exportChildren(self, outfile, level, name_='XSDataResultDiffractionCT'):
        if self.integratedIntensities:
            self.integratedIntensities.export(outfile, level, name_='integratedIntensities')
        for sinogramFile_ in self.getSinogramFile():
            sinogramFile_.export(outfile, level, name_='sinogramFile')
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataResultDiffractionCT' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultDiffractionCT.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataResultDiffractionCT" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataResultDiffractionCT'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.integratedIntensities:
            showIndent(outfile, level)
            outfile.write('integratedIntensities=XSDataFile(\n')
            self.integratedIntensities.exportLiteral(outfile, level, name_='integratedIntensities')
            showIndent(outfile, level)
            outfile.write('),\n')
        showIndent(outfile, level)
        outfile.write('sinogramFile=[\n')
        level += 1
        for sinogramFile in self.sinogramFile:
            showIndent(outfile, level)
            outfile.write('XSDataFile(\n')
            sinogramFile.exportLiteral(outfile, level, name_='sinogramFile')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'integratedIntensities':
            obj_ = XSDataFile.factory()
            obj_.build(child_)
            self.setIntegratedIntensities(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'sinogramFile':
            obj_ = XSDataFile.factory()
            obj_.build(child_)
            self.sinogramFile.append(obj_)
        XSDataResult.buildChildren(self, child_, nodeName_)
# end class XSDataResultDiffractionCT


class XSDataInputReadHeader(XSDataInput):
    subclass = None
    def __init__(self, inputFile=None, configuration=None):
        XSDataInput.__init__(self, configuration)
        self.inputFile = inputFile
    def factory(*args_, **kwargs_):
        if XSDataInputReadHeader.subclass:
            return XSDataInputReadHeader.subclass(*args_, **kwargs_)
        else:
            return XSDataInputReadHeader(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getInputFile(self): return self.inputFile
    def setInputFile(self, inputFile): self.inputFile = inputFile
    def export(self, outfile, level, name_='XSDataInputReadHeader'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputReadHeader'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputReadHeader')
    def exportChildren(self, outfile, level, name_='XSDataInputReadHeader'):
        if self.inputFile:
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataInputReadHeader' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputReadHeader.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataInputReadHeader" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataInputReadHeader'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.inputFile:
            showIndent(outfile, level)
            outfile.write('inputFile=XSDataFile(\n')
            self.inputFile.exportLiteral(outfile, level, name_='inputFile')
            showIndent(outfile, level)
            outfile.write('),\n')
...
# end class XSDataInputReadHeader


class XSDataResultReadHeader(XSDataResult):
    subclass = None
    def __init__(self, dictionary=None, status=None):
        XSDataResult.__init__(self, status)
        self.dictionary = dictionary
    def factory(*args_, **kwargs_):
        if XSDataResultReadHeader.subclass:
            return XSDataResultReadHeader.subclass(*args_, **kwargs_)
        else:
            return XSDataResultReadHeader(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getDictionary(self): return self.dictionary
    def setDictionary(self, dictionary): self.dictionary = dictionary
    def export(self, outfile, level, name_='XSDataResultReadHeader'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultReadHeader'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultReadHeader')
    def exportChildren(self, outfile, level, name_='XSDataResultReadHeader'):
        if self.dictionary:
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataResultReadHeader' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultReadHeader.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataResultReadHeader" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataResultReadHeader'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def buildChildren(self, child_, nodeName_):
        ...
        XSDataResult.buildChildren(self, child_, nodeName_)
# end class XSDataResultReadHeader


class XSDataInputPowderIntegration(XSDataInput):
    subclass = None
    def __init__(self, destinationDir=None, imageFile=None, imageParameters=None, instrumentParameters=None, configuration=None):
        XSDataInput.__init__(self, configuration)
        self.destinationDir = destinationDir
        self.imageFile = imageFile
        self.imageParameters = imageParameters
        self.instrumentParameters = instrumentParameters
    def factory(*args_, **kwargs_):
        if XSDataInputPowderIntegration.subclass:
            return XSDataInputPowderIntegration.subclass(*args_, **kwargs_)
        else:
            return XSDataInputPowderIntegration(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getDestinationDir(self): return self.destinationDir
    def setDestinationDir(self, destinationDir): self.destinationDir = destinationDir
    def getImageFile(self): return self.imageFile
    def setImageFile(self, imageFile): self.imageFile = imageFile
    def getImageParameters(self): return self.imageParameters
    def setImageParameters(self, imageParameters): self.imageParameters = imageParameters
    def getInstrumentParameters(self): return self.instrumentParameters
    def setInstrumentParameters(self, instrumentParameters): self.instrumentParameters = instrumentParameters
    def export(self, outfile, level, name_='XSDataInputPowderIntegration'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputPowderIntegration'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputPowderIntegration')
    def exportChildren(self, outfile, level, name_='XSDataInputPowderIntegration'):
        if self.destinationDir:
            self.destinationDir.export(outfile, level, name_='destinationDir')
        if self.imageFile:
            self.imageFile.export(outfile, level, name_='imageFile')
        if self.imageParameters:
            self.imageParameters.export(outfile, level, name_='imageParameters')
        if self.instrumentParameters:
            self.instrumentParameters.export(outfile, level, name_='instrumentParameters')
        XSDataInput.exportChildren(self, outfile, level, name_)
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataInputPowderIntegration' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputPowderIntegration.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataInputPowderIntegration" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataInputPowderIntegration'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.destinationDir:
            showIndent(outfile, level)
            outfile.write('destinationDir=XSDataFile(\n')
            self.destinationDir.exportLiteral(outfile, level, name_='destinationDir')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.imageFile:
            showIndent(outfile, level)
            outfile.write('imageFile=XSDataFile(\n')
            self.imageFile.exportLiteral(outfile, level, name_='imageFile')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.imageParameters:
            showIndent(outfile, level)
            outfile.write('imageParameters=XSDataDiffractionCTImage(\n')
            self.imageParameters.exportLiteral(outfile, level, name_='imageParameters')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.instrumentParameters:
            showIndent(outfile, level)
            outfile.write('instrumentParameters=XSDataDiffractionCTInstrument(\n')
            self.instrumentParameters.exportLiteral(outfile, level, name_='instrumentParameters')
            showIndent(outfile, level)
            outfile.write('),\n')
        XSDataInput.exportLiteralChildren(self, outfile, level, name_)
    def build(self, node_):
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'destinationDir':
            obj_ = XSDataFile.factory()
            obj_.build(child_)
            self.setDestinationDir(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'imageFile':
            obj_ = XSDataFile.factory()
            obj_.build(child_)
            ...
            nodeName_ == 'imageParameters':
            obj_ = XSDataDiffractionCTImage.factory()
            obj_.build(child_)
            self.setImageParameters(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'instrumentParameters':
            obj_ = XSDataDiffractionCTInstrument.factory()
            obj_.build(child_)
            self.setInstrumentParameters(obj_)
        XSDataInput.buildChildren(self, child_, nodeName_)
# end class XSDataInputPowderIntegration


class XSDataResultPowderIntegration(XSDataResult):
    subclass = None
    def __init__(self, integratedIntensities=None, status=None):
        XSDataResult.__init__(self, status)
        self.integratedIntensities = integratedIntensities
    def factory(*args_, **kwargs_):
        if XSDataResultPowderIntegration.subclass:
            return XSDataResultPowderIntegration.subclass(*args_, **kwargs_)
        else:
            return XSDataResultPowderIntegration(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getIntegratedIntensities(self): return self.integratedIntensities
    def setIntegratedIntensities(self, integratedIntensities): self.integratedIntensities = integratedIntensities
    def export(self, outfile, level, name_='XSDataResultPowderIntegration'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultPowderIntegration'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultPowderIntegration')
    def exportChildren(self, outfile, level, name_='XSDataResultPowderIntegration'):
        if self.integratedIntensities:
            self.integratedIntensities.export(outfile, level, name_='integratedIntensities')
        XSDataResult.exportChildren(self, outfile, level, name_)
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataResultPowderIntegration' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultPowderIntegration.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataResultPowderIntegration" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataResultPowderIntegration'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            self.setIntegratedIntensities(obj_)
        XSDataResult.buildChildren(self, child_, nodeName_)
# end class XSDataResultPowderIntegration


class XSDataInputWriteSinogram(XSDataInput):
    subclass = None
    def __init__(self, integratedIntensities=None, sinogramDirectory=None, sinogramFileNamePrefix=None, configuration=None):
        XSDataInput.__init__(self, configuration)
        self.integratedIntensities = integratedIntensities
        self.sinogramDirectory = sinogramDirectory
        self.sinogramFileNamePrefix = sinogramFileNamePrefix
    def factory(*args_, **kwargs_):
        if XSDataInputWriteSinogram.subclass:
            return XSDataInputWriteSinogram.subclass(*args_, **kwargs_)
        else:
            return XSDataInputWriteSinogram(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getIntegratedIntensities(self): return self.integratedIntensities
    def setIntegratedIntensities(self, integratedIntensities): self.integratedIntensities = integratedIntensities
    ...
    def getSinogramFileNamePrefix(self): return self.sinogramFileNamePrefix
    def setSinogramFileNamePrefix(self, sinogramFileNamePrefix): self.sinogramFileNamePrefix = sinogramFileNamePrefix
    def export(self, outfile, level, name_='XSDataInputWriteSinogram'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputWriteSinogram'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputWriteSinogram')
    def exportChildren(self, outfile, level, name_='XSDataInputWriteSinogram'):
        if self.integratedIntensities:
            self.integratedIntensities.export(outfile, level, name_='integratedIntensities')
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataInputWriteSinogram' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputWriteSinogram.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataInputWriteSinogram" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataInputWriteSinogram'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            self.setSinogramFileNamePrefix(obj_)
        XSDataInput.buildChildren(self, child_, nodeName_)
# end class XSDataInputWriteSinogram


class XSDataResultWriteSinogram:
    subclass = None
    def __init__(self, sinogramFile=None):
        if sinogramFile is None:
            self.sinogramFile = []
        else:
            self.sinogramFile = sinogramFile
    def factory(*args_, **kwargs_):
        if XSDataResultWriteSinogram.subclass:
            return XSDataResultWriteSinogram.subclass(*args_, **kwargs_)
        else:
            return XSDataResultWriteSinogram(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getSinogramFile(self): return self.sinogramFile
    def setSinogramFile(self, sinogramFile): self.sinogramFile = sinogramFile
    def addSinogramFile(self, value): self.sinogramFile.append(value)
    def insertSinogramFile(self, index, value): self.sinogramFile[index] = value
    def export(self, outfile, level, name_='XSDataResultWriteSinogram'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultWriteSinogram'):
        pass
    def exportChildren(self, outfile, level, name_='XSDataResultWriteSinogram'):
        for sinogramFile_ in self.getSinogramFile():
            sinogramFile_.export(outfile, level, name_='sinogramFile')
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataResultWriteSinogram' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultWriteSinogram.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataResultWriteSinogram" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataResultWriteSinogram'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            obj_.build(child_)
            self.sinogramFile.append(obj_)
# end class XSDataResultWriteSinogram
...
class SaxXSDataDoubleHandler(handler.ContentHandler):
    ...
    def startElement(self, name, attrs):
        ...
        elif name == '_diffrn_radiation_wavelength':
            obj = XSDataWavelength.factory()
            stackObj = SaxStackElement('_diffrn_radiation_wavelength', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == '_pd_instr_dist_spec_detc':
            obj = XSDataLength.factory()
            stackObj = SaxStackElement('_pd_instr_dist_spec_detc', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == '_pd_meas_2theta_range_inc':
            obj = XSDataAngle.factory()
            stackObj = SaxStackElement('_pd_meas_2theta_range_inc', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == '_pd_meas_2theta_range_max':
            obj = XSDataAngle.factory()
            stackObj = SaxStackElement('_pd_meas_2theta_range_max', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == '_pd_meas_2theta_range_min':
            obj = XSDataAngle.factory()
            stackObj = SaxStackElement('_pd_meas_2theta_range_min', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == '_synchrotron_photon_flux':
            obj = XSDataFlux.factory()
            stackObj = SaxStackElement('_synchrotron_photon_flux', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == '_synchrotron_ring_intensity':
            obj = XSDataDouble.factory()
            stackObj = SaxStackElement('_synchrotron_ring_intensity', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == '_tomo_scan_ampl':
            obj = XSDataAngle.factory()
            stackObj = SaxStackElement('_tomo_scan_ampl', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == '_tomo_scan_type':
            obj = XSDataString.factory()
            stackObj = SaxStackElement('_tomo_scan_type', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == '_tomo_spec_displ_rotation':
            obj = XSDataAngle.factory()
            stackObj = SaxStackElement('_tomo_spec_displ_rotation', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == '_tomo_spec_displ_rotation_inc':
            obj = XSDataAngle.factory()
            stackObj = SaxStackElement('_tomo_spec_displ_rotation_inc', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == '_tomo_spec_displ_x':
            obj = XSDataLength.factory()
            stackObj = SaxStackElement('_tomo_spec_displ_x', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == '_tomo_spec_displ_x_inc':
            obj = XSDataLength.factory()
            stackObj = SaxStackElement('_tomo_spec_displ_x_inc', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == '_tomo_spec_displ_x_max':
            obj = XSDataLength.factory()
            stackObj = SaxStackElement('_tomo_spec_displ_x_max', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == '_tomo_spec_displ_x_min':
            obj = XSDataLength.factory()
            stackObj = SaxStackElement('_tomo_spec_displ_x_min', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == '_tomo_spec_displ_z':
            obj = XSDataLength.factory()
            stackObj = SaxStackElement('_tomo_spec_displ_z', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == '_tomo_spec_displ_z_inc':
            obj = XSDataLength.factory()
            stackObj = SaxStackElement('_tomo_spec_displ_z_inc', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == '_tomo_spec_displ_z_max':
            obj = XSDataLength.factory()
            stackObj = SaxStackElement('_tomo_spec_displ_z_max', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == '_tomo_spec_displ_z_min':
            obj = XSDataLength.factory()
            stackObj = SaxStackElement('_tomo_spec_displ_z_min', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == '_array_element_size_1':
            obj = XSDataLength.factory()
            stackObj = SaxStackElement('_array_element_size_1', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == '_array_element_size_2':
            obj = XSDataLength.factory()
            stackObj = SaxStackElement('_array_element_size_2', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == '_diffrn_detector_element_center_2':
            obj = XSDataLength.factory()
            stackObj = SaxStackElement('_diffrn_detector_element_center_2', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == '_diffrn_detector_element_center_1':
            obj = XSDataLength.factory()
            stackObj = SaxStackElement('_diffrn_detector_element_center_1', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == '_file_correction_image_dark_current':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('_file_correction_image_dark_current', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == '_file_correction_image_flat_field':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('_file_correction_image_flat_field', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == '_file_correction_image_mask':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('_file_correction_image_mask', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == '_file_correction_spline_spatial_distortion':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('_file_correction_spline_spatial_distortion', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == '_pd_instr_special_details_tilt_angle':
            obj = XSDataAngle.factory()
            stackObj = SaxStackElement('_pd_instr_special_details_tilt_angle', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == '_pd_instr_special_details_tilt_rotation':
            obj = XSDataAngle.factory()
            stackObj = SaxStackElement('_pd_instr_special_details_tilt_rotation', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'destinationDirectory':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('destinationDirectory', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'image':
        ...
        elif name == 'sinogramFileNamePrefix':
            obj = XSDataString.factory()
            stackObj = SaxStackElement('sinogramFileNamePrefix', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'powderDiffractionSubdirectory':
            obj = XSDataString.factory()
            stackObj = SaxStackElement('powderDiffractionSubdirectory', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'powderDiffractionFormat':
            obj = XSDataString.factory()
            stackObj = SaxStackElement('powderDiffractionFormat', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'overrideImageParam':
            obj = XSDataDiffractionCTImage.factory()
            stackObj = SaxStackElement('overrideImageParam', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'overrideScanParam':
            obj = XSDataDiffractionCTInstrument.factory()
            stackObj = SaxStackElement('overrideScanParam', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'integratedIntensities':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('integratedIntensities', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'sinogramFile':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('sinogramFile', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'inputFile':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('inputFile', obj)
            self.stack.append(stackObj)
            done = 1
        ...
        elif name == 'destinationDir':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('destinationDir', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'imageFile':
            obj = XSDataFile.factory()
        ...
        elif name == 'imageParameters':
            obj = XSDataDiffractionCTImage.factory()
            stackObj = SaxStackElement('imageParameters', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'instrumentParameters':
            obj = XSDataDiffractionCTInstrument.factory()
            stackObj = SaxStackElement('instrumentParameters', obj)
            self.stack.append(stackObj)
            done = 1
    ...
    def endElement(self, name):
        ...
        if name == 'XSDataDouble':
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.set_diffrn_radiation_wavelength(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == '_pd_instr_dist_spec_detc':
            if len(self.stack) >= 2:
                self.stack[-2].obj.set_pd_instr_dist_spec_detc(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == '_pd_meas_2theta_range_inc':
            if len(self.stack) >= 2:
                self.stack[-2].obj.set_pd_meas_2theta_range_inc(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == '_pd_meas_2theta_range_max':
            if len(self.stack) >= 2:
                self.stack[-2].obj.set_pd_meas_2theta_range_max(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == '_pd_meas_2theta_range_min':
            if len(self.stack) >= 2:
                self.stack[-2].obj.set_pd_meas_2theta_range_min(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == '_synchrotron_photon_flux':
            if len(self.stack) >= 2:
                self.stack[-2].obj.set_synchrotron_photon_flux(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == '_synchrotron_ring_intensity':
            if len(self.stack) >= 2:
                self.stack[-2].obj.set_synchrotron_ring_intensity(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == '_tomo_scan_ampl':
            if len(self.stack) >= 2:
                self.stack[-2].obj.set_tomo_scan_ampl(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == '_tomo_scan_type':
            if len(self.stack) >= 2:
                self.stack[-2].obj.set_tomo_scan_type(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == '_tomo_spec_displ_rotation':
            if len(self.stack) >= 2:
                self.stack[-2].obj.set_tomo_spec_displ_rotation(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == '_tomo_spec_displ_rotation_inc':
            if len(self.stack) >= 2:
                self.stack[-2].obj.set_tomo_spec_displ_rotation_inc(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == '_tomo_spec_displ_x':
            if len(self.stack) >= 2:
                self.stack[-2].obj.set_tomo_spec_displ_x(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == '_tomo_spec_displ_x_inc':
            if len(self.stack) >= 2:
                self.stack[-2].obj.set_tomo_spec_displ_x_inc(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == '_tomo_spec_displ_x_max':
            if len(self.stack) >= 2:
                self.stack[-2].obj.set_tomo_spec_displ_x_max(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == '_tomo_spec_displ_x_min':
            if len(self.stack) >= 2:
                self.stack[-2].obj.set_tomo_spec_displ_x_min(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == '_tomo_spec_displ_z':
            if len(self.stack) >= 2:
                self.stack[-2].obj.set_tomo_spec_displ_z(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == '_tomo_spec_displ_z_inc':
            if len(self.stack) >= 2:
                self.stack[-2].obj.set_tomo_spec_displ_z_inc(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == '_tomo_spec_displ_z_max':
            if len(self.stack) >= 2:
                self.stack[-2].obj.set_tomo_spec_displ_z_max(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == '_tomo_spec_displ_z_min':
            if len(self.stack) >= 2:
                self.stack[-2].obj.set_tomo_spec_displ_z_min(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == '_array_element_size_1':
            if len(self.stack) >= 2:
                self.stack[-2].obj.set_array_element_size_1(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == '_array_element_size_2':
            if len(self.stack) >= 2:
                self.stack[-2].obj.set_array_element_size_2(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == '_diffrn_detector_element_center_2':
            if len(self.stack) >= 2:
                self.stack[-2].obj.set_diffrn_detector_element_center_2(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == '_diffrn_detector_element_center_1':
            if len(self.stack) >= 2:
                self.stack[-2].obj.set_diffrn_detector_element_center_1(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == '_file_correction_image_dark_current':
            if len(self.stack) >= 2:
                self.stack[-2].obj.set_file_correction_image_dark_current(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == '_file_correction_image_flat_field':
            if len(self.stack) >= 2:
                self.stack[-2].obj.set_file_correction_image_flat_field(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == '_file_correction_image_mask':
            if len(self.stack) >= 2:
                self.stack[-2].obj.set_file_correction_image_mask(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == '_file_correction_spline_spatial_distortion':
            if len(self.stack) >= 2:
                self.stack[-2].obj.set_file_correction_spline_spatial_distortion(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == '_pd_instr_special_details_tilt_angle':
            if len(self.stack) >= 2:
                self.stack[-2].obj.set_pd_instr_special_details_tilt_angle(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == '_pd_instr_special_details_tilt_rotation':
            if len(self.stack) >= 2:
                self.stack[-2].obj.set_pd_instr_special_details_tilt_rotation(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'destinationDirectory':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setDestinationDirectory(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'image':
            if len(self.stack) >= 2:
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setSinogramFileNamePrefix(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'powderDiffractionSubdirectory':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setPowderDiffractionSubdirectory(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'powderDiffractionFormat':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setPowderDiffractionFormat(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'overrideImageParam':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setOverrideImageParam(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'overrideScanParam':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setOverrideScanParam(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'integratedIntensities':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setIntegratedIntensities(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'sinogramFile':
            if len(self.stack) >= 2:
                self.stack[-2].obj.addSinogramFile(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'inputFile':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setInputFile(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'dictionary':
            if len(self.stack) >= 2:
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setDestinationDir(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'imageFile':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setImageFile(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'imageParameters':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setImageParameters(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'instrumentParameters':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setInstrumentParameters(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'sinogramDirectory':
            if len(self.stack) >= 2:
