...
xsDataBaseName=XSDataControlDLSArchiverv10
xsdHomeDir=${EDNA_HOME}/darcv1/plugins/EDPluginControlDLSArchiver-v1.0/datamodel
pyHomeDir=${EDNA_HOME}/darcv1/plugins/EDPluginControlDLSArchiver-v1.0/plugins
