...
#
# Generated Fri Jul 23 10:02:19 2010 by EDGenerateDS.py.
#
...
class XSDataInputPluginControlDLSArchiver( XSDataInput ):
    subclass = None
    def __init__( self, archiveLocation=None, dropZonePath=None, ignoreList=None, ignoreSubdirList=None, pollTime=None, srbDropFilePath=None, nonExistantFiles=None, nbRoundsDelay=None, configuration=None ):
        XSDataInput.__init__( self, configuration )
        self.archiveLocation = archiveLocation
        self.dropZonePath = dropZonePath
        if ignoreList is None:
            self.ignoreList = []
        else:
            self.ignoreList = ignoreList
        if ignoreSubdirList is None:
            self.ignoreSubdirList = []
        else:
            self.ignoreSubdirList = ignoreSubdirList
        self.pollTime = pollTime
        self.srbDropFilePath = srbDropFilePath
        self.nonExistantFiles = nonExistantFiles
        self.nbRoundsDelay = nbRoundsDelay
    def factory( *args_, **kwargs_ ):
        if XSDataInputPluginControlDLSArchiver.subclass:
            return XSDataInputPluginControlDLSArchiver.subclass( *args_, **kwargs_ )
        else:
            return XSDataInputPluginControlDLSArchiver( *args_, **kwargs_ )
    factory = staticmethod( factory )
    def getArchiveLocation( self ): return self.archiveLocation
    def setArchiveLocation( self, archiveLocation ): self.archiveLocation = archiveLocation
    def getDropZonePath( self ): return self.dropZonePath
    def setDropZonePath( self, dropZonePath ): self.dropZonePath = dropZonePath
    def getIgnoreList( self ): return self.ignoreList
    def setIgnoreList( self, ignoreList ): self.ignoreList = ignoreList
    def addIgnoreList( self, value ): self.ignoreList.append( value )
    def insertIgnoreList( self, index, value ): self.ignoreList[index] = value
    def getIgnoreSubdirList( self ): return self.ignoreSubdirList
    def setIgnoreSubdirList( self, ignoreSubdirList ): self.ignoreSubdirList = ignoreSubdirList
    def addIgnoreSubdirList( self, value ): self.ignoreSubdirList.append( value )
    def insertIgnoreSubdirList( self, index, value ): self.ignoreSubdirList[index] = value
    def getPollTime( self ): return self.pollTime
    def setPollTime( self, pollTime ): self.pollTime = pollTime
    def getSrbDropFilePath( self ): return self.srbDropFilePath
    def setSrbDropFilePath( self, srbDropFilePath ): self.srbDropFilePath = srbDropFilePath
    def getNonExistantFiles( self ): return self.nonExistantFiles
    def setNonExistantFiles( self, nonExistantFiles ): self.nonExistantFiles = nonExistantFiles
    def getNbRoundsDelay( self ): return self.nbRoundsDelay
    def setNbRoundsDelay( self, nbRoundsDelay ): self.nbRoundsDelay = nbRoundsDelay
    def export( self, outfile, level, name_='XSDataInputPluginControlDLSArchiver' ):
        showIndent( outfile, level )
        outfile.write( '<%s>\n' % name_ )
        self.exportChildren( outfile, level + 1, name_ )
        showIndent( outfile, level )
        outfile.write( '</%s>\n' % name_ )
    def exportAttributes( self, outfile, level, name_='XSDataInputPluginControlDLSArchiver' ):
        XSDataInput.exportAttributes( self, outfile, level, name_='XSDataInputPluginControlDLSArchiver' )
    def exportChildren( self, outfile, level, name_='XSDataInputPluginControlDLSArchiver' ):
        if self.archiveLocation:
            self.archiveLocation.export( outfile, level, name_='archiveLocation' )
        if self.dropZonePath:
            self.dropZonePath.export( outfile, level, name_='dropZonePath' )
        for ignoreList_ in self.getIgnoreList():
            ignoreList_.export( outfile, level, name_='ignoreList' )
        for ignoreSubdirList_ in self.getIgnoreSubdirList():
            ignoreSubdirList_.export( outfile, level, name_='ignoreSubdirList' )
        if self.pollTime:
            self.pollTime.export( outfile, level, name_='pollTime' )
        if self.srbDropFilePath:
            self.srbDropFilePath.export( outfile, level, name_='srbDropFilePath' )
        if self.nonExistantFiles:
            self.nonExistantFiles.export( outfile, level, name_='nonExistantFiles' )
        if self.nbRoundsDelay:
            self.nbRoundsDelay.export( outfile, level, name_='nbRoundsDelay' )
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write( "<?xml version=\"1.0\" ?>\n" )
        self.export( outfile, 0, name_='XSDataInputPluginControlDLSArchiver' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString( _inString )
        rootNode = doc.documentElement
        rootObj = XSDataInputPluginControlDLSArchiver.factory()
        rootObj.build( rootNode )
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write( '<?xml version="1.0" ?>\n' )
        self.export( oStreamString, 0, name_="XSDataInputPluginControlDLSArchiver" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral( self, outfile, level, name_='XSDataInputPluginControlDLSArchiver' ):
        level += 1
        self.exportLiteralAttributes( outfile, level, name_ )
        self.exportLiteralChildren( outfile, level, name_ )
    def exportLiteralAttributes( self, outfile, level, name_ ):
    ...
    def exportLiteralChildren( self, outfile, level, name_ ):
        if self.archiveLocation:
            showIndent( outfile, level )
            outfile.write( 'archiveLocation=XSDataFile(\n' )
            self.archiveLocation.exportLiteral( outfile, level, name_='archiveLocation' )
            showIndent( outfile, level )
            outfile.write( '),\n' )
        if self.dropZonePath:
            showIndent( outfile, level )
            outfile.write( 'dropZonePath=XSDataFile(\n' )
            self.dropZonePath.exportLiteral( outfile, level, name_='dropZonePath' )
            showIndent( outfile, level )
            outfile.write( '),\n' )
        showIndent( outfile, level )
        ...
        for ignoreList in self.ignoreList:
            ...
            ignoreList.exportLiteral( outfile, level, name_='ignoreList' )
            showIndent( outfile, level )
            outfile.write( '),\n' )
        level -= 1
        showIndent( outfile, level )
        outfile.write( '],\n' )
        showIndent( outfile, level )
        outfile.write( 'ignoreSubdirList=[\n' )
        level += 1
        for ignoreSubdirList in self.ignoreSubdirList:
            showIndent( outfile, level )
            outfile.write( 'XSDataString(\n' )
            ignoreSubdirList.exportLiteral( outfile, level, name_='ignoreSubdirList' )
            showIndent( outfile, level )
            outfile.write( '),\n' )
        level -= 1
        showIndent( outfile, level )
        ...
        if self.pollTime:
            showIndent( outfile, level )
            outfile.write( 'pollTime=XSDataInteger(\n' )
            self.pollTime.exportLiteral( outfile, level, name_='pollTime' )
            showIndent( outfile, level )
            outfile.write( '),\n' )
        if self.srbDropFilePath:
            showIndent( outfile, level )
            outfile.write( 'srbDropFilePath=XSDataFile(\n' )
            self.srbDropFilePath.exportLiteral( outfile, level, name_='srbDropFilePath' )
            showIndent( outfile, level )
            outfile.write( '),\n' )
        if self.nonExistantFiles:
            showIndent( outfile, level )
            outfile.write( 'nonExistantFiles=XSDataFile(\n' )
            self.nonExistantFiles.exportLiteral( outfile, level, name_='nonExistantFiles' )
            showIndent( outfile, level )
            outfile.write( '),\n' )
        if self.nbRoundsDelay:
            showIndent( outfile, level )
            outfile.write( 'nbRoundsDelay=XSDataInteger(\n' )
            self.nbRoundsDelay.exportLiteral( outfile, level, name_='nbRoundsDelay' )
            showIndent( outfile, level )
            outfile.write( '),\n' )
    ...
    def buildChildren( self, child_, nodeName_ ):
        if child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'archiveLocation':
            obj_ = XSDataFile.factory()
            obj_.build( child_ )
            self.setArchiveLocation( obj_ )
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'dropZonePath':
            obj_ = XSDataFile.factory()
            obj_.build( child_ )
            self.setDropZonePath( obj_ )
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'ignoreList':
            obj_ = XSDataString.factory()
            obj_.build( child_ )
            self.ignoreList.append( obj_ )
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'ignoreSubdirList':
            obj_ = XSDataString.factory()
            obj_.build( child_ )
            self.ignoreSubdirList.append( obj_ )
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'pollTime':
            obj_ = XSDataInteger.factory()
            obj_.build( child_ )
            self.setPollTime( obj_ )
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'srbDropFilePath':
            obj_ = XSDataFile.factory()
            obj_.build( child_ )
            self.setSrbDropFilePath( obj_ )
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'nonExistantFiles':
            obj_ = XSDataFile.factory()
            obj_.build( child_ )
            self.setNonExistantFiles( obj_ )
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'nbRoundsDelay':
            obj_ = XSDataInteger.factory()
            obj_.build( child_ )
            self.setNbRoundsDelay( obj_ )
        XSDataInput.buildChildren( self, child_, nodeName_ )
# end class XSDataInputPluginControlDLSArchiver


class XSDataResultPluginControlDLSArchiver( XSDataResult ):
    subclass = None
    def __init__( self, status=None, valueOf_='' ):
        XSDataResult.__init__( self, status )
        self.valueOf_ = valueOf_
    def factory( *args_, **kwargs_ ):
        if XSDataResultPluginControlDLSArchiver.subclass:
            return XSDataResultPluginControlDLSArchiver.subclass( *args_, **kwargs_ )
        else:
            return XSDataResultPluginControlDLSArchiver( *args_, **kwargs_ )
    factory = staticmethod( factory )
    def getValueOf_( self ): return self.valueOf_
    def setValueOf_( self, valueOf_ ): self.valueOf_ = valueOf_
    def export( self, outfile, level, name_='XSDataResultPluginControlDLSArchiver' ):
        showIndent( outfile, level )
        outfile.write( '<%s>\n' % name_ )
        self.exportChildren( outfile, level + 1, name_ )
        showIndent( outfile, level )
        outfile.write( '</%s>\n' % name_ )
    def exportAttributes( self, outfile, level, name_='XSDataResultPluginControlDLSArchiver' ):
        XSDataResult.exportAttributes( self, outfile, level, name_='XSDataResultPluginControlDLSArchiver' )
    def exportChildren( self, outfile, level, name_='XSDataResultPluginControlDLSArchiver' ):
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write( "<?xml version=\"1.0\" ?>\n" )
        self.export( outfile, 0, name_='XSDataResultPluginControlDLSArchiver' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString( _inString )
        rootNode = doc.documentElement
        rootObj = XSDataResultPluginControlDLSArchiver.factory()
        rootObj.build( rootNode )
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write( '<?xml version="1.0" ?>\n' )
        self.export( oStreamString, 0, name_="XSDataResultPluginControlDLSArchiver" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral( self, outfile, level, name_='XSDataResultPluginControlDLSArchiver' ):
        level += 1
        self.exportLiteralAttributes( outfile, level, name_ )
        self.exportLiteralChildren( outfile, level, name_ )
    def exportLiteralAttributes( self, outfile, level, name_ ):
...
# end class XSDataResultPluginControlDLSArchiver
...
class SaxXSDataDoubleHandler( handler.ContentHandler ):
    ...
    def startElement( self, name, attrs ):
        ...
        elif name == 'archiveLocation':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement( 'archiveLocation', obj )
            self.stack.append( stackObj )
            done = 1
        elif name == 'dropZonePath':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement( 'dropZonePath', obj )
            self.stack.append( stackObj )
            done = 1
        elif name == 'ignoreList':
            obj = XSDataString.factory()
            stackObj = SaxStackElement( 'ignoreList', obj )
            self.stack.append( stackObj )
            done = 1
        elif name == 'ignoreSubdirList':
            obj = XSDataString.factory()
            stackObj = SaxStackElement( 'ignoreSubdirList', obj )
            self.stack.append( stackObj )
            done = 1
        elif name == 'pollTime':
            obj = XSDataInteger.factory()
            stackObj = SaxStackElement( 'pollTime', obj )
            self.stack.append( stackObj )
            done = 1
        elif name == 'srbDropFilePath':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement( 'srbDropFilePath', obj )
            self.stack.append( stackObj )
            done = 1
        elif name == 'nonExistantFiles':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement( 'nonExistantFiles', obj )
            self.stack.append( stackObj )
            done = 1
        elif name == 'nbRoundsDelay':
            obj = XSDataInteger.factory()
            stackObj = SaxStackElement( 'nbRoundsDelay', obj )
            self.stack.append( stackObj )
            done = 1
        if not done:
    ...
    def endElement( self, name ):
        ...
        if name == 'XSDataDouble':
            ...
            if len( self.stack ) >= 2:
                self.stack[-2].obj.setArchiveLocation( self.stack[-1].obj )
                self.stack.pop()
                done = 1
        elif name == 'dropZonePath':
            if len( self.stack ) >= 2:
                self.stack[-2].obj.setDropZonePath( self.stack[-1].obj )
                self.stack.pop()
                done = 1
        elif name == 'ignoreList':
            if len( self.stack ) >= 2:
                self.stack[-2].obj.addIgnoreList( self.stack[-1].obj )
                self.stack.pop()
                done = 1
        elif name == 'ignoreSubdirList':
            if len( self.stack ) >= 2:
                self.stack[-2].obj.addIgnoreSubdirList( self.stack[-1].obj )
                self.stack.pop()
                done = 1
        elif name == 'pollTime':
            if len( self.stack ) >= 2:
                self.stack[-2].obj.setPollTime( self.stack[-1].obj )
                self.stack.pop()
                done = 1
        elif name == 'srbDropFilePath':
            if len( self.stack ) >= 2:
                self.stack[-2].obj.setSrbDropFilePath( self.stack[-1].obj )
                self.stack.pop()
                done = 1
        elif name == 'nonExistantFiles':
            if len( self.stack ) >= 2:
                self.stack[-2].obj.setNonExistantFiles( self.stack[-1].obj )
                self.stack.pop()
                done = 1
        elif name == 'nbRoundsDelay':
            if len( self.stack ) >= 2:
                self.stack[-2].obj.setNbRoundsDelay( self.stack[-1].obj )
                self.stack.pop()
                done = 1
        if not done:
            self.reportError( '"%s" element not allowed here.' % name )
