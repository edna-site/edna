...
#
# Generated Fri Jul 23 10:07:19 2010 by EDGenerateDS.py.
#
...
class XSDataInputPluginExecSRBRegister(XSDataInput):
    subclass = None
    def __init__(self, ignoreList=None, ignoreSubdirList=None, srbDropFileName=None, xmlIngestFileName=None, storagedCsvFile=None, storagedProcessedFiles=None, configuration=None):
        ...
        self.srbDropFileName = srbDropFileName
        self.xmlIngestFileName = xmlIngestFileName
        self.storagedCsvFile = storagedCsvFile
        self.storagedProcessedFiles = storagedProcessedFiles
    def factory(*args_, **kwargs_):
        if XSDataInputPluginExecSRBRegister.subclass:
            return XSDataInputPluginExecSRBRegister.subclass(*args_, **kwargs_)
        else:
            return XSDataInputPluginExecSRBRegister(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def getSrbDropFileName(self): return self.srbDropFileName
    def setSrbDropFileName(self, srbDropFileName): self.srbDropFileName = srbDropFileName
    ...
    def getStoragedCsvFile(self): return self.storagedCsvFile
    def setStoragedCsvFile(self, storagedCsvFile): self.storagedCsvFile = storagedCsvFile
    def getStoragedProcessedFiles(self): return self.storagedProcessedFiles
    def setStoragedProcessedFiles(self, storagedProcessedFiles): self.storagedProcessedFiles = storagedProcessedFiles
    def export(self, outfile, level, name_='XSDataInputPluginExecSRBRegister'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputPluginExecSRBRegister'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputPluginExecSRBRegister')
    def exportChildren(self, outfile, level, name_='XSDataInputPluginExecSRBRegister'):
        ...
        if self.srbDropFileName:
            self.srbDropFileName.export(outfile, level, name_='srbDropFileName')
        if self.xmlIngestFileName:
            self.xmlIngestFileName.export(outfile, level, name_='xmlIngestFileName')
        if self.storagedCsvFile:
            self.storagedCsvFile.export(outfile, level, name_='storagedCsvFile')
        if self.storagedProcessedFiles:
            self.storagedProcessedFiles.export(outfile, level, name_='storagedProcessedFiles')
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataInputPluginExecSRBRegister' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputPluginExecSRBRegister.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataInputPluginExecSRBRegister" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataInputPluginExecSRBRegister'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.srbDropFileName:
            showIndent(outfile, level)
            outfile.write('srbDropFileName=XSDataFile(\n')
            self.srbDropFileName.exportLiteral(outfile, level, name_='srbDropFileName')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.xmlIngestFileName:
            showIndent(outfile, level)
        ...
        if self.storagedCsvFile:
            showIndent(outfile, level)
            outfile.write('storagedCsvFile=XSDataFile(\n')
            self.storagedCsvFile.exportLiteral(outfile, level, name_='storagedCsvFile')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.storagedProcessedFiles:
            showIndent(outfile, level)
            outfile.write('storagedProcessedFiles=XSDataFile(\n')
            self.storagedProcessedFiles.exportLiteral(outfile, level, name_='storagedProcessedFiles')
            showIndent(outfile, level)
            outfile.write('),\n')
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            nodeName_ == 'srbDropFileName':
            obj_ = XSDataFile.factory()
            obj_.build(child_)
            self.setSrbDropFileName(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            ...
            nodeName_ == 'storagedCsvFile':
            obj_ = XSDataFile.factory()
            obj_.build(child_)
            self.setStoragedCsvFile(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'storagedProcessedFiles':
            obj_ = XSDataFile.factory()
            obj_.build(child_)
            self.setStoragedProcessedFiles(obj_)
        XSDataInput.buildChildren(self, child_, nodeName_)
# end class XSDataInputPluginExecSRBRegister


class XSDataResultPluginExecSRBRegister(XSDataResult):
    subclass = None
    def __init__(self, xmlIngestFileName=None, status=None):
        XSDataResult.__init__(self, status)
        self.xmlIngestFileName = xmlIngestFileName
    def factory(*args_, **kwargs_):
        if XSDataResultPluginExecSRBRegister.subclass:
            return XSDataResultPluginExecSRBRegister.subclass(*args_, **kwargs_)
        else:
            return XSDataResultPluginExecSRBRegister(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getXmlIngestFileName(self): return self.xmlIngestFileName
    def setXmlIngestFileName(self, xmlIngestFileName): self.xmlIngestFileName = xmlIngestFileName
    def export(self, outfile, level, name_='XSDataResultPluginExecSRBRegister'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultPluginExecSRBRegister'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultPluginExecSRBRegister')
    def exportChildren(self, outfile, level, name_='XSDataResultPluginExecSRBRegister'):
        if self.xmlIngestFileName:
            self.xmlIngestFileName.export(outfile, level, name_='xmlIngestFileName')
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataResultPluginExecSRBRegister' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultPluginExecSRBRegister.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataResultPluginExecSRBRegister" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataResultPluginExecSRBRegister'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
...
# end class XSDataResultPluginExecSRBRegister
...
class SaxXSDataDoubleHandler(handler.ContentHandler):
    ...
    def startElement(self, name, attrs):
        ...
        elif name == 'srbDropFileName':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('srbDropFileName', obj)
            self.stack.append(stackObj)
            done = 1
        ...
        elif name == 'storagedCsvFile':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('storagedCsvFile', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'storagedProcessedFiles':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('storagedProcessedFiles', obj)
            self.stack.append(stackObj)
            done = 1
        if not done:
    ...
    def endElement(self, name):
        ...
        if name == 'XSDataDouble':
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setSrbDropFileName(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'xmlIngestFileName':
            if len(self.stack) >= 2:
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setStoragedCsvFile(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'storagedProcessedFiles':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setStoragedProcessedFiles(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        if not done:
            self.reportError('"%s" element not allowed here.' % name)
