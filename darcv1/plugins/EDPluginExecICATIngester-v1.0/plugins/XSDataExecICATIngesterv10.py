...
#
# Generated Fri Jul 23 10:07:02 2010 by EDGenerateDS.py.
#
...
class XSDataInputPluginExecICATIngester(XSDataInput):
    subclass = None
    def __init__(self, xmlArchiveDirectory=None, xmlSearchDir=None, xmlIngestFileName=None, icatCsvFile=None, icatProcessedFiles=None, icatFailedFiles=None, icatFailedFolder=None, configuration=None):
        XSDataInput.__init__(self, configuration)
        self.xmlArchiveDirectory = xmlArchiveDirectory
        self.xmlSearchDir = xmlSearchDir
        self.xmlIngestFileName = xmlIngestFileName
        self.icatCsvFile = icatCsvFile
        self.icatProcessedFiles = icatProcessedFiles
        self.icatFailedFiles = icatFailedFiles
        self.icatFailedFolder = icatFailedFolder
    def factory(*args_, **kwargs_):
        if XSDataInputPluginExecICATIngester.subclass:
            return XSDataInputPluginExecICATIngester.subclass(*args_, **kwargs_)
        else:
            return XSDataInputPluginExecICATIngester(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getXmlArchiveDirectory(self): return self.xmlArchiveDirectory
    def setXmlArchiveDirectory(self, xmlArchiveDirectory): self.xmlArchiveDirectory = xmlArchiveDirectory
    def getXmlSearchDir(self): return self.xmlSearchDir
    def setXmlSearchDir(self, xmlSearchDir): self.xmlSearchDir = xmlSearchDir
    def getXmlIngestFileName(self): return self.xmlIngestFileName
    def setXmlIngestFileName(self, xmlIngestFileName): self.xmlIngestFileName = xmlIngestFileName
    def getIcatCsvFile(self): return self.icatCsvFile
    def setIcatCsvFile(self, icatCsvFile): self.icatCsvFile = icatCsvFile
    def getIcatProcessedFiles(self): return self.icatProcessedFiles
    def setIcatProcessedFiles(self, icatProcessedFiles): self.icatProcessedFiles = icatProcessedFiles
    def getIcatFailedFiles(self): return self.icatFailedFiles
    def setIcatFailedFiles(self, icatFailedFiles): self.icatFailedFiles = icatFailedFiles
    def getIcatFailedFolder(self): return self.icatFailedFolder
    def setIcatFailedFolder(self, icatFailedFolder): self.icatFailedFolder = icatFailedFolder
    def export(self, outfile, level, name_='XSDataInputPluginExecICATIngester'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputPluginExecICATIngester'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputPluginExecICATIngester')
    def exportChildren(self, outfile, level, name_='XSDataInputPluginExecICATIngester'):
        if self.xmlArchiveDirectory:
            self.xmlArchiveDirectory.export(outfile, level, name_='xmlArchiveDirectory')
        if self.xmlSearchDir:
            self.xmlSearchDir.export(outfile, level, name_='xmlSearchDir')
        if self.xmlIngestFileName:
            self.xmlIngestFileName.export(outfile, level, name_='xmlIngestFileName')
        if self.icatCsvFile:
            self.icatCsvFile.export(outfile, level, name_='icatCsvFile')
        if self.icatProcessedFiles:
            self.icatProcessedFiles.export(outfile, level, name_='icatProcessedFiles')
        if self.icatFailedFiles:
            self.icatFailedFiles.export(outfile, level, name_='icatFailedFiles')
        if self.icatFailedFolder:
            self.icatFailedFolder.export(outfile, level, name_='icatFailedFolder')
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataInputPluginExecICATIngester' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputPluginExecICATIngester.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataInputPluginExecICATIngester" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataInputPluginExecICATIngester'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.xmlArchiveDirectory:
            showIndent(outfile, level)
            outfile.write('xmlArchiveDirectory=XSDataFile(\n')
            self.xmlArchiveDirectory.exportLiteral(outfile, level, name_='xmlArchiveDirectory')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.xmlSearchDir:
            showIndent(outfile, level)
            outfile.write('xmlSearchDir=XSDataFile(\n')
            self.xmlSearchDir.exportLiteral(outfile, level, name_='xmlSearchDir')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.xmlIngestFileName:
            showIndent(outfile, level)
            outfile.write('xmlIngestFileName=XSDataFile(\n')
            self.xmlIngestFileName.exportLiteral(outfile, level, name_='xmlIngestFileName')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.icatCsvFile:
            showIndent(outfile, level)
            outfile.write('icatCsvFile=XSDataFile(\n')
            self.icatCsvFile.exportLiteral(outfile, level, name_='icatCsvFile')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.icatProcessedFiles:
            showIndent(outfile, level)
            outfile.write('icatProcessedFiles=XSDataFile(\n')
            self.icatProcessedFiles.exportLiteral(outfile, level, name_='icatProcessedFiles')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.icatFailedFiles:
            showIndent(outfile, level)
            outfile.write('icatFailedFiles=XSDataFile(\n')
            self.icatFailedFiles.exportLiteral(outfile, level, name_='icatFailedFiles')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.icatFailedFolder:
            showIndent(outfile, level)
            outfile.write('icatFailedFolder=XSDataFile(\n')
            self.icatFailedFolder.exportLiteral(outfile, level, name_='icatFailedFolder')
            showIndent(outfile, level)
            outfile.write('),\n')
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'xmlArchiveDirectory':
            obj_ = XSDataFile.factory()
            obj_.build(child_)
            self.setXmlArchiveDirectory(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'xmlSearchDir':
            obj_ = XSDataFile.factory()
            obj_.build(child_)
            self.setXmlSearchDir(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'xmlIngestFileName':
            obj_ = XSDataFile.factory()
            obj_.build(child_)
            self.setXmlIngestFileName(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'icatCsvFile':
            obj_ = XSDataFile.factory()
            obj_.build(child_)
            self.setIcatCsvFile(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'icatProcessedFiles':
            obj_ = XSDataFile.factory()
            obj_.build(child_)
            self.setIcatProcessedFiles(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'icatFailedFiles':
            obj_ = XSDataFile.factory()
            obj_.build(child_)
            self.setIcatFailedFiles(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'icatFailedFolder':
            obj_ = XSDataFile.factory()
            obj_.build(child_)
            self.setIcatFailedFolder(obj_)
        XSDataInput.buildChildren(self, child_, nodeName_)
# end class XSDataInputPluginExecICATIngester


class XSDataResultPluginExecICATIngester(XSDataResult):
    subclass = None
    def __init__(self, status=None, valueOf_=''):
        XSDataResult.__init__(self, status)
        self.valueOf_ = valueOf_
    def factory(*args_, **kwargs_):
        if XSDataResultPluginExecICATIngester.subclass:
            return XSDataResultPluginExecICATIngester.subclass(*args_, **kwargs_)
        else:
            return XSDataResultPluginExecICATIngester(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getValueOf_(self): return self.valueOf_
    def setValueOf_(self, valueOf_): self.valueOf_ = valueOf_
    def export(self, outfile, level, name_='XSDataResultPluginExecICATIngester'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultPluginExecICATIngester'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultPluginExecICATIngester')
    def exportChildren(self, outfile, level, name_='XSDataResultPluginExecICATIngester'):
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataResultPluginExecICATIngester' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultPluginExecICATIngester.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataResultPluginExecICATIngester" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataResultPluginExecICATIngester'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
...
# end class XSDataResultPluginExecICATIngester
...
class SaxXSDataDoubleHandler(handler.ContentHandler):
    ...
    def startElement(self, name, attrs):
        ...
        elif name == 'xmlArchiveDirectory':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('xmlArchiveDirectory', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'xmlSearchDir':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('xmlSearchDir', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'xmlIngestFileName':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('xmlIngestFileName', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'icatCsvFile':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('icatCsvFile', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'icatProcessedFiles':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('icatProcessedFiles', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'icatFailedFiles':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('icatFailedFiles', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'icatFailedFolder':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('icatFailedFolder', obj)
            self.stack.append(stackObj)
            done = 1
        if not done:
    ...
    def endElement(self, name):
        ...
        if name == 'XSDataDouble':
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setXmlArchiveDirectory(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'xmlSearchDir':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setXmlSearchDir(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'xmlIngestFileName':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setXmlIngestFileName(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'icatCsvFile':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setIcatCsvFile(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'icatProcessedFiles':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setIcatProcessedFiles(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'icatFailedFiles':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setIcatFailedFiles(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'icatFailedFolder':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setIcatFailedFolder(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        if not done:
            self.reportError('"%s" element not allowed here.' % name)
