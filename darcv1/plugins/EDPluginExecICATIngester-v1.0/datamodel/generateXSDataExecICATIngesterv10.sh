...
xsDataBaseName=XSDataExecICATIngesterv10
xsdHomeDir=${EDNA_HOME}/darcv1/plugins/EDPluginExecICATIngester-v1.0/datamodel
pyHomeDir=${EDNA_HOME}/darcv1/plugins/EDPluginExecICATIngester-v1.0/plugins
includeXSDFilePath=${EDNA_HOME}/kernel/datamodel/XSDataCommon.xsd

echo ${xsDataBaseName}
echo ${xsdHomeDir}
echo ${pyHomeDir}
echo ${includeXSDFilePath} 
