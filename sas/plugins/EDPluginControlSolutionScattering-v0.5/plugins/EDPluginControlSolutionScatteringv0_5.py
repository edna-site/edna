...
class EDPluginControlSolutionScatteringv0_5(EDPluginControl):
    """
    Solution scattering control plugin for running GNOM->DAMMIF->DAMAVER pipeline
    Step 1: Run AutoRg to find the Guinier region
    Step 2: run DatGnom to measure Dmax
    Step 3: Running DAMMIF jobs in parallel to build series of ab-initio models
    Step 4: Run DAMAVER pipeline to calculate an averaged model 
    """
    ...
    def checkParameters(self):
        ...
        """
        self.DEBUG("EDPluginControlSolutionScatteringv0_5.checkParameters")
    ...
    def checkRMaxSearchParameters(self):
        if self.dataInput.rMaxSearchSettings is not None:
            if self.dataInput.rMaxSearchSettings.rMaxStart is None:
                self.ERROR("EDPluginControlSolutionScatteringv0_5.setRMaxSerachParameters rMaxStart is missing")
                self.setFailure()
            else:
                if self.dataInput.rMaxSearchSettings.rMaxStart.value < self.__rMaxStart:
                    self.WARNING("EDPluginControlSolutionScatteringv0_5.setRMaxSerachParameters rMaxStart is too small. Resetting to the default.")
            if self.dataInput.rMaxSearchSettings.rMaxStop is None:
                self.ERROR("EDPluginControlSolutionScatteringv0_5.setRMaxSerachParameters rMaxStop is missing")
                self.setFailure()
            if self.dataInput.rMaxSearchSettings.getRMaxAbsTol() is None:
                self.ERROR("EDPluginControlSolutionScatteringv0_5.setRMaxSerachParameters rMaxAbsTol is missing")
                self.setFailure()
            if self.dataInput.rMaxSearchSettings.getRMaxIntervals() is None:
                self.ERROR("EDPluginControlSolutionScatteringv0_5.setRMaxSerachParameters rMaxIntervals is missing")
                self.setFailure()

    def checkModeParameter(self):
        self.DEBUG("EDPluginControlSolutionScatteringv0_5.checkModeParameter")
        try:
    ...
    def checkUnitParameter(self):
        self.DEBUG("EDPluginControlSolutionScatteringv0_5.checkUnitParameter")
        try:
    ...
    def preProcess(self, _edObject=None):
        ...
        self.DEBUG("EDPluginControlSolutionScatteringv0_5.preProcess")
    ...
    def process(self, _edObject=None):
        ...
        self.DEBUG("EDPluginControlSolutionScatteringv0_5.process")
    ...
    def postProcess(self, _edObject=None):
        ...
        self.DEBUG("EDPluginControlSolutionScatteringv0_5.postProcess")
        self.setDataOutput(self.__xsDataResultSolutionScattering)

    def doSuccessExecGnom(self, _edPlugin=None):
        self.DEBUG("EDPluginControlSolutionScatteringv0_5.doSuccessExecGnom")
        self.retrieveSuccessMessages(self.__edPluginExecGnom, "EDPluginControlSolutionScatteringv0_5.doSuccessExecGnom")
    ...
    def doFailureExecGnomActionCluster(self, _edPlugin=None):
        self.DEBUG("EDPluginControlSolutionScatteringv0_5.doFailureExecGnom")
        self.retrieveFailureMessages(self.__xsGnomJobs, "EDPluginControlSolutionScatteringv0_5.doFailureExecGnom")


    def doFailureExecGnom(self, _edPlugin=None):
        self.DEBUG("EDPluginControlSolutionScatteringv0_5.doFailureExecGnom")
        self.retrieveFailureMessages(self, "EDPluginControlSolutionScatteringv0_5.doFailureExecGnom")
    ...
    def doSuccessExecDammif(self, _edPlugin=None):
        self.DEBUG("EDPluginControlSolutionScatteringv0_5.doSuccessExecDammif")
        self.retrieveSuccessMessages(self.__xsDammifJobs, "EDPluginControlSolutionScatteringv0_5.doSuccessExecDammif")
    ...
    def doFailureExecDammif(self, _edPlugin=None):
        self.DEBUG("EDPluginControlSolutionScatteringv0_5.doFailureExecDammif")
        self.retrieveFailureMessages(self.__xsDammifJobs, "EDPluginControlSolutionScatteringv0_5.doFailureExecDammif")


    def doSuccessExecSupcomb(self, _edPlugin=None):
        self.DEBUG("EDPluginControlSolutionScatteringv0_5.doSuccessExecSupcomb")
        self.retrieveSuccessMessages(self.__xsSupcombJobs, "EDPluginControlSolutionScatteringv0_5.doSuccessExecSupcomb")
    ...
    def doFailureExecSupcomb(self, _edPlugin=None):
        self.DEBUG("EDPluginControlSolutionScatteringv0_5.doFailureExecSupcomb")
        self.retrieveFailureMessages(self.__xsSupcombJobs, "EDPluginControlSolutionScatteringv0_5.doFailureExecSupcomb")


    def doSuccessExecSupcombAlign(self, _edPlugin=None):
        self.DEBUG("EDPluginControlSolutionScatteringv0_5.doSuccessExecSupcombAlign")
        self.retrieveSuccessMessages(self.__xsSupcombJobsBest, "EDPluginControlSolutionScatteringv0_5.doSuccessExecSupcombAlign")
    ...
    def doFailureExecSupcombAlign(self, _edPlugin=None):
        self.DEBUG("EDPluginControlSolutionScatteringv0_5.doFailureExecSupcombAlign")
        self.retrieveFailureMessages(self.__xsSupcombJobsBest, "EDPluginControlSolutionScatteringv0_5.doFailureExecSupcombAlign")


    def doSuccessExecDamaver(self, _edPlugin=None):
        self.DEBUG("EDPluginControlSolutionScatteringv0_5.doSuccessExecDamaver")
        self.retrieveSuccessMessages(self.__edPluginExecDamaver, "EDPluginControlSolutionScatteringv0_5.doSuccessExecDamaver")
    ...
    def doFailureExecDamaver(self, _edPlugin=None):
        self.DEBUG("EDPluginControlSolutionScatteringv0_5.doFailureExecDamaver")
        self.retrieveFailureMessages(self.__edPluginExecDamaver, "EDPluginControlSolutionScatteringv0_5.doFailureExecDamaver")


    def doSuccessExecDamfilt(self, _edPlugin=None):
        self.DEBUG("EDPluginControlSolutionScatteringv0_5.doSuccessExecDamfilt")
        self.retrieveSuccessMessages(self.__edPluginExecDamfilt, "EDPluginControlSolutionScatteringv0_5.doSuccessExecDamfilt")
    ...
    def doFailureExecDamfilt(self, _edPlugin=None):
        self.DEBUG("EDPluginControlSolutionScatteringv0_5.doFailureExecDamfilt")
        self.retrieveFailureMessages(self.__edPluginExecDamfilt, "EDPluginControlSolutionScatteringv0_5.doFailureExecDamfilt")


    def doSuccessExecDamstart(self, _edPlugin=None):
        self.DEBUG("EDPluginControlSolutionScatteringv0_5.doSuccessExecDamstart")
        self.retrieveSuccessMessages(self.__edPluginExecDamstart, "EDPluginControlSolutionScatteringv0_5.doSuccessExecDamstart")




    def doFailureExecDamstart(self, _edPlugin=None):
        self.DEBUG("EDPluginControlSolutionScatteringv0_5.doFailureExecDamstart")
        self.retrieveFailureMessages(self.__edPluginExecDamstart, "EDPluginControlSolutionScatteringv0_5.doFailureExecDamstart")
    ...
    def readGnomDataColumns(self, fileName, _iNbColumns=1, _fQMin=None, _fQMax=None):
        ...
        if fileName:
            ...
            if not os.path.isfile(fileName):
                strErrorMessage = "EDPluginControlSolutionScatteringv0_5: experimentalDataFile: %s does not exist" % fileName
            ...
            for i in range(5):
                try:
                    ...
                    break
            if data is None:
                strErrorMessage = "EDPluginControlSolutionScatteringv0_5: Unable to parse %s with numpy.loadtxt" % fileName
                self.error(strErrorMessage)
                self.addErrorMessage(strErrorMessage)
                raise RuntimeError, strErrorMessage
                ...
                strErrorMessage = "EDPluginControlSolutionScatteringv0_5: %s contains an numpy object of shape %s" % (fileName, data.shape)
                self.error(strErrorMessage)
                self.addErrorMessage(strErrorMessage)
                raise RuntimeError, strErrorMessage
...
#        fig30.subplots_adjust(left=0.3, right=0.8)
    ...
    def generateExecutiveSummary(self, __edPlugin=None):
        ...
        """
        self.DEBUG("EDPluginControlSolutionScatteringv0_5.generateExecutiveSummary")
