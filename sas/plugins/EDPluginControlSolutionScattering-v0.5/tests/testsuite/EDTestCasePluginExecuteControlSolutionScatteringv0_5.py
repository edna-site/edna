...
class EDTestCasePluginExecuteControlSolutionScatteringv0_5(EDTestCasePluginExecute):


    def __init__(self, _strTestName=None):
        EDTestCasePluginExecute.__init__(self, "EDPluginControlSolutionScatteringv0_5")
...
if __name__ == '__main__':
    ...
    edTestCase = EDTestCasePluginExecuteControlSolutionScatteringv0_5("EDTestCasePluginExecuteControlSolutionScatteringv0_5")
    edTestCase.execute()
