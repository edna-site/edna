...
class EDTestCasePluginExecuteControlSolutionScatteringv0_3(EDTestCasePluginExecute):
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteControlSolutionScatteringv0_3 = EDTestCasePluginExecuteControlSolutionScatteringv0_3("EDTestCasePluginExecuteControlSolutionScatteringv0_3")
    edTestCasePluginExecuteControlSolutionScatteringv0_3.execute()
