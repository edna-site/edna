...
class EDTestSuitePluginControlSolutionScatteringv0_4(EDTestSuite):
    """
    This is the test suite for EDNA plugin SolutionScatteringv0_4 
...
if __name__ == '__main__':
    ...
    edTestSuite = EDTestSuitePluginControlSolutionScatteringv0_4("EDTestSuitePluginControlSolutionScatteringv0_4")
    edTestSuite.execute()
