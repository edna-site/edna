...
class EDTestCasePluginUnitControlSolutionScatteringv0_4(EDTestCasePluginUnit):


    def __init__(self, _edStringTestName=None):
        EDTestCasePluginUnit.__init__(self, "EDPluginControlSolutionScatteringv0_4")
...
if __name__ == '__main__':
    ...
    edTestCase = EDTestCasePluginUnitControlSolutionScatteringv0_4("EDTestCasePluginUnitControlSolutionScatteringv0_4")
    edTestCase.execute()
