...
class EDTestCasePluginExecuteControlAlignStackv1_0(EDTestCasePluginExecute):
...
#                                               "XSConfiguration_AlignStack.xml"))
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), \
                                           "XSDataInputAlignStack_reference.xml"))
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteControlAlignStackv1_0 = EDTestCasePluginExecuteControlAlignStackv1_0("EDTestCasePluginExecuteControlAlignStackv1_0")
