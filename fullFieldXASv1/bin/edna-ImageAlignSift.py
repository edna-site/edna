...
from EDPluginControlAlignStackv2_0 import EDPluginControlAlignStackv2_0

EDNAPluginName = "EDPluginControlAlignStackv2_0"
...
def fileName2xml(filename):
    ...
    hdf5File = os.path.splitext(filename)[0][:-len(number)] + "alignSift.h5"
    xml = "<XSDataInput>\
    ...
    <cropBordersMO><value>768</value></cropBordersMO>\
...
if __name__ == '__main__':
    ...
    EDPluginControlAlignStackv2_0.showData()
