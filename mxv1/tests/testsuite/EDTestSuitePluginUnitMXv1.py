...
class EDTestSuitePluginUnitMXv1(EDTestSuite):
    ...
    def process(self):
        ...
        self.addTestSuiteFromName("EDTestSuitePluginUnitStrategyv10")
        self.addTestSuiteFromName("EDTestSuitePluginUnitControlStrategyv1_1")
        self.addTestSuiteFromName("EDTestSuitePluginUnitControlStrategyv1_2")
        self.addTestSuiteFromName("EDTestSuitePluginUnitControlCharacterisationv10")
        self.addTestSuiteFromName("EDTestSuitePluginUnitControlCharacterisationv1_1")
        self.addTestSuiteFromName("EDTestSuitePluginUnitControlCharacterisationv1_2")
        ...
        self.addTestSuiteFromName("EDTestSuitePluginUnitInterfacev10")
        self.addTestSuiteFromName("EDTestSuitePluginUnitInterfacev1_1")
        self.addTestSuiteFromName("EDTestSuitePluginUnitControlInterfaceToMXCuBEv1_2")
