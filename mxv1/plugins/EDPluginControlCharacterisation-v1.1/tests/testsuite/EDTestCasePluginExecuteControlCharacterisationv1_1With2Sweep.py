...
class EDTestCasePluginExecuteControlCharacterisationv1_1With2Sweep(EDTestCasePluginExecuteControlCharacterisationv1_1):
    """
    ...
    def __init__(self, _edStringTestName=None):
        EDTestCasePluginExecuteControlCharacterisationv1_1.__init__(self, "EDTestCasePluginExecuteControlCharacterisationv1_1With2Sweep")
    ...
    def preProcess(self):
        EDTestCasePluginExecuteControlCharacterisationv1_1.preProcess(self)
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteControlCharacterisationv1_1With2Sweep = EDTestCasePluginExecuteControlCharacterisationv1_1With2Sweep("EDTestCasePluginExecuteControlCharacterisationv1_1With2Sweep")
    edTestCasePluginExecuteControlCharacterisationv1_1With2Sweep.execute()
