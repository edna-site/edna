...
class EDTestCasePluginUnitControlCharacterisationv1_3(EDTestCasePluginUnit):


    def __init__(self, _edStringTestName=None):
        EDTestCasePluginUnit.__init__(self, "EDPluginControlCharacterisationv1_3")
...
if __name__ == '__main__':
    ...
    EDTestCasePluginUnitControlCharacterisationv1_3 = EDTestCasePluginUnitControlCharacterisationv1_3("EDTestCasePluginUnitControlCharacterisationv1_3")
    EDTestCasePluginUnitControlCharacterisationv1_3.execute()
