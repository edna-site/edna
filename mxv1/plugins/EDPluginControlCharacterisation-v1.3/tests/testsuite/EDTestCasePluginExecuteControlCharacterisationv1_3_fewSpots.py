...
class EDTestCasePluginExecuteControlCharacterisationv1_3_fewSpots(EDTestCasePluginExecuteControlCharacterisationv1_3):
    """
    Test of characterisation error messages.
    """

    def __init__(self, _edStringTestName=None):
        EDTestCasePluginExecuteControlCharacterisationv1_3.__init__(self, "EDTestCasePluginExecuteControlCharacterisationv1_3_fewSpots")
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteControlCharacterisationv1_3_fewSpots = EDTestCasePluginExecuteControlCharacterisationv1_3_fewSpots("EDTestCasePluginExecuteControlCharacterisationv1_3_fewSpots")
    edTestCasePluginExecuteControlCharacterisationv1_3_fewSpots.execute()
