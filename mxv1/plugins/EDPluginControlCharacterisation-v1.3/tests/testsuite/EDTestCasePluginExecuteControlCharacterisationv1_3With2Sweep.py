...
class EDTestCasePluginExecuteControlCharacterisationv1_3With2Sweep(EDTestCasePluginExecuteControlCharacterisationv1_3):
    """
    ...
    def __init__(self, _edStringTestName=None):
        EDTestCasePluginExecuteControlCharacterisationv1_3.__init__(self, "EDTestCasePluginExecuteControlCharacterisationv1_3With2Sweep")
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteControlCharacterisationv1_3With2Sweep = EDTestCasePluginExecuteControlCharacterisationv1_3With2Sweep("EDTestCasePluginExecuteControlCharacterisationv1_3With2Sweep")
    edTestCasePluginExecuteControlCharacterisationv1_3With2Sweep.execute()
