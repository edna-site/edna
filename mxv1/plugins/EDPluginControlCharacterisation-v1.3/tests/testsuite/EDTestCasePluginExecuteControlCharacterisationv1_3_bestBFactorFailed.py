...
class EDTestCasePluginExecuteControlCharacterisationv1_3_bestBFactorFailed(EDTestCasePluginExecuteControlCharacterisationv1_3):
    """
    Test of characterisation error messages.
    """

    def __init__(self, _edStringTestName=None):
        EDTestCasePluginExecuteControlCharacterisationv1_3.__init__(self, "EDTestCasePluginExecuteControlCharacterisationv1_3_bestBFactorFailed")
        self.setConfigurationFile(self.getRefConfigFile())
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputCharacterisation_bestBFactorFailed.xml"))
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteControlCharacterisationv1_3_bestBFactorFailed = EDTestCasePluginExecuteControlCharacterisationv1_3_bestBFactorFailed("EDTestCasePluginExecuteControlCharacterisationv1_3_bestBFactorFailed")
    edTestCasePluginExecuteControlCharacterisationv1_3_bestBFactorFailed.execute()
