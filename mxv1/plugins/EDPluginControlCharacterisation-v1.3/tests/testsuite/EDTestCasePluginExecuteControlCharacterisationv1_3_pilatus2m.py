...
class EDTestCasePluginExecuteControlCharacterisationv1_3_pilatus2m(EDTestCasePluginExecuteControlCharacterisationv1_3):
    """
    Test of characterisation error messages.
    """

    def __init__(self, _edStringTestName=None):
        EDTestCasePluginExecuteControlCharacterisationv1_3.__init__(self, "EDTestCasePluginExecuteControlCharacterisationv1_3_pilatus2m")
        self.setConfigurationFile(self.getRefConfigFile())
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputCharacterisation_pilatus2m.xml"))
