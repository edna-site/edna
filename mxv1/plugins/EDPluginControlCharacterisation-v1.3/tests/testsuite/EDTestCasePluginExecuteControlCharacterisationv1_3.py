...
class EDTestCasePluginExecuteControlCharacterisationv1_3(EDTestCasePluginExecute):


    def __init__(self, _strTestName=None):
        EDTestCasePluginExecute.__init__(self, "EDPluginControlCharacterisationv1_3")
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteControlCharacterisationv1_3 = EDTestCasePluginExecuteControlCharacterisationv1_3("EDTestCasePluginExecuteControlCharacterisationv1_3")
    edTestCasePluginExecuteControlCharacterisationv1_3.execute()
