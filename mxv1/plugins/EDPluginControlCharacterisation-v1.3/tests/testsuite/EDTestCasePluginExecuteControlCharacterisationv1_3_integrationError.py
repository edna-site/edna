...
class EDTestCasePluginExecuteControlCharacterisationv1_3_integrationError(EDTestCasePluginExecuteControlCharacterisationv1_3):
    """
    Test of characterisation error messages.
    """

    def __init__(self, _edStringTestName=None):
        EDTestCasePluginExecuteControlCharacterisationv1_3.__init__(self, "EDTestCasePluginExecuteControlCharacterisationv1_3_integrationError")
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteControlCharacterisationv1_3_integrationError = EDTestCasePluginExecuteControlCharacterisationv1_3_integrationError("EDTestCasePluginExecuteControlCharacterisationv1_3_integrationError")
    edTestCasePluginExecuteControlCharacterisationv1_3_integrationError.execute()
