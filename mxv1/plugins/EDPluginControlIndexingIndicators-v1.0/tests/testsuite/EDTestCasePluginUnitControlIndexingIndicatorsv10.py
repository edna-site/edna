...
class EDTestCasePluginUnitControlIndexingIndicatorsv10(EDTestCasePluginUnit):


    def __init__(self, _edStringTestName=None):
        EDTestCasePluginUnit.__init__(self, "EDPluginControlIndexingIndicatorsv10")
...
if __name__ == '__main__':
    ...
    EDTestCasePluginUnitControlIndexingIndicatorsv10 = EDTestCasePluginUnitControlIndexingIndicatorsv10("EDTestCasePluginUnitControlIndexingIndicatorsv10")
    EDTestCasePluginUnitControlIndexingIndicatorsv10.execute()
