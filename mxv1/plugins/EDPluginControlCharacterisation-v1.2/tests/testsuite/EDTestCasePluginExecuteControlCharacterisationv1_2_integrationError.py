...
class EDTestCasePluginExecuteControlCharacterisationv1_2_integrationError(EDTestCasePluginExecuteControlCharacterisationv1_2):
    """
    Test of characterisation error messages.
    """

    def __init__(self, _edStringTestName=None):
        EDTestCasePluginExecuteControlCharacterisationv1_2.__init__(self, "EDTestCasePluginExecuteControlCharacterisationv1_2_integrationError")
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteControlCharacterisationv1_2_integrationError = EDTestCasePluginExecuteControlCharacterisationv1_2_integrationError("EDTestCasePluginExecuteControlCharacterisationv1_2_integrationError")
    edTestCasePluginExecuteControlCharacterisationv1_2_integrationError.execute()
