...
class EDTestCasePluginExecuteControlCharacterisationv1_2_bestBFactorFailed(EDTestCasePluginExecuteControlCharacterisationv1_2):
    """
    Test of characterisation error messages.
    """

    def __init__(self, _edStringTestName=None):
        EDTestCasePluginExecuteControlCharacterisationv1_2.__init__(self, "EDTestCasePluginExecuteControlCharacterisationv1_2_bestBFactorFailed")
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteControlCharacterisationv1_2_bestBFactorFailed = EDTestCasePluginExecuteControlCharacterisationv1_2_bestBFactorFailed("EDTestCasePluginExecuteControlCharacterisationv1_2_bestBFactorFailed")
    edTestCasePluginExecuteControlCharacterisationv1_2_bestBFactorFailed.execute()
