...
class EDTestCasePluginExecuteControlCharacterisationv1_2_fewSpots(EDTestCasePluginExecuteControlCharacterisationv1_2):
    """
    Test of characterisation error messages.
    """

    def __init__(self, _edStringTestName=None):
        EDTestCasePluginExecuteControlCharacterisationv1_2.__init__(self, "EDTestCasePluginExecuteControlCharacterisationv1_2_fewSpots")
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteControlCharacterisationv1_2_fewSpots = EDTestCasePluginExecuteControlCharacterisationv1_2_fewSpots("EDTestCasePluginExecuteControlCharacterisationv1_2_fewSpots")
    edTestCasePluginExecuteControlCharacterisationv1_2_fewSpots.execute()
