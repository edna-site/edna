...
class EDTestCasePluginExecutePluginControlReadImageHeaderv10_ADSC(EDTestCasePluginExecutePluginControlReadImageHeaderv10):
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecutePluginControlReadImageHeaderv10_ADSC = EDTestCasePluginExecutePluginControlReadImageHeaderv10_ADSC("EDTestCasePluginExecutePluginControlReadImageHeaderv10_ADSC")
    edTestCasePluginExecutePluginControlReadImageHeaderv10_ADSC.execute()
