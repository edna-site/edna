...
#
#    File: "$Id: EDTestCasePluginExecutePluginControlReadImageHeaderv10_failure.py 1513 2010-05-11 13:29:05Z svensson $"
#
...
class EDTestCasePluginExecutePluginControlReadImageHeaderv10_failure(EDTestCasePluginExecutePluginControlReadImageHeaderv10):
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecutePluginControlReadImageHeaderv10_failure = EDTestCasePluginExecutePluginControlReadImageHeaderv10_failure("EDTestCasePluginExecutePluginControlReadImageHeaderv10_failure")
    edTestCasePluginExecutePluginControlReadImageHeaderv10_failure.execute()
