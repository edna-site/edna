...
xsDataBaseName=XSDataCCP4iv1_1
xsdHomeDir=${EDNA_HOME}/mxv1/plugins/EDPluginGroupInterface-v1.1/datamodel
pyHomeDir=${EDNA_HOME}/mxv1/plugins/EDPluginGroupInterface-v1.1/plugins
