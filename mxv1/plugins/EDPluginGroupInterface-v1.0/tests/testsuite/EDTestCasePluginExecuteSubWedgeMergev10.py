...
class EDTestCasePluginExecuteSubWedgeMergev10(EDTestCasePluginExecute):
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteSubWedgeMergev10 = EDTestCasePluginExecuteSubWedgeMergev10("EDTestCasePluginExecuteSubWedgeMergev10")
    edTestCasePluginExecuteSubWedgeMergev10.execute()
