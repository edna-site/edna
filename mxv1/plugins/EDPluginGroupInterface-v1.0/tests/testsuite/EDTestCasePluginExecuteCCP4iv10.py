...
class EDTestCasePluginExecuteCCP4iv10(EDTestCasePluginExecute):
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteCCP4iv10 = EDTestCasePluginExecuteCCP4iv10("EDTestCasePluginExecuteCCP4iv10")
    edTestCasePluginExecuteCCP4iv10.execute()
