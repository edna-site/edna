...
xsDataBaseName=XSDataMXCuBEv1_3
xsdHomeDir=${EDNA_HOME}/mxv1/plugins/EDPluginControlInterfaceToMXCuBE-v1.3/datamodel
pyHomeDir=${EDNA_HOME}/mxv1/plugins/EDPluginControlInterfaceToMXCuBE-v1.3/plugins
