...
class EDTestCasePluginExecuteControlInterfaceToMXCuBEv1_3_withDamPar(EDTestCasePluginExecuteControlInterfaceToMXCuBEv1_3):
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteControlInterfaceToMXCuBEv1_3_withDamPar = EDTestCasePluginExecuteControlInterfaceToMXCuBEv1_3("EDTestCasePluginExecuteControlInterfaceToMXCuBEv1_3_withDamPar")
