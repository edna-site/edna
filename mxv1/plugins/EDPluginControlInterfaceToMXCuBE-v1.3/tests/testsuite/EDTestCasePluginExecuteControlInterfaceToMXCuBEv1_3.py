...
class EDTestCasePluginExecuteControlInterfaceToMXCuBEv1_3(EDTestCasePluginExecute):


    def __init__(self, _edStringTestName=None):
        EDTestCasePluginExecute.__init__(self, "EDPluginControlInterfaceToMXCuBEv1_3")
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteControlInterfaceToMXCuBEv1_3 = EDTestCasePluginExecuteControlInterfaceToMXCuBEv1_3("EDTestCasePluginExecuteControlInterfaceToMXCuBEv1_3")
    edTestCasePluginExecuteControlInterfaceToMXCuBEv1_3.execute()
