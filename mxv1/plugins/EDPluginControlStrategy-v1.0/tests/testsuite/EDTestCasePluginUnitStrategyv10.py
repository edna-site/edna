...
class EDTestCasePluginUnitStrategyv10(EDTestCasePluginUnit):

    def __init__(self, _edStringTestName="EDPluginControlStrategyv10"):
        EDTestCasePluginUnit.__init__(self, _edStringTestName)
        self.strDataPath = self.getPluginTestsDataHome()
        self.strObtainedInputFile = "XSDataInputStrategyv10.xml"
        self.strReferenceInputFile = os.path.join(self.strDataPath, "XSDataStrategyv10Input_reference.xml")
...
if __name__ == '__main__':
    ...
    eDTestCasePluginUnitStrategyv10 = EDTestCasePluginUnitStrategyv10("EDTestCasePluginUnitStrategyv10")
    eDTestCasePluginUnitStrategyv10.execute()
