...
class EDTestCasePluginUnitControlXDSGenerateBackgroundImagev1_0(EDTestCasePluginUnit):
    ...
    def __init__(self, _edStringTestName=None):
        EDTestCasePluginUnit.__init__(self, "EDPluginControlXDSGenerateBackgroundImagev1_0")
...
if __name__ == '__main__':
    ...
    EDTestCasePluginUnitControlXDSGenerateBackgroundImagev1_0 = EDTestCasePluginUnitControlXDSGenerateBackgroundImagev1_0("EDTestCasePluginUnitControlXDSGenerateBackgroundImagev1_0")
    EDTestCasePluginUnitControlXDSGenerateBackgroundImagev1_0.execute()
