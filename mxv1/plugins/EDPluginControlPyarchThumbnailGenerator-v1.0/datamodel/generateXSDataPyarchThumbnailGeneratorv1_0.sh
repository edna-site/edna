...
xsDataBaseName=XSDataPyarchThumbnailGeneratorv1_0
xsdHomeDir=${EDNA_HOME}/mxv1/plugins/EDPluginControlPyarchThumbnailGenerator-v1.0/datamodel
pyHomeDir=${EDNA_HOME}/mxv1/plugins/EDPluginControlPyarchThumbnailGenerator-v1.0/plugins
