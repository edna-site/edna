...
#
# Generated Tue Jan 25 17:14:37 2011 by EDGenerateDS.py.
#
...
class XSDataInputPyarchThumbnailGenerator(XSDataInput):
    subclass = None
    def __init__(self, configuration=None, diffractionImage=None, forcedOutputDirectory=None, waitForFileTimeOut=None):
        XSDataInput.__init__(self, configuration)
        self.diffractionImage = diffractionImage
        self.forcedOutputDirectory = forcedOutputDirectory
        self.waitForFileTimeOut = waitForFileTimeOut
    def factory(*args_, **kwargs_):
        if XSDataInputPyarchThumbnailGenerator.subclass:
            return XSDataInputPyarchThumbnailGenerator.subclass(*args_, **kwargs_)
        else:
            return XSDataInputPyarchThumbnailGenerator(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def getForcedOutputDirectory(self): return self.forcedOutputDirectory
    def setForcedOutputDirectory(self, forcedOutputDirectory): self.forcedOutputDirectory = forcedOutputDirectory
    def getWaitForFileTimeOut(self): return self.waitForFileTimeOut
    def setWaitForFileTimeOut(self, waitForFileTimeOut): self.waitForFileTimeOut = waitForFileTimeOut
    def export(self, outfile, level, name_='XSDataInputPyarchThumbnailGenerator'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputPyarchThumbnailGenerator'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputPyarchThumbnailGenerator')
    def exportChildren(self, outfile, level, name_='XSDataInputPyarchThumbnailGenerator'):
        if self.diffractionImage:
            self.diffractionImage.export(outfile, level, name_='diffractionImage')
        if self.getForcedOutputDirectory() != None :
            if self.forcedOutputDirectory:
                self.forcedOutputDirectory.export(outfile, level, name_='forcedOutputDirectory')
        if self.getWaitForFileTimeOut() != None :
            if self.waitForFileTimeOut:
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputPyarchThumbnailGenerator.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataInputPyarchThumbnailGenerator'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.diffractionImage:
            showIndent(outfile, level)
            outfile.write('diffractionImage=XSDataFile(\n')
            self.diffractionImage.exportLiteral(outfile, level, name_='diffractionImage')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.forcedOutputDirectory:
            showIndent(outfile, level)
            outfile.write('forcedOutputDirectory=XSDataFile(\n')
            self.forcedOutputDirectory.exportLiteral(outfile, level, name_='forcedOutputDirectory')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.waitForFileTimeOut:
            showIndent(outfile, level)
            outfile.write('waitForFileTimeOut=XSDataTime(\n')
            self.waitForFileTimeOut.exportLiteral(outfile, level, name_='waitForFileTimeOut')
            showIndent(outfile, level)
            outfile.write('),\n')
...
class XSDataResultPyarchThumbnailGenerator(XSDataResult):
    subclass = None
    def __init__(self, pathToJPEGImage=None, pathToThumbImage=None):
        XSDataResult.__init__(self)
        self.pathToJPEGImage = pathToJPEGImage
        self.pathToThumbImage = pathToThumbImage
    def factory(*args_, **kwargs_):
        if XSDataResultPyarchThumbnailGenerator.subclass:
            return XSDataResultPyarchThumbnailGenerator.subclass(*args_, **kwargs_)
        else:
            return XSDataResultPyarchThumbnailGenerator(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getPathToJPEGImage(self): return self.pathToJPEGImage
    def setPathToJPEGImage(self, pathToJPEGImage): self.pathToJPEGImage = pathToJPEGImage
    def getPathToThumbImage(self): return self.pathToThumbImage
    def setPathToThumbImage(self, pathToThumbImage): self.pathToThumbImage = pathToThumbImage
    def export(self, outfile, level, name_='XSDataResultPyarchThumbnailGenerator'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultPyarchThumbnailGenerator'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultPyarchThumbnailGenerator')
    def exportChildren(self, outfile, level, name_='XSDataResultPyarchThumbnailGenerator'):
        if self.getPathToJPEGImage() != None :
            if self.pathToJPEGImage:
                self.pathToJPEGImage.export(outfile, level, name_='pathToJPEGImage')
        if self.getPathToThumbImage() != None :
            if self.pathToThumbImage:
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultPyarchThumbnailGenerator.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataResultPyarchThumbnailGenerator'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.pathToJPEGImage:
            showIndent(outfile, level)
            outfile.write('pathToJPEGImage=XSDataFile(\n')
            self.pathToJPEGImage.exportLiteral(outfile, level, name_='pathToJPEGImage')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.pathToThumbImage:
            showIndent(outfile, level)
            outfile.write('pathToThumbImage=XSDataFile(\n')
            self.pathToThumbImage.exportLiteral(outfile, level, name_='pathToThumbImage')
            showIndent(outfile, level)
            outfile.write('),\n')
...
class SaxXSConfigurationHandler(handler.ContentHandler):
    ...
    def startElement(self, name, attrs):
        ...
        elif name == 'diffractionImage':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('diffractionImage', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'forcedOutputDirectory':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('forcedOutputDirectory', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'waitForFileTimeOut':
            obj = XSDataTime.factory()
            stackObj = SaxStackElement('waitForFileTimeOut', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'pathToJPEGImage':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('pathToJPEGImage', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'pathToThumbImage':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('pathToThumbImage', obj)
            self.stack.append(stackObj)
            done = 1
        if not done:
    ...
    def endElement(self, name):
        ...
        if name == 'XSConfiguration':
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setDiffractionImage(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'forcedOutputDirectory':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setForcedOutputDirectory(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'waitForFileTimeOut':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setWaitForFileTimeOut(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'pathToJPEGImage':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setPathToJPEGImage(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'pathToThumbImage':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setPathToThumbImage(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        if not done:
            self.reportError('"%s" element not allowed here.' % name)
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('from XSDataPyarchThumbnailGeneratorv1_0 import *\n\n')
    sys.stdout.write('rootObj = XSConfiguration(\n')
    rootObj.exportLiteral(sys.stdout, 0, name_="XSConfiguration")
    sys.stdout.write(')\n')
    return rootObj

class XSDataPyarchThumbnailGeneratorv1_0:
    pass
