...
class EDTestCasePluginExecuteControlImageQualityIndicatorsv1_1(EDTestCasePluginExecute):
...
if __name__ == '__main__':
    edTestCasePluginExecuteControlGeneratePredictionv10 = EDTestCasePluginExecuteControlImageQualityIndicatorsv1_1("EDTestCasePluginExecuteControlImageQualityIndicatorsv1_1")
