...
#
# Generated Thu Aug 26 14:45:09 2010 by EDGenerateDS.py.
#
...
class XSDataResultStrategy(XSDataResult):
    subclass = None
    def __init__(self, bestLogFile=None, collectionPlan=None, raddoseLogFile=None, status=None):
        XSDataResult.__init__(self, status)
...
class XSDataIndexingResult(XSDataResult):
    subclass = None
    def __init__(self, image=None, indexingLogFile=None, predictionResult=None, selectedSolution=None, solution=None, status=None):
        XSDataResult.__init__(self, status)
        if image is None:
            self.image = []
        else:
...
class XSDataDiffractionPlan(XSData):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.detectorMaxResolution:
            showIndent(outfile, level)
            outfile.write('detectorMaxResolution=XSDataFloat(\n')
            self.detectorMaxResolution.exportLiteral(outfile, level, name_='detectorMaxResolution')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.detectorMinResolution:
            showIndent(outfile, level)
            outfile.write('detectorMinResolution=XSDataFloat(\n')
...
class XSDataResultCharacterisation(XSDataResult):
    subclass = None
    def __init__(self, dataCollection=None, imageQualityIndicators=None, indexingResult=None, integrationResult=None, strategyResult=None, status=None):
        XSDataResult.__init__(self, status)
...
class XSDataIntegrationSubWedgeResult(XSData):
    subclass = None
    def __init__(self, bestfileDat=None, bestfileHKL=None, bestfilePar=None, experimentalConditionRefined=None, generatedMTZFile=None, integrationLogFile=None, statistics=None, statisticsPerResolutionBin=None, subWedgeNumber=None):
        XSData.__init__(self)
...
class XSDataCollectionPlan(XSData):
    subclass = None
    def __init__(self, collectionPlanNumber=None, collectionStrategy=None, comment=None, statistics=None, strategySummary=None):
        XSData.__init__(self)
...
class XSDataInputCharacterisation(XSDataInput):
    subclass = None
    def __init__(self, dataCollection=None, configuration=None):
        XSDataInput.__init__(self, configuration)
        self.dataCollection = dataCollection
    def factory(*args_, **kwargs_):
...
class XSDataSubWedge(XSData):
    subclass = None
    def __init__(self, action=None, experimentalCondition=None, image=None, subWedgeNumber=None):
        XSData.__init__(self)
        self.action = action
        self.experimentalCondition = experimentalCondition
        if image is None:
...
class XSDataInputControlISPyB(XSDataInput):
    subclass = None
    def __init__(self, characterisationResult=None, dataCollectionId=None, configuration=None):
        XSDataInput.__init__(self, configuration)
...
class XSDataInputInducedRadiationProcess(XSDataInput):
    subclass = None
    def __init__(self, characterisationResult=None, configuration=None):
        XSDataInput.__init__(self, configuration)
        self.characterisationResult = characterisationResult
    def factory(*args_, **kwargs_):
...
class XSDataResultInducedRadiationProcess(XSDataResult):
    subclass = None
    def __init__(self, bFactor=None, crystal=None, scale=None, status=None):
        XSDataResult.__init__(self, status)
...
class XSDataStatisticsIntegrationPerResolutionBin(XSData):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.profileFitted:
            showIndent(outfile, level)
            outfile.write('profileFitted=XSDataStatisticsIntegrationPerResolutionBin(\n')
            self.profileFitted.exportLiteral(outfile, level, name_='profileFitted')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.summation:
            showIndent(outfile, level)
            outfile.write('summation=XSDataStatisticsIntegrationPerResolutionBin(\n')
...
class XSDataInputMXCuBE(XSDataInput):
    subclass = None
    def __init__(self, dataCollectionId=None, diffractionPlan=None, experimentalCondition=None, outputFileDirectory=None, sample=None, dataSet=None, configuration=None):
        XSDataInput.__init__(self, configuration)
        self.dataCollectionId = dataCollectionId
        self.diffractionPlan = diffractionPlan
        self.experimentalCondition = experimentalCondition
    ...
    def factory(*args_, **kwargs_):
        if XSDataInputMXCuBE.subclass:
            return XSDataInputMXCuBE.subclass(*args_, **kwargs_)
        else:
            return XSDataInputMXCuBE(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getDataCollectionId(self): return self.dataCollectionId
    def setDataCollectionId(self, dataCollectionId): self.dataCollectionId = dataCollectionId
    def getDiffractionPlan(self): return self.diffractionPlan
    ...
    def getExperimentalCondition(self): return self.experimentalCondition
    def setExperimentalCondition(self, experimentalCondition): self.experimentalCondition = experimentalCondition
    def getOutputFileDirectory(self): return self.outputFileDirectory
    def setOutputFileDirectory(self, outputFileDirectory): self.outputFileDirectory = outputFileDirectory
    def getSample(self): return self.sample
    def setSample(self, sample): self.sample = sample
    ...
    def export(self, outfile, level, name_='XSDataInputMXCuBE'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputMXCuBE'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputMXCuBE')
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputMXCuBE.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataInputMXCuBE'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.outputFileDirectory:
            showIndent(outfile, level)
            outfile.write('outputFileDirectory=XSDataFile(\n')
            self.outputFileDirectory.exportLiteral(outfile, level, name_='outputFileDirectory')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.sample:
            showIndent(outfile, level)
        ...
        for dataSet in self.dataSet:
            showIndent(outfile, level)
            outfile.write('XSDataMXCuBEDataSet(\n')
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            nodeName_ == 'dataSet':
            obj_ = XSDataMXCuBEDataSet.factory()
            obj_.build(child_)
...
class XSDataMXCuBEDataSet:
    ...
    def factory(*args_, **kwargs_):
        if XSDataMXCuBEDataSet.subclass:
            return XSDataMXCuBEDataSet.subclass(*args_, **kwargs_)
        else:
            return XSDataMXCuBEDataSet(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def export(self, outfile, level, name_='XSDataMXCuBEDataSet'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataMXCuBEDataSet'):
        pass
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataMXCuBEDataSet.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataMXCuBEDataSet'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
...
class XSDataResultMXCuBE(XSDataResult):
    subclass = None
    def __init__(self, characterisationExecutiveSummary=None, collectionPlan=None, listOfOutputFiles=None, outputFileDictionary=None, status=None):
        XSDataResult.__init__(self, status)
        self.characterisationExecutiveSummary = characterisationExecutiveSummary
        if collectionPlan is None:
            self.collectionPlan = []
        else:
            self.collectionPlan = collectionPlan
        self.listOfOutputFiles = listOfOutputFiles
        self.outputFileDictionary = outputFileDictionary
    def factory(*args_, **kwargs_):
        if XSDataResultMXCuBE.subclass:
            return XSDataResultMXCuBE.subclass(*args_, **kwargs_)
        else:
            return XSDataResultMXCuBE(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getCharacterisationExecutiveSummary(self): return self.characterisationExecutiveSummary
    def setCharacterisationExecutiveSummary(self, characterisationExecutiveSummary): self.characterisationExecutiveSummary = characterisationExecutiveSummary
    def getCollectionPlan(self): return self.collectionPlan
    def setCollectionPlan(self, collectionPlan): self.collectionPlan = collectionPlan
    def addCollectionPlan(self, value): self.collectionPlan.append(value)
    def insertCollectionPlan(self, index, value): self.collectionPlan[index] = value
    ...
    def getOutputFileDictionary(self): return self.outputFileDictionary
    def setOutputFileDictionary(self, outputFileDictionary): self.outputFileDictionary = outputFileDictionary
    def export(self, outfile, level, name_='XSDataResultMXCuBE'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultMXCuBE'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultMXCuBE')
    def exportChildren(self, outfile, level, name_='XSDataResultMXCuBE'):
        if self.characterisationExecutiveSummary:
        ...
        if self.getOutputFileDictionary() != None :
            if self.outputFileDictionary:
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultMXCuBE.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataResultMXCuBE'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.characterisationExecutiveSummary:
            showIndent(outfile, level)
            outfile.write('characterisationExecutiveSummary=XSDataString(\n')
            self.characterisationExecutiveSummary.exportLiteral(outfile, level, name_='characterisationExecutiveSummary')
            showIndent(outfile, level)
            outfile.write('),\n')
        showIndent(outfile, level)
        outfile.write('collectionPlan=[\n')
        ...
        if self.outputFileDictionary:
            showIndent(outfile, level)
            outfile.write('outputFileDictionary=XSDataDictionary(\n')
            self.outputFileDictionary.exportLiteral(outfile, level, name_='outputFileDictionary')
            showIndent(outfile, level)
            outfile.write('),\n')
        XSDataResult.exportLiteralChildren(self, outfile, level, name_)
    def build(self, node_):
...
class SaxXSDataDoubleHandler(handler.ContentHandler):
    ...
    def startElement(self, name, attrs):
        ...
        if name == 'XSDataDouble':
            ...
            obj = XSDataResultStrategy.factory()
        ...
        elif name == 'outputFileDirectory':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('outputFileDirectory', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'dataSet':
            obj = XSDataMXCuBEDataSet.factory()
        ...
        elif name == 'characterisationExecutiveSummary':
            obj = XSDataString.factory()
            stackObj = SaxStackElement('characterisationExecutiveSummary', obj)
            self.stack.append(stackObj)
            done = 1
        ...
        elif name == 'outputFileDictionary':
            obj = XSDataDictionary.factory()
            stackObj = SaxStackElement('outputFileDictionary', obj)
            self.stack.append(stackObj)
            done = 1
        if not done:
    ...
    def endElement(self, name):
        ...
        if name == 'XSDataDouble':
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setOutputFileDirectory(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'dataSet':
            if len(self.stack) >= 2:
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setCharacterisationExecutiveSummary(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'listOfOutputFiles':
            if len(self.stack) >= 2:
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setOutputFileDictionary(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        if not done:
            self.reportError('"%s" element not allowed here.' % name)
