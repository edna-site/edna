...
xsDataBaseName=XSDataMXCuBEv1_2
xsdHomeDir=${EDNA_HOME}/mxv1/plugins/EDPluginControlInterfaceToMXCuBE-v1.2/datamodel
pyHomeDir=${EDNA_HOME}/mxv1/plugins/EDPluginControlInterfaceToMXCuBE-v1.2/plugins
