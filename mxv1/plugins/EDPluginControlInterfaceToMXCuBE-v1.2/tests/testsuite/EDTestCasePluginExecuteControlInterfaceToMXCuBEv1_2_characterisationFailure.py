...
class EDTestCasePluginExecuteControlInterfaceToMXCuBEv1_2_characterisationFailure(EDTestCasePluginExecuteControlInterfaceToMXCuBEv1_2):
    ...
    def testExecute(self):
        ...
        EDAssert.equal(True, os.path.exists(os.path.join(strWorkingDirectory, "ControlInterfaceToMXCuBEv1_2_dataOutput.xml")))
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteControlInterfaceToMXCuBEv1_2_characterisationFailure = EDTestCasePluginExecuteControlInterfaceToMXCuBEv1_2("EDTestCasePluginExecuteControlInterfaceToMXCuBEv1_2_characterisationFailure")
    edTestCasePluginExecuteControlInterfaceToMXCuBEv1_2_characterisationFailure.execute()
