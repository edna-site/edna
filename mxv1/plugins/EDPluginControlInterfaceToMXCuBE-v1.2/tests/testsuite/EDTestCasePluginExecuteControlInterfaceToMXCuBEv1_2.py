...
class EDTestCasePluginExecuteControlInterfaceToMXCuBEv1_2(EDTestCasePluginExecute):


    def __init__(self, _edStringTestName=None):
        EDTestCasePluginExecute.__init__(self, "EDPluginControlInterfaceToMXCuBEv1_2")
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteControlInterfaceToMXCuBEv1_2 = EDTestCasePluginExecuteControlInterfaceToMXCuBEv1_2("EDTestCasePluginExecuteControlInterfaceToMXCuBEv1_2")
    edTestCasePluginExecuteControlInterfaceToMXCuBEv1_2.execute()
