...
class EDTestCasePluginExecuteExecDIMPLEREFMACRigidBodyv10(
    EDTestCasePluginExecute):
    '''The execution tests for the EDNA Exec plugin
    DIMPLEREFMACRigidBodyv10.'''
    ...
    def __init__(self, _edStringTestName = None):
        ...
        self.setDataInputFile(EDUtilsPath.mergePath(
            ...
            'XSDataInputDIMPLEREFMACRigidBody_reference.xml'))
        
        self.setReferenceDataOutputFile(EDUtilsPath.mergePath(
            self.getPluginTestsDataHome(), 
            'XSDataResultDIMPLEREFMACRigidBody_reference.xml'))
...
if __name__ == '__main__':
    ...
    test_instance = EDTestCasePluginExecuteControlDIMPLEREFMACRigidBodyv10(
        'EDTestCasePluginExecuteExecDIMPLEREFMACRigidBodyv10')
