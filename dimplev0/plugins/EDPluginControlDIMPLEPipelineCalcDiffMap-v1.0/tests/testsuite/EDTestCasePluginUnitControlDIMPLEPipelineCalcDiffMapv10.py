...
class EDTestCasePluginUnitControlDIMPLEPipelineCalcDiffMapv10(
    EDTestCasePluginUnit):

    def __init__(self, _edStringTestName = None):
        EDTestCasePluginUnit.__init__(
            self, 'EDPluginExecDIMPLEPipelineCalcDiffMapv10',
...
if __name__ == '__main__':
    ...
    test_instance = EDTestCasePluginUnitControlDIMPLEPipelineCalcDiffMapv10(
        'EDTestCasePluginUnitControlDIMPLEPipelineCalcDiffMapv10')
