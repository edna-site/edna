...
class EDTestCasePluginExecuteControlDIMPLEPipelineCalcDiffMapv10(
    EDTestCasePluginExecute):
    '''Test case for the DIMPLE pipeline as a whole.'''
...
if __name__ == '__main__':
    ...
    test_instance = EDTestCasePluginExecuteControlDIMPLEPipelineCalcDiffMapv10(
        'EDTestCasePluginExecuteControlDIMPLEPipelineCalcDiffMapv10')
