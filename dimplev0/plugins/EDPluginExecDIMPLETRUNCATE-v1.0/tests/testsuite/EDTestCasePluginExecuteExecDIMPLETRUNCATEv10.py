...
class EDTestCasePluginExecuteExecDIMPLETRUNCATEv10(EDTestCasePluginExecute):
    '''The execution tests for the EDNA Exec plugin DIMPLETRUNCATEv10.'''
    
    def __init__(self, _edStringTestName = None):
        EDTestCasePluginExecute.__init__(self, 'EDPluginExecDIMPLETRUNCATEv10')
...
if __name__ == '__main__':
    ...
    test_instance = EDTestCasePluginExecuteControlDIMPLETRUNCATEv10(
        'EDTestCasePluginExecuteExecDIMPLETRUNCATEv10')
