...
class EDTestCasePluginExecuteExecDIMPLETRUNCATETESTv10(EDTestCasePluginExecute):
    '''The execution tests for the EDNA Exec plugin DIMPLETRUNCATETESTv10.'''
    
    def __init__(self, _edStringTestName = None):
        EDTestCasePluginExecute.__init__(self, 'EDPluginExecDIMPLETRUNCATETESTv10')
...
if __name__ == '__main__':
    ...
    test_instance = EDTestCasePluginExecuteControlDIMPLETRUNCATETESTv10(
        'EDTestCasePluginExecuteExecDIMPLETRUNCATETESTv10')
