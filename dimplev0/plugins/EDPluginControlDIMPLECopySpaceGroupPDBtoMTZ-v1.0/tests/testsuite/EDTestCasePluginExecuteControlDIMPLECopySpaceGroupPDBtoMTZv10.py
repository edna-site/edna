...
class EDTestCasePluginExecuteControlDIMPLECopySpaceGroupPDBtoMTZv10(
    ...
    def __init__(self, _edStringTestName = None):
        ...
        self.setConfigurationFile(EDUtilsPath.mergePath(
            ...
            'XSConfiguration_DIMPLECopySpaceGroupPDBtoMTZ.xml'))
        
        self.setDataInputFile(EDUtilsPath.mergePath(
            self.getPluginTestsDataHome(), 
            'XSDataInputDIMPLECopySpaceGroupPDBtoMTZ_reference.xml'))
        
        self.setReferenceDataOutputFile(EDUtilsPath.mergePath(
            self.getPluginTestsDataHome(),
            'XSDataResultDIMPLECopySpaceGroupPDBtoMTZ_reference.xml'))
...
if __name__ == '__main__':
    ...
    test_instance = EDTestCasePluginExecuteControlDIMPLECopySpaceGroupPDBtoMTZv10(
        'EDTestCasePluginExecuteControlDIMPLECopySpaceGroupPDBtoMTZv10')
