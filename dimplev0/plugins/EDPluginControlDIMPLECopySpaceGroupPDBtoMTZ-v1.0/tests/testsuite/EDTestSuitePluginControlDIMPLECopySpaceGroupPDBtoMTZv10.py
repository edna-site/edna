...
class EDTestSuitePluginControlDIMPLECopySpaceGroupPDBtoMTZv10(EDTestSuite):
    '''Test suite for EDNA plugin DIMPLECopySpaceGroupPDBtoMTZv10.'''

    def process(self):
        self.addTestCaseFromName(
            'EDTestCasePluginUnitControlDIMPLECopySpaceGroupPDBtoMTZv10')
        self.addTestCaseFromName(
...
if __name__ == '__main__':
    ...
    test_instance = EDTestSuitePluginControlDIMPLECopySpaceGroupPDBtoMTZv10(
