...
class EDPluginExecDIMPLEREFMACRestrainedRefinementv10(
    EDPluginExecProcessScript):
    '''An EDNA plugin for the CCP4 program refmac5 for restrained
    refinement.'''

    def __init__(self):
        EDPluginExecProcessScript.__init__(self)
        self.setXSDataInputClass(CCP4DataInputREFMACRestrainedRefinement)
    ...
    def checkParameters(self):
        EDVerbose.DEBUG(
            '*** EDPluginExecDIMPLEREFMACRestrainedRefinementv10.checkParameters')
    ...
    def preProcess(self, _edObject = None):
        ...
        EDVerbose.DEBUG(
            '*** EDPluginExecDIMPLEREFMACRestrainedRefinementv10.preProcess')
        ...
        self.refmac_restrained_refinement_script()
    ...
    def refmac_restrained_refinement_script(self):
        '''Actually write the script to run refmac5 for restrained
        refinement.'''
        
        self.setScriptCommandline(
            'hklin "%s" hklout "%s" xyzin "%s" xyzout "%s"' % 
            (self._hklin, self._hklout, self._xyzin, self._xyzout))
        self.addListCommandExecution(
            'labin FP=%s SIGFP=%s FREE=FreeR_flag' % \
    ...
    def generateExecutiveSummary(self, _edPlugin):
        ...
        EDVerbose.DEBUG("*** EDPluginExecDIMPLEREFMACRestrainedRefinementv10.generateExecutiveSummary")
        self.addExecutiveSummaryLine("")
        self.addExecutiveSummaryLine("############################################################")
        self.addExecutiveSummaryLine("###      REFMAC (restrained refinement) Output Log       ###")
        self.addExecutiveSummaryLine("############################################################")
        self.addExecutiveSummaryLine("")
