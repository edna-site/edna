...
class EDTestCasePluginExecuteExecDIMPLEREFMACRestrainedRefinementv10(
    EDTestCasePluginExecute):
    '''The execution tests for the EDNA Exec plugin
    DIMPLEREFMACRestrainedRefinementv10.'''
    ...
    def __init__(self, _edStringTestName = None):
        ...
        self.setDataInputFile(EDUtilsPath.mergePath(
            ...
            'XSDataInputDIMPLEREFMACRestrainedRefinement_reference.xml'))
        
        self.setReferenceDataOutputFile(EDUtilsPath.mergePath(
            self.getPluginTestsDataHome(), 
            'XSDataResultDIMPLEREFMACRestrainedRefinement_reference.xml'))
...
if __name__ == '__main__':
    ...
    test_instance = EDTestCasePluginExecuteControlDIMPLEREFMACRestrainedRefinementv10(
        'EDTestCasePluginExecuteExecDIMPLEREFMACRestrainedRefinementv10')
