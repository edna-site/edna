...
class EDTestCasePluginExecuteExecDIMPLECADv10(EDTestCasePluginExecute):
    '''Execution tests for the EDNA Exec plugin DIMPLECADv10.'''
    
    def __init__(self, _edStringTestName = None):
        EDTestCasePluginExecute.__init__(self, 'EDPluginExecDIMPLECADv10')

        self.setConfigurationFile( self.getRefConfigFile() )
        
        self.setDataInputFile(EDUtilsPath.mergePath(
            self.getPluginTestsDataHome(), 
            'XSDataInputDIMPLECAD_reference.xml'))
        
        self.setReferenceDataOutputFile(EDUtilsPath.mergePath(
            self.getPluginTestsDataHome(), 
            'XSDataResultDIMPLECAD_reference.xml'))
...
if __name__ == '__main__':
    ...
    test_instance = EDTestCasePluginExecuteControlDIMPLECADv10(
        'EDTestCasePluginExecuteExecDIMPLECADv10')
