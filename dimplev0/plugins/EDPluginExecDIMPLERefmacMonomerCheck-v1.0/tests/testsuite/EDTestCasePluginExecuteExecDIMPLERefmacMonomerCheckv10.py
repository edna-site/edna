...
class EDTestCasePluginExecuteExecDIMPLERefmacMonomerCheckv10(
    EDTestCasePluginExecute):
    """Test cases for the execution of the monomer checker."""
    
    def __init__(self, _strTestName = None):
        EDTestCasePluginExecute.__init__(
            self, "EDPluginExecDIMPLERefmacMonomerCheckv10")
        
        self.setConfigurationFile(
            os.path.join(self.getPluginTestsDataHome(),
                         "XSConfiguration_DIMPLERefmacMonomerCheck.xml"))
        
        self.setDataInputFile(
            os.path.join(self.getPluginTestsDataHome(), 
                         "XSDataInputDIMPLERefmacMonomerCheck_reference.xml"))
        
        self.setReferenceDataOutputFile(
            os.path.join(self.getPluginTestsDataHome(), 
                         "XSDataResultDIMPLERefmacMonomerCheck_reference.xml"))
...
if __name__ == '__main__':
    ...
    test_instance = EDTestCasePluginExecuteControlDIMPLERefmacMonomerCheckv10(
        "EDTestCasePluginExecuteExecDIMPLERefmacMonomerCheckv10")
