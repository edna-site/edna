...
class EDTestCasePluginUnitExecDIMPLERefmacMonomerCheckv10(
    EDTestCasePluginUnit):
    """Unit tests for the Monomer Check plugin."""
...
if __name__ == '__main__':
    ...
    test_instance = EDTestCasePluginUnitExecDIMPLERefmacMonomerCheckv10(
        "EDTestCasePluginUnitExecDIMPLERefmacMonomerCheckv10")
