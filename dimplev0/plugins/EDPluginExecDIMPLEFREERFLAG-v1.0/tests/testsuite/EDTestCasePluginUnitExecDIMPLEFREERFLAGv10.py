...
class EDTestCasePluginUnitExecDIMPLEFREERFLAGv10(EDTestCasePluginUnit):
    """Those are units tests for DIMPLEFREERFLAGv10. Currently there are
    none!"""

    def __init__(self, _edStringTestName = None):
        EDTestCasePluginUnit.__init__(self, "EDPluginExecDIMPLEFREERFLAGv10")
...
if __name__ == '__main__':
    ...
    test_instance = EDTestCasePluginUnitExecDIMPLEFREERFLAGv10(
        "EDTestCasePluginUnitExecDIMPLEFREERFLAGv10")
