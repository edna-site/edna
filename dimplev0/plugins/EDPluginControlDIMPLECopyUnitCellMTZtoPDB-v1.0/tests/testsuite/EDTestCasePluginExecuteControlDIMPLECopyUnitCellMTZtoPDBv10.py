...
class EDTestCasePluginExecuteControlDIMPLECopyUnitCellMTZtoPDBv10( EDTestCasePluginExecute ):
    """
    """
    ...
    def __init__( self, _edStringTestName = None):
        """
        """
        EDTestCasePluginExecute.__init__( self, "EDPluginControlDIMPLECopyUnitCellMTZtoPDBv10", "EDPluginControlDIMPLECopyUnitCellMTZtoPDB-v1.0", _edStringTestName )

        self.setConfigurationFile( self.getRefConfigFile() )
        
        self.setDataInputFile( EDUtilsPath.mergePath( self.getPluginTestsDataHome(), \
                                                      "XSDataInputDIMPLECopyUnitCellMTZtoPDB_reference.xml" ) )
        
        self.setReferenceDataOutputFile( EDUtilsPath.mergePath( self.getPluginTestsDataHome(), \
                                                                "XSDataResultDIMPLECopyUnitCellMTZtoPDB_reference.xml"))
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteControlDIMPLECopyUnitCellMTZtoPDBv10 = EDTestCasePluginExecuteControlDIMPLECopyUnitCellMTZtoPDBv10( "EDTestCasePluginExecuteControlDIMPLECopyUnitCellMTZtoPDBv10" )
    edTestCasePluginExecuteControlDIMPLECopyUnitCellMTZtoPDBv10.execute()
