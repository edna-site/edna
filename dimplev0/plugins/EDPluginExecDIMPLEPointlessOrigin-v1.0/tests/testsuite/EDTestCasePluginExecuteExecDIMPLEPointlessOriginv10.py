...
class EDTestCasePluginExecuteExecDIMPLEPointlessOriginv10(
    EDTestCasePluginExecute):
    """Execution tests for the pointless origin plugin."""
    ...
    def __init__(self, _strTestName = None):
        ...
        self.setDataInputFile(
            os.path.join(self.getPluginTestsDataHome(), \
                         "XSDataInputDIMPLEPointlessOrigin_reference.xml"))
        
        self.setReferenceDataOutputFile(
            os.path.join(self.getPluginTestsDataHome(), \
                         "XSDataResultDIMPLEPointlessOrigin_reference.xml"))
...
if __name__ == '__main__':
    ...
    test_instance = EDTestCasePluginExecuteControlDIMPLEPointlessOriginv10(
