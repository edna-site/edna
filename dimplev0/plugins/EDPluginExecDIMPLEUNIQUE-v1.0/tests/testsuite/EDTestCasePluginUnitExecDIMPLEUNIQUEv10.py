...
class EDTestCasePluginUnitExecDIMPLEUNIQUEv10(EDTestCasePluginUnit):
    """Those are all units tests for DIMPLEUNIQUEv10. Currently there
    are none..."""

    def __init__(self, _edStringTestName = None):
        EDTestCasePluginUnit.__init__(self, "EDPluginExecDIMPLEUNIQUEv10")
...
if __name__ == '__main__':
    ...
    test_instance = EDTestCasePluginUnitExecDIMPLEUNIQUEv10(
        "EDTestCasePluginUnitExecDIMPLEUNIQUEv10")
