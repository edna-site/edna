...
class EDTestCasePluginExecuteExecDIMPLEUNIQUEv10(EDTestCasePluginExecute):
    """Those are execution tests for the DIMPLEUNIQUEv10 plugin."""
    
    def __init__(self, _edStringTestName = None):
        EDTestCasePluginExecute.__init__(self, "EDPluginExecDIMPLEUNIQUEv10")
        
        self.setConfigurationFile( self.getRefConfigFile() )
        
        self.setDataInputFile(EDUtilsPath.mergePath(
            self.getPluginTestsDataHome(), 
            "XSDataInputDIMPLEUNIQUE_reference.xml"))
        
        self.setReferenceDataOutputFile(EDUtilsPath.mergePath(
            self.getPluginTestsDataHome(), 
            "XSDataResultDIMPLEUNIQUE_reference.xml"))
...
if __name__ == '__main__':
    ...
    test_instance = EDTestCasePluginExecuteControlDIMPLEUNIQUEv10(
        "EDTestCasePluginExecuteExecDIMPLEUNIQUEv10")
