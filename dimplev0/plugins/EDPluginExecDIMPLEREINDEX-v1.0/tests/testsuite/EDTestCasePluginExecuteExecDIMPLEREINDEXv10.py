...
class EDTestCasePluginExecuteExecDIMPLEREINDEXv10(EDTestCasePluginExecute):
    '''The execution tests for the EDNA Exec plugin DIMPLEREINDEXv10.'''
...
if __name__ == '__main__':
    ...
    test_instance = EDTestCasePluginExecuteControlDIMPLEREINDEXv10(
        'EDTestCasePluginExecuteExecDIMPLEREINDEXv10')
