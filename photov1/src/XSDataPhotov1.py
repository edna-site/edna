...
#
# Generated Sat Sep 25 21:22:28 2010 by EDGenerateDS.py.
#
...
class XSDataInputExecDcrawv1(XSDataInput):
    subclass = None
    def __init__(self, rawImagePath=None, outputPath=None, exportTiff=None, extractThumbnail=None, whiteBalanceAuto=None, whiteBalanceFromCamera=None, levelsFromCamera=None, interpolationQuality=None, configuration=None):
        XSDataInput.__init__(self, configuration)
        self.rawImagePath = rawImagePath
        self.outputPath = outputPath
        self.exportTiff = exportTiff
        self.extractThumbnail = extractThumbnail
        self.whiteBalanceAuto = whiteBalanceAuto
        self.whiteBalanceFromCamera = whiteBalanceFromCamera
        self.levelsFromCamera = levelsFromCamera
        self.interpolationQuality = interpolationQuality
    def factory(*args_, **kwargs_):
        if XSDataInputExecDcrawv1.subclass:
            return XSDataInputExecDcrawv1.subclass(*args_, **kwargs_)
        else:
            return XSDataInputExecDcrawv1(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getRawImagePath(self): return self.rawImagePath
    def setRawImagePath(self, rawImagePath): self.rawImagePath = rawImagePath
    def getOutputPath(self): return self.outputPath
    def setOutputPath(self, outputPath): self.outputPath = outputPath
    def getExportTiff(self): return self.exportTiff
    def setExportTiff(self, exportTiff): self.exportTiff = exportTiff
    def getExtractThumbnail(self): return self.extractThumbnail
    def setExtractThumbnail(self, extractThumbnail): self.extractThumbnail = extractThumbnail
    def getWhiteBalanceAuto(self): return self.whiteBalanceAuto
    def setWhiteBalanceAuto(self, whiteBalanceAuto): self.whiteBalanceAuto = whiteBalanceAuto
    def getWhiteBalanceFromCamera(self): return self.whiteBalanceFromCamera
    def setWhiteBalanceFromCamera(self, whiteBalanceFromCamera): self.whiteBalanceFromCamera = whiteBalanceFromCamera
    def getLevelsFromCamera(self): return self.levelsFromCamera
    def setLevelsFromCamera(self, levelsFromCamera): self.levelsFromCamera = levelsFromCamera
    def getInterpolationQuality(self): return self.interpolationQuality
    def setInterpolationQuality(self, interpolationQuality): self.interpolationQuality = interpolationQuality
    def export(self, outfile, level, name_='XSDataInputExecDcrawv1'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputExecDcrawv1'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputExecDcrawv1')
    def exportChildren(self, outfile, level, name_='XSDataInputExecDcrawv1'):
        if self.rawImagePath:
            self.rawImagePath.export(outfile, level, name_='rawImagePath')
        if self.getOutputPath() != None :
            if self.outputPath:
                self.outputPath.export(outfile, level, name_='outputPath')
        if self.getExportTiff() != None :
            if self.exportTiff:
                self.exportTiff.export(outfile, level, name_='exportTiff')
        if self.getExtractThumbnail() != None :
            if self.extractThumbnail:
                self.extractThumbnail.export(outfile, level, name_='extractThumbnail')
        if self.getWhiteBalanceAuto() != None :
            if self.whiteBalanceAuto:
                self.whiteBalanceAuto.export(outfile, level, name_='whiteBalanceAuto')
        if self.getWhiteBalanceFromCamera() != None :
            if self.whiteBalanceFromCamera:
                self.whiteBalanceFromCamera.export(outfile, level, name_='whiteBalanceFromCamera')
        if self.getLevelsFromCamera() != None :
            if self.levelsFromCamera:
                self.levelsFromCamera.export(outfile, level, name_='levelsFromCamera')
        if self.getInterpolationQuality() != None :
            if self.interpolationQuality:
                self.interpolationQuality.export(outfile, level, name_='interpolationQuality')
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataInputExecDcrawv1' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputExecDcrawv1.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataInputExecDcrawv1" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataInputExecDcrawv1'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.rawImagePath:
            showIndent(outfile, level)
            outfile.write('rawImagePath=XSDataFile(\n')
            self.rawImagePath.exportLiteral(outfile, level, name_='rawImagePath')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.outputPath:
            showIndent(outfile, level)
            outfile.write('outputPath=XSDataFile(\n')
            self.outputPath.exportLiteral(outfile, level, name_='outputPath')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.exportTiff:
            showIndent(outfile, level)
            outfile.write('exportTiff=XSDataBoolean(\n')
            self.exportTiff.exportLiteral(outfile, level, name_='exportTiff')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.extractThumbnail:
            showIndent(outfile, level)
            outfile.write('extractThumbnail=XSDataBoolean(\n')
            self.extractThumbnail.exportLiteral(outfile, level, name_='extractThumbnail')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.whiteBalanceAuto:
            showIndent(outfile, level)
            outfile.write('whiteBalanceAuto=XSDataBoolean(\n')
            self.whiteBalanceAuto.exportLiteral(outfile, level, name_='whiteBalanceAuto')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.whiteBalanceFromCamera:
            showIndent(outfile, level)
            outfile.write('whiteBalanceFromCamera=XSDataBoolean(\n')
            self.whiteBalanceFromCamera.exportLiteral(outfile, level, name_='whiteBalanceFromCamera')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.levelsFromCamera:
            showIndent(outfile, level)
            outfile.write('levelsFromCamera=XSDataBoolean(\n')
            self.levelsFromCamera.exportLiteral(outfile, level, name_='levelsFromCamera')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.interpolationQuality:
            showIndent(outfile, level)
            outfile.write('interpolationQuality=XSDataInteger(\n')
            self.interpolationQuality.exportLiteral(outfile, level, name_='interpolationQuality')
            showIndent(outfile, level)
            outfile.write('),\n')
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'rawImagePath':
            obj_ = XSDataFile.factory()
            obj_.build(child_)
            self.setRawImagePath(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            ...
            nodeName_ == 'exportTiff':
            obj_ = XSDataBoolean.factory()
            obj_.build(child_)
            self.setExportTiff(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'extractThumbnail':
            obj_ = XSDataBoolean.factory()
            obj_.build(child_)
            self.setExtractThumbnail(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'whiteBalanceAuto':
            obj_ = XSDataBoolean.factory()
            obj_.build(child_)
            self.setWhiteBalanceAuto(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'whiteBalanceFromCamera':
            obj_ = XSDataBoolean.factory()
            obj_.build(child_)
            self.setWhiteBalanceFromCamera(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'levelsFromCamera':
            obj_ = XSDataBoolean.factory()
            obj_.build(child_)
            self.setLevelsFromCamera(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'interpolationQuality':
            obj_ = XSDataInteger.factory()
            obj_.build(child_)
            self.setInterpolationQuality(obj_)
        XSDataInput.buildChildren(self, child_, nodeName_)
# end class XSDataInputExecDcrawv1


class XSDataResultExecDcrawv1(XSDataResult):
    subclass = None
    def __init__(self, outputPath=None, outputFileType=None, status=None):
        XSDataResult.__init__(self, status)
        self.outputPath = outputPath
        self.outputFileType = outputFileType
    def factory(*args_, **kwargs_):
        if XSDataResultExecDcrawv1.subclass:
            return XSDataResultExecDcrawv1.subclass(*args_, **kwargs_)
        else:
            return XSDataResultExecDcrawv1(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getOutputPath(self): return self.outputPath
    def setOutputPath(self, outputPath): self.outputPath = outputPath
    def getOutputFileType(self): return self.outputFileType
    def setOutputFileType(self, outputFileType): self.outputFileType = outputFileType
    def export(self, outfile, level, name_='XSDataResultExecDcrawv1'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultExecDcrawv1'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultExecDcrawv1')
    def exportChildren(self, outfile, level, name_='XSDataResultExecDcrawv1'):
        if self.outputPath:
            self.outputPath.export(outfile, level, name_='outputPath')
        if self.getOutputFileType() != None :
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataResultExecDcrawv1' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultExecDcrawv1.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataResultExecDcrawv1" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataResultExecDcrawv1'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.outputFileType:
            showIndent(outfile, level)
            outfile.write('outputFileType=XSDataString(\n')
            self.outputFileType.exportLiteral(outfile, level, name_='outputFileType')
            showIndent(outfile, level)
            outfile.write('),\n')
...
# end class XSDataResultExecDcrawv1


class XSDataInputCopyExifv1(XSDataInput):
    subclass = None
    def __init__(self, inputImagePath=None, outputImagePath=None, configuration=None):
        XSDataInput.__init__(self, configuration)
        self.inputImagePath = inputImagePath
        self.outputImagePath = outputImagePath
    def factory(*args_, **kwargs_):
        if XSDataInputCopyExifv1.subclass:
            return XSDataInputCopyExifv1.subclass(*args_, **kwargs_)
        else:
            return XSDataInputCopyExifv1(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getInputImagePath(self): return self.inputImagePath
    def setInputImagePath(self, inputImagePath): self.inputImagePath = inputImagePath
    def getOutputImagePath(self): return self.outputImagePath
    def setOutputImagePath(self, outputImagePath): self.outputImagePath = outputImagePath
    def export(self, outfile, level, name_='XSDataInputCopyExifv1'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputCopyExifv1'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputCopyExifv1')
    def exportChildren(self, outfile, level, name_='XSDataInputCopyExifv1'):
        if self.inputImagePath:
            self.inputImagePath.export(outfile, level, name_='inputImagePath')
        if self.outputImagePath:
            self.outputImagePath.export(outfile, level, name_='outputImagePath')
        XSDataInput.exportChildren(self, outfile, level, name_)
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataInputCopyExifv1' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputCopyExifv1.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataInputCopyExifv1" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataInputCopyExifv1'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.inputImagePath:
            showIndent(outfile, level)
            outfile.write('inputImagePath=XSDataFile(\n')
            self.inputImagePath.exportLiteral(outfile, level, name_='inputImagePath')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.outputImagePath:
            showIndent(outfile, level)
            outfile.write('outputImagePath=XSDataFile(\n')
            self.outputImagePath.exportLiteral(outfile, level, name_='outputImagePath')
            showIndent(outfile, level)
            outfile.write('),\n')
        XSDataInput.exportLiteralChildren(self, outfile, level, name_)
    def build(self, node_):
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'inputImagePath':
            obj_ = XSDataFile.factory()
            obj_.build(child_)
            self.setInputImagePath(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'outputImagePath':
            obj_ = XSDataFile.factory()
            obj_.build(child_)
            self.setOutputImagePath(obj_)
        XSDataInput.buildChildren(self, child_, nodeName_)
# end class XSDataInputCopyExifv1


class XSDataResultCopyExifv1(XSDataResult):
    subclass = None
    def __init__(self, outputImagePath=None, status=None):
        XSDataResult.__init__(self, status)
        self.outputImagePath = outputImagePath
    def factory(*args_, **kwargs_):
        if XSDataResultCopyExifv1.subclass:
            return XSDataResultCopyExifv1.subclass(*args_, **kwargs_)
        else:
            return XSDataResultCopyExifv1(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getOutputImagePath(self): return self.outputImagePath
    def setOutputImagePath(self, outputImagePath): self.outputImagePath = outputImagePath
    def export(self, outfile, level, name_='XSDataResultCopyExifv1'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultCopyExifv1'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultCopyExifv1')
    def exportChildren(self, outfile, level, name_='XSDataResultCopyExifv1'):
        if self.outputImagePath:
            self.outputImagePath.export(outfile, level, name_='outputImagePath')
        XSDataResult.exportChildren(self, outfile, level, name_)
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataResultCopyExifv1' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultCopyExifv1.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataResultCopyExifv1" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataResultCopyExifv1'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            self.setOutputImagePath(obj_)
        XSDataResult.buildChildren(self, child_, nodeName_)
# end class XSDataResultCopyExifv1


class XSDataInputDevelopRawv1(XSDataInput):
    subclass = None
    def __init__(self, inputRaw=None, outputJpeg=None, copyExifTag=None, compressRaw=None, cleanUp=None, configuration=None):
        XSDataInput.__init__(self, configuration)
        self.inputRaw = inputRaw
        self.outputJpeg = outputJpeg
        self.copyExifTag = copyExifTag
        self.compressRaw = compressRaw
        self.cleanUp = cleanUp
    def factory(*args_, **kwargs_):
        if XSDataInputDevelopRawv1.subclass:
            return XSDataInputDevelopRawv1.subclass(*args_, **kwargs_)
        else:
            return XSDataInputDevelopRawv1(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getInputRaw(self): return self.inputRaw
    def setInputRaw(self, inputRaw): self.inputRaw = inputRaw
    def getOutputJpeg(self): return self.outputJpeg
    def setOutputJpeg(self, outputJpeg): self.outputJpeg = outputJpeg
    def getCopyExifTag(self): return self.copyExifTag
    def setCopyExifTag(self, copyExifTag): self.copyExifTag = copyExifTag
    def getCompressRaw(self): return self.compressRaw
    def setCompressRaw(self, compressRaw): self.compressRaw = compressRaw
    def getCleanUp(self): return self.cleanUp
    def setCleanUp(self, cleanUp): self.cleanUp = cleanUp
    def export(self, outfile, level, name_='XSDataInputDevelopRawv1'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputDevelopRawv1'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputDevelopRawv1')
    def exportChildren(self, outfile, level, name_='XSDataInputDevelopRawv1'):
        if self.inputRaw:
            self.inputRaw.export(outfile, level, name_='inputRaw')
        if self.getOutputJpeg() != None :
            if self.outputJpeg:
                self.outputJpeg.export(outfile, level, name_='outputJpeg')
        if self.getCopyExifTag() != None :
            if self.copyExifTag:
                self.copyExifTag.export(outfile, level, name_='copyExifTag')
        if self.getCompressRaw() != None :
            if self.compressRaw:
                self.compressRaw.export(outfile, level, name_='compressRaw')
        if self.getCleanUp() != None :
            if self.cleanUp:
                self.cleanUp.export(outfile, level, name_='cleanUp')
        XSDataInput.exportChildren(self, outfile, level, name_)
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataInputDevelopRawv1' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputDevelopRawv1.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataInputDevelopRawv1" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataInputDevelopRawv1'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.inputRaw:
            showIndent(outfile, level)
            outfile.write('inputRaw=XSDataFile(\n')
            self.inputRaw.exportLiteral(outfile, level, name_='inputRaw')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.outputJpeg:
            showIndent(outfile, level)
            outfile.write('outputJpeg=XSDataFile(\n')
            self.outputJpeg.exportLiteral(outfile, level, name_='outputJpeg')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.copyExifTag:
            showIndent(outfile, level)
            outfile.write('copyExifTag=XSDataBoolean(\n')
            self.copyExifTag.exportLiteral(outfile, level, name_='copyExifTag')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.compressRaw:
            showIndent(outfile, level)
            outfile.write('compressRaw=XSDataBoolean(\n')
            self.compressRaw.exportLiteral(outfile, level, name_='compressRaw')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.cleanUp:
            showIndent(outfile, level)
            outfile.write('cleanUp=XSDataBoolean(\n')
            self.cleanUp.exportLiteral(outfile, level, name_='cleanUp')
            showIndent(outfile, level)
            outfile.write('),\n')
        XSDataInput.exportLiteralChildren(self, outfile, level, name_)
    def build(self, node_):
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            obj_ = XSDataFile.factory()
            obj_.build(child_)
            self.setInputRaw(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'outputJpeg':
            obj_ = XSDataFile.factory()
            obj_.build(child_)
            self.setOutputJpeg(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'copyExifTag':
            obj_ = XSDataBoolean.factory()
            obj_.build(child_)
            self.setCopyExifTag(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'compressRaw':
            obj_ = XSDataBoolean.factory()
            obj_.build(child_)
            self.setCompressRaw(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'cleanUp':
            obj_ = XSDataBoolean.factory()
            obj_.build(child_)
            self.setCleanUp(obj_)
        XSDataInput.buildChildren(self, child_, nodeName_)
# end class XSDataInputDevelopRawv1


class XSDataResultDevelopRawv1(XSDataResult):
    subclass = None
    def __init__(self, outputFile=None, status=None):
        XSDataResult.__init__(self, status)
        self.outputFile = outputFile
    def factory(*args_, **kwargs_):
        if XSDataResultDevelopRawv1.subclass:
            return XSDataResultDevelopRawv1.subclass(*args_, **kwargs_)
        else:
            return XSDataResultDevelopRawv1(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getOutputFile(self): return self.outputFile
    def setOutputFile(self, outputFile): self.outputFile = outputFile
    def export(self, outfile, level, name_='XSDataResultDevelopRawv1'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultDevelopRawv1'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultDevelopRawv1')
    def exportChildren(self, outfile, level, name_='XSDataResultDevelopRawv1'):
        if self.outputFile:
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataResultDevelopRawv1' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultDevelopRawv1.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataResultDevelopRawv1" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataResultDevelopRawv1'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def buildChildren(self, child_, nodeName_):
        ...
        XSDataResult.buildChildren(self, child_, nodeName_)
# end class XSDataResultDevelopRawv1
...
class XSDataArray(XSData):
    subclass = None
    def __init__(self, size=-1, shape=None, dtype='', coding='', data=''):
        XSData.__init__(self)
        self.size = size
        if shape is None:
            self.shape = []
    ...
    def exportChildren(self, outfile, level, name_='XSDataArray'):
        ...
        showIndent(outfile, level)
        outfile.write('<coding>%s</coding>\n' % quote_xml(self.getCoding()))
        showIndent(outfile, level)
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        showIndent(outfile, level)
        outfile.write('coding=%s,\n' % quote_python(self.getCoding()))
        showIndent(outfile, level)
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            coding_ = ''
            for text__content_ in child_.childNodes:
                coding_ += text__content_.nodeValue
            self.coding = coding_
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'data':
            data_ = ''
...
class SaxXSDataDoubleHandler(handler.ContentHandler):
    ...
    def startElement(self, name, attrs):
        ...
        if name == 'XSDataDouble':
            ...
            stackObj = SaxStackElement('coding', None)
            self.stack.append(stackObj)
            done = 1
        elif name == 'data':
        ...
        elif name == 'rawImagePath':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('rawImagePath', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'outputPath':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('outputPath', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'exportTiff':
            obj = XSDataBoolean.factory()
            stackObj = SaxStackElement('exportTiff', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'extractThumbnail':
            obj = XSDataBoolean.factory()
            stackObj = SaxStackElement('extractThumbnail', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'whiteBalanceAuto':
            obj = XSDataBoolean.factory()
            stackObj = SaxStackElement('whiteBalanceAuto', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'whiteBalanceFromCamera':
            obj = XSDataBoolean.factory()
            stackObj = SaxStackElement('whiteBalanceFromCamera', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'levelsFromCamera':
            obj = XSDataBoolean.factory()
            stackObj = SaxStackElement('levelsFromCamera', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'interpolationQuality':
            obj = XSDataInteger.factory()
            stackObj = SaxStackElement('interpolationQuality', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'outputFileType':
            obj = XSDataString.factory()
            stackObj = SaxStackElement('outputFileType', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'inputImagePath':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('inputImagePath', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'outputImagePath':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('outputImagePath', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'inputRaw':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('inputRaw', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'outputJpeg':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('outputJpeg', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'copyExifTag':
            obj = XSDataBoolean.factory()
            stackObj = SaxStackElement('copyExifTag', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'compressRaw':
            obj = XSDataBoolean.factory()
            stackObj = SaxStackElement('compressRaw', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'cleanUp':
            obj = XSDataBoolean.factory()
            stackObj = SaxStackElement('cleanUp', obj)
            self.stack.append(stackObj)
            done = 1
    ...
    def endElement(self, name):
        ...
        if name == 'XSDataDouble':
            ...
            if len(self.stack) >= 2:
                content = self.stack[-1].content
                self.stack[-2].obj.setCoding(content)
                self.stack.pop()
                done = 1
        elif name == 'data':
            if len(self.stack) >= 2:
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setRawImagePath(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'outputPath':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setOutputPath(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'exportTiff':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setExportTiff(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'extractThumbnail':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setExtractThumbnail(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'whiteBalanceAuto':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setWhiteBalanceAuto(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'whiteBalanceFromCamera':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setWhiteBalanceFromCamera(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'levelsFromCamera':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setLevelsFromCamera(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'interpolationQuality':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setInterpolationQuality(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'outputFileType':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setOutputFileType(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'inputImagePath':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setInputImagePath(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'outputImagePath':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setOutputImagePath(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'inputRaw':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setInputRaw(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'outputJpeg':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setOutputJpeg(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'copyExifTag':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setCopyExifTag(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'compressRaw':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setCompressRaw(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'cleanUp':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setCleanUp(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'outputFile':
            if len(self.stack) >= 2:
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('from XSDataPhotov1 import *\n\n')
