...
class EDTestSuitePluginExecAutoRgv1_0(EDTestSuite):
    """
    This is the test suite for EDNA plugin AutoRgv1_0 
...
if __name__ == '__main__':
    ...
    edTestSuitePluginExecAutoRgv1_0 = EDTestSuitePluginExecAutoRgv1_0("EDTestSuitePluginExecAutoRgv1_0")
    edTestSuitePluginExecAutoRgv1_0.execute()
