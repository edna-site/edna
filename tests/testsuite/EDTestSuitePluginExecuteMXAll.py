...
class EDTestSuitePluginExecuteMXAll(EDTestSuite):
...
if __name__ == '__main__':
    ...
    edTestSuitePluginExecuteMXAll = EDTestSuitePluginExecuteMXAll("EDTestSuitePluginExecuteMXAll")
    edTestSuitePluginExecuteMXAll.execute()
