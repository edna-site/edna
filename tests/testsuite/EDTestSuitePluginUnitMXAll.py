...
class EDTestSuitePluginUnitMXAll(EDTestSuite):
...
if __name__ == '__main__':
    ...
    edTestSuitePluginUnitMXAll = EDTestSuitePluginUnitMXAll("EDTestSuitePluginUnitMXAll")
    edTestSuitePluginUnitMXAll.execute()
