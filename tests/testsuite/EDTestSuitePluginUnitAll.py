...
class EDTestSuitePluginUnitAll(EDTestSuite):


    def process(self):
        self.addTestSuiteFromName("EDTestSuiteKernelUnit")
        self.addTestCaseFromName("EDTestCaseGPLinearAlgebra")
...
if __name__ == '__main__':
    ...
    edTestSuitePluginUnitAll = EDTestSuitePluginUnitAll("EDTestSuitePluginUnitAll")
    edTestSuitePluginUnitAll.execute()
