...
#
# Generated Mon Aug  2 11:26:16 2010 by EDGenerateDS.py.
#
...
class XSDataInputBioSaxsReprocessv1_0(XSDataInput):
    subclass = None
    def __init__(self, beamCenterX=None, beamCenterY=None, beamStopDiode=None, code=None, comments=None, concentration=None, detector=None, detectorDistance=None, directory=None, frameFirst=None, frameLast=None, keepOriginal=None, machineCurrent=None, maskFile=None, normalisation=None, operation=None, pixelSizeX=None, pixelSizeY=None, runNumber=None, specVariableAbort=None, specVariableStatus=None, specVersion=None, waveLength=None, configuration=None):
    ...
    def exportAttributes(self, outfile, level, name_='XSDataInputBioSaxsReprocessv1_0'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputBioSaxsReprocessv1_0')
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.concentration:
            showIndent(outfile, level)
            outfile.write('concentration=XSDataString(\n')
        ...
        if self.detectorDistance:
            showIndent(outfile, level)
            outfile.write('detectorDistance=XSDataString(\n')
        ...
        if self.waveLength:
            showIndent(outfile, level)
            outfile.write('waveLength=XSDataString(\n')
...
class SaxXSDataDoubleHandler(handler.ContentHandler):
    ...
    def endElement(self, name):
        ...
        if name == 'XSDataDouble':
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setRunNumber(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'specVariableAbort':
            if len(self.stack) >= 2:
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('from XSDataControlBioSaxsReprocess import *\n\n')
    sys.stdout.write('rootObj = XSDataDouble(\n')
    rootObj.exportLiteral(sys.stdout, 0, name_="XSDataDouble")
    sys.stdout.write(')\n')
    return rootObj

class XSDataControlBioSaxsReprocess:
    pass
