...
#
# Generated Thu Sep 16 14:21:25 2010 by EDGenerateDS.py.
#
...
class XSDataBioSaxsSample:
    subclass = None
    def __init__(self, sampleConcentration=None, sampleComments=None, sampleCode=None):
        self.sampleConcentration = sampleConcentration
        self.sampleComments = sampleComments
        self.sampleCode = sampleCode
    def factory(*args_, **kwargs_):
        if XSDataBioSaxsSample.subclass:
            return XSDataBioSaxsSample.subclass(*args_, **kwargs_)
        else:
            return XSDataBioSaxsSample(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getSampleConcentration(self): return self.sampleConcentration
    def setSampleConcentration(self, sampleConcentration): self.sampleConcentration = sampleConcentration
    def getSampleComments(self): return self.sampleComments
    def setSampleComments(self, sampleComments): self.sampleComments = sampleComments
    def getSampleCode(self): return self.sampleCode
    def setSampleCode(self, sampleCode): self.sampleCode = sampleCode
    def export(self, outfile, level, name_='XSDataBioSaxsSample'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataBioSaxsSample'):
        pass
    def exportChildren(self, outfile, level, name_='XSDataBioSaxsSample'):
        if self.getSampleConcentration() != None :
            if self.sampleConcentration:
                self.sampleConcentration.export(outfile, level, name_='sampleConcentration')
        if self.getSampleComments() != None :
            if self.sampleComments:
                self.sampleComments.export(outfile, level, name_='sampleComments')
        if self.getSampleCode() != None :
            if self.sampleCode:
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataBioSaxsSample.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataBioSaxsSample'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.sampleConcentration:
            showIndent(outfile, level)
            outfile.write('sampleConcentration=XSDataFloat(\n')
            self.sampleConcentration.exportLiteral(outfile, level, name_='sampleConcentration')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.sampleComments:
            showIndent(outfile, level)
            outfile.write('sampleComments=XSDataString(\n')
            self.sampleComments.exportLiteral(outfile, level, name_='sampleComments')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.sampleCode:
            showIndent(outfile, level)
            outfile.write('sampleCode=XSDataString(\n')
            self.sampleCode.exportLiteral(outfile, level, name_='sampleCode')
            showIndent(outfile, level)
            outfile.write('),\n')
    def build(self, node_):
        attrs = node_.attributes
...
class XSDataInputBioSaxsReprocessv1_0:
    subclass = None
    def __init__(self, configuration=None, specVersion=None, specVariableStatus=None, specVariableAbort=None, detector=None, detectorDistance=None, pixelSize_1=None, pixelSize_2=None, beamCenter_1=None, beamCenter_2=None, beamStopDiode=None, wavelength=None, machineCurrent=None, maskFile=None, normalizationFactor=None, sampleConcentration=None, sampleComments=None, sampleCode=None, directory=None, frameFirst=None, frameLast=None, isOnline=None, keepOriginal=None, normalisation=None, operation=None, prefix=None, runNumber=None):
        self.configuration = configuration
        self.specVersion = specVersion
        self.specVariableStatus = specVariableStatus
        self.specVariableAbort = specVariableAbort
        ...
        self.beamStopDiode = beamStopDiode
        ...
        self.frameFirst = frameFirst
        self.frameLast = frameLast
    ...
    def factory(*args_, **kwargs_):
        if XSDataInputBioSaxsReprocessv1_0.subclass:
            return XSDataInputBioSaxsReprocessv1_0.subclass(*args_, **kwargs_)
        else:
            return XSDataInputBioSaxsReprocessv1_0(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getConfiguration(self): return self.configuration
    def setConfiguration(self, configuration): self.configuration = configuration
    def getSpecVersion(self): return self.specVersion
    def setSpecVersion(self, specVersion): self.specVersion = specVersion
    def getSpecVariableStatus(self): return self.specVariableStatus
    def setSpecVariableStatus(self, specVariableStatus): self.specVariableStatus = specVariableStatus
    def getSpecVariableAbort(self): return self.specVariableAbort
    def setSpecVariableAbort(self, specVariableAbort): self.specVariableAbort = specVariableAbort
    ...
    def getPixelSize_1(self): return self.pixelSize_1
    def setPixelSize_1(self, pixelSize_1): self.pixelSize_1 = pixelSize_1
    def getPixelSize_2(self): return self.pixelSize_2
    def setPixelSize_2(self, pixelSize_2): self.pixelSize_2 = pixelSize_2
    def getBeamCenter_1(self): return self.beamCenter_1
    def setBeamCenter_1(self, beamCenter_1): self.beamCenter_1 = beamCenter_1
    def getBeamCenter_2(self): return self.beamCenter_2
    def setBeamCenter_2(self, beamCenter_2): self.beamCenter_2 = beamCenter_2
    def getBeamStopDiode(self): return self.beamStopDiode
    def setBeamStopDiode(self, beamStopDiode): self.beamStopDiode = beamStopDiode
    def getWavelength(self): return self.wavelength
    def setWavelength(self, wavelength): self.wavelength = wavelength
    def getMachineCurrent(self): return self.machineCurrent
    def setMachineCurrent(self, machineCurrent): self.machineCurrent = machineCurrent
    def getMaskFile(self): return self.maskFile
    def setMaskFile(self, maskFile): self.maskFile = maskFile
    def getNormalizationFactor(self): return self.normalizationFactor
    def setNormalizationFactor(self, normalizationFactor): self.normalizationFactor = normalizationFactor
    def getSampleConcentration(self): return self.sampleConcentration
    def setSampleConcentration(self, sampleConcentration): self.sampleConcentration = sampleConcentration
    def getSampleComments(self): return self.sampleComments
    def setSampleComments(self, sampleComments): self.sampleComments = sampleComments
    ...
    def getFrameFirst(self): return self.frameFirst
    def setFrameFirst(self, frameFirst): self.frameFirst = frameFirst
    def getFrameLast(self): return self.frameLast
    def setFrameLast(self, frameLast): self.frameLast = frameLast
    def getIsOnline(self): return self.isOnline
    def setIsOnline(self, isOnline): self.isOnline = isOnline
    def getKeepOriginal(self): return self.keepOriginal
    def setKeepOriginal(self, keepOriginal): self.keepOriginal = keepOriginal
    def getNormalisation(self): return self.normalisation
    def setNormalisation(self, normalisation): self.normalisation = normalisation
    def getOperation(self): return self.operation
    def setOperation(self, operation): self.operation = operation
    def getPrefix(self): return self.prefix
    def setPrefix(self, prefix): self.prefix = prefix
    def getRunNumber(self): return self.runNumber
    def setRunNumber(self, runNumber): self.runNumber = runNumber
    def addRunNumber(self, value): self.runNumber.append(value)
    def insertRunNumber(self, index, value): self.runNumber[index] = value
    def export(self, outfile, level, name_='XSDataInputBioSaxsReprocessv1_0'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputBioSaxsReprocessv1_0'):
        pass
    def exportChildren(self, outfile, level, name_='XSDataInputBioSaxsReprocessv1_0'):
        if self.configuration:
            self.configuration.export(outfile, level, name_='configuration')
        if self.getSpecVersion() != None :
            if self.specVersion:
                self.specVersion.export(outfile, level, name_='specVersion')
        if self.getSpecVariableStatus() != None :
            if self.specVariableStatus:
                self.specVariableStatus.export(outfile, level, name_='specVariableStatus')
        if self.getSpecVariableAbort() != None :
            if self.specVariableAbort:
        ...
        if self.getMachineCurrent() != None :
            if self.machineCurrent:
                self.machineCurrent.export(outfile, level, name_='machineCurrent')
        if self.getMaskFile() != None :
            if self.maskFile:
                self.maskFile.export(outfile, level, name_='maskFile')
        if self.getNormalizationFactor() != None :
            if self.normalizationFactor:
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputBioSaxsReprocessv1_0.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataInputBioSaxsReprocessv1_0'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.specVersion:
            showIndent(outfile, level)
            outfile.write('specVersion=XSDataString(\n')
            self.specVersion.exportLiteral(outfile, level, name_='specVersion')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.specVariableStatus:
            showIndent(outfile, level)
            outfile.write('specVariableStatus=XSDataString(\n')
            self.specVariableStatus.exportLiteral(outfile, level, name_='specVariableStatus')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.specVariableAbort:
            showIndent(outfile, level)
            outfile.write('specVariableAbort=XSDataString(\n')
            self.specVariableAbort.exportLiteral(outfile, level, name_='specVariableAbort')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.detector:
            showIndent(outfile, level)
            outfile.write('detector=XSDataString(\n')
            self.detector.exportLiteral(outfile, level, name_='detector')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.detectorDistance:
            showIndent(outfile, level)
            outfile.write('detectorDistance=XSDataLength(\n')
            self.detectorDistance.exportLiteral(outfile, level, name_='detectorDistance')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.pixelSize_1:
            showIndent(outfile, level)
            outfile.write('pixelSize_1=XSDataLength(\n')
            self.pixelSize_1.exportLiteral(outfile, level, name_='pixelSize_1')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.pixelSize_2:
            showIndent(outfile, level)
            outfile.write('pixelSize_2=XSDataLength(\n')
            self.pixelSize_2.exportLiteral(outfile, level, name_='pixelSize_2')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.beamCenter_1:
            showIndent(outfile, level)
            outfile.write('beamCenter_1=XSDataFloat(\n')
            self.beamCenter_1.exportLiteral(outfile, level, name_='beamCenter_1')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.beamCenter_2:
            showIndent(outfile, level)
            outfile.write('beamCenter_2=XSDataFloat(\n')
            self.beamCenter_2.exportLiteral(outfile, level, name_='beamCenter_2')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.beamStopDiode:
            showIndent(outfile, level)
            outfile.write('beamStopDiode=XSDataFloat(\n')
            self.beamStopDiode.exportLiteral(outfile, level, name_='beamStopDiode')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.wavelength:
            showIndent(outfile, level)
        ...
        if self.machineCurrent:
            showIndent(outfile, level)
            outfile.write('machineCurrent=XSDataFloat(\n')
            self.machineCurrent.exportLiteral(outfile, level, name_='machineCurrent')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.maskFile:
            showIndent(outfile, level)
            outfile.write('maskFile=XSDataImage(\n')
            self.maskFile.exportLiteral(outfile, level, name_='maskFile')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.normalizationFactor:
            showIndent(outfile, level)
            outfile.write('normalizationFactor=XSDataFloat(\n')
            self.normalizationFactor.exportLiteral(outfile, level, name_='normalizationFactor')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.sampleConcentration:
            showIndent(outfile, level)
        ...
        if self.directory:
            showIndent(outfile, level)
            outfile.write('directory=XSDataFile(\n')
            self.directory.exportLiteral(outfile, level, name_='directory')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.frameFirst:
            showIndent(outfile, level)
            outfile.write('frameFirst=XSDataInteger(\n')
            self.frameFirst.exportLiteral(outfile, level, name_='frameFirst')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.frameLast:
            showIndent(outfile, level)
            outfile.write('frameLast=XSDataInteger(\n')
            self.frameLast.exportLiteral(outfile, level, name_='frameLast')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.isOnline:
            showIndent(outfile, level)
            outfile.write('isOnline=XSDataBoolean(\n')
            self.isOnline.exportLiteral(outfile, level, name_='isOnline')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.keepOriginal:
            showIndent(outfile, level)
            outfile.write('keepOriginal=XSDataBoolean(\n')
            self.keepOriginal.exportLiteral(outfile, level, name_='keepOriginal')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.normalisation:
            showIndent(outfile, level)
            outfile.write('normalisation=XSDataString(\n')
            self.normalisation.exportLiteral(outfile, level, name_='normalisation')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.operation:
            showIndent(outfile, level)
            outfile.write('operation=XSDataString(\n')
            self.operation.exportLiteral(outfile, level, name_='operation')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.prefix:
            showIndent(outfile, level)
            outfile.write('prefix=XSDataString(\n')
            self.prefix.exportLiteral(outfile, level, name_='prefix')
            showIndent(outfile, level)
            outfile.write('),\n')
        showIndent(outfile, level)
        outfile.write('runNumber=[\n')
        level += 1
        for runNumber in self.runNumber:
            showIndent(outfile, level)
            outfile.write('XSDataInteger(\n')
            runNumber.exportLiteral(outfile, level, name_='runNumber')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class XSDataResultBioSaxsReprocessv1_0(XSDataResult):
    subclass = None
    def __init__(self, status=None, valueOf_=''):
        XSDataResult.__init__(self, status)
        self.valueOf_ = valueOf_
    def factory(*args_, **kwargs_):
        if XSDataResultBioSaxsReprocessv1_0.subclass:
            return XSDataResultBioSaxsReprocessv1_0.subclass(*args_, **kwargs_)
        else:
            return XSDataResultBioSaxsReprocessv1_0(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getValueOf_(self): return self.valueOf_
    def setValueOf_(self, valueOf_): self.valueOf_ = valueOf_
    def export(self, outfile, level, name_='XSDataResultBioSaxsReprocessv1_0'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultBioSaxsReprocessv1_0'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultBioSaxsReprocessv1_0')
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultBioSaxsReprocessv1_0.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataResultBioSaxsReprocessv1_0'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
...
class XSDataBioSaxsExperimentSetup:
    subclass = None
    def __init__(self, valueOf_=''):
        self.valueOf_ = valueOf_
    def factory(*args_, **kwargs_):
        if XSDataBioSaxsExperimentSetup.subclass:
            return XSDataBioSaxsExperimentSetup.subclass(*args_, **kwargs_)
        else:
            return XSDataBioSaxsExperimentSetup(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getValueOf_(self): return self.valueOf_
    def setValueOf_(self, valueOf_): self.valueOf_ = valueOf_
    def export(self, outfile, level, name_='XSDataBioSaxsExperimentSetup'):
        ...
        self.exportChildren(outfile, level + 1, name_)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataBioSaxsExperimentSetup'):
        pass
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataBioSaxsExperimentSetup.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataBioSaxsExperimentSetup'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
...
class XSDataInputBioSaxsNormalizev1_0:
    subclass = None
    def __init__(self, configuration=None, detector=None, detectorDistance=None, pixelSize_1=None, pixelSize_2=None, beamCenter_1=None, beamCenter_2=None, beamStopDiode=None, wavelength=None, machineCurrent=None, maskFile=None, normalizationFactor=None, sampleConcentration=None, sampleComments=None, sampleCode=None, rawImage=None, logFile=None, normalizedImage=None, rawImageSize=None):
        self.configuration = configuration
        self.detector = detector
        self.detectorDistance = detectorDistance
        self.pixelSize_1 = pixelSize_1
    ...
    def factory(*args_, **kwargs_):
        if XSDataInputBioSaxsNormalizev1_0.subclass:
            return XSDataInputBioSaxsNormalizev1_0.subclass(*args_, **kwargs_)
        else:
            return XSDataInputBioSaxsNormalizev1_0(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getConfiguration(self): return self.configuration
    def setConfiguration(self, configuration): self.configuration = configuration
    def getDetector(self): return self.detector
    ...
    def getSampleCode(self): return self.sampleCode
    def setSampleCode(self, sampleCode): self.sampleCode = sampleCode
    def getRawImage(self): return self.rawImage
    def setRawImage(self, rawImage): self.rawImage = rawImage
    def getLogFile(self): return self.logFile
    def setLogFile(self, logFile): self.logFile = logFile
    def getNormalizedImage(self): return self.normalizedImage
    def setNormalizedImage(self, normalizedImage): self.normalizedImage = normalizedImage
    def getRawImageSize(self): return self.rawImageSize
    def setRawImageSize(self, rawImageSize): self.rawImageSize = rawImageSize
    def export(self, outfile, level, name_='XSDataInputBioSaxsNormalizev1_0'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputBioSaxsNormalizev1_0'):
        pass
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputBioSaxsNormalizev1_0.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataInputBioSaxsNormalizev1_0'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.rawImage:
            showIndent(outfile, level)
            outfile.write('rawImage=XSDataImage(\n')
            self.rawImage.exportLiteral(outfile, level, name_='rawImage')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.logFile:
            showIndent(outfile, level)
        ...
        if self.normalizedImage:
            showIndent(outfile, level)
            outfile.write('normalizedImage=XSDataImage(\n')
            self.normalizedImage.exportLiteral(outfile, level, name_='normalizedImage')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.rawImageSize:
            showIndent(outfile, level)
            outfile.write('rawImageSize=XSDataInteger(\n')
            self.rawImageSize.exportLiteral(outfile, level, name_='rawImageSize')
            showIndent(outfile, level)
            outfile.write('),\n')
    def build(self, node_):
        attrs = node_.attributes
...
class XSDataResultBioSaxsProcessOneRunv1_0(XSDataResult):
    ...
    def __init__(self, status=None, valueOf_=''):
        ...
        self.valueOf_ = valueOf_
    def factory(*args_, **kwargs_):
        if XSDataResultBioSaxsProcessOneRunv1_0.subclass:
            return XSDataResultBioSaxsProcessOneRunv1_0.subclass(*args_, **kwargs_)
        else:
            return XSDataResultBioSaxsProcessOneRunv1_0(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getValueOf_(self): return self.valueOf_
    def setValueOf_(self, valueOf_): self.valueOf_ = valueOf_
    def export(self, outfile, level, name_='XSDataResultBioSaxsProcessOneRunv1_0'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultBioSaxsProcessOneRunv1_0'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultBioSaxsProcessOneRunv1_0')
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultBioSaxsProcessOneRunv1_0.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataResultBioSaxsProcessOneRunv1_0'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
...
class XSDataInputBioSaxsAzimutIntv1_0:
    subclass = None
    def __init__(self, configuration=None, detector=None, detectorDistance=None, pixelSize_1=None, pixelSize_2=None, beamCenter_1=None, beamCenter_2=None, beamStopDiode=None, wavelength=None, machineCurrent=None, maskFile=None, normalizationFactor=None, sampleConcentration=None, sampleComments=None, sampleCode=None, normalizedImage=None, normalizedImageSize=None, integratedImage=None, integratedSpectrum=None, correctedImage=None):
        self.configuration = configuration
        self.detector = detector
        self.detectorDistance = detectorDistance
        self.pixelSize_1 = pixelSize_1
        ...
        self.sampleCode = sampleCode
        self.normalizedImage = normalizedImage
        self.normalizedImageSize = normalizedImageSize
        self.integratedImage = integratedImage
        self.integratedSpectrum = integratedSpectrum
        self.correctedImage = correctedImage
    def factory(*args_, **kwargs_):
        if XSDataInputBioSaxsAzimutIntv1_0.subclass:
            return XSDataInputBioSaxsAzimutIntv1_0.subclass(*args_, **kwargs_)
        else:
            return XSDataInputBioSaxsAzimutIntv1_0(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getConfiguration(self): return self.configuration
    def setConfiguration(self, configuration): self.configuration = configuration
    def getDetector(self): return self.detector
    ...
    def getNormalizedImage(self): return self.normalizedImage
    def setNormalizedImage(self, normalizedImage): self.normalizedImage = normalizedImage
    def getNormalizedImageSize(self): return self.normalizedImageSize
    def setNormalizedImageSize(self, normalizedImageSize): self.normalizedImageSize = normalizedImageSize
    def getIntegratedImage(self): return self.integratedImage
    def setIntegratedImage(self, integratedImage): self.integratedImage = integratedImage
    def getIntegratedSpectrum(self): return self.integratedSpectrum
    def setIntegratedSpectrum(self, integratedSpectrum): self.integratedSpectrum = integratedSpectrum
    def getCorrectedImage(self): return self.correctedImage
    def setCorrectedImage(self, correctedImage): self.correctedImage = correctedImage
    def export(self, outfile, level, name_='XSDataInputBioSaxsAzimutIntv1_0'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputBioSaxsAzimutIntv1_0'):
        pass
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputBioSaxsAzimutIntv1_0.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataInputBioSaxsAzimutIntv1_0'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.normalizedImageSize:
            showIndent(outfile, level)
            outfile.write('normalizedImageSize=XSDataInteger(\n')
            self.normalizedImageSize.exportLiteral(outfile, level, name_='normalizedImageSize')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.integratedImage:
            showIndent(outfile, level)
            outfile.write('integratedImage=XSDataImage(\n')
            self.integratedImage.exportLiteral(outfile, level, name_='integratedImage')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.integratedSpectrum:
            showIndent(outfile, level)
            outfile.write('integratedSpectrum=XSDataFile(\n')
            self.integratedSpectrum.exportLiteral(outfile, level, name_='integratedSpectrum')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.correctedImage:
            showIndent(outfile, level)
            outfile.write('correctedImage=XSDataImage(\n')
            self.correctedImage.exportLiteral(outfile, level, name_='correctedImage')
            showIndent(outfile, level)
            outfile.write('),\n')
    def build(self, node_):
        attrs = node_.attributes
...
class XSDataSpecCommunication:
    subclass = None
    def __init__(self, specVersion=None, specVariableStatus=None, specVariableAbort=None):
        self.specVersion = specVersion
        self.specVariableStatus = specVariableStatus
        self.specVariableAbort = specVariableAbort
    def factory(*args_, **kwargs_):
        if XSDataSpecCommunication.subclass:
            return XSDataSpecCommunication.subclass(*args_, **kwargs_)
        else:
            return XSDataSpecCommunication(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getSpecVersion(self): return self.specVersion
    def setSpecVersion(self, specVersion): self.specVersion = specVersion
    def getSpecVariableStatus(self): return self.specVariableStatus
    ...
    def export(self, outfile, level, name_='XSDataSpecCommunication'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataSpecCommunication'):
        pass
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataSpecCommunication.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataSpecCommunication'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
...
class XSDataInputBioSaxsProcessOneRunv1_0:
    subclass = None
    def __init__(self, configuration=None, specVersion=None, specVariableStatus=None, specVariableAbort=None, detector=None, detectorDistance=None, pixelSize_1=None, pixelSize_2=None, beamCenter_1=None, beamCenter_2=None, beamStopDiode=None, wavelength=None, machineCurrent=None, maskFile=None, normalizationFactor=None, sampleConcentration=None, sampleComments=None, sampleCode=None, runNumber=None, frames=None, isOnline=None, prefix=None, directoryRaw=None, directory1D=None, directory2D=None, directoryMisc=None):
        self.configuration = configuration
        self.specVersion = specVersion
        self.specVariableStatus = specVariableStatus
        self.specVariableAbort = specVariableAbort
        ...
        self.isOnline = isOnline
        self.prefix = prefix
        self.directoryRaw = directoryRaw
        self.directory1D = directory1D
        self.directory2D = directory2D
        self.directoryMisc = directoryMisc
    def factory(*args_, **kwargs_):
        if XSDataInputBioSaxsProcessOneRunv1_0.subclass:
            return XSDataInputBioSaxsProcessOneRunv1_0.subclass(*args_, **kwargs_)
        else:
            return XSDataInputBioSaxsProcessOneRunv1_0(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getConfiguration(self): return self.configuration
    def setConfiguration(self, configuration): self.configuration = configuration
    def getSpecVersion(self): return self.specVersion
    ...
    def addFrames(self, value): self.frames.append(value)
    def insertFrames(self, index, value): self.frames[index] = value
    def getIsOnline(self): return self.isOnline
    def setIsOnline(self, isOnline): self.isOnline = isOnline
    def getPrefix(self): return self.prefix
    def setPrefix(self, prefix): self.prefix = prefix
    def getDirectoryRaw(self): return self.directoryRaw
    def setDirectoryRaw(self, directoryRaw): self.directoryRaw = directoryRaw
    def getDirectory1D(self): return self.directory1D
    def setDirectory1D(self, directory1D): self.directory1D = directory1D
    def getDirectory2D(self): return self.directory2D
    def setDirectory2D(self, directory2D): self.directory2D = directory2D
    def getDirectoryMisc(self): return self.directoryMisc
    def setDirectoryMisc(self, directoryMisc): self.directoryMisc = directoryMisc
    def export(self, outfile, level, name_='XSDataInputBioSaxsProcessOneRunv1_0'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputBioSaxsProcessOneRunv1_0'):
        pass
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputBioSaxsProcessOneRunv1_0.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataInputBioSaxsProcessOneRunv1_0'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.runNumber:
            showIndent(outfile, level)
            outfile.write('runNumber=XSDataInteger(\n')
            self.runNumber.exportLiteral(outfile, level, name_='runNumber')
            showIndent(outfile, level)
            outfile.write('),\n')
        showIndent(outfile, level)
        ...
        for frames in self.frames:
            showIndent(outfile, level)
            outfile.write('XSDataInteger(\n')
            frames.exportLiteral(outfile, level, name_='frames')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        ...
        if self.directoryRaw:
            showIndent(outfile, level)
            outfile.write('directoryRaw=XSDataFile(\n')
            self.directoryRaw.exportLiteral(outfile, level, name_='directoryRaw')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.directory1D:
            showIndent(outfile, level)
            outfile.write('directory1D=XSDataFile(\n')
            self.directory1D.exportLiteral(outfile, level, name_='directory1D')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.directory2D:
            showIndent(outfile, level)
            outfile.write('directory2D=XSDataFile(\n')
            self.directory2D.exportLiteral(outfile, level, name_='directory2D')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.directoryMisc:
            showIndent(outfile, level)
            outfile.write('directoryMisc=XSDataFile(\n')
            self.directoryMisc.exportLiteral(outfile, level, name_='directoryMisc')
            showIndent(outfile, level)
            outfile.write('),\n')
    def build(self, node_):
        attrs = node_.attributes
...
class XSDataResultBioSaxsNormalizev1_0(XSDataResult):
    subclass = None
    def __init__(self, normalizedImage=None, logFile=None, processLog=None, status=None):
        XSDataResult.__init__(self, status)
        self.normalizedImage = normalizedImage
        self.logFile = logFile
        self.processLog = processLog
    def factory(*args_, **kwargs_):
        if XSDataResultBioSaxsNormalizev1_0.subclass:
            return XSDataResultBioSaxsNormalizev1_0.subclass(*args_, **kwargs_)
        else:
            return XSDataResultBioSaxsNormalizev1_0(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getNormalizedImage(self): return self.normalizedImage
    def setNormalizedImage(self, normalizedImage): self.normalizedImage = normalizedImage
    def getLogFile(self): return self.logFile
    def setLogFile(self, logFile): self.logFile = logFile
    def getProcessLog(self): return self.processLog
    def setProcessLog(self, processLog): self.processLog = processLog
    def export(self, outfile, level, name_='XSDataResultBioSaxsNormalizev1_0'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultBioSaxsNormalizev1_0'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultBioSaxsNormalizev1_0')
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultBioSaxsNormalizev1_0.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataResultBioSaxsNormalizev1_0'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.processLog:
            showIndent(outfile, level)
            outfile.write('processLog=XSDataString(\n')
            self.processLog.exportLiteral(outfile, level, name_='processLog')
            showIndent(outfile, level)
            outfile.write('),\n')
        XSDataResult.exportLiteralChildren(self, outfile, level, name_)
    def build(self, node_):
...
class XSDataResultBioSaxsAzimutIntv1_0(XSDataResult):
    subclass = None
    def __init__(self, correctedImage=None, integratedImage=None, integratedSpectrum=None, processLog=None, status=None):
        XSDataResult.__init__(self, status)
        self.correctedImage = correctedImage
        self.integratedImage = integratedImage
        self.integratedSpectrum = integratedSpectrum
        self.processLog = processLog
    def factory(*args_, **kwargs_):
        if XSDataResultBioSaxsAzimutIntv1_0.subclass:
            return XSDataResultBioSaxsAzimutIntv1_0.subclass(*args_, **kwargs_)
        else:
            return XSDataResultBioSaxsAzimutIntv1_0(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getCorrectedImage(self): return self.correctedImage
    def setCorrectedImage(self, correctedImage): self.correctedImage = correctedImage
    def getIntegratedImage(self): return self.integratedImage
    ...
    def export(self, outfile, level, name_='XSDataResultBioSaxsAzimutIntv1_0'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultBioSaxsAzimutIntv1_0'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultBioSaxsAzimutIntv1_0')
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultBioSaxsAzimutIntv1_0.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataResultBioSaxsAzimutIntv1_0'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
...
class XSDataInputBioSaxsAveragev1_0:
    subclass = None
    def __init__(self, configuration=None, detector=None, detectorDistance=None, pixelSize_1=None, pixelSize_2=None, beamCenter_1=None, beamCenter_2=None, beamStopDiode=None, wavelength=None, machineCurrent=None, maskFile=None, normalizationFactor=None, sampleConcentration=None, sampleComments=None, sampleCode=None, integratedImage=None, integratedImageSize=None, averagedImage=None, averagedSpectrum=None, logFile=None):
        self.configuration = configuration
        self.detector = detector
        self.detectorDistance = detectorDistance
        self.pixelSize_1 = pixelSize_1
        ...
        if integratedImage is None:
            ...
            self.integratedImage = integratedImage
        self.integratedImageSize = integratedImageSize
        self.averagedImage = averagedImage
        self.averagedSpectrum = averagedSpectrum
        self.logFile = logFile
    def factory(*args_, **kwargs_):
        if XSDataInputBioSaxsAveragev1_0.subclass:
            return XSDataInputBioSaxsAveragev1_0.subclass(*args_, **kwargs_)
        else:
            return XSDataInputBioSaxsAveragev1_0(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getConfiguration(self): return self.configuration
    def setConfiguration(self, configuration): self.configuration = configuration
    def getDetector(self): return self.detector
    ...
    def getIntegratedImage(self): return self.integratedImage
    def setIntegratedImage(self, integratedImage): self.integratedImage = integratedImage
    def addIntegratedImage(self, value): self.integratedImage.append(value)
    def insertIntegratedImage(self, index, value): self.integratedImage[index] = value
    def getIntegratedImageSize(self): return self.integratedImageSize
    def setIntegratedImageSize(self, integratedImageSize): self.integratedImageSize = integratedImageSize
    def getAveragedImage(self): return self.averagedImage
    def setAveragedImage(self, averagedImage): self.averagedImage = averagedImage
    def getAveragedSpectrum(self): return self.averagedSpectrum
    def setAveragedSpectrum(self, averagedSpectrum): self.averagedSpectrum = averagedSpectrum
    def getLogFile(self): return self.logFile
    def setLogFile(self, logFile): self.logFile = logFile
    def export(self, outfile, level, name_='XSDataInputBioSaxsAveragev1_0'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputBioSaxsAveragev1_0'):
        pass
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputBioSaxsAveragev1_0.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataInputBioSaxsAveragev1_0'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.sampleCode:
            ...
            outfile.write('),\n')
        showIndent(outfile, level)
        outfile.write('integratedImage=[\n')
        level += 1
        for integratedImage in self.integratedImage:
            showIndent(outfile, level)
            outfile.write('XSDataImage(\n')
            integratedImage.exportLiteral(outfile, level, name_='integratedImage')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        ...
        if self.integratedImageSize:
            showIndent(outfile, level)
            outfile.write('integratedImageSize=XSDataInteger(\n')
            self.integratedImageSize.exportLiteral(outfile, level, name_='integratedImageSize')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.averagedImage:
            showIndent(outfile, level)
            outfile.write('averagedImage=XSDataImage(\n')
            self.averagedImage.exportLiteral(outfile, level, name_='averagedImage')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.averagedSpectrum:
            showIndent(outfile, level)
            outfile.write('averagedSpectrum=XSDataFile(\n')
            self.averagedSpectrum.exportLiteral(outfile, level, name_='averagedSpectrum')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.logFile:
            showIndent(outfile, level)
...
class XSDataResultBioSaxsAveragev1_0(XSDataResult):
    subclass = None
    def __init__(self, averagedImage=None, averagedSpectrum=None, processLog=None, logFile=None, status=None):
        XSDataResult.__init__(self, status)
        self.averagedImage = averagedImage
        self.averagedSpectrum = averagedSpectrum
        self.processLog = processLog
        self.logFile = logFile
    def factory(*args_, **kwargs_):
        if XSDataResultBioSaxsAveragev1_0.subclass:
            return XSDataResultBioSaxsAveragev1_0.subclass(*args_, **kwargs_)
        else:
            return XSDataResultBioSaxsAveragev1_0(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getAveragedImage(self): return self.averagedImage
    def setAveragedImage(self, averagedImage): self.averagedImage = averagedImage
    def getAveragedSpectrum(self): return self.averagedSpectrum
    ...
    def export(self, outfile, level, name_='XSDataResultBioSaxsAveragev1_0'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultBioSaxsAveragev1_0'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultBioSaxsAveragev1_0')
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultBioSaxsAveragev1_0.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataResultBioSaxsAveragev1_0'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
...
class XSDataInputBioSaxsMetadatav1_0:
    subclass = None
    def __init__(self, configuration=None, detector=None, detectorDistance=None, pixelSize_1=None, pixelSize_2=None, beamCenter_1=None, beamCenter_2=None, beamStopDiode=None, wavelength=None, machineCurrent=None, maskFile=None, normalizationFactor=None, sampleConcentration=None, sampleComments=None, sampleCode=None, inputImage=None, outputImage=None):
        self.configuration = configuration
        self.detector = detector
        self.detectorDistance = detectorDistance
        self.pixelSize_1 = pixelSize_1
    ...
    def factory(*args_, **kwargs_):
        if XSDataInputBioSaxsMetadatav1_0.subclass:
            return XSDataInputBioSaxsMetadatav1_0.subclass(*args_, **kwargs_)
        else:
            return XSDataInputBioSaxsMetadatav1_0(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getConfiguration(self): return self.configuration
    def setConfiguration(self, configuration): self.configuration = configuration
    def getDetector(self): return self.detector
    ...
    def getSampleCode(self): return self.sampleCode
    def setSampleCode(self, sampleCode): self.sampleCode = sampleCode
    def getInputImage(self): return self.inputImage
    def setInputImage(self, inputImage): self.inputImage = inputImage
    def getOutputImage(self): return self.outputImage
    def setOutputImage(self, outputImage): self.outputImage = outputImage
    def export(self, outfile, level, name_='XSDataInputBioSaxsMetadatav1_0'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputBioSaxsMetadatav1_0'):
        pass
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputBioSaxsMetadatav1_0.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataInputBioSaxsMetadatav1_0'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.inputImage:
            showIndent(outfile, level)
            outfile.write('inputImage=XSDataImage(\n')
            self.inputImage.exportLiteral(outfile, level, name_='inputImage')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.outputImage:
            showIndent(outfile, level)
            outfile.write('outputImage=XSDataImage(\n')
            self.outputImage.exportLiteral(outfile, level, name_='outputImage')
            showIndent(outfile, level)
            outfile.write('),\n')
    def build(self, node_):
        attrs = node_.attributes
...
class XSDataResultBioSaxsMetadatav1_0:
    subclass = None
    def __init__(self, status=None, detector=None, detectorDistance=None, pixelSize_1=None, pixelSize_2=None, beamCenter_1=None, beamCenter_2=None, beamStopDiode=None, wavelength=None, machineCurrent=None, maskFile=None, normalizationFactor=None, sampleConcentration=None, sampleComments=None, sampleCode=None, outputImage=None):
        self.status = status
        self.detector = detector
        self.detectorDistance = detectorDistance
        self.pixelSize_1 = pixelSize_1
        ...
        self.outputImage = outputImage
    def factory(*args_, **kwargs_):
        if XSDataResultBioSaxsMetadatav1_0.subclass:
            return XSDataResultBioSaxsMetadatav1_0.subclass(*args_, **kwargs_)
        else:
            return XSDataResultBioSaxsMetadatav1_0(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getStatus(self): return self.status
    def setStatus(self, status): self.status = status
    def getDetector(self): return self.detector
    ...
    def export(self, outfile, level, name_='XSDataResultBioSaxsMetadatav1_0'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultBioSaxsMetadatav1_0'):
        pass
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultBioSaxsMetadatav1_0.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataResultBioSaxsMetadatav1_0'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
...
class XSDataInputBioSaxsAsciiExportv1_0(XSDataInput):
    subclass = None
    def __init__(self, integratedImage=None, integratedSpectrum=None, configuration=None):
        XSDataInput.__init__(self, configuration)
        self.integratedImage = integratedImage
        self.integratedSpectrum = integratedSpectrum
    def factory(*args_, **kwargs_):
        if XSDataInputBioSaxsAsciiExportv1_0.subclass:
            return XSDataInputBioSaxsAsciiExportv1_0.subclass(*args_, **kwargs_)
        else:
            return XSDataInputBioSaxsAsciiExportv1_0(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getIntegratedImage(self): return self.integratedImage
    def setIntegratedImage(self, integratedImage): self.integratedImage = integratedImage
    def getIntegratedSpectrum(self): return self.integratedSpectrum
    ...
    def export(self, outfile, level, name_='XSDataInputBioSaxsAsciiExportv1_0'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputBioSaxsAsciiExportv1_0'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputBioSaxsAsciiExportv1_0')
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputBioSaxsAsciiExportv1_0.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataInputBioSaxsAsciiExportv1_0'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
...
class XSDataResultBioSaxsAsciiExportv1_0(XSDataResult):
    subclass = None
    def __init__(self, integratedSpectrum=None, processLog=None, status=None):
        XSDataResult.__init__(self, status)
        self.integratedSpectrum = integratedSpectrum
        self.processLog = processLog
    def factory(*args_, **kwargs_):
        if XSDataResultBioSaxsAsciiExportv1_0.subclass:
            return XSDataResultBioSaxsAsciiExportv1_0.subclass(*args_, **kwargs_)
        else:
            return XSDataResultBioSaxsAsciiExportv1_0(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getIntegratedSpectrum(self): return self.integratedSpectrum
    def setIntegratedSpectrum(self, integratedSpectrum): self.integratedSpectrum = integratedSpectrum
    def getProcessLog(self): return self.processLog
    ...
    def export(self, outfile, level, name_='XSDataResultBioSaxsAsciiExportv1_0'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultBioSaxsAsciiExportv1_0'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultBioSaxsAsciiExportv1_0')
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultBioSaxsAsciiExportv1_0.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataResultBioSaxsAsciiExportv1_0'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
...
class SaxXSDataDoubleHandler(handler.ContentHandler):
    ...
    def startElement(self, name, attrs):
        ...
        if name == 'XSDataDouble':
        ...
        elif name == 'sampleConcentration':
            obj = XSDataFloat.factory()
            stackObj = SaxStackElement('sampleConcentration', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'sampleComments':
            obj = XSDataString.factory()
            stackObj = SaxStackElement('sampleComments', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'sampleCode':
            obj = XSDataString.factory()
            stackObj = SaxStackElement('sampleCode', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'specVersion':
            obj = XSDataString.factory()
            stackObj = SaxStackElement('specVersion', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'specVariableStatus':
            obj = XSDataString.factory()
            stackObj = SaxStackElement('specVariableStatus', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'specVariableAbort':
            obj = XSDataString.factory()
            stackObj = SaxStackElement('specVariableAbort', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'detector':
            obj = XSDataString.factory()
            ...
            obj = XSDataLength.factory()
            stackObj = SaxStackElement('detectorDistance', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'pixelSize_1':
            obj = XSDataLength.factory()
            stackObj = SaxStackElement('pixelSize_1', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'pixelSize_2':
            obj = XSDataLength.factory()
            stackObj = SaxStackElement('pixelSize_2', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'beamCenter_1':
            obj = XSDataFloat.factory()
            stackObj = SaxStackElement('beamCenter_1', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'beamCenter_2':
            obj = XSDataFloat.factory()
            stackObj = SaxStackElement('beamCenter_2', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'beamStopDiode':
            obj = XSDataFloat.factory()
            stackObj = SaxStackElement('beamStopDiode', obj)
            self.stack.append(stackObj)
            done = 1
        ...
        elif name == 'machineCurrent':
            obj = XSDataFloat.factory()
            stackObj = SaxStackElement('machineCurrent', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'maskFile':
            obj = XSDataImage.factory()
            stackObj = SaxStackElement('maskFile', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'normalizationFactor':
            obj = XSDataFloat.factory()
            stackObj = SaxStackElement('normalizationFactor', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'directory':
            obj = XSDataFile.factory()
        ...
        elif name == 'frameFirst':
            obj = XSDataInteger.factory()
            stackObj = SaxStackElement('frameFirst', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'frameLast':
            obj = XSDataInteger.factory()
            stackObj = SaxStackElement('frameLast', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'isOnline':
            obj = XSDataBoolean.factory()
            stackObj = SaxStackElement('isOnline', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'keepOriginal':
            obj = XSDataBoolean.factory()
            stackObj = SaxStackElement('keepOriginal', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'normalisation':
            obj = XSDataString.factory()
            stackObj = SaxStackElement('normalisation', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'operation':
            obj = XSDataString.factory()
            stackObj = SaxStackElement('operation', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'prefix':
            obj = XSDataString.factory()
            stackObj = SaxStackElement('prefix', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'runNumber':
            obj = XSDataInteger.factory()
            stackObj = SaxStackElement('runNumber', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'rawImage':
            obj = XSDataImage.factory()
            stackObj = SaxStackElement('rawImage', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'logFile':
            obj = XSDataFile.factory()
        ...
        elif name == 'normalizedImage':
            obj = XSDataImage.factory()
            stackObj = SaxStackElement('normalizedImage', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'rawImageSize':
            obj = XSDataInteger.factory()
            stackObj = SaxStackElement('rawImageSize', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'normalizedImageSize':
            obj = XSDataInteger.factory()
            stackObj = SaxStackElement('normalizedImageSize', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'integratedImage':
            obj = XSDataImage.factory()
            stackObj = SaxStackElement('integratedImage', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'integratedSpectrum':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('integratedSpectrum', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'correctedImage':
            obj = XSDataImage.factory()
            stackObj = SaxStackElement('correctedImage', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'frames':
            obj = XSDataInteger.factory()
            stackObj = SaxStackElement('frames', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'directoryRaw':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('directoryRaw', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'directory1D':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('directory1D', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'directory2D':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('directory2D', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'directoryMisc':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('directoryMisc', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'processLog':
            obj = XSDataString.factory()
            stackObj = SaxStackElement('processLog', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'integratedImageSize':
            obj = XSDataInteger.factory()
            stackObj = SaxStackElement('integratedImageSize', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'averagedImage':
            obj = XSDataImage.factory()
            stackObj = SaxStackElement('averagedImage', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'averagedSpectrum':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('averagedSpectrum', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'inputImage':
            obj = XSDataImage.factory()
            stackObj = SaxStackElement('inputImage', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'outputImage':
            obj = XSDataImage.factory()
            stackObj = SaxStackElement('outputImage', obj)
            self.stack.append(stackObj)
            done = 1
        if not done:
    ...
    def endElement(self, name):
        ...
        if name == 'XSDataDouble':
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setSampleConcentration(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'sampleComments':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setSampleComments(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'sampleCode':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setSampleCode(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'specVersion':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setSpecVersion(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'specVariableStatus':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setSpecVariableStatus(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'specVariableAbort':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setSpecVariableAbort(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'detector':
            if len(self.stack) >= 2:
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setDetectorDistance(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'pixelSize_1':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setPixelSize_1(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'pixelSize_2':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setPixelSize_2(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'beamCenter_1':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setBeamCenter_1(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'beamCenter_2':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setBeamCenter_2(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'beamStopDiode':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setBeamStopDiode(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'wavelength':
            if len(self.stack) >= 2:
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setMachineCurrent(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'maskFile':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setMaskFile(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'normalizationFactor':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setNormalizationFactor(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'directory':
            if len(self.stack) >= 2:
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setFrameFirst(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'frameLast':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setFrameLast(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'isOnline':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setIsOnline(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'keepOriginal':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setKeepOriginal(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'normalisation':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setNormalisation(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'operation':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setOperation(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'prefix':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setPrefix(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'runNumber':
            if len(self.stack) >= 2:
                self.stack[-2].obj.addRunNumber(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'rawImage':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setRawImage(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'logFile':
            if len(self.stack) >= 2:
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setNormalizedImage(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'rawImageSize':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setRawImageSize(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'normalizedImageSize':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setNormalizedImageSize(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'integratedImage':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setIntegratedImage(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'integratedSpectrum':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setIntegratedSpectrum(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'correctedImage':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setCorrectedImage(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'frames':
            if len(self.stack) >= 2:
                self.stack[-2].obj.addFrames(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'directoryRaw':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setDirectoryRaw(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'directory1D':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setDirectory1D(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'directory2D':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setDirectory2D(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'directoryMisc':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setDirectoryMisc(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'processLog':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setProcessLog(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'integratedImageSize':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setIntegratedImageSize(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'averagedImage':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setAveragedImage(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'averagedSpectrum':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setAveragedSpectrum(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'inputImage':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setInputImage(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'outputImage':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setOutputImage(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        if not done:
            self.reportError('"%s" element not allowed here.' % name)
