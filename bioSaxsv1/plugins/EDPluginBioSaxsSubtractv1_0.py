...
class EDPluginBioSaxsSubtractv1_0(EDPluginControl):
    """
    ...
    """
    cpWaitFile = "EDPluginWaitMultiFile"
    cp
...
#        self.tKey = (None,)
    ...
    def checkParameters(self):
        ...
        """
        self.DEBUG("EDPluginBioSaxsSubtractv1_0.checkParameters")
    ...
    def preProcess(self, _edObject=None):
        ...
        self.DEBUG("EDPluginBioSaxsSubtractv1_0.preProcess")
    ...
    def process(self, _edObject=None):
        ...
        self.DEBUG("EDPluginBioSaxsSubtractv1_0.process")
    ...
    def postProcess(self, _edObject=None):
        ...
        self.DEBUG("EDPluginBioSaxsSubtractv1_0.postProcess")
...
# Code: BSA
    ...
    def doSuccessExecWait(self, _edPlugin=None):
        self.DEBUG("EDPluginBioSaxsSubtractv1_0.doSuccessExecWait")
        self.retrieveSuccessMessages(_edPlugin, "EDPluginBioSaxsSubtractv1_0.doSuccessExecWait")
    ...
    def doFailureExecWait(self, _edPlugin=None):
        self.DEBUG("EDPluginBioSaxsSubtractv1_0.doFailureExecWait")
        self.retrieveFailureMessages(_edPlugin, "EDPluginBioSaxsSubtractv1_0.doFailureExecWait")
        strErr = "Error in waiting for all input files to arrive"
        self.ERROR(strErr)
    ...
    def doSuccessExecDataver(self, _edPlugin=None):
        self.DEBUG("EDPluginBioSaxsSubtractv1_0.doSuccessExecDataver")
        self.retrieveSuccessMessages(_edPlugin, "EDPluginBioSaxsSubtractv1_0.doSuccessExecDataver")
    ...
    def doFailureExecDataver(self, _edPlugin=None):
        self.DEBUG("EDPluginBioSaxsSubtractv1_0.doFailureExecDataver")
        self.retrieveFailureMessages(_edPlugin, "EDPluginBioSaxsSubtractv1_0.doFailureExecDataver")
    ...
    def doSuccessExecDatcmp(self, _edPlugin=None):
        self.DEBUG("EDPluginBioSaxsSubtractv1_0.doSuccessExecDatcmp")
        self.retrieveSuccessMessages(_edPlugin, "EDPluginBioSaxsSubtractv1_0.doSuccessExecDatcmp")
        with self.locked():
    ...
    def doFailureExecDatcmp(self, _edPlugin=None):
        self.DEBUG("EDPluginBioSaxsSubtractv1_0.doFailureExecDatcmp")
        self.retrieveFailureMessages(_edPlugin, "EDPluginBioSaxsSubtractv1_0.doFailureExecDatcmp")
        self.lstSummary.append("Failure in Processing of Atsas 'datcmp'")
        self.setFailure()


    def doSuccessExecAutoSub(self, _edPlugin=None):
        self.DEBUG("EDPluginBioSaxsSubtractv1_0.doSuccessExecAutoSub")
        self.retrieveSuccessMessages(_edPlugin, "EDPluginBioSaxsSubtractv1_0.doSuccessExecAutoSub")
    ...
    def doFailureExecAutoSub(self, _edPlugin=None):
        self.DEBUG("EDPluginBioSaxsSubtractv1_0.doFailureExecAutoSub")
        self.retrieveFailureMessages(_edPlugin, "EDPluginBioSaxsSubtractv1_0.doFailureExecAutoSub")
