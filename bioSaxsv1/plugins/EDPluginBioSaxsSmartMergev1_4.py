...
class EDPluginBioSaxsSmartMergev1_4(EDPluginControl):
    """
    ...
    def checkParameters(self):
        ...
        """
        self.DEBUG("EDPluginBioSaxsSmartMergev1_4.checkParameters")
    ...
    def preProcess(self, _edObject=None):
        ...
        self.DEBUG("EDPluginBioSaxsSmartMergev1_4.preProcess")
    ...
    def process(self, _edObject=None):
        ...
        self.DEBUG("EDPluginBioSaxsSmartMergev1_4.process")
...
# Code: BSA
    ...
    def doFailureExecWait(self, _edPlugin=None):
        self.DEBUG("EDPluginBioSaxsSmartMergev1_4.doFailureExecWait")
    ...
    def doSuccessExecDataver(self, _edPlugin=None):
        self.DEBUG("EDPluginBioSaxsSmartMergev1_4.doSuccessExecDataver")
        self.retrieveSuccessMessages(_edPlugin, "EDPluginBioSaxsSmartMergev1_4.doSuccessExecDataver")
    ...
    def doFailureExecDataver(self, _edPlugin=None):
        self.DEBUG("EDPluginBioSaxsSmartMergev1_4.doFailureExecDataver")
        self.retrieveFailureMessages(_edPlugin, "EDPluginBioSaxsSmartMergev1_4.doFailureExecDataver")
    ...
    def doSuccessExecDatcmp(self, _edPlugin=None):
        self.DEBUG("EDPluginBioSaxsSmartMergev1_4.doSuccessExecDatcmp")
        self.retrieveSuccessMessages(_edPlugin, "EDPluginBioSaxsSmartMergev1_4.doSuccessExecDatcmp")
        with self.locked():
    ...
    def doFailureExecDatcmp(self, _edPlugin=None):
        self.DEBUG("EDPluginBioSaxsSmartMergev1_4.doFailureExecDatcmp")
        self.retrieveFailureMessages(_edPlugin, "EDPluginBioSaxsSmartMergev1_4.doFailureExecDatcmp")
    ...
    def doFailureExecAutoSub(self, _edPlugin=None):
        self.DEBUG("EDPluginBioSaxsSmartMergev1_4.doFailureExecAutoSub")
        self.retrieveFailureMessages(_edPlugin, "EDPluginBioSaxsSmartMergev1_4.doFailureExecAutoSub")
