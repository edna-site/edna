...
class EDTestCasePluginUnitBioSaxsAveragev1_0(EDTestCasePluginUnit):
    ...
    def __init__(self, _edStringTestName=None):
        EDTestCasePluginUnit.__init__(self, "EDPluginBioSaxsAveragev1_0")
...
if __name__ == '__main__':
    ...
    edTestCasePluginUnitControl = EDTestCasePluginUnitBioSaxsAveragev1_0 ("EDTestCasePluginUnitBioSaxsAveragev1_0")
