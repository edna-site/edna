...
class EDTestSuiteUnitBioSaxsAzimutIntv1_0(EDTestSuite):
    """
...
if __name__ == '__main__':
    ...
    edTestSuiteBioSaxsAzimutIntv1_0 = EDTestSuiteUnitBioSaxsAzimutIntv1_0("EDTestSuiteUnitBioSaxsAzimutIntv1_0")
