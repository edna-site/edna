...
from XSDataCommon import XSDataImage, XSDataInteger, XSDataDouble, XSDataString, XSDataFile

class EDTestCasePluginUnitBioSaxsAsciiExportv1_0(EDTestCasePluginUnit):
...
if __name__ == '__main__':
    ...
    edTestCasePlugin = EDTestCasePluginUnitBioSaxsAsciiExportv1_0 ("EDTestCasePluginUnitBioSaxsAzimutIntv1_0")
