...
class EDTestCasePluginExecuteBioSaxsAzimutIntv1_1(EDTestCasePluginExecute):


    def __init__(self, _strTestName=None):
        EDTestCasePluginExecute.__init__(self, "EDPluginBioSaxsAzimutIntv1_1")
#        self.setConfigurationFile(os.path.join(self.getPluginTestsDataHome(),
#                                               "XSConfiguration_<basePluginName>.xml"))
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), \
                                           "XSDataInputBioSaxsAzimutIntv1_1_reference.xml"))
        self.setReferenceDataOutputFile(os.path.join(self.getPluginTestsDataHome(), \
                                                     "XSDataResultBioSaxsAzimutIntv1_1_reference.xml"))
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteBioSaxsAzimutIntv1_0 = EDTestCasePluginExecuteBioSaxsAzimutIntv1_1("EDTestCasePluginExecuteBioSaxsAzimutIntv1_1")
