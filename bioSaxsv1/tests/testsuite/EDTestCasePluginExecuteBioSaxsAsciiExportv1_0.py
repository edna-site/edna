...
class EDTestCasePluginExecuteBioSaxsAsciiExportv1_0(EDTestCasePluginExecute):


    def __init__(self, _strTestName=None):
        EDTestCasePluginExecute.__init__(self, "EDPluginBioSaxsAsciiExportv1_0")
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteBioSaxsAsciiExportv1_0 = EDTestCasePluginExecuteBioSaxsAzimutIntv1_0("EDTestCasePluginExecuteBioSaxsAzimutIntv1_0")
