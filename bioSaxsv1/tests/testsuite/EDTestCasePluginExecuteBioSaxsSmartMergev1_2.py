...
class EDTestCasePluginExecuteBioSaxsSmartMergev1_2(EDTestCasePluginExecute):


    def __init__(self, _strTestName=None):
        EDTestCasePluginExecute.__init__(self, "EDPluginBioSaxsSmartMergev1_2")
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteBioSaxsSmartMergev1_2 = EDTestCasePluginExecuteBioSaxsSmartMergev1_2("EDTestCasePluginExecuteBioSaxsSmartMergev1_2")
    edTestCasePluginExecuteBioSaxsSmartMergev1_2.execute()
