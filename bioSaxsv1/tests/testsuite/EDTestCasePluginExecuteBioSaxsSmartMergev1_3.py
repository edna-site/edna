...
class EDTestCasePluginExecuteBioSaxsSmartMergev1_3(EDTestCasePluginExecute):


    def __init__(self, _strTestName=None):
        EDTestCasePluginExecute.__init__(self, "EDPluginBioSaxsSmartMergev1_3")
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteBioSaxsSmartMergev1_3 = EDTestCasePluginExecuteBioSaxsSmartMergev1_3("EDTestCasePluginExecuteBioSaxsSmartMergev1_3")
    edTestCasePluginExecuteBioSaxsSmartMergev1_3.execute()
