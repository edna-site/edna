...
class EDTestCasePluginUnitBioSaxsAsciiExportv1_1(EDTestCasePluginUnit):
    ...
    def __init__(self, _edStringTestName=None):
        EDTestCasePluginUnit.__init__(self, "EDPluginBioSaxsAsciiExportv1_1")
...
if __name__ == '__main__':
    ...
    edTestCasePlugin = EDTestCasePluginUnitBioSaxsAsciiExportv1_1 ("EDTestCasePluginUnitBioSaxsAsciiExportv1_0")
