...
class EDTestCasePluginUnitBioSaxsMetadatav1_1(EDTestCasePluginUnit):
...
if __name__ == '__main__':
    ...
    edTestCasePlugin = EDTestCasePluginUnitBioSaxsMetadatav1_1("EDTestCasePluginUnitBioSaxsMetadatav1_1")
