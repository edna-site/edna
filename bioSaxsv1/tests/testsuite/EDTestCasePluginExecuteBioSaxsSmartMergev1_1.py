...
class EDTestCasePluginExecuteBioSaxsSmartMergev1_1(EDTestCasePluginExecute):
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteBioSaxsSmartMergev1_1 = EDTestCasePluginExecuteBioSaxsSmartMergev1_1("EDTestCasePluginExecuteBioSaxsSmartMergev1_1")
    edTestCasePluginExecuteBioSaxsSmartMergev1_1.execute()
