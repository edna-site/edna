...
class EDTestCasePluginExecuteBioSaxsProcessOneFilev1_0(EDTestCasePluginExecute):
...
if __name__ == '__main__':
    ...
    edTestCase = EDTestCasePluginExecuteBioSaxsProcessOneFilev1_0("EDTestCasePluginExecuteBioSaxsProcessOneFilev1_0")
    edTestCase.execute()
