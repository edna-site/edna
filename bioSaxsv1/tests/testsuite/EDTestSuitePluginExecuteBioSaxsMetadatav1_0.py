...
class EDTestSuitePluginExecuteBioSaxsMetadatav1_0(EDTestSuite):
    """
...
if __name__ == '__main__':
    ...
    edTestSuitePluginBioSaxsMetadatav1_0 = EDTestSuitePluginExecuteBioSaxsMetadatav1_0("EDTestSuitePluginExecuteBioSaxsMetadatav1_0")
