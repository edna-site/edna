...
class EDTestCasePluginExecuteAccumulatorv1_0(EDTestCasePluginExecute):
    """
    ...
    def __init__(self, _strTestName=None):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), \
                                           "XSDataInputAccumulator_reference.xml"))
        self.setReferenceDataOutputFile(os.path.join(self.getPluginTestsDataHome(), \
                                                     "XSDataResultAccumulator_reference.xml"))
...
if __name__ == '__main__':
    ...
    testAccumulatorv1_0instance = EDTestCasePluginExecuteControlAccumulatorv1_0("EDTestCasePluginExecuteAccumulatorv1_0")
