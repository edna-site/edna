...
#
# Generated Mon Sep 13 12:20:31 2010 by EDGenerateDS.py.
#
...
class XSDataResultSaxsAddv1_0(XSDataResult):
    subclass = None
    def __init__(self, outputImage=None, status=None):
        XSDataResult.__init__(self, status)
        self.outputImage = outputImage
    def factory(*args_, **kwargs_):
        if XSDataResultSaxsAddv1_0.subclass:
            return XSDataResultSaxsAddv1_0.subclass(*args_, **kwargs_)
        else:
            return XSDataResultSaxsAddv1_0(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getOutputImage(self): return self.outputImage
    def setOutputImage(self, outputImage): self.outputImage = outputImage
    def export(self, outfile, level, name_='XSDataResultSaxsAddv1_0'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultSaxsAddv1_0'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultSaxsAddv1_0')
    def exportChildren(self, outfile, level, name_='XSDataResultSaxsAddv1_0'):
        if self.outputImage:
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataResultSaxsAddv1_0' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultSaxsAddv1_0.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataResultSaxsAddv1_0" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataResultSaxsAddv1_0'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
...
# end class XSDataResultSaxsAddv1_0


class XSDataInputSaxsAddv1_0(XSDataInput):
    subclass = None
    def __init__(self, inputImage=None, options=None, outputImage=None, configuration=None):
        ...
        self.outputImage = outputImage
    def factory(*args_, **kwargs_):
        if XSDataInputSaxsAddv1_0.subclass:
            return XSDataInputSaxsAddv1_0.subclass(*args_, **kwargs_)
        else:
            return XSDataInputSaxsAddv1_0(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getInputImage(self): return self.inputImage
    def setInputImage(self, inputImage): self.inputImage = inputImage
    def addInputImage(self, value): self.inputImage.append(value)
    def insertInputImage(self, index, value): self.inputImage[index] = value
    def getOptions(self): return self.options
    def setOptions(self, options): self.options = options
    def getOutputImage(self): return self.outputImage
    def setOutputImage(self, outputImage): self.outputImage = outputImage
    def export(self, outfile, level, name_='XSDataInputSaxsAddv1_0'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputSaxsAddv1_0'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputSaxsAddv1_0')
    def exportChildren(self, outfile, level, name_='XSDataInputSaxsAddv1_0'):
        for inputImage_ in self.getInputImage():
            inputImage_.export(outfile, level, name_='inputImage')
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataInputSaxsAddv1_0' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputSaxsAddv1_0.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataInputSaxsAddv1_0" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataInputSaxsAddv1_0'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('inputImage=[\n')
        level += 1
        for inputImage in self.inputImage:
            showIndent(outfile, level)
            outfile.write('XSDataImage(\n')
            inputImage.exportLiteral(outfile, level, name_='inputImage')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        ...
        if self.options:
            showIndent(outfile, level)
            outfile.write('options=XSDataString(\n')
...
# end class XSDataInputSaxsAddv1_0


class XSDataResultSaxsAnglev1_0(XSDataResult):
    subclass = None
    def __init__(self, regroupedDataFile=None, status=None):
        XSDataResult.__init__(self, status)
        self.regroupedDataFile = regroupedDataFile
    def factory(*args_, **kwargs_):
        if XSDataResultSaxsAnglev1_0.subclass:
            return XSDataResultSaxsAnglev1_0.subclass(*args_, **kwargs_)
        else:
            return XSDataResultSaxsAnglev1_0(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getRegroupedDataFile(self): return self.regroupedDataFile
    def setRegroupedDataFile(self, regroupedDataFile): self.regroupedDataFile = regroupedDataFile
    def export(self, outfile, level, name_='XSDataResultSaxsAnglev1_0'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultSaxsAnglev1_0'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultSaxsAnglev1_0')
    def exportChildren(self, outfile, level, name_='XSDataResultSaxsAnglev1_0'):
        if self.getRegroupedDataFile() != None :
            if self.regroupedDataFile:
                self.regroupedDataFile.export(outfile, level, name_='regroupedDataFile')
        XSDataResult.exportChildren(self, outfile, level, name_)
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataResultSaxsAnglev1_0' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultSaxsAnglev1_0.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataResultSaxsAnglev1_0" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataResultSaxsAnglev1_0'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.regroupedDataFile:
            showIndent(outfile, level)
            outfile.write('regroupedDataFile=XSDataImage(\n')
            self.regroupedDataFile.exportLiteral(outfile, level, name_='regroupedDataFile')
            showIndent(outfile, level)
            outfile.write('),\n')
        XSDataResult.exportLiteralChildren(self, outfile, level, name_)
    def build(self, node_):
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'regroupedDataFile':
            obj_ = XSDataImage.factory()
            obj_.build(child_)
            self.setRegroupedDataFile(obj_)
        XSDataResult.buildChildren(self, child_, nodeName_)
# end class XSDataResultSaxsAnglev1_0


class XSDataInputSaxsAnglev1_0(XSDataInput):
    subclass = None
    def __init__(self, inputDataFile=None, regroupedDataFile=None, beamCenterX=None, beamCenterY=None, innerRadius=None, stepRadius=None, sizeRadial=None, startAzimuth=None, stepAzimuth=None, sizeAzimuth=None, firstImage=None, lastImage=None, increment=None, dummy=None, options=None, configuration=None):
        XSDataInput.__init__(self, configuration)
        ...
        self.sizeRadial = sizeRadial
        self.startAzimuth = startAzimuth
        self.stepAzimuth = stepAzimuth
        self.sizeAzimuth = sizeAzimuth
        ...
        self.options = options
    def factory(*args_, **kwargs_):
        if XSDataInputSaxsAnglev1_0.subclass:
            return XSDataInputSaxsAnglev1_0.subclass(*args_, **kwargs_)
        else:
            return XSDataInputSaxsAnglev1_0(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getInputDataFile(self): return self.inputDataFile
    def setInputDataFile(self, inputDataFile): self.inputDataFile = inputDataFile
    def getRegroupedDataFile(self): return self.regroupedDataFile
    def setRegroupedDataFile(self, regroupedDataFile): self.regroupedDataFile = regroupedDataFile
    def getBeamCenterX(self): return self.beamCenterX
    def setBeamCenterX(self, beamCenterX): self.beamCenterX = beamCenterX
    def getBeamCenterY(self): return self.beamCenterY
    def setBeamCenterY(self, beamCenterY): self.beamCenterY = beamCenterY
    def getInnerRadius(self): return self.innerRadius
    def setInnerRadius(self, innerRadius): self.innerRadius = innerRadius
    def getStepRadius(self): return self.stepRadius
    def setStepRadius(self, stepRadius): self.stepRadius = stepRadius
    def getSizeRadial(self): return self.sizeRadial
    def setSizeRadial(self, sizeRadial): self.sizeRadial = sizeRadial
    def getStartAzimuth(self): return self.startAzimuth
    def setStartAzimuth(self, startAzimuth): self.startAzimuth = startAzimuth
    def getStepAzimuth(self): return self.stepAzimuth
    def setStepAzimuth(self, stepAzimuth): self.stepAzimuth = stepAzimuth
    def getSizeAzimuth(self): return self.sizeAzimuth
    def setSizeAzimuth(self, sizeAzimuth): self.sizeAzimuth = sizeAzimuth
    def getFirstImage(self): return self.firstImage
    def setFirstImage(self, firstImage): self.firstImage = firstImage
    def getLastImage(self): return self.lastImage
    def setLastImage(self, lastImage): self.lastImage = lastImage
    def getIncrement(self): return self.increment
    def setIncrement(self, increment): self.increment = increment
    def getDummy(self): return self.dummy
    def setDummy(self, dummy): self.dummy = dummy
    def getOptions(self): return self.options
    def setOptions(self, options): self.options = options
    def export(self, outfile, level, name_='XSDataInputSaxsAnglev1_0'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputSaxsAnglev1_0'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputSaxsAnglev1_0')
    def exportChildren(self, outfile, level, name_='XSDataInputSaxsAnglev1_0'):
        if self.getInputDataFile() != None :
            if self.inputDataFile:
                self.inputDataFile.export(outfile, level, name_='inputDataFile')
        if self.getRegroupedDataFile() != None :
            if self.regroupedDataFile:
                self.regroupedDataFile.export(outfile, level, name_='regroupedDataFile')
        if self.getBeamCenterX() != None :
            if self.beamCenterX:
                self.beamCenterX.export(outfile, level, name_='beamCenterX')
        if self.getBeamCenterY() != None :
            if self.beamCenterY:
                self.beamCenterY.export(outfile, level, name_='beamCenterY')
        if self.getInnerRadius() != None :
            if self.innerRadius:
                self.innerRadius.export(outfile, level, name_='innerRadius')
        if self.getStepRadius() != None :
            if self.stepRadius:
                self.stepRadius.export(outfile, level, name_='stepRadius')
        if self.getSizeRadial() != None :
            if self.sizeRadial:
                self.sizeRadial.export(outfile, level, name_='sizeRadial')
        if self.getStartAzimuth() != None :
            if self.startAzimuth:
                self.startAzimuth.export(outfile, level, name_='startAzimuth')
        if self.getStepAzimuth() != None :
            if self.stepAzimuth:
                self.stepAzimuth.export(outfile, level, name_='stepAzimuth')
        if self.getSizeAzimuth() != None :
            if self.sizeAzimuth:
                self.sizeAzimuth.export(outfile, level, name_='sizeAzimuth')
        if self.getFirstImage() != None :
            if self.firstImage:
                self.firstImage.export(outfile, level, name_='firstImage')
        if self.getLastImage() != None :
            if self.lastImage:
                self.lastImage.export(outfile, level, name_='lastImage')
        if self.getIncrement() != None :
            if self.increment:
                self.increment.export(outfile, level, name_='increment')
        if self.getDummy() != None :
            if self.dummy:
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataInputSaxsAnglev1_0' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputSaxsAnglev1_0.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataInputSaxsAnglev1_0" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataInputSaxsAnglev1_0'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.inputDataFile:
            showIndent(outfile, level)
            outfile.write('inputDataFile=XSDataImage(\n')
            self.inputDataFile.exportLiteral(outfile, level, name_='inputDataFile')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.regroupedDataFile:
            showIndent(outfile, level)
        ...
        if self.beamCenterX:
            showIndent(outfile, level)
            outfile.write('beamCenterX=XSDataInteger(\n')
            self.beamCenterX.exportLiteral(outfile, level, name_='beamCenterX')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.beamCenterY:
            showIndent(outfile, level)
            outfile.write('beamCenterY=XSDataInteger(\n')
            self.beamCenterY.exportLiteral(outfile, level, name_='beamCenterY')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.innerRadius:
            showIndent(outfile, level)
            outfile.write('innerRadius=XSDataString(\n')
            self.innerRadius.exportLiteral(outfile, level, name_='innerRadius')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.stepRadius:
            showIndent(outfile, level)
            outfile.write('stepRadius=XSDataString(\n')
            self.stepRadius.exportLiteral(outfile, level, name_='stepRadius')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.sizeRadial:
            showIndent(outfile, level)
            outfile.write('sizeRadial=XSDataInteger(\n')
            self.sizeRadial.exportLiteral(outfile, level, name_='sizeRadial')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.startAzimuth:
            showIndent(outfile, level)
            outfile.write('startAzimuth=XSDataString(\n')
            self.startAzimuth.exportLiteral(outfile, level, name_='startAzimuth')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.stepAzimuth:
            showIndent(outfile, level)
            outfile.write('stepAzimuth=XSDataString(\n')
            self.stepAzimuth.exportLiteral(outfile, level, name_='stepAzimuth')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.sizeAzimuth:
            showIndent(outfile, level)
            outfile.write('sizeAzimuth=XSDataInteger(\n')
            self.sizeAzimuth.exportLiteral(outfile, level, name_='sizeAzimuth')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.firstImage:
            showIndent(outfile, level)
            outfile.write('firstImage=XSDataInteger(\n')
            self.firstImage.exportLiteral(outfile, level, name_='firstImage')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.lastImage:
            showIndent(outfile, level)
            outfile.write('lastImage=XSDataInteger(\n')
            self.lastImage.exportLiteral(outfile, level, name_='lastImage')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.increment:
            showIndent(outfile, level)
            outfile.write('increment=XSDataInteger(\n')
            self.increment.exportLiteral(outfile, level, name_='increment')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.dummy:
            showIndent(outfile, level)
            outfile.write('dummy=XSDataFloat(\n')
            self.dummy.exportLiteral(outfile, level, name_='dummy')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.options:
            showIndent(outfile, level)
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'inputDataFile':
            obj_ = XSDataImage.factory()
            obj_.build(child_)
            self.setInputDataFile(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'regroupedDataFile':
            obj_ = XSDataImage.factory()
            obj_.build(child_)
            ...
            nodeName_ == 'beamCenterX':
            obj_ = XSDataInteger.factory()
            obj_.build(child_)
            self.setBeamCenterX(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'beamCenterY':
            obj_ = XSDataInteger.factory()
            obj_.build(child_)
            self.setBeamCenterY(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            ...
            nodeName_ == 'stepRadius':
            obj_ = XSDataString.factory()
            obj_.build(child_)
            self.setStepRadius(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'sizeRadial':
            obj_ = XSDataInteger.factory()
            obj_.build(child_)
            self.setSizeRadial(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            ...
            nodeName_ == 'sizeAzimuth':
            obj_ = XSDataInteger.factory()
            obj_.build(child_)
            self.setSizeAzimuth(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'firstImage':
            obj_ = XSDataInteger.factory()
            obj_.build(child_)
            self.setFirstImage(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'lastImage':
            obj_ = XSDataInteger.factory()
            obj_.build(child_)
            self.setLastImage(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'increment':
            obj_ = XSDataInteger.factory()
            obj_.build(child_)
            self.setIncrement(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'dummy':
            ...
            self.setOptions(obj_)
        XSDataInput.buildChildren(self, child_, nodeName_)
# end class XSDataInputSaxsAnglev1_0


class XSDataResultSaxsMacv1_0(XSDataResult):
    subclass = None
    def __init__(self, outputImage=None, status=None):
        XSDataResult.__init__(self, status)
        self.outputImage = outputImage
    def factory(*args_, **kwargs_):
        if XSDataResultSaxsMacv1_0.subclass:
            return XSDataResultSaxsMacv1_0.subclass(*args_, **kwargs_)
        else:
            return XSDataResultSaxsMacv1_0(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getOutputImage(self): return self.outputImage
    def setOutputImage(self, outputImage): self.outputImage = outputImage
    def export(self, outfile, level, name_='XSDataResultSaxsMacv1_0'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultSaxsMacv1_0'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultSaxsMacv1_0')
    def exportChildren(self, outfile, level, name_='XSDataResultSaxsMacv1_0'):
        if self.getOutputImage() != None :
            if self.outputImage:
                self.outputImage.export(outfile, level, name_='outputImage')
        XSDataResult.exportChildren(self, outfile, level, name_)
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataResultSaxsMacv1_0' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultSaxsMacv1_0.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataResultSaxsMacv1_0" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataResultSaxsMacv1_0'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            self.setOutputImage(obj_)
        XSDataResult.buildChildren(self, child_, nodeName_)
# end class XSDataResultSaxsMacv1_0


class XSDataInputSaxsMacv1_0(XSDataInput):
    subclass = None
    def __init__(self, inputImage=None, outputImage=None, multConst=None, addConst=None, dummy=None, firstImage=None, lastImage=None, increment=None, options=None, configuration=None):
        XSDataInput.__init__(self, configuration)
        self.inputImage = inputImage
        self.outputImage = outputImage
        ...
        self.options = options
    def factory(*args_, **kwargs_):
        if XSDataInputSaxsMacv1_0.subclass:
            return XSDataInputSaxsMacv1_0.subclass(*args_, **kwargs_)
        else:
            return XSDataInputSaxsMacv1_0(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getInputImage(self): return self.inputImage
    def setInputImage(self, inputImage): self.inputImage = inputImage
    def getOutputImage(self): return self.outputImage
    def setOutputImage(self, outputImage): self.outputImage = outputImage
    def getMultConst(self): return self.multConst
    def setMultConst(self, multConst): self.multConst = multConst
    def getAddConst(self): return self.addConst
    def setAddConst(self, addConst): self.addConst = addConst
    def getDummy(self): return self.dummy
    def setDummy(self, dummy): self.dummy = dummy
    def getFirstImage(self): return self.firstImage
    def setFirstImage(self, firstImage): self.firstImage = firstImage
    ...
    def getOptions(self): return self.options
    def setOptions(self, options): self.options = options
    def export(self, outfile, level, name_='XSDataInputSaxsMacv1_0'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputSaxsMacv1_0'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputSaxsMacv1_0')
    def exportChildren(self, outfile, level, name_='XSDataInputSaxsMacv1_0'):
        if self.getInputImage() != None :
            if self.inputImage:
                self.inputImage.export(outfile, level, name_='inputImage')
        if self.getOutputImage() != None :
            if self.outputImage:
                self.outputImage.export(outfile, level, name_='outputImage')
        if self.getMultConst() != None :
            if self.multConst:
                self.multConst.export(outfile, level, name_='multConst')
        if self.getAddConst() != None :
            if self.addConst:
                self.addConst.export(outfile, level, name_='addConst')
        if self.getDummy() != None :
            if self.dummy:
                self.dummy.export(outfile, level, name_='dummy')
        if self.getFirstImage() != None :
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataInputSaxsMacv1_0' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputSaxsMacv1_0.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataInputSaxsMacv1_0" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataInputSaxsMacv1_0'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.multConst:
            showIndent(outfile, level)
            outfile.write('multConst=XSDataFloat(\n')
            self.multConst.exportLiteral(outfile, level, name_='multConst')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.addConst:
            showIndent(outfile, level)
            outfile.write('addConst=XSDataFloat(\n')
            self.addConst.exportLiteral(outfile, level, name_='addConst')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.dummy:
            showIndent(outfile, level)
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            obj_ = XSDataFloat.factory()
            obj_.build(child_)
            self.setMultConst(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'addConst':
            obj_ = XSDataFloat.factory()
            obj_.build(child_)
            self.setAddConst(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'dummy':
            obj_ = XSDataFloat.factory()
            obj_.build(child_)
            ...
            self.setOptions(obj_)
        XSDataInput.buildChildren(self, child_, nodeName_)
# end class XSDataInputSaxsMacv1_0


class XSDataInputSaxsv1_0(XSDataInput):
    subclass = None
    def __init__(self, configuration=None, valueOf_=''):
        XSDataInput.__init__(self, configuration)
        self.valueOf_ = valueOf_
    def factory(*args_, **kwargs_):
        if XSDataInputSaxsv1_0.subclass:
            return XSDataInputSaxsv1_0.subclass(*args_, **kwargs_)
        else:
            return XSDataInputSaxsv1_0(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getValueOf_(self): return self.valueOf_
    def setValueOf_(self, valueOf_): self.valueOf_ = valueOf_
    def export(self, outfile, level, name_='XSDataInputSaxsv1_0'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputSaxsv1_0'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputSaxsv1_0')
    def exportChildren(self, outfile, level, name_='XSDataInputSaxsv1_0'):
        XSDataInput.exportChildren(self, outfile, level, name_)
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataInputSaxsv1_0' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputSaxsv1_0.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataInputSaxsv1_0" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataInputSaxsv1_0'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.TEXT_NODE:
            self.valueOf_ += child_.nodeValue
        XSDataInput.buildChildren(self, child_, nodeName_)
# end class XSDataInputSaxsv1_0


class XSDataResultSaxsCurvesv1_0(XSDataResult):
    subclass = None
    def __init__(self, outputDataFile=None, status=None):
        XSDataResult.__init__(self, status)
        self.outputDataFile = outputDataFile
    def factory(*args_, **kwargs_):
        if XSDataResultSaxsCurvesv1_0.subclass:
            return XSDataResultSaxsCurvesv1_0.subclass(*args_, **kwargs_)
        else:
            return XSDataResultSaxsCurvesv1_0(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getOutputDataFile(self): return self.outputDataFile
    def setOutputDataFile(self, outputDataFile): self.outputDataFile = outputDataFile
    def export(self, outfile, level, name_='XSDataResultSaxsCurvesv1_0'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultSaxsCurvesv1_0'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultSaxsCurvesv1_0')
    def exportChildren(self, outfile, level, name_='XSDataResultSaxsCurvesv1_0'):
        if self.outputDataFile:
            self.outputDataFile.export(outfile, level, name_='outputDataFile')
        XSDataResult.exportChildren(self, outfile, level, name_)
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataResultSaxsCurvesv1_0' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultSaxsCurvesv1_0.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataResultSaxsCurvesv1_0" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataResultSaxsCurvesv1_0'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.outputDataFile:
            showIndent(outfile, level)
            outfile.write('outputDataFile=XSDataFile(\n')
            self.outputDataFile.exportLiteral(outfile, level, name_='outputDataFile')
            showIndent(outfile, level)
            outfile.write('),\n')
        XSDataResult.exportLiteralChildren(self, outfile, level, name_)
    def build(self, node_):
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'outputDataFile':
            obj_ = XSDataFile.factory()
            obj_.build(child_)
            self.setOutputDataFile(obj_)
        XSDataResult.buildChildren(self, child_, nodeName_)
# end class XSDataResultSaxsCurvesv1_0


class XSDataInputSaxsCurvesv1_0(XSDataInput):
    subclass = None
    def __init__(self, inputImage=None, options=None, outputDataFile=None, extraHeaders=None, headerMarker=None, configuration=None):
        XSDataInput.__init__(self, configuration)
        self.inputImage = inputImage
        self.options = options
        self.outputDataFile = outputDataFile
        ...
        self.headerMarker = headerMarker
    def factory(*args_, **kwargs_):
        if XSDataInputSaxsCurvesv1_0.subclass:
            return XSDataInputSaxsCurvesv1_0.subclass(*args_, **kwargs_)
        else:
            return XSDataInputSaxsCurvesv1_0(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getInputImage(self): return self.inputImage
    def setInputImage(self, inputImage): self.inputImage = inputImage
    def getOptions(self): return self.options
    ...
    def getOutputDataFile(self): return self.outputDataFile
    def setOutputDataFile(self, outputDataFile): self.outputDataFile = outputDataFile
    def getExtraHeaders(self): return self.extraHeaders
    def setExtraHeaders(self, extraHeaders): self.extraHeaders = extraHeaders
    def addExtraHeaders(self, value): self.extraHeaders.append(value)
    def insertExtraHeaders(self, index, value): self.extraHeaders[index] = value
    def getHeaderMarker(self): return self.headerMarker
    def setHeaderMarker(self, headerMarker): self.headerMarker = headerMarker
    def export(self, outfile, level, name_='XSDataInputSaxsCurvesv1_0'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputSaxsCurvesv1_0'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputSaxsCurvesv1_0')
    def exportChildren(self, outfile, level, name_='XSDataInputSaxsCurvesv1_0'):
        if self.getInputImage() != None :
            if self.inputImage:
                self.inputImage.export(outfile, level, name_='inputImage')
        if self.getOptions() != None :
        ...
        if self.getOutputDataFile() != None :
            if self.outputDataFile:
                self.outputDataFile.export(outfile, level, name_='outputDataFile')
        for extraHeaders_ in self.getExtraHeaders():
            extraHeaders_.export(outfile, level, name_='extraHeaders')
        if self.getHeaderMarker() != None :
            if self.headerMarker:
                self.headerMarker.export(outfile, level, name_='headerMarker')
        XSDataInput.exportChildren(self, outfile, level, name_)
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataInputSaxsCurvesv1_0' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputSaxsCurvesv1_0.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataInputSaxsCurvesv1_0" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataInputSaxsCurvesv1_0'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.outputDataFile:
            ...
            outfile.write('),\n')
        showIndent(outfile, level)
        outfile.write('extraHeaders=[\n')
        level += 1
        for extraHeaders in self.extraHeaders:
            showIndent(outfile, level)
            outfile.write('XSDataString(\n')
            extraHeaders.exportLiteral(outfile, level, name_='extraHeaders')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        ...
        if self.headerMarker:
            showIndent(outfile, level)
            outfile.write('headerMarker=XSDataString(\n')
            self.headerMarker.exportLiteral(outfile, level, name_='headerMarker')
            showIndent(outfile, level)
            outfile.write('),\n')
        XSDataInput.exportLiteralChildren(self, outfile, level, name_)
    def build(self, node_):
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            nodeName_ == 'extraHeaders':
            obj_ = XSDataString.factory()
            obj_.build(child_)
            self.extraHeaders.append(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'headerMarker':
            obj_ = XSDataString.factory()
            obj_.build(child_)
            self.setHeaderMarker(obj_)
        XSDataInput.buildChildren(self, child_, nodeName_)
# end class XSDataInputSaxsCurvesv1_0


class XSDataResultSaxsAddMetadatav1_0(XSDataResult):
    subclass = None
    def __init__(self, outputImage=None, status=None):
        XSDataResult.__init__(self, status)
        self.outputImage = outputImage
    def factory(*args_, **kwargs_):
        if XSDataResultSaxsAddMetadatav1_0.subclass:
            return XSDataResultSaxsAddMetadatav1_0.subclass(*args_, **kwargs_)
        else:
            return XSDataResultSaxsAddMetadatav1_0(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getOutputImage(self): return self.outputImage
    def setOutputImage(self, outputImage): self.outputImage = outputImage
    def export(self, outfile, level, name_='XSDataResultSaxsAddMetadatav1_0'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultSaxsAddMetadatav1_0'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultSaxsAddMetadatav1_0')
    def exportChildren(self, outfile, level, name_='XSDataResultSaxsAddMetadatav1_0'):
        if self.outputImage:
            self.outputImage.export(outfile, level, name_='outputImage')
        XSDataResult.exportChildren(self, outfile, level, name_)
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataResultSaxsAddMetadatav1_0' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultSaxsAddMetadatav1_0.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataResultSaxsAddMetadatav1_0" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataResultSaxsAddMetadatav1_0'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            self.setOutputImage(obj_)
        XSDataResult.buildChildren(self, child_, nodeName_)
# end class XSDataResultSaxsAddMetadatav1_0


class XSDataInputSaxsAddMetadatav1_0(XSDataInput):
    subclass = None
    def __init__(self, inputImage=None, key=None, value=None, configuration=None):
        XSDataInput.__init__(self, configuration)
        self.inputImage = inputImage
        self.key = key
        self.value = value
    def factory(*args_, **kwargs_):
        if XSDataInputSaxsAddMetadatav1_0.subclass:
            return XSDataInputSaxsAddMetadatav1_0.subclass(*args_, **kwargs_)
        else:
            return XSDataInputSaxsAddMetadatav1_0(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getInputImage(self): return self.inputImage
    def setInputImage(self, inputImage): self.inputImage = inputImage
    ...
    def getValue(self): return self.value
    def setValue(self, value): self.value = value
    def export(self, outfile, level, name_='XSDataInputSaxsAddMetadatav1_0'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputSaxsAddMetadatav1_0'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputSaxsAddMetadatav1_0')
    def exportChildren(self, outfile, level, name_='XSDataInputSaxsAddMetadatav1_0'):
        if self.inputImage:
            self.inputImage.export(outfile, level, name_='inputImage')
        if self.getKey() != None :
            if self.key:
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataInputSaxsAddMetadatav1_0' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputSaxsAddMetadatav1_0.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataInputSaxsAddMetadatav1_0" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataInputSaxsAddMetadatav1_0'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            self.setValue(obj_)
        XSDataInput.buildChildren(self, child_, nodeName_)
# end class XSDataInputSaxsAddMetadatav1_0


class XSDataResultSaxsDelMetadatav1_0(XSDataResult):
    subclass = None
    def __init__(self, outputImage=None, status=None):
        XSDataResult.__init__(self, status)
        self.outputImage = outputImage
    def factory(*args_, **kwargs_):
        if XSDataResultSaxsDelMetadatav1_0.subclass:
            return XSDataResultSaxsDelMetadatav1_0.subclass(*args_, **kwargs_)
        else:
            return XSDataResultSaxsDelMetadatav1_0(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getOutputImage(self): return self.outputImage
    def setOutputImage(self, outputImage): self.outputImage = outputImage
    def export(self, outfile, level, name_='XSDataResultSaxsDelMetadatav1_0'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultSaxsDelMetadatav1_0'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultSaxsDelMetadatav1_0')
    def exportChildren(self, outfile, level, name_='XSDataResultSaxsDelMetadatav1_0'):
        if self.outputImage:
            self.outputImage.export(outfile, level, name_='outputImage')
        XSDataResult.exportChildren(self, outfile, level, name_)
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataResultSaxsDelMetadatav1_0' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultSaxsDelMetadatav1_0.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataResultSaxsDelMetadatav1_0" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataResultSaxsDelMetadatav1_0'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            self.setOutputImage(obj_)
        XSDataResult.buildChildren(self, child_, nodeName_)
# end class XSDataResultSaxsDelMetadatav1_0


class XSDataInputSaxsDelMetadatav1_0(XSDataInput):
    subclass = None
    def __init__(self, inputImage=None, key=None, configuration=None):
        XSDataInput.__init__(self, configuration)
        self.inputImage = inputImage
        self.key = key
    def factory(*args_, **kwargs_):
        if XSDataInputSaxsDelMetadatav1_0.subclass:
            return XSDataInputSaxsDelMetadatav1_0.subclass(*args_, **kwargs_)
        else:
            return XSDataInputSaxsDelMetadatav1_0(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getInputImage(self): return self.inputImage
    def setInputImage(self, inputImage): self.inputImage = inputImage
    def getKey(self): return self.key
    def setKey(self, key): self.key = key
    def export(self, outfile, level, name_='XSDataInputSaxsDelMetadatav1_0'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputSaxsDelMetadatav1_0'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputSaxsDelMetadatav1_0')
    def exportChildren(self, outfile, level, name_='XSDataInputSaxsDelMetadatav1_0'):
        if self.inputImage:
            self.inputImage.export(outfile, level, name_='inputImage')
        if self.getKey() != None :
            if self.key:
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataInputSaxsDelMetadatav1_0' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputSaxsDelMetadatav1_0.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataInputSaxsDelMetadatav1_0" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataInputSaxsDelMetadatav1_0'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            self.setKey(obj_)
        XSDataInput.buildChildren(self, child_, nodeName_)
# end class XSDataInputSaxsDelMetadatav1_0
...
class SaxXSDataDoubleHandler(handler.ContentHandler):
    ...
    def startElement(self, name, attrs):
        ...
        if name == 'XSDataDouble':
            ...
            obj = XSDataString.factory()
            stackObj = SaxStackElement('options', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'regroupedDataFile':
            obj = XSDataImage.factory()
            stackObj = SaxStackElement('regroupedDataFile', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'inputDataFile':
            obj = XSDataImage.factory()
            stackObj = SaxStackElement('inputDataFile', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'beamCenterX':
            obj = XSDataInteger.factory()
            stackObj = SaxStackElement('beamCenterX', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'beamCenterY':
            obj = XSDataInteger.factory()
            stackObj = SaxStackElement('beamCenterY', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'innerRadius':
            obj = XSDataString.factory()
            stackObj = SaxStackElement('innerRadius', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'stepRadius':
            obj = XSDataString.factory()
            stackObj = SaxStackElement('stepRadius', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'sizeRadial':
            obj = XSDataInteger.factory()
            stackObj = SaxStackElement('sizeRadial', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'startAzimuth':
            obj = XSDataString.factory()
            stackObj = SaxStackElement('startAzimuth', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'stepAzimuth':
            obj = XSDataString.factory()
            stackObj = SaxStackElement('stepAzimuth', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'sizeAzimuth':
            obj = XSDataInteger.factory()
            stackObj = SaxStackElement('sizeAzimuth', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'firstImage':
            obj = XSDataInteger.factory()
            stackObj = SaxStackElement('firstImage', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'lastImage':
            obj = XSDataInteger.factory()
            stackObj = SaxStackElement('lastImage', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'increment':
            obj = XSDataInteger.factory()
            stackObj = SaxStackElement('increment', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'dummy':
            obj = XSDataFloat.factory()
            stackObj = SaxStackElement('dummy', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'multConst':
            obj = XSDataFloat.factory()
            stackObj = SaxStackElement('multConst', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'addConst':
            obj = XSDataFloat.factory()
            stackObj = SaxStackElement('addConst', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'outputDataFile':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('outputDataFile', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'extraHeaders':
            obj = XSDataString.factory()
            stackObj = SaxStackElement('extraHeaders', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'headerMarker':
            obj = XSDataString.factory()
            stackObj = SaxStackElement('headerMarker', obj)
            self.stack.append(stackObj)
            done = 1
        if not done:
    ...
    def endElement(self, name):
        ...
        if name == 'XSDataDouble':
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.addInputImage(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'options':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setOptions(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'regroupedDataFile':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setRegroupedDataFile(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'inputDataFile':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setInputDataFile(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'beamCenterX':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setBeamCenterX(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'beamCenterY':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setBeamCenterY(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'innerRadius':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setInnerRadius(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'stepRadius':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setStepRadius(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'sizeRadial':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setSizeRadial(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'startAzimuth':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setStartAzimuth(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'stepAzimuth':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setStepAzimuth(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'sizeAzimuth':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setSizeAzimuth(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'firstImage':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setFirstImage(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'lastImage':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setLastImage(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'increment':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setIncrement(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'dummy':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setDummy(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'multConst':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setMultConst(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'addConst':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setAddConst(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'outputDataFile':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setOutputDataFile(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'extraHeaders':
            if len(self.stack) >= 2:
                self.stack[-2].obj.addExtraHeaders(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'headerMarker':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setHeaderMarker(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        if not done:
            self.reportError('"%s" element not allowed here.' % name)
