...
__license__ = "GPLv3+"
__copyright__ = "2008-2009 - EDNA Default Copyright"

from EDTestSuite  import EDTestSuite

class EDTestSuiteSaxs(EDTestSuite):
    """
...
if __name__ == '__main__':
    ...
    edTestSuiteSaxs = EDTestSuiteSaxs("EDTestSuitePluginExecSaxsAnglev1_0")
    edTestSuiteSaxs.execute()
