...
from XSDataSaxsv1_0                      import XSDataResultSaxsMacv1_0
...
class EDTestCasePluginExecuteExecSaxsMacv1_0(EDTestCasePluginExecute):
    """
    Those are all execution tests for the EDNA Exec plugin SaxsMacv1_0
    """

    def __init__(self, _strTestName=None):
        """
        """
        EDTestCasePluginExecute.__init__(self, "EDPluginExecSaxsMacv1_0")
#        self.setConfigurationFile(os.path.join(self.getPluginTestsDataHome(),
#                                               "XSConfiguration_SaxsMac.xml"))
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), \
                                           "XSDataInputSaxsMac_reference.xml"))
        self.setReferenceDataOutputFile(os.path.join(self.getPluginTestsDataHome(), \
                                                     "XSDataResultSaxsMac_reference.xml"))
    def preProcess(self):
        """
...
if __name__ == '__main__':
    ...
    edtestSaxsMacv1_0 = EDTestCasePluginExecuteExecSaxsMacv1_0("EDTestCasePluginExecuteExecSaxsMacv1_0")
    edtestSaxsMacv1_0.execute()
