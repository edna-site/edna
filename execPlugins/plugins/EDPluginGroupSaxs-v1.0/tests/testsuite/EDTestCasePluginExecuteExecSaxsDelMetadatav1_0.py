...
class EDTestCasePluginExecuteExecSaxsDelMetadatav1_0(EDTestCasePluginExecute):
    """
    Those are all execution tests for the EDNA Exec plugin SaxsDelMetadatav1_0
    """

    def __init__(self, _strTestName=None):
        """
        """
        EDTestCasePluginExecute.__init__(self, "EDPluginExecSaxsDelMetadatav1_0")
#        self.setConfigurationFile(os.path.join(self.getPluginTestsDataHome(),
#                                               "XSConfiguration_SaxsDelMetadata.xml"))
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), \
                                           "XSDataInputSaxsDelMetadata_reference.xml"))
        self.setReferenceDataOutputFile(os.path.join(self.getPluginTestsDataHome(), \
                                                     "XSDataResultSaxsDelMetadata_reference.xml"))
        self.testImage = "saxsDelMetadata.edf"
        self.refImage = "saxsAddMetadata.edf"
    ...
    def testExecute(self):
        ...
        xsDataResultReference = XSDataResultSaxsDelMetadatav1_0.parseString(strExpectedOutput)
...
if __name__ == '__main__':
    ...
    testSaxsDelMetadatav1_0instance = EDTestCasePluginExecuteControlSaxsDelMetadatav1_0("EDTestCasePluginExecuteExecSaxsDelMetadatav1_0")
    testSaxsDelMetadatav1_0instance.execute()
