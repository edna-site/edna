...
class EDTestSuitePluginExecSaxsAnglev1_0(EDTestSuite):
    """
...
if __name__ == '__main__':
    ...
    edTestSuitePluginExecSaxsAnglev1_0 = EDTestSuitePluginExecSaxsAnglev1_0("EDTestSuitePluginExecSaxsAnglev1_0")
    edTestSuitePluginExecSaxsAnglev1_0.execute()
