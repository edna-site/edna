...
class EDTestCasePluginExecuteHDF5StackImagesv10_manyFilesForcedPosition(EDTestCasePluginExecuteHDF5StackImagesv10):
    """
    ...
    def __init__(self, _strTestName=None):
        """
        """
        EDTestCasePluginExecuteHDF5StackImagesv10.__init__(self, "EDTestCasePluginExecuteHDF5StackImagesv10_manyFilesForcedPosition")
        self.setConfigurationFile(os.path.join(self.getPluginTestsDataHome(),
                                               "XSConfiguration_HDF5StackImages.xml"))
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), \
                                           "XSDataInputHDF5StackImages_reference_ManyFilesForced.xml"))
        self.setReferenceDataOutputFile(os.path.join(self.getPluginTestsDataHome(), \
                                                     "XSDataResultHDF5StackImages_reference_ManyFilesForced.xml"))
    def preProcess(self):
        """
...
if __name__ == '__main__':
    ...
    testHDF5StackImagesv10instance = EDTestCasePluginExecuteHDF5StackImagesv10_manyFilesForcedPosition("EDTestCasePluginExecuteHDF5StackImagesv10_manyFilesForcedPosition")
