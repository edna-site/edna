...
def fileName2xml(filename):
    ...
    <HDF5File><path><value>/mnt/data/ID22-ODA-TBdataset/ID22-ODA-Raw.h5</value></path></HDF5File>\
    <internalHDF5Path><value>RawStack</value></internalHDF5Path>\
    <inputImageFile>\
        <path><value>%s</value></path>\
        <index><value>%s</value></index>\
    </inputImageFile>\
    <multiFiles><value>1</value></multiFiles>\
    </XSDataInputStackOfImagesHDF5Writer>" % (filename, number)
