...
#
# Generated Thu Mar 31 14:12:08 2011 by EDGenerateDS.py.
#
...
class XSDataInputMedianFilter(XSDataInput):
    subclass = None
    def __init__(self, configuration=None, inputImages=None, outputImage=None):
    ...
    def factory(*args_, **kwargs_):
        if XSDataInputMedianFilter.subclass:
            return XSDataInputMedianFilter.subclass(*args_, **kwargs_)
        else:
            return XSDataInputMedianFilter(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getInputImages(self): return self.inputImages
    def setInputImages(self, inputImages): self.inputImages = inputImages
    def addInputImages(self, value): self.inputImages.append(value)
    def insertInputImages(self, index, value): self.inputImages[index] = value
    def getOutputImage(self): return self.outputImage
    def setOutputImage(self, outputImage): self.outputImage = outputImage
    def export(self, outfile, level, name_='XSDataInputMedianFilter'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputMedianFilter'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputMedianFilter')
    def exportChildren(self, outfile, level, name_='XSDataInputMedianFilter'):
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataInputMedianFilter' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputMedianFilter.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataInputMedianFilter" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataInputMedianFilter'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('inputImages=[\n')
        level += 1
        for inputImages in self.inputImages:
            showIndent(outfile, level)
            outfile.write('XSDataImage(\n')
            inputImages.exportLiteral(outfile, level, name_='inputImages')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
# end class XSDataInputMedianFilter


class XSDataInputMedianFilterImage(XSDataInput):
    subclass = None
    def __init__(self, configuration=None, inputImage=None, filterWidth=None, medianFilteredImage=None):
        XSDataInput.__init__(self, configuration)
        self.inputImage = inputImage
        self.filterWidth = filterWidth
        self.medianFilteredImage = medianFilteredImage
    def factory(*args_, **kwargs_):
        if XSDataInputMedianFilterImage.subclass:
            return XSDataInputMedianFilterImage.subclass(*args_, **kwargs_)
        else:
            return XSDataInputMedianFilterImage(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getInputImage(self): return self.inputImage
    def setInputImage(self, inputImage): self.inputImage = inputImage
    def getFilterWidth(self): return self.filterWidth
    def setFilterWidth(self, filterWidth): self.filterWidth = filterWidth
    def getMedianFilteredImage(self): return self.medianFilteredImage
    def setMedianFilteredImage(self, medianFilteredImage): self.medianFilteredImage = medianFilteredImage
    def export(self, outfile, level, name_='XSDataInputMedianFilterImage'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputMedianFilterImage'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputMedianFilterImage')
    def exportChildren(self, outfile, level, name_='XSDataInputMedianFilterImage'):
        if self.inputImage:
            self.inputImage.export(outfile, level, name_='inputImage')
        if self.filterWidth:
            self.filterWidth.export(outfile, level, name_='filterWidth')
        if self.getMedianFilteredImage() != None :
            if self.medianFilteredImage:
                self.medianFilteredImage.export(outfile, level, name_='medianFilteredImage')
        XSDataInput.exportChildren(self, outfile, level, name_)
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataInputMedianFilterImage' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputMedianFilterImage.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataInputMedianFilterImage" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataInputMedianFilterImage'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.filterWidth:
            showIndent(outfile, level)
            outfile.write('filterWidth=XSDataInteger(\n')
            self.filterWidth.exportLiteral(outfile, level, name_='filterWidth')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.medianFilteredImage:
            showIndent(outfile, level)
            outfile.write('medianFilteredImage=XSDataImage(\n')
            self.medianFilteredImage.exportLiteral(outfile, level, name_='medianFilteredImage')
            showIndent(outfile, level)
            outfile.write('),\n')
        XSDataInput.exportLiteralChildren(self, outfile, level, name_)
    def build(self, node_):
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            nodeName_ == 'filterWidth':
            obj_ = XSDataInteger.factory()
            obj_.build(child_)
            self.setFilterWidth(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'medianFilteredImage':
            obj_ = XSDataImage.factory()
            obj_.build(child_)
            self.setMedianFilteredImage(obj_)
        XSDataInput.buildChildren(self, child_, nodeName_)
# end class XSDataInputMedianFilterImage


class XSDataResultMedianFilter(XSDataResult):
    subclass = None
    def __init__(self, status=None, outputArray=None, outputImage=None):
        XSDataResult.__init__(self, status)
        self.outputArray = outputArray
        self.outputImage = outputImage
    def factory(*args_, **kwargs_):
        if XSDataResultMedianFilter.subclass:
            return XSDataResultMedianFilter.subclass(*args_, **kwargs_)
        else:
            return XSDataResultMedianFilter(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getOutputArray(self): return self.outputArray
    def setOutputArray(self, outputArray): self.outputArray = outputArray
    def getOutputImage(self): return self.outputImage
    def setOutputImage(self, outputImage): self.outputImage = outputImage
    def export(self, outfile, level, name_='XSDataResultMedianFilter'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultMedianFilter'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultMedianFilter')
    def exportChildren(self, outfile, level, name_='XSDataResultMedianFilter'):
        if self.getOutputArray() != None :
            if self.outputArray:
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataResultMedianFilter' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultMedianFilter.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataResultMedianFilter" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataResultMedianFilter'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.outputArray:
            showIndent(outfile, level)
            outfile.write('outputArray=XSDataArray(\n')
            self.outputArray.exportLiteral(outfile, level, name_='outputArray')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.outputImage:
            showIndent(outfile, level)
...
# end class XSDataResultMedianFilter


class XSDataResultMedianFilterImage(XSDataResult):
    subclass = None
    def __init__(self, status=None, medianFilteredImage=None, medianFilteredArray=None):
        XSDataResult.__init__(self, status)
        self.medianFilteredImage = medianFilteredImage
        self.medianFilteredArray = medianFilteredArray
    def factory(*args_, **kwargs_):
        if XSDataResultMedianFilterImage.subclass:
            return XSDataResultMedianFilterImage.subclass(*args_, **kwargs_)
        else:
            return XSDataResultMedianFilterImage(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getMedianFilteredImage(self): return self.medianFilteredImage
    def setMedianFilteredImage(self, medianFilteredImage): self.medianFilteredImage = medianFilteredImage
    def getMedianFilteredArray(self): return self.medianFilteredArray
    def setMedianFilteredArray(self, medianFilteredArray): self.medianFilteredArray = medianFilteredArray
    def export(self, outfile, level, name_='XSDataResultMedianFilterImage'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultMedianFilterImage'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultMedianFilterImage')
    def exportChildren(self, outfile, level, name_='XSDataResultMedianFilterImage'):
        if self.getMedianFilteredImage() != None :
            if self.medianFilteredImage:
                self.medianFilteredImage.export(outfile, level, name_='medianFilteredImage')
        if self.getMedianFilteredArray() != None :
            if self.medianFilteredArray:
                self.medianFilteredArray.export(outfile, level, name_='medianFilteredArray')
        XSDataResult.exportChildren(self, outfile, level, name_)
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataResultMedianFilterImage' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultMedianFilterImage.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataResultMedianFilterImage" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataResultMedianFilterImage'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.medianFilteredArray:
            showIndent(outfile, level)
            outfile.write('medianFilteredArray=XSDataArray(\n')
            self.medianFilteredArray.exportLiteral(outfile, level, name_='medianFilteredArray')
            showIndent(outfile, level)
            outfile.write('),\n')
        XSDataResult.exportLiteralChildren(self, outfile, level, name_)
    def build(self, node_):
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            nodeName_ == 'medianFilteredArray':
            obj_ = XSDataArray.factory()
            obj_.build(child_)
            self.setMedianFilteredArray(obj_)
        XSDataResult.buildChildren(self, child_, nodeName_)
# end class XSDataResultMedianFilterImage
...
class SaxXSConfigurationHandler(handler.ContentHandler):
    ...
    def startElement(self, name, attrs):
        ...
        elif name == 'inputImages':
            obj = XSDataImage.factory()
            stackObj = SaxStackElement('inputImages', obj)
            self.stack.append(stackObj)
            done = 1
        ...
        elif name == 'filterWidth':
            obj = XSDataInteger.factory()
            stackObj = SaxStackElement('filterWidth', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'medianFilteredImage':
            obj = XSDataImage.factory()
            stackObj = SaxStackElement('medianFilteredImage', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'outputArray':
            obj = XSDataArray.factory()
            stackObj = SaxStackElement('outputArray', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'medianFilteredArray':
            obj = XSDataArray.factory()
            stackObj = SaxStackElement('medianFilteredArray', obj)
            self.stack.append(stackObj)
            done = 1
        if not done:
    ...
    def endElement(self, name):
        ...
        if name == 'XSConfiguration':
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.addInputImages(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'outputImage':
            if len(self.stack) >= 2:
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setFilterWidth(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'medianFilteredImage':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setMedianFilteredImage(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'outputArray':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setOutputArray(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'medianFilteredArray':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setMedianFilteredArray(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        if not done:
            self.reportError('"%s" element not allowed here.' % name)
