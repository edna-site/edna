...
xsDataBaseName=XSDataImageFilter.xsd
xsdHomeDir=${EDNA_HOME}/execPlugins/plugins/EDPluginGroupImageFilter/datamodel
pyHomeDir=${EDNA_HOME}/execPlugins/plugins/EDPluginGroupImageFilter/plugins
includeXSDFilePath=${EDNA_HOME}/kernel/datamodel/XSDataCommon.xsd

echo running: java -jar ${EDNA_HOME}/kernel/datamodel/EDGenerateDS.jar  -includepaths ${includeXSDFilePath},${xsdHomeDir} -source ${xsdHomeDir}/${xsDataBaseName}  -targetdir ${pyHome}
