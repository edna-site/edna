...
from XSDataCommon           import XSDataBoolean, XSDataFile, XSDataString, \
    XSDataDouble, XSDataDoubleWithUnit, XSDataInteger
...
if __name__ == '__main__':
    ...
    for i in sys.argv[1:]:
        if i.lower().find("-online") in [0, 1]:
            ...
            debug = True
        elif i.lower().find("-gamma") in [0, 1]:
            gamma = float(i.split("=", 1)[1])
