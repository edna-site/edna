...
class EDTestCasePluginExecuteExecThumbnailv10_equalize(EDTestCasePluginExecuteExecThumbnailv10):
    """
    ...
    def __init__(self):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputThumbnail_reference_equalize.xml"))
        self.setReferenceDataOutputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataResultThumbnail_reference_equalize.xml"))
...
if __name__ == '__main__':
    ...
    testThumbnailv10instance = EDTestCasePluginExecuteExecThumbnailv10_equalize()
