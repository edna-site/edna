...
class EDTestCasePluginExecuteExecThumbnailv10_colorize(EDTestCasePluginExecuteExecThumbnailv10):
    """
    Those are all execution tests for the EDNA Exec plugin Thumbnailv10 with color ouput (larger contrasts expected)
    """
    ...
    def __init__(self):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputThumbnail_reference_colorize.xml"))
        self.setReferenceDataOutputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataResultThumbnail_reference_colorize.xml"))
...
if __name__ == '__main__':
    ...
    testThumbnailv10instance = EDTestCasePluginExecuteExecThumbnailv10_colorize("EDTestCasePluginExecuteExecThumbnailv10_colorize")
