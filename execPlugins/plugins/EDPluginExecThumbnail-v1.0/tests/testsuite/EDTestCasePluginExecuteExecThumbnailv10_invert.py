...
class EDTestCasePluginExecuteExecThumbnailv10_invert(EDTestCasePluginExecuteExecThumbnailv10):
    """
    ...
    def __init__(self):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputThumbnail_reference_invert.xml"))
        self.setReferenceDataOutputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataResultThumbnail_reference_invert.xml"))
...
if __name__ == '__main__':
    testThumbnailv10instance = EDTestCasePluginExecuteExecThumbnailv10_invert()
