...
class EDTestCasePluginExecuteExecThumbnailv10_minimal(EDTestCasePluginExecuteExecThumbnailv10):
    """
    Those are all execution tests for the EDNA Exec plugin Thumbnailv10 minimal input file
    """
    def __init__(self):
        """
        Constructor of the Class Execute Test Plugin Exec fro thumbnails with minimal options
        """
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputThumbnail_reference_minimal.xml"))
        self.setReferenceDataOutputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataResultThumbnail_reference_minimal.xml"))
...
if __name__ == '__main__':
    testThumbnailv10instance = EDTestCasePluginExecuteExecThumbnailv10_minimal()
