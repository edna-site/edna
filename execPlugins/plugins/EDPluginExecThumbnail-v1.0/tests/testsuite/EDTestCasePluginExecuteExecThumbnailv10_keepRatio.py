...
class EDTestCasePluginExecuteExecThumbnailv10_keepRatio(EDTestCasePluginExecuteExecThumbnailv10):
    """
    ...
    def __init__(self):
        """
        Constructor of the Class Execute Test Plugin Exec fro thumbnails resize and keep ratio
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputThumbnail_reference_keepRatio.xml"))
        self.setReferenceDataOutputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataResultThumbnail_reference_keepRatio.xml"))
...
if __name__ == '__main__':
    ...
    testThumbnailv10instance = EDTestCasePluginExecuteExecThumbnailv10_keepRatio()
