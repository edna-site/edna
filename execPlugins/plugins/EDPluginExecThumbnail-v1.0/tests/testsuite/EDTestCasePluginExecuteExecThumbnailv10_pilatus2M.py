...
class EDTestCasePluginExecuteExecThumbnailv10_pilatus2M(EDTestCasePluginExecuteExecThumbnailv10):
    """
    Those are all execution tests for the EDNA Exec plugin Thumbnailv10 with pilatus2M test for Saxs people.
    """
    ...
    def __init__(self):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputThumbnail_reference_pilatus2M.xml"))
        self.setReferenceDataOutputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataResultThumbnail_reference_pilatus2M.xml"))
...
if __name__ == '__main__':
    testThumbnailv10instance = EDTestCasePluginExecuteExecThumbnailv10_pilatus2M()
