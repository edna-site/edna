...
#
# Generated Wed Feb 10 17:13:46 2010 by EDGenerateDS.py.
#
...
class XSDataInputExecCommandLine(XSDataInput):
    subclass = None
    def __init__(self, commandLineOptions=None, commandLineProgram=None, fireAndForget=None, inputFileName=None, inputFileType=None, outfileFromStdout=None, outputPath=None, configuration=None):
        XSDataInput.__init__(self, configuration)
        self.commandLineOptions = commandLineOptions
        self.commandLineProgram = commandLineProgram
        self.fireAndForget = fireAndForget
        self.inputFileName = inputFileName
        self.inputFileType = inputFileType
        self.outfileFromStdout = outfileFromStdout
        self.outputPath = outputPath
    def factory(*args_, **kwargs_):
        if XSDataInputExecCommandLine.subclass:
            return XSDataInputExecCommandLine.subclass(*args_, **kwargs_)
        else:
            return XSDataInputExecCommandLine(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getCommandLineOptions(self): return self.commandLineOptions
    def setCommandLineOptions(self, commandLineOptions): self.commandLineOptions = commandLineOptions
    def getCommandLineProgram(self): return self.commandLineProgram
    def setCommandLineProgram(self, commandLineProgram): self.commandLineProgram = commandLineProgram
    def getFireAndForget(self): return self.fireAndForget
    def setFireAndForget(self, fireAndForget): self.fireAndForget = fireAndForget
    def getInputFileName(self): return self.inputFileName
    def setInputFileName(self, inputFileName): self.inputFileName = inputFileName
    def getInputFileType(self): return self.inputFileType
    def setInputFileType(self, inputFileType): self.inputFileType = inputFileType
    def getOutfileFromStdout(self): return self.outfileFromStdout
    def setOutfileFromStdout(self, outfileFromStdout): self.outfileFromStdout = outfileFromStdout
    ...
    def export(self, outfile, level, name_='XSDataInputExecCommandLine'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputExecCommandLine'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputExecCommandLine')
    def exportChildren(self, outfile, level, name_='XSDataInputExecCommandLine'):
        if self.getCommandLineOptions() != None :
            if self.commandLineOptions:
                self.commandLineOptions.export(outfile, level, name_='commandLineOptions')
        if self.commandLineProgram:
            self.commandLineProgram.export(outfile, level, name_='commandLineProgram')
        if self.getFireAndForget() != None :
            if self.fireAndForget:
        ...
        if self.getInputFileType() != None :
            if self.inputFileType:
                self.inputFileType.export(outfile, level, name_='inputFileType')
        if self.getOutfileFromStdout() != None :
            if self.outfileFromStdout:
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputExecCommandLine.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataInputExecCommandLine'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.commandLineOptions:
            showIndent(outfile, level)
            outfile.write('commandLineOptions=XSDataString(\n')
            self.commandLineOptions.exportLiteral(outfile, level, name_='commandLineOptions')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.commandLineProgram:
            showIndent(outfile, level)
            outfile.write('commandLineProgram=XSDataFile(\n')
            self.commandLineProgram.exportLiteral(outfile, level, name_='commandLineProgram')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.fireAndForget:
            showIndent(outfile, level)
            outfile.write('fireAndForget=XSDataBoolean(\n')
            self.fireAndForget.exportLiteral(outfile, level, name_='fireAndForget')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.inputFileName:
            showIndent(outfile, level)
            outfile.write('inputFileName=XSDataFile(\n')
            self.inputFileName.exportLiteral(outfile, level, name_='inputFileName')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.inputFileType:
            showIndent(outfile, level)
            outfile.write('inputFileType=XSDataString(\n')
            self.inputFileType.exportLiteral(outfile, level, name_='inputFileType')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.outfileFromStdout:
            showIndent(outfile, level)
            outfile.write('outfileFromStdout=XSDataBoolean(\n')
            self.outfileFromStdout.exportLiteral(outfile, level, name_='outfileFromStdout')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.outputPath:
            showIndent(outfile, level)
...
class XSDataResultExecCommandLine(XSDataResult):
    ...
    def factory(*args_, **kwargs_):
        if XSDataResultExecCommandLine.subclass:
            return XSDataResultExecCommandLine.subclass(*args_, **kwargs_)
        else:
            return XSDataResultExecCommandLine(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def export(self, outfile, level, name_='XSDataResultExecCommandLine'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultExecCommandLine'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultExecCommandLine')
    def exportChildren(self, outfile, level, name_='XSDataResultExecCommandLine'):
        if self.getOutputFilename() != None :
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultExecCommandLine.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataResultExecCommandLine'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.outputFilename:
            showIndent(outfile, level)
            outfile.write('outputFilename=XSDataFile(\n')
...
class SaxXSDataDoubleHandler(handler.ContentHandler):
    ...
    def startElement(self, name, attrs):
        ...
        elif name == 'commandLineOptions':
            obj = XSDataString.factory()
            stackObj = SaxStackElement('commandLineOptions', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'commandLineProgram':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('commandLineProgram', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'fireAndForget':
            obj = XSDataBoolean.factory()
            stackObj = SaxStackElement('fireAndForget', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'inputFileName':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('inputFileName', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'inputFileType':
            obj = XSDataString.factory()
            stackObj = SaxStackElement('inputFileType', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'outfileFromStdout':
            obj = XSDataBoolean.factory()
            stackObj = SaxStackElement('outfileFromStdout', obj)
            self.stack.append(stackObj)
            done = 1
    ...
    def endElement(self, name):
        ...
        if name == 'XSDataDouble':
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setCommandLineOptions(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'commandLineProgram':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setCommandLineProgram(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'fireAndForget':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setFireAndForget(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'inputFileName':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setInputFileName(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'inputFileType':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setInputFileType(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'outfileFromStdout':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setOutfileFromStdout(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'outputPath':
            if len(self.stack) >= 2:
