...
class EDTestCasePluginExecuteWaitFile_nofile(EDTestCasePluginExecuteWaitFile):
    """
    ...
    def __init__(self, _strTestName=None):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), \
                                           "XSDataInputWaitFile_nofile.xml"))
        self.setReferenceDataOutputFile(os.path.join(self.getPluginTestsDataHome(), \
                                                     "XSDataResultWaitFile_nofile.xml"))
...
if __name__ == '__main__':
    ...
    testWaitFileinstance = EDTestCasePluginExecuteControlWaitFile_nofile("EDTestCasePluginExecuteWaitFile_nofile")
