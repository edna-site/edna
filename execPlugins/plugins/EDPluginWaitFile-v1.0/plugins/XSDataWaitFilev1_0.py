...
#
# Generated Tue Jan 25 17:07:46 2011 by EDGenerateDS.py.
#
...
class XSDataInputWaitFile(XSDataInput):
    subclass = None
    def __init__(self, configuration=None, expectedFile=None, expectedSize=None, timeOut=None):
        XSDataInput.__init__(self, configuration)
        self.expectedFile = expectedFile
        self.expectedSize = expectedSize
        self.timeOut = timeOut
    def factory(*args_, **kwargs_):
        if XSDataInputWaitFile.subclass:
            return XSDataInputWaitFile.subclass(*args_, **kwargs_)
        else:
            return XSDataInputWaitFile(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getExpectedFile(self): return self.expectedFile
    def setExpectedFile(self, expectedFile): self.expectedFile = expectedFile
    def getExpectedSize(self): return self.expectedSize
    def setExpectedSize(self, expectedSize): self.expectedSize = expectedSize
    ...
    def export(self, outfile, level, name_='XSDataInputWaitFile'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputWaitFile'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputWaitFile')
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputWaitFile.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataInputWaitFile'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.expectedFile:
            showIndent(outfile, level)
            outfile.write('expectedFile=XSDataFile(\n')
            self.expectedFile.exportLiteral(outfile, level, name_='expectedFile')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.expectedSize:
            showIndent(outfile, level)
            outfile.write('expectedSize=XSDataInteger(\n')
            self.expectedSize.exportLiteral(outfile, level, name_='expectedSize')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.timeOut:
            showIndent(outfile, level)
            outfile.write('timeOut=XSDataTime(\n')
...
class XSDataInputWaitMultiFile(XSDataInput):
    ...
    def __init__(self, configuration=None, expectedFile=None, expectedSize=None, timeOut=None):
        ...
        self.timeOut = timeOut
    def factory(*args_, **kwargs_):
        if XSDataInputWaitMultiFile.subclass:
            return XSDataInputWaitMultiFile.subclass(*args_, **kwargs_)
        else:
            return XSDataInputWaitMultiFile(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getExpectedFile(self): return self.expectedFile
    def setExpectedFile(self, expectedFile): self.expectedFile = expectedFile
    def addExpectedFile(self, value): self.expectedFile.append(value)
    def insertExpectedFile(self, index, value): self.expectedFile[index] = value
    def getExpectedSize(self): return self.expectedSize
    def setExpectedSize(self, expectedSize): self.expectedSize = expectedSize
    def getTimeOut(self): return self.timeOut
    def setTimeOut(self, timeOut): self.timeOut = timeOut
    def export(self, outfile, level, name_='XSDataInputWaitMultiFile'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputWaitMultiFile'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputWaitMultiFile')
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputWaitMultiFile.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataInputWaitMultiFile'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('expectedFile=[\n')
        level += 1
        for expectedFile in self.expectedFile:
            showIndent(outfile, level)
            outfile.write('XSDataFile(\n')
            expectedFile.exportLiteral(outfile, level, name_='expectedFile')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class XSDataResultWaitFile(XSDataResult):
    subclass = None
    def __init__(self, actualFile=None, actualSize=None, timedOut=None):
        XSDataResult.__init__(self)
        self.actualFile = actualFile
        self.actualSize = actualSize
        self.timedOut = timedOut
    def factory(*args_, **kwargs_):
        if XSDataResultWaitFile.subclass:
            return XSDataResultWaitFile.subclass(*args_, **kwargs_)
        else:
            return XSDataResultWaitFile(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getActualFile(self): return self.actualFile
    def setActualFile(self, actualFile): self.actualFile = actualFile
    def getActualSize(self): return self.actualSize
    def setActualSize(self, actualSize): self.actualSize = actualSize
    def getTimedOut(self): return self.timedOut
    def setTimedOut(self, timedOut): self.timedOut = timedOut
    def export(self, outfile, level, name_='XSDataResultWaitFile'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultWaitFile'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultWaitFile')
    def exportChildren(self, outfile, level, name_='XSDataResultWaitFile'):
        if self.getActualFile() != None :
            if self.actualFile:
                self.actualFile.export(outfile, level, name_='actualFile')
        if self.getActualSize() != None :
            if self.actualSize:
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultWaitFile.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataResultWaitFile'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.actualFile:
            showIndent(outfile, level)
            outfile.write('actualFile=XSDataFile(\n')
            self.actualFile.exportLiteral(outfile, level, name_='actualFile')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.actualSize:
            showIndent(outfile, level)
            outfile.write('actualSize=XSDataInteger(\n')
            self.actualSize.exportLiteral(outfile, level, name_='actualSize')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.timedOut:
            showIndent(outfile, level)
            outfile.write('timedOut=XSDataBoolean(\n')
            self.timedOut.exportLiteral(outfile, level, name_='timedOut')
            showIndent(outfile, level)
            outfile.write('),\n')
...
class XSDataResultWaitMultiFile(XSDataResult):
    subclass = None
    def __init__(self, actualFile=None, actualMinSize=None, timedOut=None):
        XSDataResult.__init__(self)
        if actualFile is None:
            self.actualFile = []
        else:
            self.actualFile = actualFile
        self.actualMinSize = actualMinSize
        self.timedOut = timedOut
    def factory(*args_, **kwargs_):
        if XSDataResultWaitMultiFile.subclass:
            return XSDataResultWaitMultiFile.subclass(*args_, **kwargs_)
        else:
            return XSDataResultWaitMultiFile(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getActualFile(self): return self.actualFile
    def setActualFile(self, actualFile): self.actualFile = actualFile
    def addActualFile(self, value): self.actualFile.append(value)
    def insertActualFile(self, index, value): self.actualFile[index] = value
    def getActualMinSize(self): return self.actualMinSize
    def setActualMinSize(self, actualMinSize): self.actualMinSize = actualMinSize
    def getTimedOut(self): return self.timedOut
    def setTimedOut(self, timedOut): self.timedOut = timedOut
    def export(self, outfile, level, name_='XSDataResultWaitMultiFile'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultWaitMultiFile'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultWaitMultiFile')
    def exportChildren(self, outfile, level, name_='XSDataResultWaitMultiFile'):
        ...
        if self.getActualMinSize() != None :
            if self.actualMinSize:
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultWaitMultiFile.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataResultWaitMultiFile'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('actualFile=[\n')
        level += 1
        for actualFile in self.actualFile:
            showIndent(outfile, level)
            outfile.write('XSDataFile(\n')
            actualFile.exportLiteral(outfile, level, name_='actualFile')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        ...
        if self.actualMinSize:
            showIndent(outfile, level)
            outfile.write('actualMinSize=XSDataInteger(\n')
            self.actualMinSize.exportLiteral(outfile, level, name_='actualMinSize')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.timedOut:
            showIndent(outfile, level)
...
class SaxXSConfigurationHandler(handler.ContentHandler):
    ...
    def startElement(self, name, attrs):
        ...
        elif name == 'expectedFile':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('expectedFile', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'expectedSize':
            obj = XSDataInteger.factory()
            stackObj = SaxStackElement('expectedSize', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'timeOut':
            obj = XSDataTime.factory()
            stackObj = SaxStackElement('timeOut', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'actualFile':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('actualFile', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'actualSize':
            obj = XSDataInteger.factory()
            stackObj = SaxStackElement('actualSize', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'timedOut':
            obj = XSDataBoolean.factory()
            stackObj = SaxStackElement('timedOut', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'actualMinSize':
            obj = XSDataInteger.factory()
            stackObj = SaxStackElement('actualMinSize', obj)
            self.stack.append(stackObj)
            done = 1
        if not done:
    ...
    def endElement(self, name):
        ...
        if name == 'XSConfiguration':
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setExpectedFile(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'expectedSize':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setExpectedSize(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'timeOut':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setTimeOut(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'actualFile':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setActualFile(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'actualSize':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setActualSize(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'timedOut':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setTimedOut(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'actualMinSize':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setActualMinSize(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        if not done:
            self.reportError('"%s" element not allowed here.' % name)
