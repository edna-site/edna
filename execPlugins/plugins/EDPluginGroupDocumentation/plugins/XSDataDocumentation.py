...
#
# Generated Wed Apr 13 15:29:43 2011 by EDGenerateDS.py.
#
...
class XSDataInputEpydoc(XSDataInput):
    subclass = None
    def __init__(self, configuration=None, docPath=None, sources=None, docType=None, verbosity=None, projectName=None):
    ...
    def factory(*args_, **kwargs_):
        if XSDataInputEpydoc.subclass:
            return XSDataInputEpydoc.subclass(*args_, **kwargs_)
        else:
            return XSDataInputEpydoc(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getDocPath(self): return self.docPath
    def setDocPath(self, docPath): self.docPath = docPath
    def getSources(self): return self.sources
    def setSources(self, sources): self.sources = sources
    def addSources(self, value): self.sources.append(value)
    def insertSources(self, index, value): self.sources[index] = value
    def getDocType(self): return self.docType
    def setDocType(self, docType): self.docType = docType
    def getVerbosity(self): return self.verbosity
    def setVerbosity(self, verbosity): self.verbosity = verbosity
    ...
    def export(self, outfile, level, name_='XSDataInputEpydoc'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputEpydoc'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputEpydoc')
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputEpydoc.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataInputEpydoc'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.docPath:
            showIndent(outfile, level)
            outfile.write('docPath=XSDataFile(\n')
            self.docPath.exportLiteral(outfile, level, name_='docPath')
            showIndent(outfile, level)
            outfile.write('),\n')
        showIndent(outfile, level)
        ...
        for sources in self.sources:
            ...
            sources.exportLiteral(outfile, level, name_='sources')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        ...
        if self.docType:
            showIndent(outfile, level)
            outfile.write('docType=XSDataString(\n')
            self.docType.exportLiteral(outfile, level, name_='docType')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.verbosity:
            showIndent(outfile, level)
            outfile.write('verbosity=XSDataInteger(\n')
            self.verbosity.exportLiteral(outfile, level, name_='verbosity')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.projectName:
            showIndent(outfile, level)
            outfile.write('projectName=XSDataString(\n')
            self.projectName.exportLiteral(outfile, level, name_='projectName')
            showIndent(outfile, level)
            outfile.write('),\n')
...
class XSDataResultEpydoc(XSDataResult):
    ...
    def __init__(self, status=None, docPath=None):
        ...
        self.docPath = docPath
    def factory(*args_, **kwargs_):
        if XSDataResultEpydoc.subclass:
            return XSDataResultEpydoc.subclass(*args_, **kwargs_)
        else:
            return XSDataResultEpydoc(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getDocPath(self): return self.docPath
    def setDocPath(self, docPath): self.docPath = docPath
    def export(self, outfile, level, name_='XSDataResultEpydoc'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultEpydoc'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultEpydoc')
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultEpydoc.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataResultEpydoc'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
...
class SaxXSConfigurationHandler(handler.ContentHandler):
    ...
    def startElement(self, name, attrs):
        ...
        if name == 'XSConfiguration':
            ...
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('docPath', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'sources':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('sources', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'docType':
            obj = XSDataString.factory()
            stackObj = SaxStackElement('docType', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'verbosity':
            obj = XSDataInteger.factory()
            stackObj = SaxStackElement('verbosity', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'projectName':
            obj = XSDataString.factory()
            stackObj = SaxStackElement('projectName', obj)
            self.stack.append(stackObj)
            done = 1
        if not done:
    ...
    def endElement(self, name):
        ...
        if name == 'XSConfiguration':
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setDocPath(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'sources':
            if len(self.stack) >= 2:
                self.stack[-2].obj.addSources(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'docType':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setDocType(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'verbosity':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setVerbosity(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'projectName':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setProjectName(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        if not done:
            self.reportError('"%s" element not allowed here.' % name)
