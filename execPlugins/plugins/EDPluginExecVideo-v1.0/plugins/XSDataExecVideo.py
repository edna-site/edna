...
#
# Generated Fri Feb 26 14:16:31 2010 by EDGenerateDS.py.
#
...
class XSDataInputExecVideo(XSDataInput):
    subclass = None
    def __init__(self, inputImagePath=None, outputPath=None, videoBitRate=None, videoCodec=None, videoFPS=None, configuration=None):
    ...
    def factory(*args_, **kwargs_):
        if XSDataInputExecVideo.subclass:
            return XSDataInputExecVideo.subclass(*args_, **kwargs_)
        else:
            return XSDataInputExecVideo(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def addInputImagePath(self, value): self.inputImagePath.append(value)
    def insertInputImagePath(self, index, value): self.inputImagePath[index] = value
    def getOutputPath(self): return self.outputPath
    def setOutputPath(self, outputPath): self.outputPath = outputPath
    def getVideoBitRate(self): return self.videoBitRate
    def setVideoBitRate(self, videoBitRate): self.videoBitRate = videoBitRate
    def getVideoCodec(self): return self.videoCodec
    def setVideoCodec(self, videoCodec): self.videoCodec = videoCodec
    def getVideoFPS(self): return self.videoFPS
    def setVideoFPS(self, videoFPS): self.videoFPS = videoFPS
    def export(self, outfile, level, name_='XSDataInputExecVideo'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputExecVideo'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputExecVideo')
    def exportChildren(self, outfile, level, name_='XSDataInputExecVideo'):
        for inputImagePath_ in self.getInputImagePath():
            inputImagePath_.export(outfile, level, name_='inputImagePath')
        if self.getOutputPath() != None :
            if self.outputPath:
                self.outputPath.export(outfile, level, name_='outputPath')
        if self.getVideoBitRate() != None :
            if self.videoBitRate:
                self.videoBitRate.export(outfile, level, name_='videoBitRate')
        if self.getVideoCodec() != None :
            if self.videoCodec:
                self.videoCodec.export(outfile, level, name_='videoCodec')
        if self.getVideoFPS() != None :
            if self.videoFPS:
                self.videoFPS.export(outfile, level, name_='videoFPS')
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataInputExecVideo' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputExecVideo.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataInputExecVideo" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataInputExecVideo'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('inputImagePath=[\n')
        level += 1
        for inputImagePath in self.inputImagePath:
            showIndent(outfile, level)
            outfile.write('XSDataFile(\n')
            inputImagePath.exportLiteral(outfile, level, name_='inputImagePath')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        ...
        if self.videoBitRate:
            showIndent(outfile, level)
            outfile.write('videoBitRate=XSDataInteger(\n')
            self.videoBitRate.exportLiteral(outfile, level, name_='videoBitRate')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.videoCodec:
            showIndent(outfile, level)
            outfile.write('videoCodec=XSDataString(\n')
            self.videoCodec.exportLiteral(outfile, level, name_='videoCodec')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.videoFPS:
            showIndent(outfile, level)
            outfile.write('videoFPS=XSDataFloat(\n')
            self.videoFPS.exportLiteral(outfile, level, name_='videoFPS')
            showIndent(outfile, level)
            outfile.write('),\n')
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            obj_ = XSDataFile.factory()
            obj_.build(child_)
            self.inputImagePath.append(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            ...
            nodeName_ == 'videoBitRate':
            obj_ = XSDataInteger.factory()
            obj_.build(child_)
            self.setVideoBitRate(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'videoCodec':
            obj_ = XSDataString.factory()
            obj_.build(child_)
            self.setVideoCodec(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'videoFPS':
            obj_ = XSDataFloat.factory()
            obj_.build(child_)
            self.setVideoFPS(obj_)
        XSDataInput.buildChildren(self, child_, nodeName_)
# end class XSDataInputExecVideo


class XSDataResultExecVideo(XSDataResult):
    subclass = None
    def __init__(self, videoCodec=None, videoPath=None, status=None):
        XSDataResult.__init__(self, status)
        self.videoCodec = videoCodec
        self.videoPath = videoPath
    def factory(*args_, **kwargs_):
        if XSDataResultExecVideo.subclass:
            return XSDataResultExecVideo.subclass(*args_, **kwargs_)
        else:
            return XSDataResultExecVideo(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getVideoCodec(self): return self.videoCodec
    def setVideoCodec(self, videoCodec): self.videoCodec = videoCodec
    def getVideoPath(self): return self.videoPath
    def setVideoPath(self, videoPath): self.videoPath = videoPath
    def export(self, outfile, level, name_='XSDataResultExecVideo'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultExecVideo'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultExecVideo')
    def exportChildren(self, outfile, level, name_='XSDataResultExecVideo'):
        if self.videoCodec:
            self.videoCodec.export(outfile, level, name_='videoCodec')
        if self.videoPath:
            self.videoPath.export(outfile, level, name_='videoPath')
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataResultExecVideo' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultExecVideo.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataResultExecVideo" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataResultExecVideo'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.videoPath:
            showIndent(outfile, level)
            outfile.write('videoPath=XSDataFile(\n')
            self.videoPath.exportLiteral(outfile, level, name_='videoPath')
            showIndent(outfile, level)
            outfile.write('),\n')
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            obj_ = XSDataFile.factory()
            obj_.build(child_)
            self.setVideoPath(obj_)
        XSDataResult.buildChildren(self, child_, nodeName_)
# end class XSDataResultExecVideo
...
class SaxXSDataDoubleHandler(handler.ContentHandler):
    ...
    def startElement(self, name, attrs):
        ...
        elif name == 'videoBitRate':
            obj = XSDataInteger.factory()
            stackObj = SaxStackElement('videoBitRate', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'videoCodec':
            obj = XSDataString.factory()
            stackObj = SaxStackElement('videoCodec', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'videoFPS':
            obj = XSDataFloat.factory()
            stackObj = SaxStackElement('videoFPS', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'videoPath':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('videoPath', obj)
            self.stack.append(stackObj)
            done = 1
        if not done:
    ...
    def endElement(self, name):
        ...
        if name == 'XSDataDouble':
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.addInputImagePath(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'outputPath':
            if len(self.stack) >= 2:
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setVideoBitRate(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'videoCodec':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setVideoCodec(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'videoFPS':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setVideoFPS(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'videoPath':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setVideoPath(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        if not done:
            self.reportError('"%s" element not allowed here.' % name)
