...
class EDTestSuitePluginExecShiftImagev1_0(EDTestSuite):
    """
...
if __name__ == '__main__':
    ...
    edTestSuitePluginExecShiftImagev1_0 = EDTestSuitePluginExecShiftImagev1_0("EDTestSuitePluginExecShiftImagev1_0")
