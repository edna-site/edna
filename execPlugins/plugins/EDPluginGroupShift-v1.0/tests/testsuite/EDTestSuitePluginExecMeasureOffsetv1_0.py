...
class EDTestSuitePluginExecMeasureOffsetv1_0(EDTestSuite):
    """
    This is the test suite for EDNA plugin MeasureOffsetv1_0 
...
if __name__ == '__main__':
    ...
    edTestSuitePluginExecMeasureOffsetv1_0 = EDTestSuitePluginExecMeasureOffsetv1_0("EDTestSuitePluginExecMeasureOffsetv1_0")
    edTestSuitePluginExecMeasureOffsetv1_0.execute()
