...
class EDTestCasePluginExecuteExecMeasureOffsetv1_0_crop(EDTestCasePluginExecuteExecMeasureOffsetv1_0):
    """
...
#                                               "XSConfiguration_MeasureOffset.xml"))
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), \
                                           "XSDataInputMeasureOffset_crop.xml"))
...
if __name__ == '__main__':
    ...
    testMeasureOffsetv1_0instance = EDTestCasePluginExecuteExecMeasureOffsetv1_0_crop("EDTestCasePluginExecuteExecMeasureOffsetv1_0_crop")
