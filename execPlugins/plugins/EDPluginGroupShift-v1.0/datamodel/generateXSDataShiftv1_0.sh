...
xsDataBaseName=XSDataShiftv1_0.xsd
xsdHomeDir=${EDNA_HOME}/execPlugins/plugins/EDPluginGroupShift-v1.0/datamodel
pyHomeDir=${EDNA_HOME}/execPlugins/plugins/EDPluginGroupShift-v1.0/src
