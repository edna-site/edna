...
class EDTestCasePluginUnitSPDCakev1_1(EDTestCasePluginUnit):
    """
    """
    ...
    def __init__(self, _edStringTestName=None):
        """
        """
        EDTestCasePluginUnit.__init__(self, "EDPluginSPDCakev1_1")
...
if __name__ == '__main__':
    ...
    edTestCasePluginUnitSPDCakev1_1 = EDTestCasePluginUnitSPDCakev1_1("EDTestCasePluginUnitSPDCakev1_1")
    edTestCasePluginUnitSPDCakev1_1.execute()
