...
class EDTestCasePluginExecuteSPDCakev1_5(EDTestCasePluginExecute):
    """
    """
    ...
    def __init__(self, _edStringTestName=None):
        """
        """
        self.refInput = "diff6105.edf"
        self.refOutput = "diff6105.azim"
        EDTestCasePluginExecute.__init__(self, "EDPluginSPDCakev1_5", _edStringTestName)
        self.setConfigurationFile(self.getRefConfigFile())
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), \
                                                      "XSDataInputSPDCakev1_5_reference.xml"))

        self.setReferenceDataOutputFile(os.path.join(self.getPluginTestsDataHome(), \
                                                                "XSDataResultSPDCakev1_5_reference.xml"))
    ...
    def preProcess(self):
        ...
        self.loadTestImage([self.refInput, self.refOutput, "darks0001.edf", "flats0001.edf" ])
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteSPDCakev1_5 = EDTestCasePluginExecuteSPDCakev1_5("EDTestCasePluginExecuteSPDCakev1_5")
