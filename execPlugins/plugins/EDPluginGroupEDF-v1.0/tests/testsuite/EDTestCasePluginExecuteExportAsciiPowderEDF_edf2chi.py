...
class EDTestCasePluginExecuteExportAsciiPowderEDF_edf2chi(EDTestCasePluginExecute):
    """
...
#                                               "XSConfiguration_<basePluginName>.xml"))
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), \
                                           "XSDataInput1DPowder_edf2chi.xml"))
        self.setReferenceDataOutputFile(os.path.join(self.getPluginTestsDataHome(), \
                                                     "XSDataResult1DPowder_edf2chi.xml"))
...
if __name__ == '__main__':
    ...
    testinstance = EDTestCasePluginExecuteExportAsciiPowderEDF_edf2chi("EDTestCasePluginExecuteExportAsciiPowderEDF_edf2chi")
