...
class EDTestCasePluginExecuteExportAsciiPowderEDF_edf2cif(EDTestCasePluginExecute):
    """
...
#                                               "XSConfiguration_<basePluginName>.xml"))
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), \
                                           "XSDataInput1DPowder_edf2cif.xml"))
        self.setReferenceDataOutputFile(os.path.join(self.getPluginTestsDataHome(), \
                                                     "XSDataResult1DPowder_edf2cif.xml"))
        self.refOutput = "sample1_6284.cif"
    ...
    def testExecute(self):
        ...
        EDAssert.strAlmostEqual(referenceData, outputData, "Powder CIF files are the same")
...
if __name__ == '__main__':
    ...
    testinstance = EDTestCasePluginExecuteExportAsciiPowderEDF_edf2cif("EDTestCasePluginExecuteExportAsciiPowderEDF_edf2cif")
