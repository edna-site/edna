...
class EDTestCasePluginExecuteExportAsciiPowderEDF_edf2chi_mask(EDTestCasePluginExecute):
    """
...
#                                               "XSConfiguration_<basePluginName>.xml"))
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), \
                                           "XSDataInput1DPowder_edf2chi_mask.xml"))
        self.setReferenceDataOutputFile(os.path.join(self.getPluginTestsDataHome(), \
                                                     "XSDataResult1DPowder_edf2chi_mask.xml"))
        self.refOutput = "LaB6_0022.chi"
    ...
    def preProcess(self):
        ...
        self.loadTestImage(["LaB6_0022.azim" , self.refOutput])
        tmpdir = "%s/edna-%s" % (tempfile.gettempdir(), os.environ["USER"])
...
if __name__ == '__main__':
    ...
    testinstance = EDTestCasePluginExecuteExportAsciiPowderEDF_edf2chi_mask("EDTestCasePluginExecuteExportAsciiPowderEDF_edf2chi_mask")
