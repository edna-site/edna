...
class EDTestCasePluginExecuteExportAsciiPowderEDF_array2array(EDTestCasePluginExecute):
    """
...
#                                               "XSConfiguration_<basePluginName>.xml"))
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), \
                                           "XSDataInput1DPowder_array2array.xml"))
...
if __name__ == '__main__':
    ...
    testinstance = EDTestCasePluginExecuteExportAsciiPowderEDF_array2array("EDTestCasePluginExecuteExportAsciiPowderEDF_array2array")
