...
xsDataBaseName=XSDataEDFv1_0
xsdHomeDir=${EDNA_HOME}/execPlugins/plugins/EDPluginGroupEDF-v1.0/datamodel
pyHomeDir=${EDNA_HOME}/execPlugins/plugins/EDPluginGroupEDF-v1.0/plugins
