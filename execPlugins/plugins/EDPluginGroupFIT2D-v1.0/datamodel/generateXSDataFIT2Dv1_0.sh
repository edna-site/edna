...
xsDataBaseName=XSDataFIT2Dv1_0
xsdHomeDir=${EDNA_HOME}/execPlugins/plugins/EDPluginGroupFIT2D-v1.0/datamodel
pyHomeDir=${EDNA_HOME}/execPlugins/plugins/EDPluginGroupFIT2D-v1.0/plugins
