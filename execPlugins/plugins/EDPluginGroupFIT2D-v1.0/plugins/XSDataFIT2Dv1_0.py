...
#
# Generated Wed Nov  4 09:59:11 2009 by EDGenerateDS.py.
#
...
class XSDataInputFIT2D(XSDataInput):
    subclass = None
    def __init__(self, beamCentreInPixelsX=None, beamCentreInPixelsY=None, bufferSizeX=None, bufferSizeY=None, darkCurrentImageFile=None, flatFieldImageFile=None, inputFile=None, outputFileType=None, pixelSizeX=None, pixelSizeY=None, spatialDistortionFile=None, wavelength=None, configuration=None):
        XSDataInput.__init__(self, configuration)
        self.beamCentreInPixelsX = beamCentreInPixelsX
        self.beamCentreInPixelsY = beamCentreInPixelsY
        self.bufferSizeX = bufferSizeX
        self.bufferSizeY = bufferSizeY
        self.darkCurrentImageFile = darkCurrentImageFile
        self.flatFieldImageFile = flatFieldImageFile
        self.inputFile = inputFile
        self.outputFileType = outputFileType
        self.pixelSizeX = pixelSizeX
        self.pixelSizeY = pixelSizeY
        self.spatialDistortionFile = spatialDistortionFile
        self.wavelength = wavelength
    def factory(*args_, **kwargs_):
        if XSDataInputFIT2D.subclass:
            return XSDataInputFIT2D.subclass(*args_, **kwargs_)
        else:
            return XSDataInputFIT2D(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getBeamCentreInPixelsX(self): return self.beamCentreInPixelsX
    def setBeamCentreInPixelsX(self, beamCentreInPixelsX): self.beamCentreInPixelsX = beamCentreInPixelsX
    def getBeamCentreInPixelsY(self): return self.beamCentreInPixelsY
    def setBeamCentreInPixelsY(self, beamCentreInPixelsY): self.beamCentreInPixelsY = beamCentreInPixelsY
    def getBufferSizeX(self): return self.bufferSizeX
    def setBufferSizeX(self, bufferSizeX): self.bufferSizeX = bufferSizeX
    def getBufferSizeY(self): return self.bufferSizeY
    def setBufferSizeY(self, bufferSizeY): self.bufferSizeY = bufferSizeY
    def getDarkCurrentImageFile(self): return self.darkCurrentImageFile
    def setDarkCurrentImageFile(self, darkCurrentImageFile): self.darkCurrentImageFile = darkCurrentImageFile
    def getFlatFieldImageFile(self): return self.flatFieldImageFile
    def setFlatFieldImageFile(self, flatFieldImageFile): self.flatFieldImageFile = flatFieldImageFile
    ...
    def getSpatialDistortionFile(self): return self.spatialDistortionFile
    def setSpatialDistortionFile(self, spatialDistortionFile): self.spatialDistortionFile = spatialDistortionFile
    def getWavelength(self): return self.wavelength
    def setWavelength(self, wavelength): self.wavelength = wavelength
    def export(self, outfile, level, name_='XSDataInputFIT2D'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputFIT2D'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputFIT2D')
    def exportChildren(self, outfile, level, name_='XSDataInputFIT2D'):
        if self.beamCentreInPixelsX:
            self.beamCentreInPixelsX.export(outfile, level, name_='beamCentreInPixelsX')
        if self.beamCentreInPixelsY:
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataInputFIT2D' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputFIT2D.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataInputFIT2D" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataInputFIT2D'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.beamCentreInPixelsX:
            showIndent(outfile, level)
            outfile.write('beamCentreInPixelsX=XSDataDouble(\n')
            self.beamCentreInPixelsX.exportLiteral(outfile, level, name_='beamCentreInPixelsX')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.beamCentreInPixelsY:
            showIndent(outfile, level)
            outfile.write('beamCentreInPixelsY=XSDataDouble(\n')
            self.beamCentreInPixelsY.exportLiteral(outfile, level, name_='beamCentreInPixelsY')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.bufferSizeX:
            showIndent(outfile, level)
            outfile.write('bufferSizeX=XSDataInteger(\n')
            self.bufferSizeX.exportLiteral(outfile, level, name_='bufferSizeX')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.bufferSizeY:
            showIndent(outfile, level)
            outfile.write('bufferSizeY=XSDataInteger(\n')
            self.bufferSizeY.exportLiteral(outfile, level, name_='bufferSizeY')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.darkCurrentImageFile:
            showIndent(outfile, level)
            outfile.write('darkCurrentImageFile=XSDataFile(\n')
            self.darkCurrentImageFile.exportLiteral(outfile, level, name_='darkCurrentImageFile')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.flatFieldImageFile:
            showIndent(outfile, level)
            outfile.write('flatFieldImageFile=XSDataFile(\n')
            self.flatFieldImageFile.exportLiteral(outfile, level, name_='flatFieldImageFile')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.inputFile:
            showIndent(outfile, level)
        ...
        if self.pixelSizeX:
            showIndent(outfile, level)
            outfile.write('pixelSizeX=XSDataDouble(\n')
            self.pixelSizeX.exportLiteral(outfile, level, name_='pixelSizeX')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.pixelSizeY:
            showIndent(outfile, level)
            outfile.write('pixelSizeY=XSDataDouble(\n')
            self.pixelSizeY.exportLiteral(outfile, level, name_='pixelSizeY')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.spatialDistortionFile:
            showIndent(outfile, level)
            outfile.write('spatialDistortionFile=XSDataFile(\n')
            self.spatialDistortionFile.exportLiteral(outfile, level, name_='spatialDistortionFile')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.wavelength:
            showIndent(outfile, level)
...
# end class XSDataInputFIT2D


class XSDataInputFIT2DCake(XSDataInputFIT2D):
    subclass = None
    def __init__(self, angleOfTilt=None, endAzimuth=None, innerRadius=None, outerRadius=None, sampleToDetectorDistance=None, startAzimuth=None, tiltRotation=None, beamCentreInPixelsX=None, beamCentreInPixelsY=None, bufferSizeX=None, bufferSizeY=None, darkCurrentImageFile=None, flatFieldImageFile=None, inputFile=None, outputFileType=None, pixelSizeX=None, pixelSizeY=None, spatialDistortionFile=None, wavelength=None, configuration=None):
        XSDataInputFIT2D.__init__(self, beamCentreInPixelsX, beamCentreInPixelsY, bufferSizeX, bufferSizeY, darkCurrentImageFile, flatFieldImageFile, inputFile, outputFileType, pixelSizeX, pixelSizeY, spatialDistortionFile, wavelength, configuration)
        self.angleOfTilt = angleOfTilt
        self.endAzimuth = endAzimuth
        self.innerRadius = innerRadius
        self.outerRadius = outerRadius
        self.sampleToDetectorDistance = sampleToDetectorDistance
        self.startAzimuth = startAzimuth
        self.tiltRotation = tiltRotation
    def factory(*args_, **kwargs_):
        if XSDataInputFIT2DCake.subclass:
            return XSDataInputFIT2DCake.subclass(*args_, **kwargs_)
        else:
            return XSDataInputFIT2DCake(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getAngleOfTilt(self): return self.angleOfTilt
    def setAngleOfTilt(self, angleOfTilt): self.angleOfTilt = angleOfTilt
    def getEndAzimuth(self): return self.endAzimuth
    def setEndAzimuth(self, endAzimuth): self.endAzimuth = endAzimuth
    def getInnerRadius(self): return self.innerRadius
    def setInnerRadius(self, innerRadius): self.innerRadius = innerRadius
    def getOuterRadius(self): return self.outerRadius
    def setOuterRadius(self, outerRadius): self.outerRadius = outerRadius
    def getSampleToDetectorDistance(self): return self.sampleToDetectorDistance
    def setSampleToDetectorDistance(self, sampleToDetectorDistance): self.sampleToDetectorDistance = sampleToDetectorDistance
    def getStartAzimuth(self): return self.startAzimuth
    def setStartAzimuth(self, startAzimuth): self.startAzimuth = startAzimuth
    def getTiltRotation(self): return self.tiltRotation
    def setTiltRotation(self, tiltRotation): self.tiltRotation = tiltRotation
    def export(self, outfile, level, name_='XSDataInputFIT2DCake'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputFIT2DCake'):
        XSDataInputFIT2D.exportAttributes(self, outfile, level, name_='XSDataInputFIT2DCake')
    def exportChildren(self, outfile, level, name_='XSDataInputFIT2DCake'):
        if self.angleOfTilt:
            self.angleOfTilt.export(outfile, level, name_='angleOfTilt')
        if self.endAzimuth:
            self.endAzimuth.export(outfile, level, name_='endAzimuth')
        if self.innerRadius:
            self.innerRadius.export(outfile, level, name_='innerRadius')
        if self.outerRadius:
            self.outerRadius.export(outfile, level, name_='outerRadius')
        if self.sampleToDetectorDistance:
        ...
        if self.tiltRotation:
            self.tiltRotation.export(outfile, level, name_='tiltRotation')
        XSDataInputFIT2D.exportChildren(self, outfile, level, name_)

    #Only to export the entire XML tree to a file stream on disk
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataInputFIT2DCake' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputFIT2DCake.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataInputFIT2DCake" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataInputFIT2DCake'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
        pass
        XSDataInputFIT2D.exportLiteralAttributes(self, outfile, level, name_)
    def exportLiteralChildren(self, outfile, level, name_):
        if self.angleOfTilt:
            showIndent(outfile, level)
            outfile.write('angleOfTilt=XSDataDouble(\n')
            self.angleOfTilt.exportLiteral(outfile, level, name_='angleOfTilt')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.endAzimuth:
            showIndent(outfile, level)
            outfile.write('endAzimuth=XSDataDouble(\n')
            self.endAzimuth.exportLiteral(outfile, level, name_='endAzimuth')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.innerRadius:
            showIndent(outfile, level)
            outfile.write('innerRadius=XSDataDouble(\n')
            self.innerRadius.exportLiteral(outfile, level, name_='innerRadius')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.outerRadius:
            showIndent(outfile, level)
            outfile.write('outerRadius=XSDataDouble(\n')
            self.outerRadius.exportLiteral(outfile, level, name_='outerRadius')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.sampleToDetectorDistance:
            showIndent(outfile, level)
            outfile.write('sampleToDetectorDistance=XSDataDouble(\n')
            self.sampleToDetectorDistance.exportLiteral(outfile, level, name_='sampleToDetectorDistance')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.startAzimuth:
            showIndent(outfile, level)
            outfile.write('startAzimuth=XSDataDouble(\n')
            self.startAzimuth.exportLiteral(outfile, level, name_='startAzimuth')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.tiltRotation:
            showIndent(outfile, level)
            outfile.write('tiltRotation=XSDataDouble(\n')
            self.tiltRotation.exportLiteral(outfile, level, name_='tiltRotation')
            showIndent(outfile, level)
            outfile.write('),\n')
        XSDataInputFIT2D.exportLiteralChildren(self, outfile, level, name_)
    def build(self, node_):
        attrs = node_.attributes
        self.buildAttributes(attrs)
        for child_ in node_.childNodes:
            ...
            self.buildChildren(child_, nodeName_)
    def buildAttributes(self, attrs):
        XSDataInputFIT2D.buildAttributes(self, attrs)
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            nodeName_ == 'endAzimuth':
            obj_ = XSDataDouble.factory()
            obj_.build(child_)
            self.setEndAzimuth(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
        ...
        XSDataInputFIT2D.buildChildren(self, child_, nodeName_)
# end class XSDataInputFIT2DCake


class XSDataResultFIT2DCake(XSDataResult):
    subclass = None
    def __init__(self, resultFile=None, status=None):
        XSDataResult.__init__(self, status)
        self.resultFile = resultFile
    def factory(*args_, **kwargs_):
        if XSDataResultFIT2DCake.subclass:
            return XSDataResultFIT2DCake.subclass(*args_, **kwargs_)
        else:
            return XSDataResultFIT2DCake(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getResultFile(self): return self.resultFile
    def setResultFile(self, resultFile): self.resultFile = resultFile
    def export(self, outfile, level, name_='XSDataResultFIT2DCake'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultFIT2DCake'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultFIT2DCake')
    def exportChildren(self, outfile, level, name_='XSDataResultFIT2DCake'):
        if self.resultFile:
            self.resultFile.export(outfile, level, name_='resultFile')
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataResultFIT2DCake' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultFIT2DCake.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataResultFIT2DCake" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataResultFIT2DCake'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.resultFile:
            showIndent(outfile, level)
            outfile.write('resultFile=XSDataFile(\n')
            self.resultFile.exportLiteral(outfile, level, name_='resultFile')
            showIndent(outfile, level)
            outfile.write('),\n')
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'resultFile':
            obj_ = XSDataFile.factory()
            obj_.build(child_)
            self.setResultFile(obj_)
        XSDataResult.buildChildren(self, child_, nodeName_)
# end class XSDataResultFIT2DCake
...
class SaxXSDataDoubleHandler(handler.ContentHandler):
    ...
    def startElement(self, name, attrs):
        ...
        elif name == 'beamCentreInPixelsX':
            obj = XSDataDouble.factory()
            stackObj = SaxStackElement('beamCentreInPixelsX', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'beamCentreInPixelsY':
            obj = XSDataDouble.factory()
            stackObj = SaxStackElement('beamCentreInPixelsY', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'bufferSizeX':
            obj = XSDataInteger.factory()
            stackObj = SaxStackElement('bufferSizeX', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'bufferSizeY':
            obj = XSDataInteger.factory()
            stackObj = SaxStackElement('bufferSizeY', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'darkCurrentImageFile':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('darkCurrentImageFile', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'flatFieldImageFile':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('flatFieldImageFile', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'inputFile':
            obj = XSDataFile.factory()
        ...
        elif name == 'spatialDistortionFile':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('spatialDistortionFile', obj)
            self.stack.append(stackObj)
            done = 1
        ...
        elif name == 'angleOfTilt':
            obj = XSDataDouble.factory()
            stackObj = SaxStackElement('angleOfTilt', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'endAzimuth':
            obj = XSDataDouble.factory()
            stackObj = SaxStackElement('endAzimuth', obj)
            self.stack.append(stackObj)
            done = 1
        ...
        elif name == 'outerRadius':
            obj = XSDataDouble.factory()
            stackObj = SaxStackElement('outerRadius', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'sampleToDetectorDistance':
            obj = XSDataDouble.factory()
            stackObj = SaxStackElement('sampleToDetectorDistance', obj)
            self.stack.append(stackObj)
            done = 1
        ...
        elif name == 'tiltRotation':
            obj = XSDataDouble.factory()
            stackObj = SaxStackElement('tiltRotation', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'resultFile':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('resultFile', obj)
            self.stack.append(stackObj)
            done = 1
        if not done:
    ...
    def endElement(self, name):
        ...
        if name == 'XSDataDouble':
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setBeamCentreInPixelsX(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'beamCentreInPixelsY':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setBeamCentreInPixelsY(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'bufferSizeX':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setBufferSizeX(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'bufferSizeY':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setBufferSizeY(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'darkCurrentImageFile':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setDarkCurrentImageFile(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'flatFieldImageFile':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setFlatFieldImageFile(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'inputFile':
            if len(self.stack) >= 2:
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setSpatialDistortionFile(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'wavelength':
            if len(self.stack) >= 2:
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setAngleOfTilt(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'endAzimuth':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setEndAzimuth(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'innerRadius':
            if len(self.stack) >= 2:
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setOuterRadius(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'sampleToDetectorDistance':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setSampleToDetectorDistance(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'startAzimuth':
            if len(self.stack) >= 2:
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setTiltRotation(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'resultFile':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setResultFile(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        if not done:
            self.reportError('"%s" element not allowed here.' % name)
