...
class EDTestCasePluginUnitFIT2DCakev1_1(EDTestCasePluginUnit):
    """
    """
    ...
    def __init__(self, _edStringTestName=None):
        """
        """
        EDTestCasePluginUnit.__init__(self, "EDPluginFIT2DCakev1_1")
...
if __name__ == '__main__':
    ...
    edTestCasePluginUnitFIT2DCakev1_1 = EDTestCasePluginUnitFIT2DCakev1_1("EDTestCasePluginUnitFIT2DCakev1_1")
    edTestCasePluginUnitFIT2DCakev1_1.execute()
