...
class EDTestCasePluginExecuteFIT2DCakev1_1(EDTestCasePluginExecute):
    """
    """
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteFIT2Dv1_1 = EDTestCasePluginExecuteFIT2Dv1_1("EDTestCasePluginExecuteFIT2Dv1_1")
