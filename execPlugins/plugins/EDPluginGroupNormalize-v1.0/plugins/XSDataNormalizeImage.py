...
#
# Generated Fri Dec 17 09:58:01 2010 by EDGenerateDS.py.
#
...
class XSDataInputNormalize(XSDataInput):
    subclass = None
    def __init__(self, data=None, dark=None, flat=None, outputFile=None, configuration=None):
    ...
    def factory(*args_, **kwargs_):
        if XSDataInputNormalize.subclass:
            return XSDataInputNormalize.subclass(*args_, **kwargs_)
        else:
            return XSDataInputNormalize(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getData(self): return self.data
    def setData(self, data): self.data = data
    def addData(self, value): self.data.append(value)
    def insertData(self, index, value): self.data[index] = value
    def getDark(self): return self.dark
    def setDark(self, dark): self.dark = dark
    def addDark(self, value): self.dark.append(value)
    def insertDark(self, index, value): self.dark[index] = value
    def getFlat(self): return self.flat
    def setFlat(self, flat): self.flat = flat
    def addFlat(self, value): self.flat.append(value)
    def insertFlat(self, index, value): self.flat[index] = value
    ...
    def export(self, outfile, level, name_='XSDataInputNormalize'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputNormalize'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputNormalize')
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputNormalize.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataInputNormalize'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for data in self.data:
            showIndent(outfile, level)
            outfile.write('XSDataImageExt(\n')
            data.exportLiteral(outfile, level, name_='data')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        ...
        for dark in self.dark:
            showIndent(outfile, level)
            outfile.write('XSDataImageExt(\n')
            dark.exportLiteral(outfile, level, name_='dark')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        ...
        for flat in self.flat:
            showIndent(outfile, level)
            outfile.write('XSDataImageExt(\n')
            flat.exportLiteral(outfile, level, name_='flat')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class XSDataResultNormalize(XSDataResult):
    subclass = None
    def __init__(self, normalizedFile=None, normalizedArray=None, status=None):
        XSDataResult.__init__(self, status)
        self.normalizedFile = normalizedFile
        self.normalizedArray = normalizedArray
    def factory(*args_, **kwargs_):
        if XSDataResultNormalize.subclass:
            return XSDataResultNormalize.subclass(*args_, **kwargs_)
        else:
            return XSDataResultNormalize(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getNormalizedFile(self): return self.normalizedFile
    def setNormalizedFile(self, normalizedFile): self.normalizedFile = normalizedFile
    def getNormalizedArray(self): return self.normalizedArray
    def setNormalizedArray(self, normalizedArray): self.normalizedArray = normalizedArray
    def export(self, outfile, level, name_='XSDataResultNormalize'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultNormalize'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultNormalize')
    def exportChildren(self, outfile, level, name_='XSDataResultNormalize'):
        if self.getNormalizedFile() != None :
            if self.normalizedFile:
                self.normalizedFile.export(outfile, level, name_='normalizedFile')
        if self.getNormalizedArray() != None :
            if self.normalizedArray:
                self.normalizedArray.export(outfile, level, name_='normalizedArray')
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultNormalize.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataResultNormalize'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.normalizedFile:
            showIndent(outfile, level)
            outfile.write('normalizedFile=XSDataImage(\n')
            self.normalizedFile.exportLiteral(outfile, level, name_='normalizedFile')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.normalizedArray:
            showIndent(outfile, level)
            outfile.write('normalizedArray=XSDataArray(\n')
            self.normalizedArray.exportLiteral(outfile, level, name_='normalizedArray')
            showIndent(outfile, level)
            outfile.write('),\n')
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'normalizedFile':
            obj_ = XSDataImage.factory()
            obj_.build(child_)
            self.setNormalizedFile(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'normalizedArray':
            obj_ = XSDataArray.factory()
            obj_.build(child_)
            self.setNormalizedArray(obj_)
...
class XSDataImageExt(XSDataImage):
    subclass = None
    def __init__(self, array=None, exposureTime=None, date=None, number=None, path=None):
        XSDataImage.__init__(self, date, number, path)
        self.array = array
        self.exposureTime = exposureTime
    def factory(*args_, **kwargs_):
        if XSDataImageExt.subclass:
            return XSDataImageExt.subclass(*args_, **kwargs_)
        else:
            return XSDataImageExt(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getArray(self): return self.array
    def setArray(self, array): self.array = array
    ...
    def export(self, outfile, level, name_='XSDataImageExt'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataImageExt'):
        XSDataImage.exportAttributes(self, outfile, level, name_='XSDataImageExt')
    def exportChildren(self, outfile, level, name_='XSDataImageExt'):
        if self.getArray() != None :
            if self.array:
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataImageExt.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataImageExt'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
        pass
        XSDataImage.exportLiteralAttributes(self, outfile, level, name_)
    def exportLiteralChildren(self, outfile, level, name_):
        if self.array:
            showIndent(outfile, level)
            outfile.write('array=XSDataArray(\n')
            self.array.exportLiteral(outfile, level, name_='array')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.exposureTime:
            showIndent(outfile, level)
            ...
            showIndent(outfile, level)
            outfile.write('),\n')
        XSDataImage.exportLiteralChildren(self, outfile, level, name_)
    def build(self, node_):
        attrs = node_.attributes
        self.buildAttributes(attrs)
        for child_ in node_.childNodes:
            ...
            self.buildChildren(child_, nodeName_)
    def buildAttributes(self, attrs):
        XSDataImage.buildAttributes(self, attrs)
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'array':
            obj_ = XSDataArray.factory()
...
class SaxXSDataDoubleHandler(handler.ContentHandler):
    ...
    def startElement(self, name, attrs):
        ...
        if name == 'XSDataDouble':
            ...
            obj = XSDataImageExt.factory()
            stackObj = SaxStackElement('dark', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'flat':
            obj = XSDataImageExt.factory()
            stackObj = SaxStackElement('flat', obj)
            self.stack.append(stackObj)
            done = 1
        ...
        elif name == 'normalizedFile':
            obj = XSDataImage.factory()
            stackObj = SaxStackElement('normalizedFile', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'normalizedArray':
            obj = XSDataArray.factory()
            stackObj = SaxStackElement('normalizedArray', obj)
            self.stack.append(stackObj)
            done = 1
        if not done:
    ...
    def endElement(self, name):
        ...
        if name == 'XSDataDouble':
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setArray(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'exposureTime':
            if len(self.stack) >= 2:
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.addDark(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'flat':
            if len(self.stack) >= 2:
                self.stack[-2].obj.addFlat(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'outputFile':
            if len(self.stack) >= 2:
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setNormalizedFile(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'normalizedArray':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setNormalizedArray(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        if not done:
            self.reportError('"%s" element not allowed here.' % name)
