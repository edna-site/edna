...
class EDTestCasePluginUnitExecNormalizeImagev1_0(EDTestCasePluginUnit):
    """
    Those are all units tests for the EDNA Exec plugin NormalizeImagev1_0
    """

    def __init__(self, _strTestName=None):
        """
        """
        EDTestCasePluginUnit.__init__(self, "EDPluginExecNormalizeImagev1_0")
...
if __name__ == '__main__':
    ...
    edTestCasePluginUnitExecNormalizeImagev1_0 = EDTestCasePluginUnitExecNormalizeImagev1_0("EDTestCasePluginUnitExecNormalizeImagev1_0")
    edTestCasePluginUnitExecNormalizeImagev1_0.execute()
