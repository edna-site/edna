...
class EDTestCasePluginUnitExecNormalizeImagev1_1(EDTestCasePluginUnit):
    """
    Those are all units tests for the EDNA Exec plugin NormalizeImagev1_1
    """

    def __init__(self, _strTestName=None):
        """
        """
        EDTestCasePluginUnit.__init__(self, "EDPluginExecNormalizeImagev1_1")
...
if __name__ == '__main__':
    ...
    edTestCasePluginUnitExecNormalizeImagev1_1 = EDTestCasePluginUnitExecNormalizeImagev1_1("EDTestCasePluginUnitExecNormalizeImagev1_1")
    edTestCasePluginUnitExecNormalizeImagev1_1.execute()
