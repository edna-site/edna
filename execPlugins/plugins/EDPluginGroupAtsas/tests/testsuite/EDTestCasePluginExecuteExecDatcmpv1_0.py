...
from XSDataAtsas                         import XSDataResultDatcmp


class EDTestCasePluginExecuteExecDatcmpv1_0(EDTestCasePluginExecute):
    """
    Those are all execution tests for the EDNA Exec plugin Datcmpv1_0
    """

    def __init__(self, _strTestName=None):
        """
        """
        EDTestCasePluginExecute.__init__(self, "EDPluginExecDatcmpv1_0")
...
if __name__ == '__main__':
    ...
    testDatcmpv1_0instance = EDTestCasePluginExecuteControlDatcmpv1_0("EDTestCasePluginExecuteExecDatcmpv1_0")
