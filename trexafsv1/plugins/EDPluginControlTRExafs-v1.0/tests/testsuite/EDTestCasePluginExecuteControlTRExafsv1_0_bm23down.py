...
class EDTestCasePluginExecuteControlTRExafsv1_0_bm23down(EDTestCasePluginExecuteControlTRExafsv1_0):
    """
    ...
    def __init__(self, _strTestName = None):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), \
                                           "XSDataInputTRExafs_bm23down.xml"))
    ...
    def preProcess(self):
        ...
        self.loadTestImage(["XSDataArrayEnergy_bm23down.xml", "XSDataArrayData_bm23down.xml"])
