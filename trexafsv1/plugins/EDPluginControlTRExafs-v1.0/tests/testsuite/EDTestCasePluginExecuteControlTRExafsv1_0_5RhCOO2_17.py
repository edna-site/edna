...
class EDTestCasePluginExecuteControlTRExafsv1_0_5RhCOO2_17(EDTestCasePluginExecuteControlTRExafsv1_0):
    """
    ...
    def __init__(self, _strTestName = None):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), \
                                           "XSDataInputTRExafs_5RhCOO2_17.xml"))
    ...
    def preProcess(self):
        ...
        self.loadTestImage(["XSDataArrayEnergy_5RhCOO2_17.xml", "XSDataArrayData_5RhCOO2_17.xml"])
