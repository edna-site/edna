...
class EDTestCasePluginExecuteControlTRExafsv1_0_2PdAl_21(EDTestCasePluginExecuteControlTRExafsv1_0):
    """
    ...
    def __init__(self, _strTestName = None):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), \
                                           "XSDataInputTRExafs_2PdAl_21.xml"))
    ...
    def preProcess(self):
        ...
        self.loadTestImage(["XSDataArrayEnergy_2PdAl_21.xml", "XSDataArrayData_2PdAl_21.xml"])
