...
class EDTestCasePluginExecuteExecReadDataBM23v1_0_up(EDTestCasePluginExecute):
    """
    ...
    def testExecute(self):
        ...
        xsDataArrayEnergy.exportToFile("XSDataArrayEnergy_bm23up.xml")
        xsDataArrayData = xsDataResult.dataArray
        xsDataArrayData.exportToFile("XSDataArrayData_bm23up.xml")
