...
class EDTestSuitePluginUnitCCP4v0(EDTestSuite):
...
if __name__ == '__main__':
    ...
    edTestSuitePluginUnitCCP4v0 = EDTestSuitePluginUnitCCP4v0("EDTestSuitePluginUnitCCP4v0")
    edTestSuitePluginUnitCCP4v0.execute()
