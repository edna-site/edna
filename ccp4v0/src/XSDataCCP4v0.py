...
#
# Generated Thu Jan 28 16:42:37 2010 by EDGenerateDS.py.
#
...
class XSDataUnitCell(XSData):
    ...
    def factory(*args_, **kwargs_):
        if XSDataUnitCell.subclass:
            return XSDataUnitCell.subclass(*args_, **kwargs_)
        else:
            return XSDataUnitCell(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def export(self, outfile, level, name_='XSDataUnitCell'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataUnitCell'):
        XSData.exportAttributes(self, outfile, level, name_='XSDataUnitCell')
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataUnitCell.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataUnitCell'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
...
class XSDataSpaceGroup(XSData):
    subclass = None
    def __init__(self, ITNumber=None, name=None, symmetryOperator=None):
        XSData.__init__(self)
        self.ITNumber = ITNumber
        self.name = name
        if symmetryOperator is None:
            self.symmetryOperator = []
        else:
            self.symmetryOperator = symmetryOperator
    def factory(*args_, **kwargs_):
    ...
    def getName(self): return self.name
    def setName(self, name): self.name = name
    def getSymmetryOperator(self): return self.symmetryOperator
    def setSymmetryOperator(self, symmetryOperator): self.symmetryOperator = symmetryOperator
    def addSymmetryOperator(self, value): self.symmetryOperator.append(value)
    def insertSymmetryOperator(self, index, value): self.symmetryOperator[index] = value
    ...
    def exportChildren(self, outfile, level, name_='XSDataSpaceGroup'):
        ...
        for symmetryOperator_ in self.getSymmetryOperator():
            symmetryOperator_.export(outfile, level, name_='symmetryOperator')
        XSData.exportChildren(self, outfile, level, name_)
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.name:
            ...
            outfile.write('),\n')
        showIndent(outfile, level)
        outfile.write('symmetryOperator=[\n')
        level += 1
        for symmetryOperator in self.symmetryOperator:
            showIndent(outfile, level)
            outfile.write('XSDataString(\n')
            symmetryOperator.exportLiteral(outfile, level, name_='symmetryOperator')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            nodeName_ == 'symmetryOperator':
            obj_ = XSDataString.factory()
            obj_.build(child_)
            self.symmetryOperator.append(obj_)
# end class XSDataSpaceGroup


class XSDataInputPDBSETUnitCell(XSDataInput):
    subclass = None
    def __init__(self, destinationPDBFile=None, inputPDBFile=None, unitCell=None, configuration=None):
        XSDataInput.__init__(self, configuration)
        self.destinationPDBFile = destinationPDBFile
        self.inputPDBFile = inputPDBFile
        self.unitCell = unitCell
    def factory(*args_, **kwargs_):
        if XSDataInputPDBSETUnitCell.subclass:
            return XSDataInputPDBSETUnitCell.subclass(*args_, **kwargs_)
        else:
            return XSDataInputPDBSETUnitCell(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getDestinationPDBFile(self): return self.destinationPDBFile
    def setDestinationPDBFile(self, destinationPDBFile): self.destinationPDBFile = destinationPDBFile
    ...
    def export(self, outfile, level, name_='XSDataInputPDBSETUnitCell'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputPDBSETUnitCell'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputPDBSETUnitCell')
    def exportChildren(self, outfile, level, name_='XSDataInputPDBSETUnitCell'):
        if self.getDestinationPDBFile() != None :
            if self.destinationPDBFile:
                self.destinationPDBFile.export(outfile, level, name_='destinationPDBFile')
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataInputPDBSETUnitCell' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputPDBSETUnitCell.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataInputPDBSETUnitCell" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataInputPDBSETUnitCell'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.destinationPDBFile:
            showIndent(outfile, level)
            outfile.write('destinationPDBFile=XSDataFile(\n')
            self.destinationPDBFile.exportLiteral(outfile, level, name_='destinationPDBFile')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.inputPDBFile:
            showIndent(outfile, level)
        ...
        if self.unitCell:
            showIndent(outfile, level)
            outfile.write('unitCell=XSDataUnitCell(\n')
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'destinationPDBFile':
            obj_ = XSDataFile.factory()
            obj_.build(child_)
            self.setDestinationPDBFile(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            ...
            nodeName_ == 'unitCell':
            obj_ = XSDataUnitCell.factory()
            obj_.build(child_)
            self.setUnitCell(obj_)
        XSDataInput.buildChildren(self, child_, nodeName_)
# end class XSDataInputPDBSETUnitCell


class XSDataInputMTZDUMPUnitCellSpaceGroup(XSDataInput):
    subclass = None
    def __init__(self, inputMTZFile=None, configuration=None):
        XSDataInput.__init__(self, configuration)
        self.inputMTZFile = inputMTZFile
    def factory(*args_, **kwargs_):
        if XSDataInputMTZDUMPUnitCellSpaceGroup.subclass:
            return XSDataInputMTZDUMPUnitCellSpaceGroup.subclass(*args_, **kwargs_)
        else:
            return XSDataInputMTZDUMPUnitCellSpaceGroup(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getInputMTZFile(self): return self.inputMTZFile
    def setInputMTZFile(self, inputMTZFile): self.inputMTZFile = inputMTZFile
    def export(self, outfile, level, name_='XSDataInputMTZDUMPUnitCellSpaceGroup'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputMTZDUMPUnitCellSpaceGroup'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputMTZDUMPUnitCellSpaceGroup')
    def exportChildren(self, outfile, level, name_='XSDataInputMTZDUMPUnitCellSpaceGroup'):
        if self.inputMTZFile:
            self.inputMTZFile.export(outfile, level, name_='inputMTZFile')
        XSDataInput.exportChildren(self, outfile, level, name_)
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataInputMTZDUMPUnitCellSpaceGroup' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputMTZDUMPUnitCellSpaceGroup.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataInputMTZDUMPUnitCellSpaceGroup" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataInputMTZDUMPUnitCellSpaceGroup'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.inputMTZFile:
            showIndent(outfile, level)
            outfile.write('inputMTZFile=XSDataFile(\n')
            self.inputMTZFile.exportLiteral(outfile, level, name_='inputMTZFile')
            showIndent(outfile, level)
            outfile.write('),\n')
        XSDataInput.exportLiteralChildren(self, outfile, level, name_)
    def build(self, node_):
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'inputMTZFile':
            obj_ = XSDataFile.factory()
            obj_.build(child_)
            self.setInputMTZFile(obj_)
        XSDataInput.buildChildren(self, child_, nodeName_)
# end class XSDataInputMTZDUMPUnitCellSpaceGroup


class XSDataResultMTZDUMPUnitCellSpaceGroup(XSDataResult):
    subclass = None
    def __init__(self, spaceGroup=None, unitCell=None, status=None):
        XSDataResult.__init__(self, status)
        self.spaceGroup = spaceGroup
        self.unitCell = unitCell
    def factory(*args_, **kwargs_):
        if XSDataResultMTZDUMPUnitCellSpaceGroup.subclass:
            return XSDataResultMTZDUMPUnitCellSpaceGroup.subclass(*args_, **kwargs_)
        else:
            return XSDataResultMTZDUMPUnitCellSpaceGroup(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getSpaceGroup(self): return self.spaceGroup
    def setSpaceGroup(self, spaceGroup): self.spaceGroup = spaceGroup
    def getUnitCell(self): return self.unitCell
    def setUnitCell(self, unitCell): self.unitCell = unitCell
    def export(self, outfile, level, name_='XSDataResultMTZDUMPUnitCellSpaceGroup'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultMTZDUMPUnitCellSpaceGroup'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultMTZDUMPUnitCellSpaceGroup')
    def exportChildren(self, outfile, level, name_='XSDataResultMTZDUMPUnitCellSpaceGroup'):
        if self.spaceGroup:
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataResultMTZDUMPUnitCellSpaceGroup' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultMTZDUMPUnitCellSpaceGroup.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataResultMTZDUMPUnitCellSpaceGroup" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataResultMTZDUMPUnitCellSpaceGroup'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
...
# end class XSDataResultMTZDUMPUnitCellSpaceGroup


class XSDataResultPDBSETUnitCell(XSDataResult):
    subclass = None
    def __init__(self, outputPDBFile=None, status=None):
        XSDataResult.__init__(self, status)
        self.outputPDBFile = outputPDBFile
    def factory(*args_, **kwargs_):
        if XSDataResultPDBSETUnitCell.subclass:
            return XSDataResultPDBSETUnitCell.subclass(*args_, **kwargs_)
        else:
            return XSDataResultPDBSETUnitCell(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def export(self, outfile, level, name_='XSDataResultPDBSETUnitCell'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultPDBSETUnitCell'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultPDBSETUnitCell')
    def exportChildren(self, outfile, level, name_='XSDataResultPDBSETUnitCell'):
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataResultPDBSETUnitCell' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultPDBSETUnitCell.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataResultPDBSETUnitCell" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataResultPDBSETUnitCell'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def buildChildren(self, child_, nodeName_):
        ...
        XSDataResult.buildChildren(self, child_, nodeName_)
# end class XSDataResultPDBSETUnitCell


class XSDataInputCopyUnitCellMTZtoPDB(XSDataInput):
    subclass = None
    def __init__(self, destinationPDBFile=None, inputMTZFile=None, inputPDBFile=None, configuration=None):
        XSDataInput.__init__(self, configuration)
        self.destinationPDBFile = destinationPDBFile
        self.inputMTZFile = inputMTZFile
        self.inputPDBFile = inputPDBFile
    def factory(*args_, **kwargs_):
        if XSDataInputCopyUnitCellMTZtoPDB.subclass:
            return XSDataInputCopyUnitCellMTZtoPDB.subclass(*args_, **kwargs_)
        else:
            return XSDataInputCopyUnitCellMTZtoPDB(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getDestinationPDBFile(self): return self.destinationPDBFile
    def setDestinationPDBFile(self, destinationPDBFile): self.destinationPDBFile = destinationPDBFile
    def getInputMTZFile(self): return self.inputMTZFile
    ...
    def getInputPDBFile(self): return self.inputPDBFile
    def setInputPDBFile(self, inputPDBFile): self.inputPDBFile = inputPDBFile
    def export(self, outfile, level, name_='XSDataInputCopyUnitCellMTZtoPDB'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputCopyUnitCellMTZtoPDB'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputCopyUnitCellMTZtoPDB')
    def exportChildren(self, outfile, level, name_='XSDataInputCopyUnitCellMTZtoPDB'):
        if self.getDestinationPDBFile() != None :
            if self.destinationPDBFile:
                self.destinationPDBFile.export(outfile, level, name_='destinationPDBFile')
        if self.inputMTZFile:
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataInputCopyUnitCellMTZtoPDB' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputCopyUnitCellMTZtoPDB.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataInputCopyUnitCellMTZtoPDB" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataInputCopyUnitCellMTZtoPDB'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            self.setInputPDBFile(obj_)
        XSDataInput.buildChildren(self, child_, nodeName_)
# end class XSDataInputCopyUnitCellMTZtoPDB


class XSDataResultCopyUnitCellMTZtoPDB(XSDataResult):
    subclass = None
    def __init__(self, outputPDBFile=None, status=None):
        XSDataResult.__init__(self, status)
        self.outputPDBFile = outputPDBFile
    def factory(*args_, **kwargs_):
        if XSDataResultCopyUnitCellMTZtoPDB.subclass:
            return XSDataResultCopyUnitCellMTZtoPDB.subclass(*args_, **kwargs_)
        else:
            return XSDataResultCopyUnitCellMTZtoPDB(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getOutputPDBFile(self): return self.outputPDBFile
    def setOutputPDBFile(self, outputPDBFile): self.outputPDBFile = outputPDBFile
    def export(self, outfile, level, name_='XSDataResultCopyUnitCellMTZtoPDB'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultCopyUnitCellMTZtoPDB'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultCopyUnitCellMTZtoPDB')
    def exportChildren(self, outfile, level, name_='XSDataResultCopyUnitCellMTZtoPDB'):
        if self.outputPDBFile:
            self.outputPDBFile.export(outfile, level, name_='outputPDBFile')
        XSDataResult.exportChildren(self, outfile, level, name_)
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataResultCopyUnitCellMTZtoPDB' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultCopyUnitCellMTZtoPDB.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataResultCopyUnitCellMTZtoPDB" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataResultCopyUnitCellMTZtoPDB'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            self.setOutputPDBFile(obj_)
        XSDataResult.buildChildren(self, child_, nodeName_)
# end class XSDataResultCopyUnitCellMTZtoPDB
...
class SaxXSDataDoubleHandler(handler.ContentHandler):
    ...
    def startElement(self, name, attrs):
        ...
        if name == 'XSDataDouble':
        ...
        elif name == 'symmetryOperator':
            obj = XSDataString.factory()
            stackObj = SaxStackElement('symmetryOperator', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'destinationPDBFile':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('destinationPDBFile', obj)
            self.stack.append(stackObj)
            done = 1
            ...
            obj = XSDataUnitCell.factory()
            stackObj = SaxStackElement('unitCell', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'inputMTZFile':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('inputMTZFile', obj)
            self.stack.append(stackObj)
            done = 1
    ...
    def endElement(self, name):
        ...
        if name == 'XSDataDouble':
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.addSymmetryOperator(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'destinationPDBFile':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setDestinationPDBFile(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'inputPDBFile':
            if len(self.stack) >= 2:
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setInputMTZFile(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'spaceGroup':
            if len(self.stack) >= 2:
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('from XSDataCCP4v0 import *\n\n')
