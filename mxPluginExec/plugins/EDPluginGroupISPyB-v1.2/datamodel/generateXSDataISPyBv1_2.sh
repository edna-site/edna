...
xsDataBaseName=XSDataISPyBv1_2
xsdHomeDir=${EDNA_HOME}/mxPluginExec/plugins/EDPluginGroupISPyB-v1.2/datamodel
pyHomeDir=${EDNA_HOME}/mxPluginExec/plugins/EDPluginGroupISPyB-v1.2/plugins
