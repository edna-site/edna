...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteDistlSignalStrengthThinClientv1_1 = EDTestCasePluginExecuteDistlSignalStrengthThinClientv1_1("EDTestCasePluginExecuteDistlSignalStrengthThinClientv1_1")
    edTestCasePluginExecuteDistlSignalStrengthThinClientv1_1.execute()
