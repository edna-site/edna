...
xsDataBaseName=XSDataISPyBv10
xsdHomeDir=${EDNA_HOME}/mxPluginExec/plugins/EDPluginGroupISPyB-v1.0/datamodel
pyHomeDir=${EDNA_HOME}/mxPluginExec/plugins/EDPluginGroupISPyB-v1.0/plugins
