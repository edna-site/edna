...
class EDTestCasePluginExecuteISPyBStoreAutoProcv1_3_failedProcessing(EDTestCasePluginExecute):
...
if __name__ == '__main__':
    edTestCasePluginExecuteISPyBStoreAutoProcv1_3_failedProcessing = EDTestCasePluginExecuteISPyBStoreAutoProcv1_3_failedProcessing("EDTestCasePluginExecuteISPyBStoreAutoProcv1_3_failedProcessing")
    edTestCasePluginExecuteISPyBStoreAutoProcv1_3_failedProcessing.execute()
