...
class EDTestCasePluginExecuteISPyBStoreScreeningv1_3(EDTestCasePluginExecute):

    def __init__(self, _edStringTestName=None):
        """
        Sets config file + input and output reference files. 
        """
        EDTestCasePluginExecute.__init__(self, "EDPluginISPyBStoreScreeningv1_3")
...
if __name__ == '__main__':
    edTestCasePluginExecuteISPyBStoreScreeningv1_3 = EDTestCasePluginExecuteISPyBStoreScreeningv1_3("EDTestCasePluginExecuteISPyBStoreScreeningv1_3")
    edTestCasePluginExecuteISPyBStoreScreeningv1_3.execute()
