...
from XSDataISPyBv1_3 import XSDataInputStoreScreening
from XSDataISPyBv1_3 import XSDataResultStoreScreening
...
class EDPluginISPyBStoreScreeningv1_3(EDPluginExec):
    ...
    def __init__(self):
        ...
        self.setXSDataInputClass(XSDataInputStoreScreening)
    ...
    def configure(self):
        ...
        if self.strToolsForAutoprocessingWebServiceWsdl is None:
            self.ERROR("EDPluginISPyBStoreScreeningv1_3.configure: No toolsForAutoprocessingWebServiceWsdl found in configuration!")
            self.setFailure()
    ...
    def storeAutoProcProgram(self, _clientToolsForAutoprocessingWebService, _xsDataAutoProcProgram):
        ...
        self.DEBUG("EDPluginISPyBStoreScreeningv1_3.storeAutoProcProgram")
