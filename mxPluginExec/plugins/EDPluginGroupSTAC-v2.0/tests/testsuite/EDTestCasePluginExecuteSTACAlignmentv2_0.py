...
class EDTestCasePluginExecuteSTACAlignmentv2_0(EDTestCasePluginExecute):
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteSTACAlignmentv2_0 = EDTestCasePluginExecuteSTACAlignmentv2_0("EDTestCasePluginExecuteSTACAlignmentv2_0")
    edTestCasePluginExecuteSTACAlignmentv2_0.execute()
