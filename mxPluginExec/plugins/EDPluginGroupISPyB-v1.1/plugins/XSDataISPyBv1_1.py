...
#
# Generated Tue Mar 30 12:11:29 2010 by EDGenerateDS.py.
#
...
class XSDataInputISPyB(XSDataInput):
    subclass = None
    def __init__(self, screening=None, screeningInput=None, screeningOutputContainer=None, screeningRank=None, screeningRankSet=None, image=None, configuration=None):
...
class XSDataISPyBScreeningOutputContainer(XSData):
    subclass = None
    def __init__(self, screeningOutput=None, screeningOutputLattice=None, screeningStrategy=None):
        XSData.__init__(self)
    ...
    def addScreeningStrategy(self, value): self.screeningStrategy.append(value)
    def insertScreeningStrategy(self, index, value): self.screeningStrategy[index] = value
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        level += 1
        for screeningStrategy in self.screeningStrategy:
            showIndent(outfile, level)
            outfile.write('XSDataISPyBScreeningStrategy(\n')
            screeningStrategy.exportLiteral(outfile, level, name_='screeningStrategy')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class XSDataResultISPyB(XSDataResult):
    subclass = None
    def __init__(self, dataCollectionId=None, screeningStatus=None, screeningInputStatus=None, screeningOutputStatus=None, screeningOutputLatticeStatus=None, screeningRankStatus=None, screeningRankSetStatus=None, screeningStrategyStatus=None, status=None):
...
class XSDataISPyBScreeningStrategy(XSData):
    subclass = None
    def __init__(self, screeningStrategyId=None, screeningOutputId=None, phiStart=None, phiEnd=None, rotation=None, exposureTime=None, resolution=None, completeness=None, multiplicity=None, anomalous=None, program=None, rankingResolution=None, transmission=None):
        XSData.__init__(self)
...
class XSDataISPyBScreeningOutputLattice(XSData):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.timeStamp:
            showIndent(outfile, level)
            outfile.write('timeStamp=XSDataDouble(\n')
...
class XSDataISPyBScreening(XSData):
    subclass = None
    def __init__(self, screeningId=None, dataCollectionId=None, timeStamp=None, programVersion=None):
        XSData.__init__(self)
        self.screeningId = screeningId
        self.dataCollectionId = dataCollectionId
        self.timeStamp = timeStamp
...
class SaxXSDataDoubleHandler(handler.ContentHandler):
    ...
    def endElement(self, name):
        ...
        if name == 'XSDataDouble':
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.addScreeningInput(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'screeningOutputContainer':
            if len(self.stack) >= 2:
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.addScreeningStrategy(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'screeningRankId':
            if len(self.stack) >= 2:
