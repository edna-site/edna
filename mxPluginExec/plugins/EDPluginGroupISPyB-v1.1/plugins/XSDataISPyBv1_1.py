...
#
# Generated Wed Feb 22 11:26::27 2012 by EDGenerateDS.
#
...
class XSDataISPyBScreening(XSData):
	def __init__(self, programVersion=None, timeStamp=None, dataCollectionId=None, screeningId=None):
		XSData.__init__(self, )
...
class XSDataISPyBScreeningInput(XSData):
	def __init__(self, minimumSignalToNoise=None, maximumFractionRejected=None, minimumFractionIndexed=None, rmsErrorLimits=None, beamY=None, beamX=None, screeningId=None, screeningInputId=None):
		...
		self.__screeningId = screeningId
		checkType("XSDataISPyBScreeningInput", "Constructor of XSDataISPyBScreeningInput", beamX, "XSDataDouble")
		self.__beamX = beamX
		checkType("XSDataISPyBScreeningInput", "Constructor of XSDataISPyBScreeningInput", beamY, "XSDataDouble")
		self.__beamY = beamY
	...
	def setBeamX(self, beamX):
		checkType("XSDataISPyBScreeningInput", "setBeamX", beamX, "XSDataDouble")
		self.__beamX = beamX
	...
	def setBeamY(self, beamY):
		checkType("XSDataISPyBScreeningInput", "setBeamY", beamY, "XSDataDouble")
		self.__beamY = beamY
	...
	def exportChildren(self, outfile, level, name_='XSDataISPyBScreeningInput'):
		...
		if self.__beamX is not None:
			...
			warnEmptyAttribute("beamX", "XSDataDouble")
		if self.__beamY is not None:
			self.beamY.export(outfile, level, name_='beamY')
		else:
			warnEmptyAttribute("beamY", "XSDataDouble")
...
class XSDataISPyBScreeningOutputLattice(XSData):
	def __init__(self, timeStamp=None, unitCell_gamma=None, unitCell_beta=None, unitCell_alpha=None, unitCell_c=None, unitCell_b=None, unitCell_a=None, rawOrientationMatrix_c_z=None, rawOrientationMatrix_c_y=None, rawOrientationMatrix_c_x=None, rawOrientationMatrix_b_z=None, rawOrientationMatrix_b_y=None, rawOrientationMatrix_b_x=None, rawOrientationMatrix_a_z=None, rawOrientationMatrix_a_y=None, rawOrientationMatrix_a_x=None, bravaisLattice=None, pointGroup=None, spaceGroup=None, screeningOutputId=None, screeningOutputLatticeId=None):
		...
		checkType("XSDataISPyBScreeningOutputLattice", "Constructor of XSDataISPyBScreeningOutputLattice", timeStamp, "XSDataDouble")
		self.__timeStamp = timeStamp
	...
	def getTimeStamp(self): return self.__timeStamp
	def setTimeStamp(self, timeStamp):
		checkType("XSDataISPyBScreeningOutputLattice", "setTimeStamp", timeStamp, "XSDataDouble")
		self.__timeStamp = timeStamp
	def delTimeStamp(self): self.__timeStamp = None
	# Properties
	timeStamp = property(getTimeStamp, setTimeStamp, delTimeStamp, "Property for timeStamp")
	...
	def exportChildren(self, outfile, level, name_='XSDataISPyBScreeningOutputLattice'):
		...
		if self.__timeStamp is not None:
			...
			warnEmptyAttribute("timeStamp", "XSDataDouble")
	def build(self, node_):
		for child_ in node_.childNodes:
			nodeName_ = child_.nodeName.split(':')[-1]
			self.buildChildren(child_, nodeName_)
...
class XSDataISPyBScreeningOutputContainer(XSData):
	def __init__(self, screeningStrategy=None, screeningOutputLattice=None, screeningOutput=None):
		XSData.__init__(self, )
		...
		if screeningStrategy is None:
			self.__screeningStrategy = []
		else:
			checkType("XSDataISPyBScreeningOutputContainer", "Constructor of XSDataISPyBScreeningOutputContainer", screeningStrategy, "list")
	...
	def setScreeningStrategy(self, screeningStrategy):
		checkType("XSDataISPyBScreeningOutputContainer", "setScreeningStrategy", screeningStrategy, "list")
		self.__screeningStrategy = screeningStrategy
	...
	def addScreeningStrategy(self, value):
		checkType("XSDataISPyBScreeningOutputContainer", "setScreeningStrategy", value, "XSDataISPyBScreeningStrategy")
		self.__screeningStrategy.append(value)
	def insertScreeningStrategy(self, index, value):
		checkType("XSDataISPyBScreeningOutputContainer", "setScreeningStrategy", value, "XSDataISPyBScreeningStrategy")
		self.__screeningStrategy[index] = value
	...
	def exportChildren(self, outfile, level, name_='XSDataISPyBScreeningOutputContainer'):
		...
		for screeningStrategy_ in self.getScreeningStrategy():
			screeningStrategy_.export(outfile, level, name_='screeningStrategy')
	def build(self, node_):
		for child_ in node_.childNodes:
			nodeName_ = child_.nodeName.split(':')[-1]
			self.buildChildren(child_, nodeName_)
	def buildChildren(self, child_, nodeName_):
		if child_.nodeType == Node.ELEMENT_NODE and \
			...
			obj_.build(child_)
			self.screeningStrategy.append(obj_)
		XSData.buildChildren(self, child_, nodeName_)
	#Method for marshalling an object
	def marshal( self ):
		oStreamString = StringIO()
...
class XSDataResultStatus(XSData):
	def __init__(self, message=None, code=None, id=None):
		XSData.__init__(self, )
...
class XSDatadbstatus(XSData):
	def __init__(self, message=None, code=None, dataCollectionId=None, screeningRankSetId=None, screeningRankId=None, screeningStrategyId=None, screeningOutputLatticeId=None, screeningOutputId=None, screeningInputId=None, screeningId=None):
		XSData.__init__(self, )
...
class XSDataInputISPyB(XSDataInput):
	def __init__(self, configuration=None, image=None, screeningRankSet=None, screeningRank=None, screeningOutputContainer=None, screeningInput=None, screening=None):
		...
		if screeningInput is None:
			...
			checkType("XSDataInputISPyB", "Constructor of XSDataInputISPyB", screeningInput, "list")
			self.__screeningInput = screeningInput
		if screeningOutputContainer is None:
			self.__screeningOutputContainer = []
		else:
			checkType("XSDataInputISPyB", "Constructor of XSDataInputISPyB", screeningOutputContainer, "list")
			self.__screeningOutputContainer = screeningOutputContainer
		if screeningRank is None:
			self.__screeningRank = []
		else:
			checkType("XSDataInputISPyB", "Constructor of XSDataInputISPyB", screeningRank, "list")
	...
	def getScreeningInput(self): return self.__screeningInput
	def setScreeningInput(self, screeningInput):
		checkType("XSDataInputISPyB", "setScreeningInput", screeningInput, "list")
		self.__screeningInput = screeningInput
	def delScreeningInput(self): self.__screeningInput = None
	# Properties
	screeningInput = property(getScreeningInput, setScreeningInput, delScreeningInput, "Property for screeningInput")
	def addScreeningInput(self, value):
		checkType("XSDataInputISPyB", "setScreeningInput", value, "XSDataISPyBScreeningInput")
	...
	def setScreeningOutputContainer(self, screeningOutputContainer):
		checkType("XSDataInputISPyB", "setScreeningOutputContainer", screeningOutputContainer, "list")
		self.__screeningOutputContainer = screeningOutputContainer
	...
	def addScreeningOutputContainer(self, value):
		checkType("XSDataInputISPyB", "setScreeningOutputContainer", value, "XSDataISPyBScreeningOutputContainer")
	...
	def setScreeningRank(self, screeningRank):
		checkType("XSDataInputISPyB", "setScreeningRank", screeningRank, "list")
		self.__screeningRank = screeningRank
	...
	def addScreeningRank(self, value):
		checkType("XSDataInputISPyB", "setScreeningRank", value, "XSDataISPyBScreeningRank")
...
class XSDataResultISPyB(XSDataResult):
	def __init__(self, status=None, screeningStrategyStatus=None, screeningRankSetStatus=None, screeningRankStatus=None, screeningOutputLatticeStatus=None, screeningOutputStatus=None, screeningInputStatus=None, screeningStatus=None, dataCollectionId=None):
