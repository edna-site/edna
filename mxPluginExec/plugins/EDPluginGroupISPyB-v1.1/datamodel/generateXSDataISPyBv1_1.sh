...
xsDataBaseName=XSDataISPyBv1_1
xsdHomeDir=${EDNA_HOME}/mxPluginExec/plugins/EDPluginGroupISPyB-v1.1/datamodel
pyHomeDir=${EDNA_HOME}/mxPluginExec/plugins/EDPluginGroupISPyB-v1.1/plugins
