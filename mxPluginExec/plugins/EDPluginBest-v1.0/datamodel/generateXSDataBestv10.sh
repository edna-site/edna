...
xsDataBaseName=XSDataBestv10
xsdHomeDir=${EDNA_HOME}/mxPluginExec/plugins/EDPluginBest-v1.0/datamodel
pyHomeDir=${EDNA_HOME}/mxPluginExec/plugins/EDPluginBest-v1.0/plugins
...
xsDataBaseName=XSDataDnaTablesBest
