...
#
# Generated Mon May 10 12:12:39 2010 by EDGenerateDS.py.
#
...
class XSDataXDSDetector(XSData):
    subclass = None
    def __init__(self, detector_name=None, image_format=None, nx=None, ny=None, qx=None, qy=None):
        XSData.__init__(self)
    ...
    def getImage_format(self): return self.image_format
    def setImage_format(self, image_format): self.image_format = image_format
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.image_format:
            showIndent(outfile, level)
            outfile.write('image_format=XSDataString(\n')
            self.image_format.exportLiteral(outfile, level, name_='image_format')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.nx:
            showIndent(outfile, level)
...
class XSDataInputXDSSpotSearch(XSDataInput):
    subclass = None
    def __init__(self, job=None, subWedge=None, detector=None, configuration=None):
    ...
    def factory(*args_, **kwargs_):
        if XSDataInputXDSSpotSearch.subclass:
            return XSDataInputXDSSpotSearch.subclass(*args_, **kwargs_)
        else:
            return XSDataInputXDSSpotSearch(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getJob(self): return self.job
    def setJob(self, job): self.job = job
    def addJob(self, value): self.job.append(value)
    def insertJob(self, index, value): self.job[index] = value
    ...
    def export(self, outfile, level, name_='XSDataInputXDSSpotSearch'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputXDSSpotSearch'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputXDSSpotSearch')
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputXDSSpotSearch.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataInputXDSSpotSearch'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for job in self.job:
            ...
            job.exportLiteral(outfile, level, name_='job')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        ...
        if self.subWedge:
            showIndent(outfile, level)
            outfile.write('subWedge=XSDataXDSSubWedge(\n')
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            nodeName_ == 'subWedge':
            obj_ = XSDataXDSSubWedge.factory()
            obj_.build(child_)
...
class XSDataXDSRange(XSData):
    ...
    def __init__(self, lower=None, upper=None):
        ...
        self.upper = upper
    def factory(*args_, **kwargs_):
        if XSDataXDSRange.subclass:
            return XSDataXDSRange.subclass(*args_, **kwargs_)
        else:
            return XSDataXDSRange(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def export(self, outfile, level, name_='XSDataXDSRange'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataXDSRange'):
        XSData.exportAttributes(self, outfile, level, name_='XSDataXDSRange')
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataXDSRange.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataXDSRange'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
...
class XSDataResultXDSSpotSearch(XSDataResult):
    subclass = None
    def __init__(self, spot=None, status=None):
        ...
        if spot is None:
            ...
            self.spot = spot
    def factory(*args_, **kwargs_):
        if XSDataResultXDSSpotSearch.subclass:
            return XSDataResultXDSSpotSearch.subclass(*args_, **kwargs_)
        else:
            return XSDataResultXDSSpotSearch(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getSpot(self): return self.spot
    def setSpot(self, spot): self.spot = spot
    def addSpot(self, value): self.spot.append(value)
    def insertSpot(self, index, value): self.spot[index] = value
    def export(self, outfile, level, name_='XSDataResultXDSSpotSearch'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultXDSSpotSearch'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultXDSSpotSearch')
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultXDSSpotSearch.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataResultXDSSpotSearch'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for spot in self.spot:
            showIndent(outfile, level)
            outfile.write('XSDataXDSSpot(\n')
            spot.exportLiteral(outfile, level, name_='spot')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class XSDataXDSSpot(XSData):
    subclass = None
    def __init__(self, centroidFrame=None, centroidX=None, centroidY=None, IoverSigma=None):
        XSData.__init__(self)
        self.centroidFrame = centroidFrame
        self.centroidX = centroidX
        self.centroidY = centroidY
        self.IoverSigma = IoverSigma
    def factory(*args_, **kwargs_):
        if XSDataXDSSpot.subclass:
            return XSDataXDSSpot.subclass(*args_, **kwargs_)
        else:
            return XSDataXDSSpot(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getCentroidFrame(self): return self.centroidFrame
    def setCentroidFrame(self, centroidFrame): self.centroidFrame = centroidFrame
    def getCentroidX(self): return self.centroidX
    def setCentroidX(self, centroidX): self.centroidX = centroidX
    def getCentroidY(self): return self.centroidY
    def setCentroidY(self, centroidY): self.centroidY = centroidY
    ...
    def export(self, outfile, level, name_='XSDataXDSSpot'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataXDSSpot'):
        XSData.exportAttributes(self, outfile, level, name_='XSDataXDSSpot')
    def exportChildren(self, outfile, level, name_='XSDataXDSSpot'):
        if self.centroidFrame:
    ...
    def exportLiteral(self, outfile, level, name_='XSDataXDSSpot'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.centroidFrame:
            showIndent(outfile, level)
            outfile.write('centroidFrame=XSDataDouble(\n')
            self.centroidFrame.exportLiteral(outfile, level, name_='centroidFrame')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.centroidX:
            showIndent(outfile, level)
            outfile.write('centroidX=XSDataDouble(\n')
            self.centroidX.exportLiteral(outfile, level, name_='centroidX')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.centroidY:
            showIndent(outfile, level)
            outfile.write('centroidY=XSDataDouble(\n')
            self.centroidY.exportLiteral(outfile, level, name_='centroidY')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.IoverSigma:
            showIndent(outfile, level)
...
class XSDataXDSSubWedge(XSData):
    subclass = None
    def __init__(self, background_range=None, data_range=None, name_template_of_data_frames=None, XSDataXDSRange=None):
        XSData.__init__(self)
        self.background_range = background_range
        self.data_range = data_range
        self.name_template_of_data_frames = name_template_of_data_frames
        self.XSDataXDSRange = XSDataXDSRange
    def factory(*args_, **kwargs_):
        if XSDataXDSSubWedge.subclass:
            return XSDataXDSSubWedge.subclass(*args_, **kwargs_)
        else:
            return XSDataXDSSubWedge(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def getXSDataXDSRange(self): return self.XSDataXDSRange
    def setXSDataXDSRange(self, XSDataXDSRange): self.XSDataXDSRange = XSDataXDSRange
    def export(self, outfile, level, name_='XSDataXDSSubWedge'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataXDSSubWedge'):
        XSData.exportAttributes(self, outfile, level, name_='XSDataXDSSubWedge')
    def exportChildren(self, outfile, level, name_='XSDataXDSSubWedge'):
        ...
        if self.XSDataXDSRange:
            self.XSDataXDSRange.export(outfile, level)
        XSData.exportChildren(self, outfile, level, name_)
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataXDSSubWedge.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataXDSSubWedge'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.background_range:
            showIndent(outfile, level)
            outfile.write('background_range=XSDataXDSRange(\n')
            self.background_range.exportLiteral(outfile, level, name_='background_range')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.data_range:
            showIndent(outfile, level)
            outfile.write('data_range=XSDataXDSRange(\n')
            self.data_range.exportLiteral(outfile, level, name_='data_range')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.name_template_of_data_frames:
            showIndent(outfile, level)
        ...
        if self.XSDataXDSRange:
            showIndent(outfile, level)
            outfile.write('XSDataXDSRange=XSDataXDSRange(\n')
            self.XSDataXDSRange.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        XSData.exportLiteralChildren(self, outfile, level, name_)
    def build(self, node_):
...
class SaxXSDataDoubleHandler(handler.ContentHandler):
    ...
    def startElement(self, name, attrs):
        ...
        if name == 'XSDataDouble':
            ...
            obj = XSDataString.factory()
            stackObj = SaxStackElement('image_format', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'nx':
            obj = XSDataInteger.factory()
            ...
            obj = XSDataString.factory()
            stackObj = SaxStackElement('job', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'subWedge':
            obj = XSDataXDSSubWedge.factory()
            ...
            obj = XSDataXDSSpot.factory()
            stackObj = SaxStackElement('spot', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'centroidFrame':
            obj = XSDataDouble.factory()
            stackObj = SaxStackElement('centroidFrame', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'centroidX':
            obj = XSDataDouble.factory()
            stackObj = SaxStackElement('centroidX', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'centroidY':
            obj = XSDataDouble.factory()
            stackObj = SaxStackElement('centroidY', obj)
            self.stack.append(stackObj)
            done = 1
        ...
        elif name == 'XSDataXDSRange':
            obj = XSDataXDSRange.factory()
            stackObj = SaxStackElement('XSDataXDSRange', obj)
            self.stack.append(stackObj)
            done = 1
        if not done:
    ...
    def endElement(self, name):
        ...
        if name == 'XSDataDouble':
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setImage_format(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'nx':
            if len(self.stack) >= 2:
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.addJob(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'subWedge':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setSubWedge(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'detector':
            if len(self.stack) >= 2:
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.addSpot(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'centroidFrame':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setCentroidFrame(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'centroidX':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setCentroidX(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'centroidY':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setCentroidY(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'IoverSigma':
            if len(self.stack) >= 2:
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setBackground_range(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'data_range':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setData_range(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'name_template_of_data_frames':
            if len(self.stack) >= 2:
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setXSDataXDSRange(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        if not done:
            self.reportError('"%s" element not allowed here.' % name)
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('from XSDataXDSv1_1 import *\n\n')
