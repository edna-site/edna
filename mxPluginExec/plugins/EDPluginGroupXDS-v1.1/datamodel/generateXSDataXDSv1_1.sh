...
xsDataBaseName=XSDataXDSv1_1
xsdHomeDir=${EDNA_HOME}/mxPluginExec/plugins/EDPluginGroupXDS-v1.1/datamodel
pyHomeDir=${EDNA_HOME}/mxPluginExec/plugins/EDPluginGroupXDS-v1.1/plugins
