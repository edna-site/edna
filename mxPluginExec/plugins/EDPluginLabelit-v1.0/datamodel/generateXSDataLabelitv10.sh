...
xsDataBaseName=XSDataLabelitv10
xsdHomeDir=${EDNA_HOME}/mxPluginExec/plugins/EDPluginLabelit-v1.0/datamodel
pyHomeDir=${EDNA_HOME}/mxPluginExec/plugins/EDPluginLabelit-v1.0/plugins
