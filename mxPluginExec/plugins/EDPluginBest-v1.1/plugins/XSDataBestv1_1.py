...
class XSDataBestResolutionBin:
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.chi2:
            showIndent(outfile, level)
            outfile.write('chi2=XSDataDouble(\n')
        ...
        if self.IOverSigmaChi:
            showIndent(outfile, level)
            outfile.write('IOverSigmaChi=XSDataDouble(\n')
...
class XSDataBestStrategySummary:
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.attenuation:
            showIndent(outfile, level)
            outfile.write('attenuation=XSDataDouble(\n')
        ...
        if self.iSigma:
            showIndent(outfile, level)
            outfile.write('iSigma=XSDataDouble(\n')
...
class XSDataInputBest(XSDataInput):
    subclass = None
    def __init__(self, aimedCompleteness=None, aimedIOverSigma=None, aimedRedundancy=None, aimedResolution=None, anomalousData=None, beamExposureTime=None, beamMaxExposureTime=None, beamMinExposureTime=None, bestFileContentDat=None, bestFileContentHKL=None, bestFileContentPar=None, complexity=None, crystalAbsorbedDoseRate=None, crystalShape=None, crystalSusceptibility=None, detectorType=None, goniostatMaxRotationSpeed=None, goniostatMinRotationWidth=None, transmission=None, configuration=None):
    ...
    def factory(*args_, **kwargs_):
        if XSDataInputBest.subclass:
            return XSDataInputBest.subclass(*args_, **kwargs_)
        else:
            return XSDataInputBest(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def export(self, outfile, level, name_='XSDataInputBest'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputBest'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputBest')
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputBest.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataInputBest'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.aimedIOverSigma:
            showIndent(outfile, level)
            outfile.write('aimedIOverSigma=XSDataDouble(\n')
            self.aimedIOverSigma.exportLiteral(outfile, level, name_='aimedIOverSigma')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.aimedRedundancy:
            showIndent(outfile, level)
            outfile.write('aimedRedundancy=XSDataDouble(\n')
        ...
        if self.crystalShape:
            showIndent(outfile, level)
            outfile.write('crystalShape=XSDataDouble(\n')
            self.crystalShape.exportLiteral(outfile, level, name_='crystalShape')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.crystalSusceptibility:
            showIndent(outfile, level)
            outfile.write('crystalSusceptibility=XSDataDouble(\n')
...
class XSDataBestCollectionRun:
    subclass = None
    def __init__(self, collectionRunNumber=None, distance=None, exposureTime=None, numberOfImages=None, overlaps=None, phiStart=None, phiWidth=None):
        self.collectionRunNumber = collectionRunNumber
    ...
    factory = staticmethod(factory)
    def getCollectionRunNumber(self): return self.collectionRunNumber
    def setCollectionRunNumber(self, collectionRunNumber): self.collectionRunNumber = collectionRunNumber
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.collectionRunNumber:
            showIndent(outfile, level)
            outfile.write('collectionRunNumber=XSDataInteger(\n')
            self.collectionRunNumber.exportLiteral(outfile, level, name_='collectionRunNumber')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.distance:
            showIndent(outfile, level)
...
class XSDataBestCollectionPlan:
    subclass = None
    def __init__(self, collectionPlanNumber=None, collectionRun=None, strategySummary=None, statisticalPrediction=None):
...
class XSDataResultBest(XSDataResult):
    ...
    def factory(*args_, **kwargs_):
        if XSDataResultBest.subclass:
            return XSDataResultBest.subclass(*args_, **kwargs_)
        else:
            return XSDataResultBest(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def export(self, outfile, level, name_='XSDataResultBest'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultBest'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultBest')
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultBest.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataResultBest'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
...
class SaxXSDataDoubleHandler(handler.ContentHandler):
    ...
    def startElement(self, name, attrs):
        ...
        elif name == 'collectionRunNumber':
            obj = XSDataInteger.factory()
            stackObj = SaxStackElement('collectionRunNumber', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'distance':
            obj = XSDataLength.factory()
    ...
    def endElement(self, name):
        ...
        if name == 'XSDataDouble':
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setCollectionRunNumber(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'distance':
            if len(self.stack) >= 2:
