...
xsDataBaseName=XSDataBestv1_1
xsdHomeDir=${EDNA_HOME}/mxPluginExec/plugins/EDPluginBest-v1.1/datamodel
pyHomeDir=${EDNA_HOME}/mxPluginExec/plugins/EDPluginBest-v1.1/plugins
...
xsDataBaseName=XSDataDnaTablesBestv1_1
