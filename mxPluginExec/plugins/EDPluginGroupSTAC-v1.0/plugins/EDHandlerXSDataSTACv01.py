...
import XSDataMXv1
EDFactoryPluginStatic.loadModule("XSDataSTACv01")
import XSDataSTACv01
...
class EDHandlerXSDataSTACv01:
    ...
    def removeOrientation(_possible_orientation, kappa, phi):
        ...
        result:
        newpossibleOrientations(XSDataSTACv01.kappa_alignment_response): the list of orientations filtered not to contain the orientation used
        '''
        tol = 0.1
