...
class EDTestSuitePluginUnitXDSv1_0(EDTestSuite):


    def process(self):
        self.addTestCaseFromName("EDTestCasePluginUnitXDSv1_0")
        #self.addTestCaseFromName("EDTestCasePluginUnitXDSIndexingv1_0")

if __name__ == '__main__':

    edTestSuitePluginUnitXDSv1_0 = EDTestSuitePluginUnitXDSv1_0("EDTestSuitePluginUnitXDSv1_0")
    edTestSuitePluginUnitXDSv1_0.execute()
