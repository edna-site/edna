...
class EDPluginISPyBStoreWorkflowMeshv1_4(EDPluginExec):
    """
    ...
    def configure(self):
        ...
        if self.strUserName is None:
            self.ERROR("EDPluginISPyBStoreWorkflowMeshv1_4.configure: No user name found in configuration!")
            self.setFailure()
        self.strPassWord = self.config.get("passWord")
        if self.strPassWord is None:
            self.ERROR("EDPluginISPyBStoreWorkflowMeshv1_4.configure: No pass word found in configuration!")
            self.setFailure()
        ...
        if self.strToolsForCollectionWebServiceWsdl is None:
            self.ERROR("EDPluginISPyBStoreWorkflowMeshv1_4.configure: No toolsForCollectionWebServiceWsdl found in configuration!")
            self.setFailure()
