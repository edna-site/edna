...
#
# Generated Tue Apr 22 12:44::04 2014 by EDGenerateDS.
#
...
class AutoProc(object):
    def __init__(self, refinedCell_gamma=None, refinedCell_beta=None, refinedCell_alpha=None, refinedCell_c=None, refinedCell_b=None, refinedCell_a=None, spaceGroup=None, autoProcId=None):
        ...
        if refinedCell_a is None:
            self._refinedCell_a = None
        else:
            self._refinedCell_a = float(refinedCell_a)
        if refinedCell_b is None:
            self._refinedCell_b = None
        else:
            self._refinedCell_b = float(refinedCell_b)
        if refinedCell_c is None:
            self._refinedCell_c = None
        else:
            self._refinedCell_c = float(refinedCell_c)
        if refinedCell_alpha is None:
            self._refinedCell_alpha = None
        else:
            self._refinedCell_alpha = float(refinedCell_alpha)
        if refinedCell_beta is None:
            self._refinedCell_beta = None
        else:
            self._refinedCell_beta = float(refinedCell_beta)
        if refinedCell_gamma is None:
            self._refinedCell_gamma = None
        else:
            self._refinedCell_gamma = float(refinedCell_gamma)
    ...
    def exportChildren(self, outfile, level, name_='AutoProc'):
        ...
        if self._refinedCell_a is not None:
            showIndent(outfile, level)
            outfile.write(unicode('<refinedCell_a>%e</refinedCell_a>\n' % self._refinedCell_a))
        else:
            warnEmptyAttribute("refinedCell_a", "float")
        if self._refinedCell_b is not None:
            showIndent(outfile, level)
            outfile.write(unicode('<refinedCell_b>%e</refinedCell_b>\n' % self._refinedCell_b))
        else:
            warnEmptyAttribute("refinedCell_b", "float")
        if self._refinedCell_c is not None:
            showIndent(outfile, level)
            outfile.write(unicode('<refinedCell_c>%e</refinedCell_c>\n' % self._refinedCell_c))
        else:
            warnEmptyAttribute("refinedCell_c", "float")
        if self._refinedCell_alpha is not None:
            showIndent(outfile, level)
            outfile.write(unicode('<refinedCell_alpha>%e</refinedCell_alpha>\n' % self._refinedCell_alpha))
        else:
            warnEmptyAttribute("refinedCell_alpha", "float")
        if self._refinedCell_beta is not None:
            showIndent(outfile, level)
            outfile.write(unicode('<refinedCell_beta>%e</refinedCell_beta>\n' % self._refinedCell_beta))
        else:
            warnEmptyAttribute("refinedCell_beta", "float")
        if self._refinedCell_gamma is not None:
            showIndent(outfile, level)
            outfile.write(unicode('<refinedCell_gamma>%e</refinedCell_gamma>\n' % self._refinedCell_gamma))
        else:
            warnEmptyAttribute("refinedCell_gamma", "float")
...
class XSDataISPyBDiffractionPlan(XSData):
    def __init__(self, xmlDocumentId=None, strategyOption=None, anomalousScatterer=None, screeningResolution=None, requiredResolution=None, requiredMultiplicity=None, requiredCompleteness=None, radiationSensitivityGamma=None, radiationSensitivityBeta=None, radiationSensitivity=None, preferredBeamSizeY=None, preferredBeamSizeX=None, oscillationRange=None, observedResolution=None, numberOfPositions=None, minimalResolution=None, minDimAccrossSpindleAxis=None, maximalResolution=None, maxDimAccrossSpindleAxis=None, kappaStrategyOption=None, forcedSpaceGroup=None, exposureTime=None, experimentKind=None, estimateRadiationDamage=None, diffractionPlanId=None, complexity=None, comments=None, anomalousData=None, aimedResolution=None, aimedMultiplicity=None, aimedIOverSigmaAtHighestResolution=None, aimedCompleteness=None):
        ...
        if kappaStrategyOption is None:
            ...
            raise BaseException(strMessage)
        if maxDimAccrossSpindleAxis is None:
            self._maxDimAccrossSpindleAxis = None
        elif maxDimAccrossSpindleAxis.__class__.__name__ == "XSDataDouble":
            self._maxDimAccrossSpindleAxis = maxDimAccrossSpindleAxis
        else:
            strMessage = "ERROR! XSDataISPyBDiffractionPlan constructor argument 'maxDimAccrossSpindleAxis' is not XSDataDouble but %s" % self._maxDimAccrossSpindleAxis.__class__.__name__
            raise BaseException(strMessage)
        if maximalResolution is None:
            ...
            raise BaseException(strMessage)
        if minDimAccrossSpindleAxis is None:
            self._minDimAccrossSpindleAxis = None
        elif minDimAccrossSpindleAxis.__class__.__name__ == "XSDataDouble":
            self._minDimAccrossSpindleAxis = minDimAccrossSpindleAxis
        else:
            strMessage = "ERROR! XSDataISPyBDiffractionPlan constructor argument 'minDimAccrossSpindleAxis' is not XSDataDouble but %s" % self._minDimAccrossSpindleAxis.__class__.__name__
            raise BaseException(strMessage)
        ...
        if radiationSensitivity is None:
            ...
            raise BaseException(strMessage)
        if radiationSensitivityBeta is None:
            self._radiationSensitivityBeta = None
        elif radiationSensitivityBeta.__class__.__name__ == "XSDataDouble":
            self._radiationSensitivityBeta = radiationSensitivityBeta
        else:
            strMessage = "ERROR! XSDataISPyBDiffractionPlan constructor argument 'radiationSensitivityBeta' is not XSDataDouble but %s" % self._radiationSensitivityBeta.__class__.__name__
            raise BaseException(strMessage)
        if radiationSensitivityGamma is None:
            self._radiationSensitivityGamma = None
        elif radiationSensitivityGamma.__class__.__name__ == "XSDataDouble":
            self._radiationSensitivityGamma = radiationSensitivityGamma
        else:
            strMessage = "ERROR! XSDataISPyBDiffractionPlan constructor argument 'radiationSensitivityGamma' is not XSDataDouble but %s" % self._radiationSensitivityGamma.__class__.__name__
            raise BaseException(strMessage)
    ...
    # Methods and properties for the 'maxDimAccrossSpindleAxis' attribute
    def getMaxDimAccrossSpindleAxis(self): return self._maxDimAccrossSpindleAxis
    def setMaxDimAccrossSpindleAxis(self, maxDimAccrossSpindleAxis):
        if maxDimAccrossSpindleAxis is None:
            self._maxDimAccrossSpindleAxis = None
        elif maxDimAccrossSpindleAxis.__class__.__name__ == "XSDataDouble":
            self._maxDimAccrossSpindleAxis = maxDimAccrossSpindleAxis
        else:
            strMessage = "ERROR! XSDataISPyBDiffractionPlan.setMaxDimAccrossSpindleAxis argument is not XSDataDouble but %s" % maxDimAccrossSpindleAxis.__class__.__name__
            raise BaseException(strMessage)
    def delMaxDimAccrossSpindleAxis(self): self._maxDimAccrossSpindleAxis = None
    maxDimAccrossSpindleAxis = property(getMaxDimAccrossSpindleAxis, setMaxDimAccrossSpindleAxis, delMaxDimAccrossSpindleAxis, "Property for maxDimAccrossSpindleAxis")
    ...
    # Methods and properties for the 'minDimAccrossSpindleAxis' attribute
    def getMinDimAccrossSpindleAxis(self): return self._minDimAccrossSpindleAxis
    def setMinDimAccrossSpindleAxis(self, minDimAccrossSpindleAxis):
        if minDimAccrossSpindleAxis is None:
            self._minDimAccrossSpindleAxis = None
        elif minDimAccrossSpindleAxis.__class__.__name__ == "XSDataDouble":
            self._minDimAccrossSpindleAxis = minDimAccrossSpindleAxis
        else:
            strMessage = "ERROR! XSDataISPyBDiffractionPlan.setMinDimAccrossSpindleAxis argument is not XSDataDouble but %s" % minDimAccrossSpindleAxis.__class__.__name__
            raise BaseException(strMessage)
    def delMinDimAccrossSpindleAxis(self): self._minDimAccrossSpindleAxis = None
    minDimAccrossSpindleAxis = property(getMinDimAccrossSpindleAxis, setMinDimAccrossSpindleAxis, delMinDimAccrossSpindleAxis, "Property for minDimAccrossSpindleAxis")
    ...
    # Methods and properties for the 'radiationSensitivityBeta' attribute
    def getRadiationSensitivityBeta(self): return self._radiationSensitivityBeta
    def setRadiationSensitivityBeta(self, radiationSensitivityBeta):
        if radiationSensitivityBeta is None:
            self._radiationSensitivityBeta = None
        elif radiationSensitivityBeta.__class__.__name__ == "XSDataDouble":
            self._radiationSensitivityBeta = radiationSensitivityBeta
        else:
            strMessage = "ERROR! XSDataISPyBDiffractionPlan.setRadiationSensitivityBeta argument is not XSDataDouble but %s" % radiationSensitivityBeta.__class__.__name__
            raise BaseException(strMessage)
    def delRadiationSensitivityBeta(self): self._radiationSensitivityBeta = None
    radiationSensitivityBeta = property(getRadiationSensitivityBeta, setRadiationSensitivityBeta, delRadiationSensitivityBeta, "Property for radiationSensitivityBeta")
    # Methods and properties for the 'radiationSensitivityGamma' attribute
    def getRadiationSensitivityGamma(self): return self._radiationSensitivityGamma
    def setRadiationSensitivityGamma(self, radiationSensitivityGamma):
        if radiationSensitivityGamma is None:
            self._radiationSensitivityGamma = None
        elif radiationSensitivityGamma.__class__.__name__ == "XSDataDouble":
            self._radiationSensitivityGamma = radiationSensitivityGamma
        else:
            strMessage = "ERROR! XSDataISPyBDiffractionPlan.setRadiationSensitivityGamma argument is not XSDataDouble but %s" % radiationSensitivityGamma.__class__.__name__
            raise BaseException(strMessage)
    def delRadiationSensitivityGamma(self): self._radiationSensitivityGamma = None
    radiationSensitivityGamma = property(getRadiationSensitivityGamma, setRadiationSensitivityGamma, delRadiationSensitivityGamma, "Property for radiationSensitivityGamma")
    ...
    def exportChildren(self, outfile, level, name_='XSDataISPyBDiffractionPlan'):
        ...
        if self._maxDimAccrossSpindleAxis is not None:
            self.maxDimAccrossSpindleAxis.export(outfile, level, name_='maxDimAccrossSpindleAxis')
        if self._maximalResolution is not None:
            self.maximalResolution.export(outfile, level, name_='maximalResolution')
        if self._minDimAccrossSpindleAxis is not None:
            self.minDimAccrossSpindleAxis.export(outfile, level, name_='minDimAccrossSpindleAxis')
        ...
        if self._radiationSensitivityBeta is not None:
            self.radiationSensitivityBeta.export(outfile, level, name_='radiationSensitivityBeta')
        if self._radiationSensitivityGamma is not None:
            self.radiationSensitivityGamma.export(outfile, level, name_='radiationSensitivityGamma')
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            nodeName_ == 'maxDimAccrossSpindleAxis':
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setMaxDimAccrossSpindleAxis(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            ...
            nodeName_ == 'minDimAccrossSpindleAxis':
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setMinDimAccrossSpindleAxis(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            ...
            nodeName_ == 'radiationSensitivityBeta':
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setRadiationSensitivityBeta(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'radiationSensitivityGamma':
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setRadiationSensitivityGamma(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
...
class XSDataISPyBImageCreation(XSData):
    def __init__(self, isCreated=None, imageId=None, fileName=None, fileLocation=None):
        XSData.__init__(self, )
        if fileLocation is None:
            self._fileLocation = None
        elif fileLocation.__class__.__name__ == "XSDataString":
            ...
            strMessage = "ERROR! XSDataISPyBImageCreation constructor argument 'fileLocation' is not XSDataString but %s" % self._fileLocation.__class__.__name__
            raise BaseException(strMessage)
        if fileName is None:
            self._fileName = None
        elif fileName.__class__.__name__ == "XSDataString":
            ...
            strMessage = "ERROR! XSDataISPyBImageCreation constructor argument 'fileName' is not XSDataString but %s" % self._fileName.__class__.__name__
            raise BaseException(strMessage)
        if imageId is None:
            self._imageId = None
        elif imageId.__class__.__name__ == "XSDataInteger":
            ...
            strMessage = "ERROR! XSDataISPyBImageCreation constructor argument 'imageId' is not XSDataInteger but %s" % self._imageId.__class__.__name__
            raise BaseException(strMessage)
        if isCreated is None:
            self._isCreated = None
        elif isCreated.__class__.__name__ == "XSDataBoolean":
            self._isCreated = isCreated
        else:
            strMessage = "ERROR! XSDataISPyBImageCreation constructor argument 'isCreated' is not XSDataBoolean but %s" % self._isCreated.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'fileLocation' attribute
    def getFileLocation(self): return self._fileLocation
    def setFileLocation(self, fileLocation):
        if fileLocation is None:
            ...
            strMessage = "ERROR! XSDataISPyBImageCreation.setFileLocation argument is not XSDataString but %s" % fileLocation.__class__.__name__
            raise BaseException(strMessage)
    def delFileLocation(self): self._fileLocation = None
    fileLocation = property(getFileLocation, setFileLocation, delFileLocation, "Property for fileLocation")
    # Methods and properties for the 'fileName' attribute
    ...
    def setFileName(self, fileName):
        if fileName is None:
            ...
            strMessage = "ERROR! XSDataISPyBImageCreation.setFileName argument is not XSDataString but %s" % fileName.__class__.__name__
            raise BaseException(strMessage)
    def delFileName(self): self._fileName = None
    fileName = property(getFileName, setFileName, delFileName, "Property for fileName")
    # Methods and properties for the 'imageId' attribute
    ...
    def setImageId(self, imageId):
        if imageId is None:
            ...
            strMessage = "ERROR! XSDataISPyBImageCreation.setImageId argument is not XSDataInteger but %s" % imageId.__class__.__name__
            raise BaseException(strMessage)
    def delImageId(self): self._imageId = None
    imageId = property(getImageId, setImageId, delImageId, "Property for imageId")
    # Methods and properties for the 'isCreated' attribute
    def getIsCreated(self): return self._isCreated
    def setIsCreated(self, isCreated):
        if isCreated is None:
            self._isCreated = None
        elif isCreated.__class__.__name__ == "XSDataBoolean":
            self._isCreated = isCreated
        else:
            strMessage = "ERROR! XSDataISPyBImageCreation.setIsCreated argument is not XSDataBoolean but %s" % isCreated.__class__.__name__
            raise BaseException(strMessage)
    def delIsCreated(self): self._isCreated = None
    isCreated = property(getIsCreated, setIsCreated, delIsCreated, "Property for isCreated")
    def export(self, outfile, level, name_='XSDataISPyBImageCreation'):
        showIndent(outfile, level)
        outfile.write(unicode('<%s>\n' % name_))
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write(unicode('</%s>\n' % name_))
    def exportChildren(self, outfile, level, name_='XSDataISPyBImageCreation'):
        XSData.exportChildren(self, outfile, level, name_)
        if self._fileLocation is not None:
            self.fileLocation.export(outfile, level, name_='fileLocation')
        else:
        ...
        if self._isCreated is not None:
            self.isCreated.export(outfile, level, name_='isCreated')
        else:
            warnEmptyAttribute("isCreated", "XSDataBoolean")
    def build(self, node_):
        for child_ in node_.childNodes:
            nodeName_ = child_.nodeName.split(':')[-1]
            self.buildChildren(child_, nodeName_)
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            obj_ = XSDataBoolean()
            obj_.build(child_)
            self.setIsCreated(obj_)
        XSData.buildChildren(self, child_, nodeName_)
    #Method for marshalling an object
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
        self.export( oStreamString, 0, name_="XSDataISPyBImageCreation" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML
    #Only to export the entire XML tree to a file stream on disk
    def exportToFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write(unicode('<?xml version=\"1.0\" ?>\n'))
        self.export( outfile, 0, name_='XSDataISPyBImageCreation' )
        outfile.close()
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataISPyBImageCreation is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
        return XSDataISPyBImageCreation.parseString(self.marshal())
    #Static method for parsing a string
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataISPyBImageCreation()
        rootObj.build(rootNode)
        # Check that all minOccurs are obeyed by marshalling the created object
        oStreamString = StringIO()
        rootObj.export( oStreamString, 0, name_="XSDataISPyBImageCreation" )
        oStreamString.close()
        return rootObj
    parseString = staticmethod( parseString )
    #Static method for parsing a file
...
class XSDataISPyBImageQualityIndicators(XSData):
    def __init__(self, background3D_score=None, totalIntegratedSignal=None, spotTotal=None, signalRangeMin=None, signalRangeMax=None, signalRangeAverage=None, saturationRangeMin=None, saturationRangeMax=None, saturationRangeAverage=None, pctSaturationTop50Peaks=None, method2Res=None, method1Res=None, maxUnitCell=None, inResolutionOvrlSpots=None, inResTotal=None, image=None, iceRings=None, goodBraggCandidates=None, binPopCutOffMethod2Res=None):
        ...
        if totalIntegratedSignal is None:
            ...
            raise BaseException(strMessage)
        if background3D_score is None:
            self._background3D_score = None
        elif background3D_score.__class__.__name__ == "XSDataDouble":
            self._background3D_score = background3D_score
        else:
            strMessage = "ERROR! XSDataISPyBImageQualityIndicators constructor argument 'background3D_score' is not XSDataDouble but %s" % self._background3D_score.__class__.__name__
            raise BaseException(strMessage)
    ...
    # Methods and properties for the 'background3D_score' attribute
    def getBackground3D_score(self): return self._background3D_score
    def setBackground3D_score(self, background3D_score):
        if background3D_score is None:
            self._background3D_score = None
        elif background3D_score.__class__.__name__ == "XSDataDouble":
            self._background3D_score = background3D_score
        else:
            strMessage = "ERROR! XSDataISPyBImageQualityIndicators.setBackground3D_score argument is not XSDataDouble but %s" % background3D_score.__class__.__name__
            raise BaseException(strMessage)
    def delBackground3D_score(self): self._background3D_score = None
    background3D_score = property(getBackground3D_score, setBackground3D_score, delBackground3D_score, "Property for background3D_score")
    ...
    def exportChildren(self, outfile, level, name_='XSDataISPyBImageQualityIndicators'):
        ...
        if self._background3D_score is not None:
            self.background3D_score.export(outfile, level, name_='background3D_score')
    def build(self, node_):
        for child_ in node_.childNodes:
            nodeName_ = child_.nodeName.split(':')[-1]
            self.buildChildren(child_, nodeName_)
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            nodeName_ == 'background3D_score':
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setBackground3D_score(obj_)
        XSData.buildChildren(self, child_, nodeName_)
    #Method for marshalling an object
    def marshal( self ):
        oStreamString = StringIO()
...
class XSDataISPyBWorkflow(XSData):
    def __init__(self, workflowType=None, workflowTitle=None, workflowId=None, status=None, resultFilePath=None, recordTimeStamp=None, logFilePath=None, comments=None):
        XSData.__init__(self, )
        if comments is None:
            self._comments = None
        elif comments.__class__.__name__ == "XSDataString":
            ...
            strMessage = "ERROR! XSDataISPyBWorkflow constructor argument 'comments' is not XSDataString but %s" % self._comments.__class__.__name__
            raise BaseException(strMessage)
        if logFilePath is None:
            self._logFilePath = None
        elif logFilePath.__class__.__name__ == "XSDataString":
            self._logFilePath = logFilePath
        else:
            strMessage = "ERROR! XSDataISPyBWorkflow constructor argument 'logFilePath' is not XSDataString but %s" % self._logFilePath.__class__.__name__
            raise BaseException(strMessage)
        if recordTimeStamp is None:
            self._recordTimeStamp = None
        elif recordTimeStamp.__class__.__name__ == "XSDataString":
            self._recordTimeStamp = recordTimeStamp
        else:
            strMessage = "ERROR! XSDataISPyBWorkflow constructor argument 'recordTimeStamp' is not XSDataString but %s" % self._recordTimeStamp.__class__.__name__
            raise BaseException(strMessage)
        if resultFilePath is None:
            self._resultFilePath = None
        elif resultFilePath.__class__.__name__ == "XSDataString":
            self._resultFilePath = resultFilePath
        else:
            strMessage = "ERROR! XSDataISPyBWorkflow constructor argument 'resultFilePath' is not XSDataString but %s" % self._resultFilePath.__class__.__name__
            raise BaseException(strMessage)
        if status is None:
            self._status = None
        elif status.__class__.__name__ == "XSDataString":
            self._status = status
        else:
            strMessage = "ERROR! XSDataISPyBWorkflow constructor argument 'status' is not XSDataString but %s" % self._status.__class__.__name__
            raise BaseException(strMessage)
        if workflowId is None:
            ...
            strMessage = "ERROR! XSDataISPyBWorkflow constructor argument 'workflowId' is not XSDataInteger but %s" % self._workflowId.__class__.__name__
            raise BaseException(strMessage)
        if workflowTitle is None:
            self._workflowTitle = None
        elif workflowTitle.__class__.__name__ == "XSDataString":
            self._workflowTitle = workflowTitle
        else:
            strMessage = "ERROR! XSDataISPyBWorkflow constructor argument 'workflowTitle' is not XSDataString but %s" % self._workflowTitle.__class__.__name__
            raise BaseException(strMessage)
        if workflowType is None:
            self._workflowType = None
        elif workflowType.__class__.__name__ == "XSDataString":
            self._workflowType = workflowType
        else:
            strMessage = "ERROR! XSDataISPyBWorkflow constructor argument 'workflowType' is not XSDataString but %s" % self._workflowType.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'comments' attribute
    def getComments(self): return self._comments
    def setComments(self, comments):
        if comments is None:
            ...
            strMessage = "ERROR! XSDataISPyBWorkflow.setComments argument is not XSDataString but %s" % comments.__class__.__name__
            raise BaseException(strMessage)
    def delComments(self): self._comments = None
    comments = property(getComments, setComments, delComments, "Property for comments")
    # Methods and properties for the 'logFilePath' attribute
    def getLogFilePath(self): return self._logFilePath
    def setLogFilePath(self, logFilePath):
        if logFilePath is None:
            ...
            strMessage = "ERROR! XSDataISPyBWorkflow.setLogFilePath argument is not XSDataString but %s" % logFilePath.__class__.__name__
            raise BaseException(strMessage)
    def delLogFilePath(self): self._logFilePath = None
    logFilePath = property(getLogFilePath, setLogFilePath, delLogFilePath, "Property for logFilePath")
    # Methods and properties for the 'recordTimeStamp' attribute
    def getRecordTimeStamp(self): return self._recordTimeStamp
    def setRecordTimeStamp(self, recordTimeStamp):
        if recordTimeStamp is None:
            ...
            strMessage = "ERROR! XSDataISPyBWorkflow.setRecordTimeStamp argument is not XSDataString but %s" % recordTimeStamp.__class__.__name__
            raise BaseException(strMessage)
    def delRecordTimeStamp(self): self._recordTimeStamp = None
    recordTimeStamp = property(getRecordTimeStamp, setRecordTimeStamp, delRecordTimeStamp, "Property for recordTimeStamp")
    # Methods and properties for the 'resultFilePath' attribute
    def getResultFilePath(self): return self._resultFilePath
    def setResultFilePath(self, resultFilePath):
        if resultFilePath is None:
            ...
            strMessage = "ERROR! XSDataISPyBWorkflow.setResultFilePath argument is not XSDataString but %s" % resultFilePath.__class__.__name__
            raise BaseException(strMessage)
    def delResultFilePath(self): self._resultFilePath = None
    resultFilePath = property(getResultFilePath, setResultFilePath, delResultFilePath, "Property for resultFilePath")
    # Methods and properties for the 'status' attribute
    def getStatus(self): return self._status
    def setStatus(self, status):
        if status is None:
            ...
            strMessage = "ERROR! XSDataISPyBWorkflow.setStatus argument is not XSDataString but %s" % status.__class__.__name__
            raise BaseException(strMessage)
    def delStatus(self): self._status = None
    status = property(getStatus, setStatus, delStatus, "Property for status")
    ...
    def setWorkflowId(self, workflowId):
        if workflowId is None:
            ...
            strMessage = "ERROR! XSDataISPyBWorkflow.setWorkflowId argument is not XSDataInteger but %s" % workflowId.__class__.__name__
            raise BaseException(strMessage)
    ...
    # Methods and properties for the 'workflowTitle' attribute
    def getWorkflowTitle(self): return self._workflowTitle
    def setWorkflowTitle(self, workflowTitle):
        if workflowTitle is None:
            self._workflowTitle = None
        elif workflowTitle.__class__.__name__ == "XSDataString":
            self._workflowTitle = workflowTitle
        else:
            strMessage = "ERROR! XSDataISPyBWorkflow.setWorkflowTitle argument is not XSDataString but %s" % workflowTitle.__class__.__name__
            raise BaseException(strMessage)
    def delWorkflowTitle(self): self._workflowTitle = None
    workflowTitle = property(getWorkflowTitle, setWorkflowTitle, delWorkflowTitle, "Property for workflowTitle")
    # Methods and properties for the 'workflowType' attribute
    def getWorkflowType(self): return self._workflowType
    def setWorkflowType(self, workflowType):
        if workflowType is None:
            self._workflowType = None
        elif workflowType.__class__.__name__ == "XSDataString":
            self._workflowType = workflowType
        else:
            strMessage = "ERROR! XSDataISPyBWorkflow.setWorkflowType argument is not XSDataString but %s" % workflowType.__class__.__name__
            raise BaseException(strMessage)
    def delWorkflowType(self): self._workflowType = None
    workflowType = property(getWorkflowType, setWorkflowType, delWorkflowType, "Property for workflowType")
    def export(self, outfile, level, name_='XSDataISPyBWorkflow'):
        showIndent(outfile, level)
        outfile.write(unicode('<%s>\n' % name_))
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write(unicode('</%s>\n' % name_))
    def exportChildren(self, outfile, level, name_='XSDataISPyBWorkflow'):
        XSData.exportChildren(self, outfile, level, name_)
        if self._comments is not None:
            self.comments.export(outfile, level, name_='comments')
        if self._logFilePath is not None:
            self.logFilePath.export(outfile, level, name_='logFilePath')
        if self._recordTimeStamp is not None:
            self.recordTimeStamp.export(outfile, level, name_='recordTimeStamp')
        if self._resultFilePath is not None:
            self.resultFilePath.export(outfile, level, name_='resultFilePath')
        if self._status is not None:
            self.status.export(outfile, level, name_='status')
        else:
            warnEmptyAttribute("status", "XSDataString")
        if self._workflowId is not None:
            self.workflowId.export(outfile, level, name_='workflowId')
        if self._workflowTitle is not None:
            self.workflowTitle.export(outfile, level, name_='workflowTitle')
        if self._workflowType is not None:
            self.workflowType.export(outfile, level, name_='workflowType')
    def build(self, node_):
        for child_ in node_.childNodes:
            nodeName_ = child_.nodeName.split(':')[-1]
            self.buildChildren(child_, nodeName_)
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            nodeName_ == 'logFilePath':
            obj_ = XSDataString()
            obj_.build(child_)
            self.setLogFilePath(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'recordTimeStamp':
            obj_ = XSDataString()
            obj_.build(child_)
            self.setRecordTimeStamp(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'resultFilePath':
            obj_ = XSDataString()
            obj_.build(child_)
            self.setResultFilePath(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'status':
            obj_ = XSDataString()
            obj_.build(child_)
            ...
            nodeName_ == 'workflowTitle':
            obj_ = XSDataString()
            obj_.build(child_)
            self.setWorkflowTitle(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'workflowType':
            obj_ = XSDataString()
            obj_.build(child_)
            self.setWorkflowType(obj_)
        XSData.buildChildren(self, child_, nodeName_)
    #Method for marshalling an object
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
        self.export( oStreamString, 0, name_="XSDataISPyBWorkflow" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML
    #Only to export the entire XML tree to a file stream on disk
    def exportToFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write(unicode('<?xml version=\"1.0\" ?>\n'))
        self.export( outfile, 0, name_='XSDataISPyBWorkflow' )
        outfile.close()
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataISPyBWorkflow is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
        return XSDataISPyBWorkflow.parseString(self.marshal())
    #Static method for parsing a string
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataISPyBWorkflow()
        rootObj.build(rootNode)
        # Check that all minOccurs are obeyed by marshalling the created object
        oStreamString = StringIO()
        rootObj.export( oStreamString, 0, name_="XSDataISPyBWorkflow" )
        oStreamString.close()
        return rootObj
    parseString = staticmethod( parseString )
    #Static method for parsing a file
...
class XSDataInputISPyBDataCollectionPosition(XSData):
    def __init__(self, endPosition=None, startPosition=None, fileName=None):
        XSData.__init__(self, )
        if fileName is None:
            self._fileName = None
        elif fileName.__class__.__name__ == "XSDataFile":
            ...
            strMessage = "ERROR! XSDataInputISPyBDataCollectionPosition constructor argument 'fileName' is not XSDataFile but %s" % self._fileName.__class__.__name__
            raise BaseException(strMessage)
        if startPosition is None:
            self._startPosition = None
        elif startPosition.__class__.__name__ == "XSDataISPyBSamplePosition":
            self._startPosition = startPosition
        else:
            strMessage = "ERROR! XSDataInputISPyBDataCollectionPosition constructor argument 'startPosition' is not XSDataISPyBSamplePosition but %s" % self._startPosition.__class__.__name__
            raise BaseException(strMessage)
        if endPosition is None:
            self._endPosition = None
        elif endPosition.__class__.__name__ == "XSDataISPyBSamplePosition":
            self._endPosition = endPosition
        else:
            strMessage = "ERROR! XSDataInputISPyBDataCollectionPosition constructor argument 'endPosition' is not XSDataISPyBSamplePosition but %s" % self._endPosition.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'fileName' attribute
    def getFileName(self): return self._fileName
    def setFileName(self, fileName):
        if fileName is None:
            ...
            strMessage = "ERROR! XSDataInputISPyBDataCollectionPosition.setFileName argument is not XSDataFile but %s" % fileName.__class__.__name__
            raise BaseException(strMessage)
    def delFileName(self): self._fileName = None
    fileName = property(getFileName, setFileName, delFileName, "Property for fileName")
    # Methods and properties for the 'startPosition' attribute
    def getStartPosition(self): return self._startPosition
    def setStartPosition(self, startPosition):
        if startPosition is None:
            ...
            strMessage = "ERROR! XSDataInputISPyBDataCollectionPosition.setStartPosition argument is not XSDataISPyBSamplePosition but %s" % startPosition.__class__.__name__
            raise BaseException(strMessage)
    def delStartPosition(self): self._startPosition = None
    startPosition = property(getStartPosition, setStartPosition, delStartPosition, "Property for startPosition")
    # Methods and properties for the 'endPosition' attribute
    def getEndPosition(self): return self._endPosition
    def setEndPosition(self, endPosition):
        if endPosition is None:
            ...
            strMessage = "ERROR! XSDataInputISPyBDataCollectionPosition.setEndPosition argument is not XSDataISPyBSamplePosition but %s" % endPosition.__class__.__name__
            raise BaseException(strMessage)
    def delEndPosition(self): self._endPosition = None
    endPosition = property(getEndPosition, setEndPosition, delEndPosition, "Property for endPosition")
    def export(self, outfile, level, name_='XSDataInputISPyBDataCollectionPosition'):
        showIndent(outfile, level)
        outfile.write(unicode('<%s>\n' % name_))
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write(unicode('</%s>\n' % name_))
    def exportChildren(self, outfile, level, name_='XSDataInputISPyBDataCollectionPosition'):
        XSData.exportChildren(self, outfile, level, name_)
        if self._fileName is not None:
            self.fileName.export(outfile, level, name_='fileName')
        else:
        ...
        if self._startPosition is not None:
            self.startPosition.export(outfile, level, name_='startPosition')
        else:
            warnEmptyAttribute("startPosition", "XSDataISPyBSamplePosition")
        if self._endPosition is not None:
            self.endPosition.export(outfile, level, name_='endPosition')
        else:
            warnEmptyAttribute("endPosition", "XSDataISPyBSamplePosition")
    def build(self, node_):
        for child_ in node_.childNodes:
            nodeName_ = child_.nodeName.split(':')[-1]
            self.buildChildren(child_, nodeName_)
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            nodeName_ == 'startPosition':
            obj_ = XSDataISPyBSamplePosition()
            obj_.build(child_)
            self.setStartPosition(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'endPosition':
            obj_ = XSDataISPyBSamplePosition()
            obj_.build(child_)
            self.setEndPosition(obj_)
        XSData.buildChildren(self, child_, nodeName_)
    #Method for marshalling an object
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
        self.export( oStreamString, 0, name_="XSDataInputISPyBDataCollectionPosition" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML
    #Only to export the entire XML tree to a file stream on disk
    def exportToFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write(unicode('<?xml version=\"1.0\" ?>\n'))
        self.export( outfile, 0, name_='XSDataInputISPyBDataCollectionPosition' )
        outfile.close()
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataInputISPyBDataCollectionPosition is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
        return XSDataInputISPyBDataCollectionPosition.parseString(self.marshal())
    #Static method for parsing a string
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputISPyBDataCollectionPosition()
        rootObj.build(rootNode)
        # Check that all minOccurs are obeyed by marshalling the created object
        oStreamString = StringIO()
        rootObj.export( oStreamString, 0, name_="XSDataInputISPyBDataCollectionPosition" )
        oStreamString.close()
        return rootObj
    parseString = staticmethod( parseString )
    #Static method for parsing a file
    def parseFile( _inFilePath ):
        ...
        return rootObj
    parseFile = staticmethod( parseFile )
# end class XSDataInputISPyBDataCollectionPosition


class XSDataInputGetSampleInformation(XSDataInput):
    def __init__(self, configuration=None, sampleId=None):
        XSDataInput.__init__(self, configuration)
        if sampleId is None:
            self._sampleId = None
        elif sampleId.__class__.__name__ == "XSDataInteger":
            self._sampleId = sampleId
        else:
            strMessage = "ERROR! XSDataInputGetSampleInformation constructor argument 'sampleId' is not XSDataInteger but %s" % self._sampleId.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'sampleId' attribute
    def getSampleId(self): return self._sampleId
    def setSampleId(self, sampleId):
        if sampleId is None:
            ...
            strMessage = "ERROR! XSDataInputGetSampleInformation.setSampleId argument is not XSDataInteger but %s" % sampleId.__class__.__name__
            raise BaseException(strMessage)
    def delSampleId(self): self._sampleId = None
    sampleId = property(getSampleId, setSampleId, delSampleId, "Property for sampleId")
    def export(self, outfile, level, name_='XSDataInputGetSampleInformation'):
        showIndent(outfile, level)
        outfile.write(unicode('<%s>\n' % name_))
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write(unicode('</%s>\n' % name_))
    def exportChildren(self, outfile, level, name_='XSDataInputGetSampleInformation'):
        XSDataInput.exportChildren(self, outfile, level, name_)
        if self._sampleId is not None:
            self.sampleId.export(outfile, level, name_='sampleId')
        else:
            warnEmptyAttribute("sampleId", "XSDataInteger")
    def build(self, node_):
        for child_ in node_.childNodes:
            nodeName_ = child_.nodeName.split(':')[-1]
            self.buildChildren(child_, nodeName_)
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            obj_ = XSDataInteger()
            obj_.build(child_)
            self.setSampleId(obj_)
        XSDataInput.buildChildren(self, child_, nodeName_)
    #Method for marshalling an object
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
        self.export( oStreamString, 0, name_="XSDataInputGetSampleInformation" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML
    #Only to export the entire XML tree to a file stream on disk
    def exportToFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write(unicode('<?xml version=\"1.0\" ?>\n'))
        self.export( outfile, 0, name_='XSDataInputGetSampleInformation' )
        outfile.close()
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataInputGetSampleInformation is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
        return XSDataInputGetSampleInformation.parseString(self.marshal())
    #Static method for parsing a string
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputGetSampleInformation()
        rootObj.build(rootNode)
        # Check that all minOccurs are obeyed by marshalling the created object
        oStreamString = StringIO()
        rootObj.export( oStreamString, 0, name_="XSDataInputGetSampleInformation" )
        oStreamString.close()
        return rootObj
    parseString = staticmethod( parseString )
    #Static method for parsing a file
    def parseFile( _inFilePath ):
        ...
        return rootObj
    parseFile = staticmethod( parseFile )
# end class XSDataInputGetSampleInformation


class XSDataInputISPyBGroupDataCollections(XSDataInput):
    def __init__(self, configuration=None, filePath=None, dataCollectionGroupId=None):
        XSDataInput.__init__(self, configuration)
        if dataCollectionGroupId is None:
            ...
            strMessage = "ERROR! XSDataInputISPyBGroupDataCollections constructor argument 'dataCollectionGroupId' is not XSDataInteger but %s" % self._dataCollectionGroupId.__class__.__name__
            raise BaseException(strMessage)
        if filePath is None:
            self._filePath = []
        elif filePath.__class__.__name__ == "list":
            self._filePath = filePath
        else:
            strMessage = "ERROR! XSDataInputISPyBGroupDataCollections constructor argument 'filePath' is not list but %s" % self._filePath.__class__.__name__
            raise BaseException(strMessage)
    ...
    def setDataCollectionGroupId(self, dataCollectionGroupId):
        if dataCollectionGroupId is None:
            ...
            strMessage = "ERROR! XSDataInputISPyBGroupDataCollections.setDataCollectionGroupId argument is not XSDataInteger but %s" % dataCollectionGroupId.__class__.__name__
            raise BaseException(strMessage)
    ...
    def setFilePath(self, filePath):
        if filePath is None:
            ...
            strMessage = "ERROR! XSDataInputISPyBGroupDataCollections.setFilePath argument is not list but %s" % filePath.__class__.__name__
            raise BaseException(strMessage)
    def delFilePath(self): self._filePath = None
    filePath = property(getFilePath, setFilePath, delFilePath, "Property for filePath")
    def addFilePath(self, value):
        if value is None:
            strMessage = "ERROR! XSDataInputISPyBGroupDataCollections.addFilePath argument is None"
            raise BaseException(strMessage)            
        elif value.__class__.__name__ == "XSDataString":
            self._filePath.append(value)
        else:
            strMessage = "ERROR! XSDataInputISPyBGroupDataCollections.addFilePath argument is not XSDataString but %s" % value.__class__.__name__
            raise BaseException(strMessage)
    def insertFilePath(self, index, value):
        if index is None:
            strMessage = "ERROR! XSDataInputISPyBGroupDataCollections.insertFilePath argument 'index' is None"
            raise BaseException(strMessage)            
        if value is None:
            strMessage = "ERROR! XSDataInputISPyBGroupDataCollections.insertFilePath argument 'value' is None"
            raise BaseException(strMessage)            
        elif value.__class__.__name__ == "XSDataString":
            self._filePath[index] = value
        else:
            strMessage = "ERROR! XSDataInputISPyBGroupDataCollections.addFilePath argument is not XSDataString but %s" % value.__class__.__name__
            raise BaseException(strMessage)
    ...
    def exportChildren(self, outfile, level, name_='XSDataInputISPyBGroupDataCollections'):
        ...
        for filePath_ in self.getFilePath():
            filePath_.export(outfile, level, name_='filePath')
        if self.getFilePath() == []:
            warnEmptyAttribute("filePath", "XSDataString")
    def build(self, node_):
        for child_ in node_.childNodes:
...
class XSDataInputISPyBSetBestWilsonPlotPath(XSDataInput):
    def __init__(self, configuration=None, bestWilsonPlotPath=None, dataCollectionId=None):
        XSDataInput.__init__(self, configuration)
        if dataCollectionId is None:
            self._dataCollectionId = None
        elif dataCollectionId.__class__.__name__ == "XSDataInteger":
            ...
            strMessage = "ERROR! XSDataInputISPyBSetBestWilsonPlotPath constructor argument 'dataCollectionId' is not XSDataInteger but %s" % self._dataCollectionId.__class__.__name__
            raise BaseException(strMessage)
        if bestWilsonPlotPath is None:
            self._bestWilsonPlotPath = None
        elif bestWilsonPlotPath.__class__.__name__ == "XSDataString":
            self._bestWilsonPlotPath = bestWilsonPlotPath
        else:
            strMessage = "ERROR! XSDataInputISPyBSetBestWilsonPlotPath constructor argument 'bestWilsonPlotPath' is not XSDataString but %s" % self._bestWilsonPlotPath.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'dataCollectionId' attribute
    def getDataCollectionId(self): return self._dataCollectionId
    def setDataCollectionId(self, dataCollectionId):
        if dataCollectionId is None:
            ...
            strMessage = "ERROR! XSDataInputISPyBSetBestWilsonPlotPath.setDataCollectionId argument is not XSDataInteger but %s" % dataCollectionId.__class__.__name__
            raise BaseException(strMessage)
    def delDataCollectionId(self): self._dataCollectionId = None
    dataCollectionId = property(getDataCollectionId, setDataCollectionId, delDataCollectionId, "Property for dataCollectionId")
    # Methods and properties for the 'bestWilsonPlotPath' attribute
    def getBestWilsonPlotPath(self): return self._bestWilsonPlotPath
    def setBestWilsonPlotPath(self, bestWilsonPlotPath):
        if bestWilsonPlotPath is None:
            self._bestWilsonPlotPath = None
        elif bestWilsonPlotPath.__class__.__name__ == "XSDataString":
            self._bestWilsonPlotPath = bestWilsonPlotPath
        else:
            strMessage = "ERROR! XSDataInputISPyBSetBestWilsonPlotPath.setBestWilsonPlotPath argument is not XSDataString but %s" % bestWilsonPlotPath.__class__.__name__
            raise BaseException(strMessage)
    def delBestWilsonPlotPath(self): self._bestWilsonPlotPath = None
    bestWilsonPlotPath = property(getBestWilsonPlotPath, setBestWilsonPlotPath, delBestWilsonPlotPath, "Property for bestWilsonPlotPath")
    def export(self, outfile, level, name_='XSDataInputISPyBSetBestWilsonPlotPath'):
        showIndent(outfile, level)
        outfile.write(unicode('<%s>\n' % name_))
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write(unicode('</%s>\n' % name_))
    def exportChildren(self, outfile, level, name_='XSDataInputISPyBSetBestWilsonPlotPath'):
        XSDataInput.exportChildren(self, outfile, level, name_)
        if self._dataCollectionId is not None:
            self.dataCollectionId.export(outfile, level, name_='dataCollectionId')
        else:
            warnEmptyAttribute("dataCollectionId", "XSDataInteger")
        if self._bestWilsonPlotPath is not None:
            self.bestWilsonPlotPath.export(outfile, level, name_='bestWilsonPlotPath')
        else:
            warnEmptyAttribute("bestWilsonPlotPath", "XSDataString")
    def build(self, node_):
        for child_ in node_.childNodes:
            nodeName_ = child_.nodeName.split(':')[-1]
            self.buildChildren(child_, nodeName_)
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            nodeName_ == 'bestWilsonPlotPath':
            obj_ = XSDataString()
            obj_.build(child_)
            self.setBestWilsonPlotPath(obj_)
        XSDataInput.buildChildren(self, child_, nodeName_)
    #Method for marshalling an object
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
        self.export( oStreamString, 0, name_="XSDataInputISPyBSetBestWilsonPlotPath" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML
    #Only to export the entire XML tree to a file stream on disk
    def exportToFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write(unicode('<?xml version=\"1.0\" ?>\n'))
        self.export( outfile, 0, name_='XSDataInputISPyBSetBestWilsonPlotPath' )
        outfile.close()
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataInputISPyBSetBestWilsonPlotPath is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
        return XSDataInputISPyBSetBestWilsonPlotPath.parseString(self.marshal())
    #Static method for parsing a string
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputISPyBSetBestWilsonPlotPath()
        rootObj.build(rootNode)
        # Check that all minOccurs are obeyed by marshalling the created object
        oStreamString = StringIO()
        rootObj.export( oStreamString, 0, name_="XSDataInputISPyBSetBestWilsonPlotPath" )
        oStreamString.close()
        return rootObj
    parseString = staticmethod( parseString )
    #Static method for parsing a file
    def parseFile( _inFilePath ):
        ...
        return rootObj
    parseFile = staticmethod( parseFile )
# end class XSDataInputISPyBSetBestWilsonPlotPath


class XSDataInputISPyBSetDataCollectionPosition(XSDataInput):
    def __init__(self, configuration=None, endPosition=None, startPosition=None, fileName=None):
        XSDataInput.__init__(self, configuration)
        if fileName is None:
            self._fileName = None
        elif fileName.__class__.__name__ == "XSDataFile":
            ...
            strMessage = "ERROR! XSDataInputISPyBSetDataCollectionPosition constructor argument 'fileName' is not XSDataFile but %s" % self._fileName.__class__.__name__
            raise BaseException(strMessage)
        if startPosition is None:
            self._startPosition = None
        elif startPosition.__class__.__name__ == "XSDataISPyBSamplePosition":
            ...
            strMessage = "ERROR! XSDataInputISPyBSetDataCollectionPosition constructor argument 'startPosition' is not XSDataISPyBSamplePosition but %s" % self._startPosition.__class__.__name__
            raise BaseException(strMessage)
        if endPosition is None:
            self._endPosition = None
        elif endPosition.__class__.__name__ == "XSDataISPyBSamplePosition":
            ...
            strMessage = "ERROR! XSDataInputISPyBSetDataCollectionPosition constructor argument 'endPosition' is not XSDataISPyBSamplePosition but %s" % self._endPosition.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'fileName' attribute
    def getFileName(self): return self._fileName
    def setFileName(self, fileName):
        if fileName is None:
            ...
            strMessage = "ERROR! XSDataInputISPyBSetDataCollectionPosition.setFileName argument is not XSDataFile but %s" % fileName.__class__.__name__
            raise BaseException(strMessage)
    def delFileName(self): self._fileName = None
    fileName = property(getFileName, setFileName, delFileName, "Property for fileName")
    # Methods and properties for the 'startPosition' attribute
    ...
    def setStartPosition(self, startPosition):
        if startPosition is None:
            ...
            strMessage = "ERROR! XSDataInputISPyBSetDataCollectionPosition.setStartPosition argument is not XSDataISPyBSamplePosition but %s" % startPosition.__class__.__name__
            raise BaseException(strMessage)
    def delStartPosition(self): self._startPosition = None
    startPosition = property(getStartPosition, setStartPosition, delStartPosition, "Property for startPosition")
    # Methods and properties for the 'endPosition' attribute
    ...
    def setEndPosition(self, endPosition):
        if endPosition is None:
            ...
            strMessage = "ERROR! XSDataInputISPyBSetDataCollectionPosition.setEndPosition argument is not XSDataISPyBSamplePosition but %s" % endPosition.__class__.__name__
            raise BaseException(strMessage)
    def delEndPosition(self): self._endPosition = None
    endPosition = property(getEndPosition, setEndPosition, delEndPosition, "Property for endPosition")
    def export(self, outfile, level, name_='XSDataInputISPyBSetDataCollectionPosition'):
        showIndent(outfile, level)
        outfile.write(unicode('<%s>\n' % name_))
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write(unicode('</%s>\n' % name_))
    def exportChildren(self, outfile, level, name_='XSDataInputISPyBSetDataCollectionPosition'):
        XSDataInput.exportChildren(self, outfile, level, name_)
        if self._fileName is not None:
            self.fileName.export(outfile, level, name_='fileName')
        else:
    ...
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
        self.export( oStreamString, 0, name_="XSDataInputISPyBSetDataCollectionPosition" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML
    #Only to export the entire XML tree to a file stream on disk
    def exportToFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write(unicode('<?xml version=\"1.0\" ?>\n'))
        self.export( outfile, 0, name_='XSDataInputISPyBSetDataCollectionPosition' )
        outfile.close()
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataInputISPyBSetDataCollectionPosition is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
        return XSDataInputISPyBSetDataCollectionPosition.parseString(self.marshal())
    #Static method for parsing a string
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputISPyBSetDataCollectionPosition()
        rootObj.build(rootNode)
        # Check that all minOccurs are obeyed by marshalling the created object
        oStreamString = StringIO()
        rootObj.export( oStreamString, 0, name_="XSDataInputISPyBSetDataCollectionPosition" )
        oStreamString.close()
        return rootObj
    parseString = staticmethod( parseString )
    #Static method for parsing a file
    def parseFile( _inFilePath ):
        ...
        return rootObj
    parseFile = staticmethod( parseFile )
# end class XSDataInputISPyBSetDataCollectionPosition


class XSDataInputISPyBSetDataCollectionsPositions(XSDataInput):
    def __init__(self, configuration=None, dataCollectionPosition=None):
        XSDataInput.__init__(self, configuration)
        if dataCollectionPosition is None:
            self._dataCollectionPosition = []
        elif dataCollectionPosition.__class__.__name__ == "list":
            self._dataCollectionPosition = dataCollectionPosition
        else:
            strMessage = "ERROR! XSDataInputISPyBSetDataCollectionsPositions constructor argument 'dataCollectionPosition' is not list but %s" % self._dataCollectionPosition.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'dataCollectionPosition' attribute
    def getDataCollectionPosition(self): return self._dataCollectionPosition
    def setDataCollectionPosition(self, dataCollectionPosition):
        if dataCollectionPosition is None:
            self._dataCollectionPosition = []
        elif dataCollectionPosition.__class__.__name__ == "list":
            self._dataCollectionPosition = dataCollectionPosition
        else:
            strMessage = "ERROR! XSDataInputISPyBSetDataCollectionsPositions.setDataCollectionPosition argument is not list but %s" % dataCollectionPosition.__class__.__name__
            raise BaseException(strMessage)
    def delDataCollectionPosition(self): self._dataCollectionPosition = None
    dataCollectionPosition = property(getDataCollectionPosition, setDataCollectionPosition, delDataCollectionPosition, "Property for dataCollectionPosition")
    def addDataCollectionPosition(self, value):
        if value is None:
            strMessage = "ERROR! XSDataInputISPyBSetDataCollectionsPositions.addDataCollectionPosition argument is None"
            raise BaseException(strMessage)            
        elif value.__class__.__name__ == "XSDataInputISPyBDataCollectionPosition":
            self._dataCollectionPosition.append(value)
        else:
            strMessage = "ERROR! XSDataInputISPyBSetDataCollectionsPositions.addDataCollectionPosition argument is not XSDataInputISPyBDataCollectionPosition but %s" % value.__class__.__name__
            raise BaseException(strMessage)
    def insertDataCollectionPosition(self, index, value):
        if index is None:
            strMessage = "ERROR! XSDataInputISPyBSetDataCollectionsPositions.insertDataCollectionPosition argument 'index' is None"
            raise BaseException(strMessage)            
        if value is None:
            strMessage = "ERROR! XSDataInputISPyBSetDataCollectionsPositions.insertDataCollectionPosition argument 'value' is None"
            raise BaseException(strMessage)            
        elif value.__class__.__name__ == "XSDataInputISPyBDataCollectionPosition":
            self._dataCollectionPosition[index] = value
        else:
            strMessage = "ERROR! XSDataInputISPyBSetDataCollectionsPositions.addDataCollectionPosition argument is not XSDataInputISPyBDataCollectionPosition but %s" % value.__class__.__name__
            raise BaseException(strMessage)
    def export(self, outfile, level, name_='XSDataInputISPyBSetDataCollectionsPositions'):
        showIndent(outfile, level)
        outfile.write(unicode('<%s>\n' % name_))
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write(unicode('</%s>\n' % name_))
    def exportChildren(self, outfile, level, name_='XSDataInputISPyBSetDataCollectionsPositions'):
        XSDataInput.exportChildren(self, outfile, level, name_)
        for dataCollectionPosition_ in self.getDataCollectionPosition():
            dataCollectionPosition_.export(outfile, level, name_='dataCollectionPosition')
        if self.getDataCollectionPosition() == []:
            warnEmptyAttribute("dataCollectionPosition", "XSDataInputISPyBDataCollectionPosition")
    def build(self, node_):
        for child_ in node_.childNodes:
            nodeName_ = child_.nodeName.split(':')[-1]
            self.buildChildren(child_, nodeName_)
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'dataCollectionPosition':
            obj_ = XSDataInputISPyBDataCollectionPosition()
            obj_.build(child_)
            self.dataCollectionPosition.append(obj_)
        XSDataInput.buildChildren(self, child_, nodeName_)
    #Method for marshalling an object
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
        self.export( oStreamString, 0, name_="XSDataInputISPyBSetDataCollectionsPositions" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML
    #Only to export the entire XML tree to a file stream on disk
    def exportToFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write(unicode('<?xml version=\"1.0\" ?>\n'))
        self.export( outfile, 0, name_='XSDataInputISPyBSetDataCollectionsPositions' )
        outfile.close()
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataInputISPyBSetDataCollectionsPositions is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
        return XSDataInputISPyBSetDataCollectionsPositions.parseString(self.marshal())
    #Static method for parsing a string
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputISPyBSetDataCollectionsPositions()
        rootObj.build(rootNode)
        # Check that all minOccurs are obeyed by marshalling the created object
        oStreamString = StringIO()
        rootObj.export( oStreamString, 0, name_="XSDataInputISPyBSetDataCollectionsPositions" )
        oStreamString.close()
        return rootObj
    parseString = staticmethod( parseString )
    #Static method for parsing a file
...
class XSDataInputISPyBSetImagesPositions(XSDataInput):
    def __init__(self, configuration=None, imagePosition=None):
        XSDataInput.__init__(self, configuration)
        if imagePosition is None:
            self._imagePosition = []
        elif imagePosition.__class__.__name__ == "list":
            self._imagePosition = imagePosition
        else:
            strMessage = "ERROR! XSDataInputISPyBSetImagesPositions constructor argument 'imagePosition' is not list but %s" % self._imagePosition.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'imagePosition' attribute
    def getImagePosition(self): return self._imagePosition
    def setImagePosition(self, imagePosition):
        if imagePosition is None:
            ...
            strMessage = "ERROR! XSDataInputISPyBSetImagesPositions.setImagePosition argument is not list but %s" % imagePosition.__class__.__name__
            raise BaseException(strMessage)
    def delImagePosition(self): self._imagePosition = None
    imagePosition = property(getImagePosition, setImagePosition, delImagePosition, "Property for imagePosition")
    def addImagePosition(self, value):
        if value is None:
            strMessage = "ERROR! XSDataInputISPyBSetImagesPositions.addImagePosition argument is None"
            raise BaseException(strMessage)            
        elif value.__class__.__name__ == "XSDataISPyBImagePosition":
            self._imagePosition.append(value)
        else:
            strMessage = "ERROR! XSDataInputISPyBSetImagesPositions.addImagePosition argument is not XSDataISPyBImagePosition but %s" % value.__class__.__name__
            raise BaseException(strMessage)
    def insertImagePosition(self, index, value):
        if index is None:
            strMessage = "ERROR! XSDataInputISPyBSetImagesPositions.insertImagePosition argument 'index' is None"
            raise BaseException(strMessage)            
        if value is None:
            strMessage = "ERROR! XSDataInputISPyBSetImagesPositions.insertImagePosition argument 'value' is None"
            raise BaseException(strMessage)            
        elif value.__class__.__name__ == "XSDataISPyBImagePosition":
            self._imagePosition[index] = value
        else:
            strMessage = "ERROR! XSDataInputISPyBSetImagesPositions.addImagePosition argument is not XSDataISPyBImagePosition but %s" % value.__class__.__name__
            raise BaseException(strMessage)
    def export(self, outfile, level, name_='XSDataInputISPyBSetImagesPositions'):
        showIndent(outfile, level)
        outfile.write(unicode('<%s>\n' % name_))
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write(unicode('</%s>\n' % name_))
    def exportChildren(self, outfile, level, name_='XSDataInputISPyBSetImagesPositions'):
        XSDataInput.exportChildren(self, outfile, level, name_)
        for imagePosition_ in self.getImagePosition():
            imagePosition_.export(outfile, level, name_='imagePosition')
        if self.getImagePosition() == []:
            warnEmptyAttribute("imagePosition", "XSDataISPyBImagePosition")
    def build(self, node_):
        for child_ in node_.childNodes:
            nodeName_ = child_.nodeName.split(':')[-1]
            self.buildChildren(child_, nodeName_)
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'imagePosition':
            obj_ = XSDataISPyBImagePosition()
            obj_.build(child_)
            self.imagePosition.append(obj_)
        XSDataInput.buildChildren(self, child_, nodeName_)
    #Method for marshalling an object
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
        self.export( oStreamString, 0, name_="XSDataInputISPyBSetImagesPositions" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML
    #Only to export the entire XML tree to a file stream on disk
    def exportToFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write(unicode('<?xml version=\"1.0\" ?>\n'))
        self.export( outfile, 0, name_='XSDataInputISPyBSetImagesPositions' )
        outfile.close()
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataInputISPyBSetImagesPositions is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
        return XSDataInputISPyBSetImagesPositions.parseString(self.marshal())
    #Static method for parsing a string
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputISPyBSetImagesPositions()
        rootObj.build(rootNode)
        # Check that all minOccurs are obeyed by marshalling the created object
        oStreamString = StringIO()
        rootObj.export( oStreamString, 0, name_="XSDataInputISPyBSetImagesPositions" )
        oStreamString.close()
        return rootObj
    parseString = staticmethod( parseString )
    #Static method for parsing a file
    def parseFile( _inFilePath ):
        ...
        return rootObj
    parseFile = staticmethod( parseFile )
# end class XSDataInputISPyBSetImagesPositions


class XSDataInputISPyBStoreGridInfo(XSDataInput):
    def __init__(self, configuration=None, meshAngle=None, steps_y=None, steps_x=None, yOffset=None, xOffset=None, dy_mm=None, dx_mm=None, workflowMeshId=None, gridInfoId=None):
        XSDataInput.__init__(self, configuration)
        if gridInfoId is None:
            self._gridInfoId = None
        elif gridInfoId.__class__.__name__ == "XSDataInteger":
            self._gridInfoId = gridInfoId
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreGridInfo constructor argument 'gridInfoId' is not XSDataInteger but %s" % self._gridInfoId.__class__.__name__
            raise BaseException(strMessage)
        if workflowMeshId is None:
            self._workflowMeshId = None
        elif workflowMeshId.__class__.__name__ == "XSDataInteger":
            self._workflowMeshId = workflowMeshId
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreGridInfo constructor argument 'workflowMeshId' is not XSDataInteger but %s" % self._workflowMeshId.__class__.__name__
            raise BaseException(strMessage)
        if dx_mm is None:
            self._dx_mm = None
        elif dx_mm.__class__.__name__ == "XSDataDouble":
            self._dx_mm = dx_mm
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreGridInfo constructor argument 'dx_mm' is not XSDataDouble but %s" % self._dx_mm.__class__.__name__
            raise BaseException(strMessage)
        if dy_mm is None:
            self._dy_mm = None
        elif dy_mm.__class__.__name__ == "XSDataDouble":
            self._dy_mm = dy_mm
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreGridInfo constructor argument 'dy_mm' is not XSDataDouble but %s" % self._dy_mm.__class__.__name__
            raise BaseException(strMessage)
        if xOffset is None:
            self._xOffset = None
        elif xOffset.__class__.__name__ == "XSDataDouble":
            self._xOffset = xOffset
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreGridInfo constructor argument 'xOffset' is not XSDataDouble but %s" % self._xOffset.__class__.__name__
            raise BaseException(strMessage)
        if yOffset is None:
            self._yOffset = None
        elif yOffset.__class__.__name__ == "XSDataDouble":
            self._yOffset = yOffset
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreGridInfo constructor argument 'yOffset' is not XSDataDouble but %s" % self._yOffset.__class__.__name__
            raise BaseException(strMessage)
        if steps_x is None:
            self._steps_x = None
        elif steps_x.__class__.__name__ == "XSDataInteger":
            self._steps_x = steps_x
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreGridInfo constructor argument 'steps_x' is not XSDataInteger but %s" % self._steps_x.__class__.__name__
            raise BaseException(strMessage)
        if steps_y is None:
            self._steps_y = None
        elif steps_y.__class__.__name__ == "XSDataInteger":
            self._steps_y = steps_y
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreGridInfo constructor argument 'steps_y' is not XSDataInteger but %s" % self._steps_y.__class__.__name__
            raise BaseException(strMessage)
        if meshAngle is None:
            self._meshAngle = None
        elif meshAngle.__class__.__name__ == "XSDataDouble":
            self._meshAngle = meshAngle
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreGridInfo constructor argument 'meshAngle' is not XSDataDouble but %s" % self._meshAngle.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'gridInfoId' attribute
    def getGridInfoId(self): return self._gridInfoId
    def setGridInfoId(self, gridInfoId):
        if gridInfoId is None:
            self._gridInfoId = None
        elif gridInfoId.__class__.__name__ == "XSDataInteger":
            self._gridInfoId = gridInfoId
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreGridInfo.setGridInfoId argument is not XSDataInteger but %s" % gridInfoId.__class__.__name__
            raise BaseException(strMessage)
    def delGridInfoId(self): self._gridInfoId = None
    gridInfoId = property(getGridInfoId, setGridInfoId, delGridInfoId, "Property for gridInfoId")
    # Methods and properties for the 'workflowMeshId' attribute
    def getWorkflowMeshId(self): return self._workflowMeshId
    def setWorkflowMeshId(self, workflowMeshId):
        if workflowMeshId is None:
            self._workflowMeshId = None
        elif workflowMeshId.__class__.__name__ == "XSDataInteger":
            self._workflowMeshId = workflowMeshId
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreGridInfo.setWorkflowMeshId argument is not XSDataInteger but %s" % workflowMeshId.__class__.__name__
            raise BaseException(strMessage)
    def delWorkflowMeshId(self): self._workflowMeshId = None
    workflowMeshId = property(getWorkflowMeshId, setWorkflowMeshId, delWorkflowMeshId, "Property for workflowMeshId")
    # Methods and properties for the 'dx_mm' attribute
    def getDx_mm(self): return self._dx_mm
    def setDx_mm(self, dx_mm):
        if dx_mm is None:
            self._dx_mm = None
        elif dx_mm.__class__.__name__ == "XSDataDouble":
            self._dx_mm = dx_mm
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreGridInfo.setDx_mm argument is not XSDataDouble but %s" % dx_mm.__class__.__name__
            raise BaseException(strMessage)
    def delDx_mm(self): self._dx_mm = None
    dx_mm = property(getDx_mm, setDx_mm, delDx_mm, "Property for dx_mm")
    # Methods and properties for the 'dy_mm' attribute
    def getDy_mm(self): return self._dy_mm
    def setDy_mm(self, dy_mm):
        if dy_mm is None:
            self._dy_mm = None
        elif dy_mm.__class__.__name__ == "XSDataDouble":
            self._dy_mm = dy_mm
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreGridInfo.setDy_mm argument is not XSDataDouble but %s" % dy_mm.__class__.__name__
            raise BaseException(strMessage)
    def delDy_mm(self): self._dy_mm = None
    dy_mm = property(getDy_mm, setDy_mm, delDy_mm, "Property for dy_mm")
    # Methods and properties for the 'xOffset' attribute
    def getXOffset(self): return self._xOffset
    def setXOffset(self, xOffset):
        if xOffset is None:
            ...
            strMessage = "ERROR! XSDataInputISPyBStoreGridInfo.setXOffset argument is not XSDataDouble but %s" % xOffset.__class__.__name__
            raise BaseException(strMessage)
    def delXOffset(self): self._xOffset = None
    xOffset = property(getXOffset, setXOffset, delXOffset, "Property for xOffset")
    # Methods and properties for the 'yOffset' attribute
    def getYOffset(self): return self._yOffset
    def setYOffset(self, yOffset):
        if yOffset is None:
            ...
            strMessage = "ERROR! XSDataInputISPyBStoreGridInfo.setYOffset argument is not XSDataDouble but %s" % yOffset.__class__.__name__
            raise BaseException(strMessage)
    def delYOffset(self): self._yOffset = None
    yOffset = property(getYOffset, setYOffset, delYOffset, "Property for yOffset")
    # Methods and properties for the 'steps_x' attribute
    def getSteps_x(self): return self._steps_x
    def setSteps_x(self, steps_x):
        if steps_x is None:
            self._steps_x = None
        elif steps_x.__class__.__name__ == "XSDataInteger":
            self._steps_x = steps_x
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreGridInfo.setSteps_x argument is not XSDataInteger but %s" % steps_x.__class__.__name__
            raise BaseException(strMessage)
    def delSteps_x(self): self._steps_x = None
    steps_x = property(getSteps_x, setSteps_x, delSteps_x, "Property for steps_x")
    # Methods and properties for the 'steps_y' attribute
    def getSteps_y(self): return self._steps_y
    def setSteps_y(self, steps_y):
        if steps_y is None:
            self._steps_y = None
        elif steps_y.__class__.__name__ == "XSDataInteger":
            self._steps_y = steps_y
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreGridInfo.setSteps_y argument is not XSDataInteger but %s" % steps_y.__class__.__name__
            raise BaseException(strMessage)
    def delSteps_y(self): self._steps_y = None
    steps_y = property(getSteps_y, setSteps_y, delSteps_y, "Property for steps_y")
    # Methods and properties for the 'meshAngle' attribute
    def getMeshAngle(self): return self._meshAngle
    def setMeshAngle(self, meshAngle):
        if meshAngle is None:
            self._meshAngle = None
        elif meshAngle.__class__.__name__ == "XSDataDouble":
            self._meshAngle = meshAngle
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreGridInfo.setMeshAngle argument is not XSDataDouble but %s" % meshAngle.__class__.__name__
            raise BaseException(strMessage)
    def delMeshAngle(self): self._meshAngle = None
    meshAngle = property(getMeshAngle, setMeshAngle, delMeshAngle, "Property for meshAngle")
    def export(self, outfile, level, name_='XSDataInputISPyBStoreGridInfo'):
        showIndent(outfile, level)
        outfile.write(unicode('<%s>\n' % name_))
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write(unicode('</%s>\n' % name_))
    def exportChildren(self, outfile, level, name_='XSDataInputISPyBStoreGridInfo'):
        XSDataInput.exportChildren(self, outfile, level, name_)
        if self._gridInfoId is not None:
            self.gridInfoId.export(outfile, level, name_='gridInfoId')
        if self._workflowMeshId is not None:
            self.workflowMeshId.export(outfile, level, name_='workflowMeshId')
        else:
            warnEmptyAttribute("workflowMeshId", "XSDataInteger")
        if self._dx_mm is not None:
            self.dx_mm.export(outfile, level, name_='dx_mm')
        else:
            warnEmptyAttribute("dx_mm", "XSDataDouble")
        if self._dy_mm is not None:
            self.dy_mm.export(outfile, level, name_='dy_mm')
        else:
            warnEmptyAttribute("dy_mm", "XSDataDouble")
        if self._xOffset is not None:
            self.xOffset.export(outfile, level, name_='xOffset')
        else:
            warnEmptyAttribute("xOffset", "XSDataDouble")
        if self._yOffset is not None:
            self.yOffset.export(outfile, level, name_='yOffset')
        else:
            warnEmptyAttribute("yOffset", "XSDataDouble")
        if self._steps_x is not None:
            self.steps_x.export(outfile, level, name_='steps_x')
        else:
            warnEmptyAttribute("steps_x", "XSDataInteger")
        if self._steps_y is not None:
            self.steps_y.export(outfile, level, name_='steps_y')
        else:
            warnEmptyAttribute("steps_y", "XSDataInteger")
        if self._meshAngle is not None:
            self.meshAngle.export(outfile, level, name_='meshAngle')
        else:
            warnEmptyAttribute("meshAngle", "XSDataDouble")
    def build(self, node_):
        for child_ in node_.childNodes:
            nodeName_ = child_.nodeName.split(':')[-1]
            self.buildChildren(child_, nodeName_)
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'gridInfoId':
            obj_ = XSDataInteger()
            obj_.build(child_)
            self.setGridInfoId(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'workflowMeshId':
            obj_ = XSDataInteger()
            obj_.build(child_)
            self.setWorkflowMeshId(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'dx_mm':
            obj_ = XSDataDouble()
            obj_.build(child_)
            ...
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setXOffset(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'yOffset':
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setYOffset(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'steps_x':
            obj_ = XSDataInteger()
            obj_.build(child_)
            self.setSteps_x(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'steps_y':
            obj_ = XSDataInteger()
            obj_.build(child_)
            self.setSteps_y(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'meshAngle':
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setMeshAngle(obj_)
        XSDataInput.buildChildren(self, child_, nodeName_)
    #Method for marshalling an object
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
        self.export( oStreamString, 0, name_="XSDataInputISPyBStoreGridInfo" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML
    #Only to export the entire XML tree to a file stream on disk
    def exportToFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write(unicode('<?xml version=\"1.0\" ?>\n'))
        self.export( outfile, 0, name_='XSDataInputISPyBStoreGridInfo' )
        outfile.close()
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataInputISPyBStoreGridInfo is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
        return XSDataInputISPyBStoreGridInfo.parseString(self.marshal())
    #Static method for parsing a string
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputISPyBStoreGridInfo()
        rootObj.build(rootNode)
        # Check that all minOccurs are obeyed by marshalling the created object
        oStreamString = StringIO()
        rootObj.export( oStreamString, 0, name_="XSDataInputISPyBStoreGridInfo" )
        oStreamString.close()
        return rootObj
    parseString = staticmethod( parseString )
    #Static method for parsing a file
    def parseFile( _inFilePath ):
        ...
        return rootObj
    parseFile = staticmethod( parseFile )
# end class XSDataInputISPyBStoreGridInfo


class XSDataInputISPyBStoreMotorPosition(XSDataInput):
    def __init__(self, configuration=None, motorPosition=None):
        XSDataInput.__init__(self, configuration)
        if motorPosition is None:
            self._motorPosition = None
        elif motorPosition.__class__.__name__ == "XSDataISPyBSamplePosition":
            self._motorPosition = motorPosition
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreMotorPosition constructor argument 'motorPosition' is not XSDataISPyBSamplePosition but %s" % self._motorPosition.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'motorPosition' attribute
    def getMotorPosition(self): return self._motorPosition
    def setMotorPosition(self, motorPosition):
        if motorPosition is None:
            ...
            strMessage = "ERROR! XSDataInputISPyBStoreMotorPosition.setMotorPosition argument is not XSDataISPyBSamplePosition but %s" % motorPosition.__class__.__name__
            raise BaseException(strMessage)
    def delMotorPosition(self): self._motorPosition = None
    motorPosition = property(getMotorPosition, setMotorPosition, delMotorPosition, "Property for motorPosition")
    def export(self, outfile, level, name_='XSDataInputISPyBStoreMotorPosition'):
        showIndent(outfile, level)
        outfile.write(unicode('<%s>\n' % name_))
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write(unicode('</%s>\n' % name_))
    def exportChildren(self, outfile, level, name_='XSDataInputISPyBStoreMotorPosition'):
        XSDataInput.exportChildren(self, outfile, level, name_)
        if self._motorPosition is not None:
            self.motorPosition.export(outfile, level, name_='motorPosition')
        else:
            warnEmptyAttribute("motorPosition", "XSDataISPyBSamplePosition")
    def build(self, node_):
        for child_ in node_.childNodes:
            nodeName_ = child_.nodeName.split(':')[-1]
            self.buildChildren(child_, nodeName_)
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'motorPosition':
            obj_ = XSDataISPyBSamplePosition()
            obj_.build(child_)
            self.setMotorPosition(obj_)
        XSDataInput.buildChildren(self, child_, nodeName_)
    #Method for marshalling an object
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
        self.export( oStreamString, 0, name_="XSDataInputISPyBStoreMotorPosition" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML
    #Only to export the entire XML tree to a file stream on disk
    def exportToFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write(unicode('<?xml version=\"1.0\" ?>\n'))
        self.export( outfile, 0, name_='XSDataInputISPyBStoreMotorPosition' )
        outfile.close()
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataInputISPyBStoreMotorPosition is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
        return XSDataInputISPyBStoreMotorPosition.parseString(self.marshal())
    #Static method for parsing a string
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputISPyBStoreMotorPosition()
        rootObj.build(rootNode)
        # Check that all minOccurs are obeyed by marshalling the created object
        oStreamString = StringIO()
        rootObj.export( oStreamString, 0, name_="XSDataInputISPyBStoreMotorPosition" )
        oStreamString.close()
        return rootObj
    parseString = staticmethod( parseString )
    #Static method for parsing a file
    def parseFile( _inFilePath ):
        ...
        return rootObj
    parseFile = staticmethod( parseFile )
# end class XSDataInputISPyBStoreMotorPosition
...
class XSDataInputISPyBStoreWorkflow(XSDataInput):
    def __init__(self, configuration=None, workflow=None):
        XSDataInput.__init__(self, configuration)
        if workflow is None:
            self._workflow = None
        elif workflow.__class__.__name__ == "XSDataISPyBWorkflow":
            self._workflow = workflow
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflow constructor argument 'workflow' is not XSDataISPyBWorkflow but %s" % self._workflow.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'workflow' attribute
    ...
    def setWorkflow(self, workflow):
        if workflow is None:
            ...
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflow.setWorkflow argument is not XSDataISPyBWorkflow but %s" % workflow.__class__.__name__
            raise BaseException(strMessage)
    def delWorkflow(self): self._workflow = None
    workflow = property(getWorkflow, setWorkflow, delWorkflow, "Property for workflow")
    def export(self, outfile, level, name_='XSDataInputISPyBStoreWorkflow'):
        showIndent(outfile, level)
        outfile.write(unicode('<%s>\n' % name_))
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write(unicode('</%s>\n' % name_))
    def exportChildren(self, outfile, level, name_='XSDataInputISPyBStoreWorkflow'):
        XSDataInput.exportChildren(self, outfile, level, name_)
        if self._workflow is not None:
            self.workflow.export(outfile, level, name_='workflow')
        else:
            warnEmptyAttribute("workflow", "XSDataISPyBWorkflow")
    def build(self, node_):
        for child_ in node_.childNodes:
            nodeName_ = child_.nodeName.split(':')[-1]
            self.buildChildren(child_, nodeName_)
    ...
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
        self.export( oStreamString, 0, name_="XSDataInputISPyBStoreWorkflow" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML
    #Only to export the entire XML tree to a file stream on disk
    def exportToFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write(unicode('<?xml version=\"1.0\" ?>\n'))
        self.export( outfile, 0, name_='XSDataInputISPyBStoreWorkflow' )
        outfile.close()
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataInputISPyBStoreWorkflow is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
        return XSDataInputISPyBStoreWorkflow.parseString(self.marshal())
    #Static method for parsing a string
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputISPyBStoreWorkflow()
        rootObj.build(rootNode)
        # Check that all minOccurs are obeyed by marshalling the created object
        oStreamString = StringIO()
        rootObj.export( oStreamString, 0, name_="XSDataInputISPyBStoreWorkflow" )
        oStreamString.close()
        return rootObj
    parseString = staticmethod( parseString )
    #Static method for parsing a file
...
class XSDataInputISPyBStoreWorkflowMesh(XSDataInput):
    def __init__(self, configuration=None, cartographyPath=None, value4=None, value3=None, value2=None, value1=None, bestImageId=None, bestPositionId=None, workflowId=None):
        XSDataInput.__init__(self, configuration)
        if workflowId is None:
            self._workflowId = None
        elif workflowId.__class__.__name__ == "XSDataInteger":
            ...
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowMesh constructor argument 'workflowId' is not XSDataInteger but %s" % self._workflowId.__class__.__name__
            raise BaseException(strMessage)
        if bestPositionId is None:
            self._bestPositionId = None
        elif bestPositionId.__class__.__name__ == "XSDataInteger":
            self._bestPositionId = bestPositionId
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowMesh constructor argument 'bestPositionId' is not XSDataInteger but %s" % self._bestPositionId.__class__.__name__
            raise BaseException(strMessage)
        if bestImageId is None:
            self._bestImageId = None
        elif bestImageId.__class__.__name__ == "XSDataInteger":
            self._bestImageId = bestImageId
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowMesh constructor argument 'bestImageId' is not XSDataInteger but %s" % self._bestImageId.__class__.__name__
            raise BaseException(strMessage)
        if value1 is None:
            self._value1 = None
        elif value1.__class__.__name__ == "XSDataDouble":
            self._value1 = value1
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowMesh constructor argument 'value1' is not XSDataDouble but %s" % self._value1.__class__.__name__
            raise BaseException(strMessage)
        if value2 is None:
            self._value2 = None
        elif value2.__class__.__name__ == "XSDataDouble":
            self._value2 = value2
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowMesh constructor argument 'value2' is not XSDataDouble but %s" % self._value2.__class__.__name__
            raise BaseException(strMessage)
        if value3 is None:
            self._value3 = None
        elif value3.__class__.__name__ == "XSDataDouble":
            self._value3 = value3
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowMesh constructor argument 'value3' is not XSDataDouble but %s" % self._value3.__class__.__name__
            raise BaseException(strMessage)
        if value4 is None:
            self._value4 = None
        elif value4.__class__.__name__ == "XSDataDouble":
            self._value4 = value4
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowMesh constructor argument 'value4' is not XSDataDouble but %s" % self._value4.__class__.__name__
            raise BaseException(strMessage)
        if cartographyPath is None:
            self._cartographyPath = None
        elif cartographyPath.__class__.__name__ == "XSDataString":
            self._cartographyPath = cartographyPath
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowMesh constructor argument 'cartographyPath' is not XSDataString but %s" % self._cartographyPath.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'workflowId' attribute
    def getWorkflowId(self): return self._workflowId
    def setWorkflowId(self, workflowId):
        if workflowId is None:
            ...
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowMesh.setWorkflowId argument is not XSDataInteger but %s" % workflowId.__class__.__name__
            raise BaseException(strMessage)
    def delWorkflowId(self): self._workflowId = None
    workflowId = property(getWorkflowId, setWorkflowId, delWorkflowId, "Property for workflowId")
    # Methods and properties for the 'bestPositionId' attribute
    def getBestPositionId(self): return self._bestPositionId
    def setBestPositionId(self, bestPositionId):
        if bestPositionId is None:
            self._bestPositionId = None
        elif bestPositionId.__class__.__name__ == "XSDataInteger":
            self._bestPositionId = bestPositionId
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowMesh.setBestPositionId argument is not XSDataInteger but %s" % bestPositionId.__class__.__name__
            raise BaseException(strMessage)
    def delBestPositionId(self): self._bestPositionId = None
    bestPositionId = property(getBestPositionId, setBestPositionId, delBestPositionId, "Property for bestPositionId")
    # Methods and properties for the 'bestImageId' attribute
    def getBestImageId(self): return self._bestImageId
    def setBestImageId(self, bestImageId):
        if bestImageId is None:
            self._bestImageId = None
        elif bestImageId.__class__.__name__ == "XSDataInteger":
            self._bestImageId = bestImageId
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowMesh.setBestImageId argument is not XSDataInteger but %s" % bestImageId.__class__.__name__
            raise BaseException(strMessage)
    def delBestImageId(self): self._bestImageId = None
    bestImageId = property(getBestImageId, setBestImageId, delBestImageId, "Property for bestImageId")
    # Methods and properties for the 'value1' attribute
    ...
    def setValue1(self, value1):
        if value1 is None:
            ...
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowMesh.setValue1 argument is not XSDataDouble but %s" % value1.__class__.__name__
            raise BaseException(strMessage)
    def delValue1(self): self._value1 = None
    value1 = property(getValue1, setValue1, delValue1, "Property for value1")
    # Methods and properties for the 'value2' attribute
    ...
    def setValue2(self, value2):
        if value2 is None:
            ...
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowMesh.setValue2 argument is not XSDataDouble but %s" % value2.__class__.__name__
            raise BaseException(strMessage)
    def delValue2(self): self._value2 = None
    value2 = property(getValue2, setValue2, delValue2, "Property for value2")
    # Methods and properties for the 'value3' attribute
    ...
    def setValue3(self, value3):
        if value3 is None:
            ...
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowMesh.setValue3 argument is not XSDataDouble but %s" % value3.__class__.__name__
            raise BaseException(strMessage)
    def delValue3(self): self._value3 = None
    value3 = property(getValue3, setValue3, delValue3, "Property for value3")
    # Methods and properties for the 'value4' attribute
    def getValue4(self): return self._value4
    def setValue4(self, value4):
        if value4 is None:
            ...
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowMesh.setValue4 argument is not XSDataDouble but %s" % value4.__class__.__name__
            raise BaseException(strMessage)
    def delValue4(self): self._value4 = None
    value4 = property(getValue4, setValue4, delValue4, "Property for value4")
    # Methods and properties for the 'cartographyPath' attribute
    def getCartographyPath(self): return self._cartographyPath
    def setCartographyPath(self, cartographyPath):
        if cartographyPath is None:
            self._cartographyPath = None
        elif cartographyPath.__class__.__name__ == "XSDataString":
            self._cartographyPath = cartographyPath
        else:
            strMessage = "ERROR! XSDataInputISPyBStoreWorkflowMesh.setCartographyPath argument is not XSDataString but %s" % cartographyPath.__class__.__name__
            raise BaseException(strMessage)
    def delCartographyPath(self): self._cartographyPath = None
    cartographyPath = property(getCartographyPath, setCartographyPath, delCartographyPath, "Property for cartographyPath")
    def export(self, outfile, level, name_='XSDataInputISPyBStoreWorkflowMesh'):
        showIndent(outfile, level)
        outfile.write(unicode('<%s>\n' % name_))
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write(unicode('</%s>\n' % name_))
    def exportChildren(self, outfile, level, name_='XSDataInputISPyBStoreWorkflowMesh'):
        XSDataInput.exportChildren(self, outfile, level, name_)
        if self._workflowId is not None:
            self.workflowId.export(outfile, level, name_='workflowId')
        else:
            warnEmptyAttribute("workflowId", "XSDataInteger")
        if self._bestPositionId is not None:
            self.bestPositionId.export(outfile, level, name_='bestPositionId')
        else:
            warnEmptyAttribute("bestPositionId", "XSDataInteger")
        if self._bestImageId is not None:
            self.bestImageId.export(outfile, level, name_='bestImageId')
        else:
            warnEmptyAttribute("bestImageId", "XSDataInteger")
        if self._value1 is not None:
            self.value1.export(outfile, level, name_='value1')
        else:
            warnEmptyAttribute("value1", "XSDataDouble")
        if self._value2 is not None:
            self.value2.export(outfile, level, name_='value2')
        else:
            warnEmptyAttribute("value2", "XSDataDouble")
        if self._value3 is not None:
            self.value3.export(outfile, level, name_='value3')
        else:
            warnEmptyAttribute("value3", "XSDataDouble")
        if self._value4 is not None:
            self.value4.export(outfile, level, name_='value4')
        else:
            warnEmptyAttribute("value4", "XSDataDouble")
        if self._cartographyPath is not None:
            self.cartographyPath.export(outfile, level, name_='cartographyPath')
        else:
            warnEmptyAttribute("cartographyPath", "XSDataString")
    def build(self, node_):
        for child_ in node_.childNodes:
            nodeName_ = child_.nodeName.split(':')[-1]
            self.buildChildren(child_, nodeName_)
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            nodeName_ == 'bestPositionId':
            obj_ = XSDataInteger()
            obj_.build(child_)
            self.setBestPositionId(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'bestImageId':
            obj_ = XSDataInteger()
            obj_.build(child_)
            self.setBestImageId(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'value1':
            obj_ = XSDataDouble()
            obj_.build(child_)
            ...
            nodeName_ == 'cartographyPath':
            obj_ = XSDataString()
            obj_.build(child_)
            self.setCartographyPath(obj_)
        XSDataInput.buildChildren(self, child_, nodeName_)
    #Method for marshalling an object
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
        self.export( oStreamString, 0, name_="XSDataInputISPyBStoreWorkflowMesh" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML
    #Only to export the entire XML tree to a file stream on disk
    def exportToFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write(unicode('<?xml version=\"1.0\" ?>\n'))
        self.export( outfile, 0, name_='XSDataInputISPyBStoreWorkflowMesh' )
        outfile.close()
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataInputISPyBStoreWorkflowMesh is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
        return XSDataInputISPyBStoreWorkflowMesh.parseString(self.marshal())
    #Static method for parsing a string
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputISPyBStoreWorkflowMesh()
        rootObj.build(rootNode)
        # Check that all minOccurs are obeyed by marshalling the created object
        oStreamString = StringIO()
        rootObj.export( oStreamString, 0, name_="XSDataInputISPyBStoreWorkflowMesh" )
        oStreamString.close()
        return rootObj
    parseString = staticmethod( parseString )
    #Static method for parsing a file
    def parseFile( _inFilePath ):
        ...
        return rootObj
    parseFile = staticmethod( parseFile )
# end class XSDataInputISPyBStoreWorkflowMesh
...
class XSDataInputISPyBUpdateWorkflowStatus(XSDataInput):
    def __init__(self, configuration=None, newStatus=None, workflowId=None):
        XSDataInput.__init__(self, configuration)
        if workflowId is None:
            self._workflowId = None
        elif workflowId.__class__.__name__ == "XSDataInteger":
            ...
            strMessage = "ERROR! XSDataInputISPyBUpdateWorkflowStatus constructor argument 'workflowId' is not XSDataInteger but %s" % self._workflowId.__class__.__name__
            raise BaseException(strMessage)
        if newStatus is None:
            self._newStatus = None
        elif newStatus.__class__.__name__ == "XSDataString":
            self._newStatus = newStatus
        else:
            strMessage = "ERROR! XSDataInputISPyBUpdateWorkflowStatus constructor argument 'newStatus' is not XSDataString but %s" % self._newStatus.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'workflowId' attribute
    def getWorkflowId(self): return self._workflowId
    def setWorkflowId(self, workflowId):
        if workflowId is None:
            ...
            strMessage = "ERROR! XSDataInputISPyBUpdateWorkflowStatus.setWorkflowId argument is not XSDataInteger but %s" % workflowId.__class__.__name__
            raise BaseException(strMessage)
    def delWorkflowId(self): self._workflowId = None
    workflowId = property(getWorkflowId, setWorkflowId, delWorkflowId, "Property for workflowId")
    # Methods and properties for the 'newStatus' attribute
    def getNewStatus(self): return self._newStatus
    def setNewStatus(self, newStatus):
        if newStatus is None:
            ...
            strMessage = "ERROR! XSDataInputISPyBUpdateWorkflowStatus.setNewStatus argument is not XSDataString but %s" % newStatus.__class__.__name__
            raise BaseException(strMessage)
    def delNewStatus(self): self._newStatus = None
    newStatus = property(getNewStatus, setNewStatus, delNewStatus, "Property for newStatus")
    def export(self, outfile, level, name_='XSDataInputISPyBUpdateWorkflowStatus'):
        showIndent(outfile, level)
        outfile.write(unicode('<%s>\n' % name_))
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write(unicode('</%s>\n' % name_))
    def exportChildren(self, outfile, level, name_='XSDataInputISPyBUpdateWorkflowStatus'):
        XSDataInput.exportChildren(self, outfile, level, name_)
        if self._workflowId is not None:
            self.workflowId.export(outfile, level, name_='workflowId')
        else:
            warnEmptyAttribute("workflowId", "XSDataInteger")
        if self._newStatus is not None:
            self.newStatus.export(outfile, level, name_='newStatus')
        else:
            warnEmptyAttribute("newStatus", "XSDataString")
    def build(self, node_):
        for child_ in node_.childNodes:
            nodeName_ = child_.nodeName.split(':')[-1]
            self.buildChildren(child_, nodeName_)
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            obj_ = XSDataString()
            obj_.build(child_)
            self.setNewStatus(obj_)
        XSDataInput.buildChildren(self, child_, nodeName_)
    #Method for marshalling an object
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
        self.export( oStreamString, 0, name_="XSDataInputISPyBUpdateWorkflowStatus" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML
    #Only to export the entire XML tree to a file stream on disk
    def exportToFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write(unicode('<?xml version=\"1.0\" ?>\n'))
        self.export( outfile, 0, name_='XSDataInputISPyBUpdateWorkflowStatus' )
        outfile.close()
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataInputISPyBUpdateWorkflowStatus is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
        return XSDataInputISPyBUpdateWorkflowStatus.parseString(self.marshal())
    #Static method for parsing a string
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputISPyBUpdateWorkflowStatus()
        rootObj.build(rootNode)
        # Check that all minOccurs are obeyed by marshalling the created object
        oStreamString = StringIO()
        rootObj.export( oStreamString, 0, name_="XSDataInputISPyBUpdateWorkflowStatus" )
        oStreamString.close()
        return rootObj
    parseString = staticmethod( parseString )
    #Static method for parsing a file
    def parseFile( _inFilePath ):
        ...
        return rootObj
    parseFile = staticmethod( parseFile )
# end class XSDataInputISPyBUpdateWorkflowStatus
...
class XSDataInputStoreListOfImageQualityIndicators(XSDataInput):
    def __init__(self, configuration=None, imageQualityIndicators=None):
        XSDataInput.__init__(self, configuration)
        if imageQualityIndicators is None:
            ...
            strMessage = "ERROR! XSDataInputStoreListOfImageQualityIndicators constructor argument 'imageQualityIndicators' is not list but %s" % self._imageQualityIndicators.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'imageQualityIndicators' attribute
    def getImageQualityIndicators(self): return self._imageQualityIndicators
    def setImageQualityIndicators(self, imageQualityIndicators):
        if imageQualityIndicators is None:
            ...
            strMessage = "ERROR! XSDataInputStoreListOfImageQualityIndicators.setImageQualityIndicators argument is not list but %s" % imageQualityIndicators.__class__.__name__
            raise BaseException(strMessage)
    def delImageQualityIndicators(self): self._imageQualityIndicators = None
    imageQualityIndicators = property(getImageQualityIndicators, setImageQualityIndicators, delImageQualityIndicators, "Property for imageQualityIndicators")
    def addImageQualityIndicators(self, value):
        if value is None:
            strMessage = "ERROR! XSDataInputStoreListOfImageQualityIndicators.addImageQualityIndicators argument is None"
            raise BaseException(strMessage)            
        elif value.__class__.__name__ == "XSDataISPyBImageQualityIndicators":
            self._imageQualityIndicators.append(value)
        else:
            strMessage = "ERROR! XSDataInputStoreListOfImageQualityIndicators.addImageQualityIndicators argument is not XSDataISPyBImageQualityIndicators but %s" % value.__class__.__name__
            raise BaseException(strMessage)
    def insertImageQualityIndicators(self, index, value):
        if index is None:
            strMessage = "ERROR! XSDataInputStoreListOfImageQualityIndicators.insertImageQualityIndicators argument 'index' is None"
            raise BaseException(strMessage)            
        if value is None:
            strMessage = "ERROR! XSDataInputStoreListOfImageQualityIndicators.insertImageQualityIndicators argument 'value' is None"
            raise BaseException(strMessage)            
        elif value.__class__.__name__ == "XSDataISPyBImageQualityIndicators":
            ...
            strMessage = "ERROR! XSDataInputStoreListOfImageQualityIndicators.addImageQualityIndicators argument is not XSDataISPyBImageQualityIndicators but %s" % value.__class__.__name__
            raise BaseException(strMessage)
    def export(self, outfile, level, name_='XSDataInputStoreListOfImageQualityIndicators'):
        showIndent(outfile, level)
        outfile.write(unicode('<%s>\n' % name_))
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write(unicode('</%s>\n' % name_))
    def exportChildren(self, outfile, level, name_='XSDataInputStoreListOfImageQualityIndicators'):
        XSDataInput.exportChildren(self, outfile, level, name_)
        ...
        if self.getImageQualityIndicators() == []:
            warnEmptyAttribute("imageQualityIndicators", "XSDataISPyBImageQualityIndicators")
    def build(self, node_):
        for child_ in node_.childNodes:
            nodeName_ = child_.nodeName.split(':')[-1]
    ...
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
        self.export( oStreamString, 0, name_="XSDataInputStoreListOfImageQualityIndicators" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML
    #Only to export the entire XML tree to a file stream on disk
    def exportToFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write(unicode('<?xml version=\"1.0\" ?>\n'))
        self.export( outfile, 0, name_='XSDataInputStoreListOfImageQualityIndicators' )
        outfile.close()
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataInputStoreListOfImageQualityIndicators is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
        return XSDataInputStoreListOfImageQualityIndicators.parseString(self.marshal())
    #Static method for parsing a string
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputStoreListOfImageQualityIndicators()
        rootObj.build(rootNode)
        # Check that all minOccurs are obeyed by marshalling the created object
        oStreamString = StringIO()
        rootObj.export( oStreamString, 0, name_="XSDataInputStoreListOfImageQualityIndicators" )
        oStreamString.close()
        return rootObj
    parseString = staticmethod( parseString )
    #Static method for parsing a file
    def parseFile( _inFilePath ):
        ...
        return rootObj
    parseFile = staticmethod( parseFile )
# end class XSDataInputStoreListOfImageQualityIndicators


class XSDataResultGetSampleInformation(XSDataResult):
    def __init__(self, status=None, sampleName=None, sampleLocation=None, sampleId=None, proteinAcronym=None, minimalResolution=None, holderLength=None, experimentType=None, diffractionPlan=None, crystalSpaceGroup=None, containerSampleChangerLocation=None, code=None, cellGamma=None, cellBeta=None, cellAlpha=None, cellC=None, cellB=None, cellA=None):
        XSDataResult.__init__(self, status)
        if cellA is None:
            self._cellA = None
        elif cellA.__class__.__name__ == "XSDataDouble":
            self._cellA = cellA
        else:
            strMessage = "ERROR! XSDataResultGetSampleInformation constructor argument 'cellA' is not XSDataDouble but %s" % self._cellA.__class__.__name__
            raise BaseException(strMessage)
        if cellB is None:
            self._cellB = None
        elif cellB.__class__.__name__ == "XSDataDouble":
            self._cellB = cellB
        else:
            strMessage = "ERROR! XSDataResultGetSampleInformation constructor argument 'cellB' is not XSDataDouble but %s" % self._cellB.__class__.__name__
            raise BaseException(strMessage)
        if cellC is None:
            self._cellC = None
        elif cellC.__class__.__name__ == "XSDataDouble":
            self._cellC = cellC
        else:
            strMessage = "ERROR! XSDataResultGetSampleInformation constructor argument 'cellC' is not XSDataDouble but %s" % self._cellC.__class__.__name__
            raise BaseException(strMessage)
        if cellAlpha is None:
            self._cellAlpha = None
        elif cellAlpha.__class__.__name__ == "XSDataDouble":
            self._cellAlpha = cellAlpha
        else:
            strMessage = "ERROR! XSDataResultGetSampleInformation constructor argument 'cellAlpha' is not XSDataDouble but %s" % self._cellAlpha.__class__.__name__
            raise BaseException(strMessage)
        if cellBeta is None:
            self._cellBeta = None
        elif cellBeta.__class__.__name__ == "XSDataDouble":
            self._cellBeta = cellBeta
        else:
            strMessage = "ERROR! XSDataResultGetSampleInformation constructor argument 'cellBeta' is not XSDataDouble but %s" % self._cellBeta.__class__.__name__
            raise BaseException(strMessage)
        if cellGamma is None:
            self._cellGamma = None
        elif cellGamma.__class__.__name__ == "XSDataDouble":
            self._cellGamma = cellGamma
        else:
            strMessage = "ERROR! XSDataResultGetSampleInformation constructor argument 'cellGamma' is not XSDataDouble but %s" % self._cellGamma.__class__.__name__
            raise BaseException(strMessage)
        if code is None:
            self._code = None
            ...
            strMessage = "ERROR! XSDataResultGetSampleInformation constructor argument 'code' is not XSDataString but %s" % self._code.__class__.__name__
            raise BaseException(strMessage)
        if containerSampleChangerLocation is None:
            self._containerSampleChangerLocation = None
        elif containerSampleChangerLocation.__class__.__name__ == "XSDataString":
            self._containerSampleChangerLocation = containerSampleChangerLocation
        else:
            strMessage = "ERROR! XSDataResultGetSampleInformation constructor argument 'containerSampleChangerLocation' is not XSDataString but %s" % self._containerSampleChangerLocation.__class__.__name__
            raise BaseException(strMessage)
        if crystalSpaceGroup is None:
            self._crystalSpaceGroup = None
        elif crystalSpaceGroup.__class__.__name__ == "XSDataString":
            self._crystalSpaceGroup = crystalSpaceGroup
        else:
            strMessage = "ERROR! XSDataResultGetSampleInformation constructor argument 'crystalSpaceGroup' is not XSDataString but %s" % self._crystalSpaceGroup.__class__.__name__
            raise BaseException(strMessage)
        if diffractionPlan is None:
            self._diffractionPlan = None
        elif diffractionPlan.__class__.__name__ == "XSDataISPyBDiffractionPlan":
            ...
            strMessage = "ERROR! XSDataResultGetSampleInformation constructor argument 'diffractionPlan' is not XSDataISPyBDiffractionPlan but %s" % self._diffractionPlan.__class__.__name__
            raise BaseException(strMessage)
        if experimentType is None:
            self._experimentType = None
        elif experimentType.__class__.__name__ == "XSDataString":
            self._experimentType = experimentType
        else:
            strMessage = "ERROR! XSDataResultGetSampleInformation constructor argument 'experimentType' is not XSDataString but %s" % self._experimentType.__class__.__name__
            raise BaseException(strMessage)
        if holderLength is None:
            self._holderLength = None
        elif holderLength.__class__.__name__ == "XSDataDouble":
            self._holderLength = holderLength
        else:
            strMessage = "ERROR! XSDataResultGetSampleInformation constructor argument 'holderLength' is not XSDataDouble but %s" % self._holderLength.__class__.__name__
            raise BaseException(strMessage)
        if minimalResolution is None:
            self._minimalResolution = None
        elif minimalResolution.__class__.__name__ == "XSDataDouble":
            ...
            strMessage = "ERROR! XSDataResultGetSampleInformation constructor argument 'minimalResolution' is not XSDataDouble but %s" % self._minimalResolution.__class__.__name__
            raise BaseException(strMessage)
        if proteinAcronym is None:
            self._proteinAcronym = None
        elif proteinAcronym.__class__.__name__ == "XSDataString":
            self._proteinAcronym = proteinAcronym
        else:
            strMessage = "ERROR! XSDataResultGetSampleInformation constructor argument 'proteinAcronym' is not XSDataString but %s" % self._proteinAcronym.__class__.__name__
            raise BaseException(strMessage)
        if sampleId is None:
            self._sampleId = None
        elif sampleId.__class__.__name__ == "XSDataInteger":
            ...
            strMessage = "ERROR! XSDataResultGetSampleInformation constructor argument 'sampleId' is not XSDataInteger but %s" % self._sampleId.__class__.__name__
            raise BaseException(strMessage)
        if sampleLocation is None:
            self._sampleLocation = None
        elif sampleLocation.__class__.__name__ == "XSDataString":
            self._sampleLocation = sampleLocation
        else:
            strMessage = "ERROR! XSDataResultGetSampleInformation constructor argument 'sampleLocation' is not XSDataString but %s" % self._sampleLocation.__class__.__name__
            raise BaseException(strMessage)
        if sampleName is None:
            self._sampleName = None
        elif sampleName.__class__.__name__ == "XSDataString":
            self._sampleName = sampleName
        else:
            strMessage = "ERROR! XSDataResultGetSampleInformation constructor argument 'sampleName' is not XSDataString but %s" % self._sampleName.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'cellA' attribute
    def getCellA(self): return self._cellA
    def setCellA(self, cellA):
        if cellA is None:
            self._cellA = None
        elif cellA.__class__.__name__ == "XSDataDouble":
            self._cellA = cellA
        else:
            strMessage = "ERROR! XSDataResultGetSampleInformation.setCellA argument is not XSDataDouble but %s" % cellA.__class__.__name__
            raise BaseException(strMessage)
    def delCellA(self): self._cellA = None
    cellA = property(getCellA, setCellA, delCellA, "Property for cellA")
    # Methods and properties for the 'cellB' attribute
    def getCellB(self): return self._cellB
    def setCellB(self, cellB):
        if cellB is None:
            self._cellB = None
        elif cellB.__class__.__name__ == "XSDataDouble":
            self._cellB = cellB
        else:
            strMessage = "ERROR! XSDataResultGetSampleInformation.setCellB argument is not XSDataDouble but %s" % cellB.__class__.__name__
            raise BaseException(strMessage)
    def delCellB(self): self._cellB = None
    cellB = property(getCellB, setCellB, delCellB, "Property for cellB")
    # Methods and properties for the 'cellC' attribute
    def getCellC(self): return self._cellC
    def setCellC(self, cellC):
        if cellC is None:
            self._cellC = None
        elif cellC.__class__.__name__ == "XSDataDouble":
            self._cellC = cellC
        else:
            strMessage = "ERROR! XSDataResultGetSampleInformation.setCellC argument is not XSDataDouble but %s" % cellC.__class__.__name__
            raise BaseException(strMessage)
    def delCellC(self): self._cellC = None
    cellC = property(getCellC, setCellC, delCellC, "Property for cellC")
    # Methods and properties for the 'cellAlpha' attribute
    def getCellAlpha(self): return self._cellAlpha
    def setCellAlpha(self, cellAlpha):
        if cellAlpha is None:
            self._cellAlpha = None
        elif cellAlpha.__class__.__name__ == "XSDataDouble":
            self._cellAlpha = cellAlpha
        else:
            strMessage = "ERROR! XSDataResultGetSampleInformation.setCellAlpha argument is not XSDataDouble but %s" % cellAlpha.__class__.__name__
            raise BaseException(strMessage)
    def delCellAlpha(self): self._cellAlpha = None
    cellAlpha = property(getCellAlpha, setCellAlpha, delCellAlpha, "Property for cellAlpha")
    # Methods and properties for the 'cellBeta' attribute
    def getCellBeta(self): return self._cellBeta
    def setCellBeta(self, cellBeta):
        if cellBeta is None:
            self._cellBeta = None
        elif cellBeta.__class__.__name__ == "XSDataDouble":
            self._cellBeta = cellBeta
        else:
            strMessage = "ERROR! XSDataResultGetSampleInformation.setCellBeta argument is not XSDataDouble but %s" % cellBeta.__class__.__name__
            raise BaseException(strMessage)
    def delCellBeta(self): self._cellBeta = None
    cellBeta = property(getCellBeta, setCellBeta, delCellBeta, "Property for cellBeta")
    # Methods and properties for the 'cellGamma' attribute
    def getCellGamma(self): return self._cellGamma
    def setCellGamma(self, cellGamma):
        if cellGamma is None:
            self._cellGamma = None
        elif cellGamma.__class__.__name__ == "XSDataDouble":
            self._cellGamma = cellGamma
        else:
            strMessage = "ERROR! XSDataResultGetSampleInformation.setCellGamma argument is not XSDataDouble but %s" % cellGamma.__class__.__name__
            raise BaseException(strMessage)
    def delCellGamma(self): self._cellGamma = None
    cellGamma = property(getCellGamma, setCellGamma, delCellGamma, "Property for cellGamma")
    ...
    def setCode(self, code):
        if code is None:
            ...
            strMessage = "ERROR! XSDataResultGetSampleInformation.setCode argument is not XSDataString but %s" % code.__class__.__name__
            raise BaseException(strMessage)
    def delCode(self): self._code = None
    code = property(getCode, setCode, delCode, "Property for code")
    # Methods and properties for the 'containerSampleChangerLocation' attribute
    def getContainerSampleChangerLocation(self): return self._containerSampleChangerLocation
    def setContainerSampleChangerLocation(self, containerSampleChangerLocation):
        if containerSampleChangerLocation is None:
            self._containerSampleChangerLocation = None
        elif containerSampleChangerLocation.__class__.__name__ == "XSDataString":
            self._containerSampleChangerLocation = containerSampleChangerLocation
        else:
            strMessage = "ERROR! XSDataResultGetSampleInformation.setContainerSampleChangerLocation argument is not XSDataString but %s" % containerSampleChangerLocation.__class__.__name__
            raise BaseException(strMessage)
    def delContainerSampleChangerLocation(self): self._containerSampleChangerLocation = None
    containerSampleChangerLocation = property(getContainerSampleChangerLocation, setContainerSampleChangerLocation, delContainerSampleChangerLocation, "Property for containerSampleChangerLocation")
    # Methods and properties for the 'crystalSpaceGroup' attribute
    def getCrystalSpaceGroup(self): return self._crystalSpaceGroup
    def setCrystalSpaceGroup(self, crystalSpaceGroup):
        if crystalSpaceGroup is None:
            self._crystalSpaceGroup = None
        elif crystalSpaceGroup.__class__.__name__ == "XSDataString":
            self._crystalSpaceGroup = crystalSpaceGroup
        else:
            strMessage = "ERROR! XSDataResultGetSampleInformation.setCrystalSpaceGroup argument is not XSDataString but %s" % crystalSpaceGroup.__class__.__name__
            raise BaseException(strMessage)
    def delCrystalSpaceGroup(self): self._crystalSpaceGroup = None
    crystalSpaceGroup = property(getCrystalSpaceGroup, setCrystalSpaceGroup, delCrystalSpaceGroup, "Property for crystalSpaceGroup")
    # Methods and properties for the 'diffractionPlan' attribute
    def getDiffractionPlan(self): return self._diffractionPlan
    def setDiffractionPlan(self, diffractionPlan):
        if diffractionPlan is None:
            ...
            strMessage = "ERROR! XSDataResultGetSampleInformation.setDiffractionPlan argument is not XSDataISPyBDiffractionPlan but %s" % diffractionPlan.__class__.__name__
            raise BaseException(strMessage)
    def delDiffractionPlan(self): self._diffractionPlan = None
    diffractionPlan = property(getDiffractionPlan, setDiffractionPlan, delDiffractionPlan, "Property for diffractionPlan")
    ...
    def setExperimentType(self, experimentType):
        if experimentType is None:
            ...
            strMessage = "ERROR! XSDataResultGetSampleInformation.setExperimentType argument is not XSDataString but %s" % experimentType.__class__.__name__
            raise BaseException(strMessage)
    ...
    # Methods and properties for the 'holderLength' attribute
    def getHolderLength(self): return self._holderLength
    def setHolderLength(self, holderLength):
        if holderLength is None:
            self._holderLength = None
        elif holderLength.__class__.__name__ == "XSDataDouble":
            self._holderLength = holderLength
        else:
            strMessage = "ERROR! XSDataResultGetSampleInformation.setHolderLength argument is not XSDataDouble but %s" % holderLength.__class__.__name__
            raise BaseException(strMessage)
    def delHolderLength(self): self._holderLength = None
    holderLength = property(getHolderLength, setHolderLength, delHolderLength, "Property for holderLength")
    # Methods and properties for the 'minimalResolution' attribute
    def getMinimalResolution(self): return self._minimalResolution
    def setMinimalResolution(self, minimalResolution):
        if minimalResolution is None:
            ...
            strMessage = "ERROR! XSDataResultGetSampleInformation.setMinimalResolution argument is not XSDataDouble but %s" % minimalResolution.__class__.__name__
            raise BaseException(strMessage)
    def delMinimalResolution(self): self._minimalResolution = None
    minimalResolution = property(getMinimalResolution, setMinimalResolution, delMinimalResolution, "Property for minimalResolution")
    # Methods and properties for the 'proteinAcronym' attribute
    def getProteinAcronym(self): return self._proteinAcronym
    def setProteinAcronym(self, proteinAcronym):
        if proteinAcronym is None:
            self._proteinAcronym = None
        elif proteinAcronym.__class__.__name__ == "XSDataString":
            self._proteinAcronym = proteinAcronym
        else:
            strMessage = "ERROR! XSDataResultGetSampleInformation.setProteinAcronym argument is not XSDataString but %s" % proteinAcronym.__class__.__name__
            raise BaseException(strMessage)
    def delProteinAcronym(self): self._proteinAcronym = None
    proteinAcronym = property(getProteinAcronym, setProteinAcronym, delProteinAcronym, "Property for proteinAcronym")
    # Methods and properties for the 'sampleId' attribute
    def getSampleId(self): return self._sampleId
    def setSampleId(self, sampleId):
        if sampleId is None:
            ...
            strMessage = "ERROR! XSDataResultGetSampleInformation.setSampleId argument is not XSDataInteger but %s" % sampleId.__class__.__name__
            raise BaseException(strMessage)
    def delSampleId(self): self._sampleId = None
    sampleId = property(getSampleId, setSampleId, delSampleId, "Property for sampleId")
    # Methods and properties for the 'sampleLocation' attribute
    def getSampleLocation(self): return self._sampleLocation
    def setSampleLocation(self, sampleLocation):
        if sampleLocation is None:
            self._sampleLocation = None
        elif sampleLocation.__class__.__name__ == "XSDataString":
            self._sampleLocation = sampleLocation
        else:
            strMessage = "ERROR! XSDataResultGetSampleInformation.setSampleLocation argument is not XSDataString but %s" % sampleLocation.__class__.__name__
            raise BaseException(strMessage)
    def delSampleLocation(self): self._sampleLocation = None
    sampleLocation = property(getSampleLocation, setSampleLocation, delSampleLocation, "Property for sampleLocation")
    # Methods and properties for the 'sampleName' attribute
    def getSampleName(self): return self._sampleName
    def setSampleName(self, sampleName):
        if sampleName is None:
            ...
            strMessage = "ERROR! XSDataResultGetSampleInformation.setSampleName argument is not XSDataString but %s" % sampleName.__class__.__name__
            raise BaseException(strMessage)
    def delSampleName(self): self._sampleName = None
    sampleName = property(getSampleName, setSampleName, delSampleName, "Property for sampleName")
    def export(self, outfile, level, name_='XSDataResultGetSampleInformation'):
        showIndent(outfile, level)
        outfile.write(unicode('<%s>\n' % name_))
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write(unicode('</%s>\n' % name_))
    def exportChildren(self, outfile, level, name_='XSDataResultGetSampleInformation'):
        XSDataResult.exportChildren(self, outfile, level, name_)
        if self._cellA is not None:
            self.cellA.export(outfile, level, name_='cellA')
        else:
            warnEmptyAttribute("cellA", "XSDataDouble")
        if self._cellB is not None:
            self.cellB.export(outfile, level, name_='cellB')
        else:
            warnEmptyAttribute("cellB", "XSDataDouble")
        if self._cellC is not None:
            self.cellC.export(outfile, level, name_='cellC')
        else:
            warnEmptyAttribute("cellC", "XSDataDouble")
        if self._cellAlpha is not None:
            self.cellAlpha.export(outfile, level, name_='cellAlpha')
        else:
            warnEmptyAttribute("cellAlpha", "XSDataDouble")
        if self._cellBeta is not None:
            self.cellBeta.export(outfile, level, name_='cellBeta')
        else:
            warnEmptyAttribute("cellBeta", "XSDataDouble")
        if self._cellGamma is not None:
            self.cellGamma.export(outfile, level, name_='cellGamma')
        else:
            warnEmptyAttribute("cellGamma", "XSDataDouble")
        if self._code is not None:
            self.code.export(outfile, level, name_='code')
        else:
            warnEmptyAttribute("code", "XSDataString")
        if self._containerSampleChangerLocation is not None:
            self.containerSampleChangerLocation.export(outfile, level, name_='containerSampleChangerLocation')
        else:
            warnEmptyAttribute("containerSampleChangerLocation", "XSDataString")
        if self._crystalSpaceGroup is not None:
            self.crystalSpaceGroup.export(outfile, level, name_='crystalSpaceGroup')
        else:
            warnEmptyAttribute("crystalSpaceGroup", "XSDataString")
        if self._diffractionPlan is not None:
            self.diffractionPlan.export(outfile, level, name_='diffractionPlan')
        else:
            warnEmptyAttribute("diffractionPlan", "XSDataISPyBDiffractionPlan")
        ...
        if self._holderLength is not None:
            self.holderLength.export(outfile, level, name_='holderLength')
        else:
            warnEmptyAttribute("holderLength", "XSDataDouble")
        if self._minimalResolution is not None:
            self.minimalResolution.export(outfile, level, name_='minimalResolution')
        else:
            warnEmptyAttribute("minimalResolution", "XSDataDouble")
        if self._proteinAcronym is not None:
            self.proteinAcronym.export(outfile, level, name_='proteinAcronym')
        else:
            warnEmptyAttribute("proteinAcronym", "XSDataString")
        if self._sampleId is not None:
            self.sampleId.export(outfile, level, name_='sampleId')
        else:
            warnEmptyAttribute("sampleId", "XSDataInteger")
        if self._sampleLocation is not None:
            self.sampleLocation.export(outfile, level, name_='sampleLocation')
        else:
            warnEmptyAttribute("sampleLocation", "XSDataString")
        if self._sampleName is not None:
            self.sampleName.export(outfile, level, name_='sampleName')
        else:
            warnEmptyAttribute("sampleName", "XSDataString")
    def build(self, node_):
        for child_ in node_.childNodes:
            nodeName_ = child_.nodeName.split(':')[-1]
            self.buildChildren(child_, nodeName_)
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setCellAlpha(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'cellBeta':
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setCellBeta(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'cellGamma':
            obj_ = XSDataDouble()
            obj_.build(child_)
            self.setCellGamma(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'code':
            obj_ = XSDataString()
            obj_.build(child_)
            ...
            nodeName_ == 'containerSampleChangerLocation':
            obj_ = XSDataString()
            obj_.build(child_)
            self.setContainerSampleChangerLocation(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'crystalSpaceGroup':
            obj_ = XSDataString()
            obj_.build(child_)
            self.setCrystalSpaceGroup(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'diffractionPlan':
            obj_ = XSDataISPyBDiffractionPlan()
            obj_.build(child_)
            ...
            nodeName_ == 'proteinAcronym':
            obj_ = XSDataString()
            obj_.build(child_)
            self.setProteinAcronym(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'sampleId':
            obj_ = XSDataInteger()
            obj_.build(child_)
            ...
            nodeName_ == 'sampleLocation':
            obj_ = XSDataString()
            obj_.build(child_)
            self.setSampleLocation(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'sampleName':
            obj_ = XSDataString()
            obj_.build(child_)
            self.setSampleName(obj_)
        XSDataResult.buildChildren(self, child_, nodeName_)
    #Method for marshalling an object
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
        self.export( oStreamString, 0, name_="XSDataResultGetSampleInformation" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML
    #Only to export the entire XML tree to a file stream on disk
    def exportToFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write(unicode('<?xml version=\"1.0\" ?>\n'))
        self.export( outfile, 0, name_='XSDataResultGetSampleInformation' )
        outfile.close()
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataResultGetSampleInformation is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
        return XSDataResultGetSampleInformation.parseString(self.marshal())
    #Static method for parsing a string
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultGetSampleInformation()
        rootObj.build(rootNode)
        # Check that all minOccurs are obeyed by marshalling the created object
        oStreamString = StringIO()
        rootObj.export( oStreamString, 0, name_="XSDataResultGetSampleInformation" )
        oStreamString.close()
        return rootObj
    parseString = staticmethod( parseString )
    #Static method for parsing a file
    def parseFile( _inFilePath ):
        ...
        return rootObj
    parseFile = staticmethod( parseFile )
# end class XSDataResultGetSampleInformation
...
class XSDataResultISPyBGroupDataCollections(XSDataResult):
    def __init__(self, status=None, dataCollectionId=None):
        ...
        if dataCollectionId is None:
            self._dataCollectionId = []
        elif dataCollectionId.__class__.__name__ == "list":
            self._dataCollectionId = dataCollectionId
        else:
            strMessage = "ERROR! XSDataResultISPyBGroupDataCollections constructor argument 'dataCollectionId' is not list but %s" % self._dataCollectionId.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'dataCollectionId' attribute
    def getDataCollectionId(self): return self._dataCollectionId
    def setDataCollectionId(self, dataCollectionId):
        if dataCollectionId is None:
            ...
            strMessage = "ERROR! XSDataResultISPyBGroupDataCollections.setDataCollectionId argument is not list but %s" % dataCollectionId.__class__.__name__
            raise BaseException(strMessage)
    def delDataCollectionId(self): self._dataCollectionId = None
    dataCollectionId = property(getDataCollectionId, setDataCollectionId, delDataCollectionId, "Property for dataCollectionId")
    def addDataCollectionId(self, value):
        if value is None:
            strMessage = "ERROR! XSDataResultISPyBGroupDataCollections.addDataCollectionId argument is None"
            raise BaseException(strMessage)            
        elif value.__class__.__name__ == "XSDataInteger":
            self._dataCollectionId.append(value)
        else:
            strMessage = "ERROR! XSDataResultISPyBGroupDataCollections.addDataCollectionId argument is not XSDataInteger but %s" % value.__class__.__name__
            raise BaseException(strMessage)
    def insertDataCollectionId(self, index, value):
        if index is None:
            strMessage = "ERROR! XSDataResultISPyBGroupDataCollections.insertDataCollectionId argument 'index' is None"
            raise BaseException(strMessage)            
        if value is None:
            strMessage = "ERROR! XSDataResultISPyBGroupDataCollections.insertDataCollectionId argument 'value' is None"
            raise BaseException(strMessage)            
        elif value.__class__.__name__ == "XSDataInteger":
            self._dataCollectionId[index] = value
        else:
            strMessage = "ERROR! XSDataResultISPyBGroupDataCollections.addDataCollectionId argument is not XSDataInteger but %s" % value.__class__.__name__
            raise BaseException(strMessage)
    ...
    def exportChildren(self, outfile, level, name_='XSDataResultISPyBGroupDataCollections'):
        XSDataResult.exportChildren(self, outfile, level, name_)
        for dataCollectionId_ in self.getDataCollectionId():
            dataCollectionId_.export(outfile, level, name_='dataCollectionId')
    def build(self, node_):
        for child_ in node_.childNodes:
            nodeName_ = child_.nodeName.split(':')[-1]
            self.buildChildren(child_, nodeName_)
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            obj_ = XSDataInteger()
            obj_.build(child_)
            self.dataCollectionId.append(obj_)
        XSDataResult.buildChildren(self, child_, nodeName_)
    #Method for marshalling an object
    def marshal( self ):
        oStreamString = StringIO()
...
class XSDataResultISPyBSetBestWilsonPlotPath(XSDataResult):
    def __init__(self, status=None, dataCollectionId=None):
        XSDataResult.__init__(self, status)
        if dataCollectionId is None:
            self._dataCollectionId = None
            ...
            strMessage = "ERROR! XSDataResultISPyBSetBestWilsonPlotPath constructor argument 'dataCollectionId' is not XSDataInteger but %s" % self._dataCollectionId.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'dataCollectionId' attribute
    def getDataCollectionId(self): return self._dataCollectionId
    def setDataCollectionId(self, dataCollectionId):
        if dataCollectionId is None:
            ...
            strMessage = "ERROR! XSDataResultISPyBSetBestWilsonPlotPath.setDataCollectionId argument is not XSDataInteger but %s" % dataCollectionId.__class__.__name__
            raise BaseException(strMessage)
    def delDataCollectionId(self): self._dataCollectionId = None
    dataCollectionId = property(getDataCollectionId, setDataCollectionId, delDataCollectionId, "Property for dataCollectionId")
    def export(self, outfile, level, name_='XSDataResultISPyBSetBestWilsonPlotPath'):
        showIndent(outfile, level)
        outfile.write(unicode('<%s>\n' % name_))
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write(unicode('</%s>\n' % name_))
    def exportChildren(self, outfile, level, name_='XSDataResultISPyBSetBestWilsonPlotPath'):
        XSDataResult.exportChildren(self, outfile, level, name_)
        if self._dataCollectionId is not None:
            self.dataCollectionId.export(outfile, level, name_='dataCollectionId')
        else:
    ...
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
        self.export( oStreamString, 0, name_="XSDataResultISPyBSetBestWilsonPlotPath" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML
    #Only to export the entire XML tree to a file stream on disk
    def exportToFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write(unicode('<?xml version=\"1.0\" ?>\n'))
        self.export( outfile, 0, name_='XSDataResultISPyBSetBestWilsonPlotPath' )
        outfile.close()
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataResultISPyBSetBestWilsonPlotPath is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
        return XSDataResultISPyBSetBestWilsonPlotPath.parseString(self.marshal())
    #Static method for parsing a string
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultISPyBSetBestWilsonPlotPath()
        rootObj.build(rootNode)
        # Check that all minOccurs are obeyed by marshalling the created object
        oStreamString = StringIO()
        rootObj.export( oStreamString, 0, name_="XSDataResultISPyBSetBestWilsonPlotPath" )
        oStreamString.close()
        return rootObj
    parseString = staticmethod( parseString )
    #Static method for parsing a file
    def parseFile( _inFilePath ):
        ...
        return rootObj
    parseFile = staticmethod( parseFile )
# end class XSDataResultISPyBSetBestWilsonPlotPath


class XSDataResultISPyBSetDataCollectionPosition(XSDataResult):
    def __init__(self, status=None, dataCollectionId=None):
        XSDataResult.__init__(self, status)
        if dataCollectionId is None:
            self._dataCollectionId = None
            ...
            strMessage = "ERROR! XSDataResultISPyBSetDataCollectionPosition constructor argument 'dataCollectionId' is not XSDataInteger but %s" % self._dataCollectionId.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'dataCollectionId' attribute
    def getDataCollectionId(self): return self._dataCollectionId
    def setDataCollectionId(self, dataCollectionId):
        if dataCollectionId is None:
            ...
            strMessage = "ERROR! XSDataResultISPyBSetDataCollectionPosition.setDataCollectionId argument is not XSDataInteger but %s" % dataCollectionId.__class__.__name__
            raise BaseException(strMessage)
    def delDataCollectionId(self): self._dataCollectionId = None
    dataCollectionId = property(getDataCollectionId, setDataCollectionId, delDataCollectionId, "Property for dataCollectionId")
    def export(self, outfile, level, name_='XSDataResultISPyBSetDataCollectionPosition'):
        showIndent(outfile, level)
        outfile.write(unicode('<%s>\n' % name_))
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write(unicode('</%s>\n' % name_))
    def exportChildren(self, outfile, level, name_='XSDataResultISPyBSetDataCollectionPosition'):
        XSDataResult.exportChildren(self, outfile, level, name_)
        if self._dataCollectionId is not None:
            self.dataCollectionId.export(outfile, level, name_='dataCollectionId')
        else:
    ...
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
        self.export( oStreamString, 0, name_="XSDataResultISPyBSetDataCollectionPosition" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML
    #Only to export the entire XML tree to a file stream on disk
    def exportToFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write(unicode('<?xml version=\"1.0\" ?>\n'))
        self.export( outfile, 0, name_='XSDataResultISPyBSetDataCollectionPosition' )
        outfile.close()
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataResultISPyBSetDataCollectionPosition is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
        return XSDataResultISPyBSetDataCollectionPosition.parseString(self.marshal())
    #Static method for parsing a string
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultISPyBSetDataCollectionPosition()
        rootObj.build(rootNode)
        # Check that all minOccurs are obeyed by marshalling the created object
        oStreamString = StringIO()
        rootObj.export( oStreamString, 0, name_="XSDataResultISPyBSetDataCollectionPosition" )
        oStreamString.close()
        return rootObj
    parseString = staticmethod( parseString )
    #Static method for parsing a file
    def parseFile( _inFilePath ):
        ...
        return rootObj
    parseFile = staticmethod( parseFile )
# end class XSDataResultISPyBSetDataCollectionPosition


class XSDataResultISPyBSetDataCollectionsPositions(XSDataResult):
    def __init__(self, status=None, dataCollectionId=None):
        XSDataResult.__init__(self, status)
        if dataCollectionId is None:
            self._dataCollectionId = []
            ...
            strMessage = "ERROR! XSDataResultISPyBSetDataCollectionsPositions constructor argument 'dataCollectionId' is not list but %s" % self._dataCollectionId.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'dataCollectionId' attribute
    def getDataCollectionId(self): return self._dataCollectionId
    def setDataCollectionId(self, dataCollectionId):
        if dataCollectionId is None:
            ...
            strMessage = "ERROR! XSDataResultISPyBSetDataCollectionsPositions.setDataCollectionId argument is not list but %s" % dataCollectionId.__class__.__name__
            raise BaseException(strMessage)
    def delDataCollectionId(self): self._dataCollectionId = None
    dataCollectionId = property(getDataCollectionId, setDataCollectionId, delDataCollectionId, "Property for dataCollectionId")
    def addDataCollectionId(self, value):
        if value is None:
            strMessage = "ERROR! XSDataResultISPyBSetDataCollectionsPositions.addDataCollectionId argument is None"
            raise BaseException(strMessage)            
        elif value.__class__.__name__ == "XSDataInteger":
            self._dataCollectionId.append(value)
        else:
            strMessage = "ERROR! XSDataResultISPyBSetDataCollectionsPositions.addDataCollectionId argument is not XSDataInteger but %s" % value.__class__.__name__
            raise BaseException(strMessage)
    def insertDataCollectionId(self, index, value):
        if index is None:
            strMessage = "ERROR! XSDataResultISPyBSetDataCollectionsPositions.insertDataCollectionId argument 'index' is None"
            raise BaseException(strMessage)            
        if value is None:
            strMessage = "ERROR! XSDataResultISPyBSetDataCollectionsPositions.insertDataCollectionId argument 'value' is None"
            raise BaseException(strMessage)            
        elif value.__class__.__name__ == "XSDataInteger":
            self._dataCollectionId[index] = value
        else:
            strMessage = "ERROR! XSDataResultISPyBSetDataCollectionsPositions.addDataCollectionId argument is not XSDataInteger but %s" % value.__class__.__name__
            raise BaseException(strMessage)
    def export(self, outfile, level, name_='XSDataResultISPyBSetDataCollectionsPositions'):
        showIndent(outfile, level)
        outfile.write(unicode('<%s>\n' % name_))
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write(unicode('</%s>\n' % name_))
    def exportChildren(self, outfile, level, name_='XSDataResultISPyBSetDataCollectionsPositions'):
        XSDataResult.exportChildren(self, outfile, level, name_)
        for dataCollectionId_ in self.getDataCollectionId():
            dataCollectionId_.export(outfile, level, name_='dataCollectionId')
    def build(self, node_):
    ...
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
        self.export( oStreamString, 0, name_="XSDataResultISPyBSetDataCollectionsPositions" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML
    #Only to export the entire XML tree to a file stream on disk
    def exportToFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write(unicode('<?xml version=\"1.0\" ?>\n'))
        self.export( outfile, 0, name_='XSDataResultISPyBSetDataCollectionsPositions' )
        outfile.close()
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataResultISPyBSetDataCollectionsPositions is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
        return XSDataResultISPyBSetDataCollectionsPositions.parseString(self.marshal())
    #Static method for parsing a string
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultISPyBSetDataCollectionsPositions()
        rootObj.build(rootNode)
        # Check that all minOccurs are obeyed by marshalling the created object
        oStreamString = StringIO()
        rootObj.export( oStreamString, 0, name_="XSDataResultISPyBSetDataCollectionsPositions" )
        oStreamString.close()
        return rootObj
    parseString = staticmethod( parseString )
    #Static method for parsing a file
...
class XSDataResultISPyBSetImagesPositions(XSDataResult):
    def __init__(self, status=None, imageCreation=None):
        XSDataResult.__init__(self, status)
        if imageCreation is None:
            self._imageCreation = []
        elif imageCreation.__class__.__name__ == "list":
            self._imageCreation = imageCreation
        else:
            strMessage = "ERROR! XSDataResultISPyBSetImagesPositions constructor argument 'imageCreation' is not list but %s" % self._imageCreation.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'imageCreation' attribute
    def getImageCreation(self): return self._imageCreation
    def setImageCreation(self, imageCreation):
        if imageCreation is None:
            self._imageCreation = []
        elif imageCreation.__class__.__name__ == "list":
            self._imageCreation = imageCreation
        else:
            strMessage = "ERROR! XSDataResultISPyBSetImagesPositions.setImageCreation argument is not list but %s" % imageCreation.__class__.__name__
            raise BaseException(strMessage)
    def delImageCreation(self): self._imageCreation = None
    imageCreation = property(getImageCreation, setImageCreation, delImageCreation, "Property for imageCreation")
    def addImageCreation(self, value):
        if value is None:
            strMessage = "ERROR! XSDataResultISPyBSetImagesPositions.addImageCreation argument is None"
            raise BaseException(strMessage)            
        elif value.__class__.__name__ == "XSDataISPyBImageCreation":
            self._imageCreation.append(value)
        else:
            strMessage = "ERROR! XSDataResultISPyBSetImagesPositions.addImageCreation argument is not XSDataISPyBImageCreation but %s" % value.__class__.__name__
            raise BaseException(strMessage)
    def insertImageCreation(self, index, value):
        if index is None:
            strMessage = "ERROR! XSDataResultISPyBSetImagesPositions.insertImageCreation argument 'index' is None"
            raise BaseException(strMessage)            
        if value is None:
            strMessage = "ERROR! XSDataResultISPyBSetImagesPositions.insertImageCreation argument 'value' is None"
            raise BaseException(strMessage)            
        elif value.__class__.__name__ == "XSDataISPyBImageCreation":
            self._imageCreation[index] = value
        else:
            strMessage = "ERROR! XSDataResultISPyBSetImagesPositions.addImageCreation argument is not XSDataISPyBImageCreation but %s" % value.__class__.__name__
            raise BaseException(strMessage)
    def export(self, outfile, level, name_='XSDataResultISPyBSetImagesPositions'):
        showIndent(outfile, level)
        outfile.write(unicode('<%s>\n' % name_))
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write(unicode('</%s>\n' % name_))
    def exportChildren(self, outfile, level, name_='XSDataResultISPyBSetImagesPositions'):
        XSDataResult.exportChildren(self, outfile, level, name_)
        for imageCreation_ in self.getImageCreation():
            imageCreation_.export(outfile, level, name_='imageCreation')
    def build(self, node_):
        for child_ in node_.childNodes:
            nodeName_ = child_.nodeName.split(':')[-1]
            self.buildChildren(child_, nodeName_)
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'imageCreation':
            obj_ = XSDataISPyBImageCreation()
            obj_.build(child_)
            self.imageCreation.append(obj_)
        XSDataResult.buildChildren(self, child_, nodeName_)
    #Method for marshalling an object
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
        self.export( oStreamString, 0, name_="XSDataResultISPyBSetImagesPositions" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML
    #Only to export the entire XML tree to a file stream on disk
    def exportToFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write(unicode('<?xml version=\"1.0\" ?>\n'))
        self.export( outfile, 0, name_='XSDataResultISPyBSetImagesPositions' )
        outfile.close()
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataResultISPyBSetImagesPositions is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
        return XSDataResultISPyBSetImagesPositions.parseString(self.marshal())
    #Static method for parsing a string
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultISPyBSetImagesPositions()
        rootObj.build(rootNode)
        # Check that all minOccurs are obeyed by marshalling the created object
        oStreamString = StringIO()
        rootObj.export( oStreamString, 0, name_="XSDataResultISPyBSetImagesPositions" )
        oStreamString.close()
        return rootObj
    parseString = staticmethod( parseString )
    #Static method for parsing a file
    def parseFile( _inFilePath ):
        ...
        return rootObj
    parseFile = staticmethod( parseFile )
# end class XSDataResultISPyBSetImagesPositions


class XSDataResultISPyBStoreGridInfo(XSDataResult):
    def __init__(self, status=None, gridInfoId=None):
        XSDataResult.__init__(self, status)
        if gridInfoId is None:
            self._gridInfoId = None
        elif gridInfoId.__class__.__name__ == "XSDataInteger":
            ...
            strMessage = "ERROR! XSDataResultISPyBStoreGridInfo constructor argument 'gridInfoId' is not XSDataInteger but %s" % self._gridInfoId.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'gridInfoId' attribute
    def getGridInfoId(self): return self._gridInfoId
    def setGridInfoId(self, gridInfoId):
        if gridInfoId is None:
            ...
            strMessage = "ERROR! XSDataResultISPyBStoreGridInfo.setGridInfoId argument is not XSDataInteger but %s" % gridInfoId.__class__.__name__
            raise BaseException(strMessage)
    def delGridInfoId(self): self._gridInfoId = None
    gridInfoId = property(getGridInfoId, setGridInfoId, delGridInfoId, "Property for gridInfoId")
    def export(self, outfile, level, name_='XSDataResultISPyBStoreGridInfo'):
        showIndent(outfile, level)
        outfile.write(unicode('<%s>\n' % name_))
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write(unicode('</%s>\n' % name_))
    def exportChildren(self, outfile, level, name_='XSDataResultISPyBStoreGridInfo'):
        XSDataResult.exportChildren(self, outfile, level, name_)
        if self._gridInfoId is not None:
            self.gridInfoId.export(outfile, level, name_='gridInfoId')
    def build(self, node_):
    ...
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
        self.export( oStreamString, 0, name_="XSDataResultISPyBStoreGridInfo" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML
    #Only to export the entire XML tree to a file stream on disk
    def exportToFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write(unicode('<?xml version=\"1.0\" ?>\n'))
        self.export( outfile, 0, name_='XSDataResultISPyBStoreGridInfo' )
        outfile.close()
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataResultISPyBStoreGridInfo is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
        return XSDataResultISPyBStoreGridInfo.parseString(self.marshal())
    #Static method for parsing a string
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultISPyBStoreGridInfo()
        rootObj.build(rootNode)
        # Check that all minOccurs are obeyed by marshalling the created object
        oStreamString = StringIO()
        rootObj.export( oStreamString, 0, name_="XSDataResultISPyBStoreGridInfo" )
        oStreamString.close()
        return rootObj
    parseString = staticmethod( parseString )
    #Static method for parsing a file
    def parseFile( _inFilePath ):
        ...
        return rootObj
    parseFile = staticmethod( parseFile )
# end class XSDataResultISPyBStoreGridInfo


class XSDataResultISPyBStoreMotorPosition(XSDataResult):
    def __init__(self, status=None, motorPositionId=None):
        XSDataResult.__init__(self, status)
        if motorPositionId is None:
            self._motorPositionId = None
        elif motorPositionId.__class__.__name__ == "XSDataInteger":
            self._motorPositionId = motorPositionId
        else:
            strMessage = "ERROR! XSDataResultISPyBStoreMotorPosition constructor argument 'motorPositionId' is not XSDataInteger but %s" % self._motorPositionId.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'motorPositionId' attribute
    def getMotorPositionId(self): return self._motorPositionId
    def setMotorPositionId(self, motorPositionId):
        if motorPositionId is None:
            self._motorPositionId = None
        elif motorPositionId.__class__.__name__ == "XSDataInteger":
            self._motorPositionId = motorPositionId
        else:
            strMessage = "ERROR! XSDataResultISPyBStoreMotorPosition.setMotorPositionId argument is not XSDataInteger but %s" % motorPositionId.__class__.__name__
            raise BaseException(strMessage)
    def delMotorPositionId(self): self._motorPositionId = None
    motorPositionId = property(getMotorPositionId, setMotorPositionId, delMotorPositionId, "Property for motorPositionId")
    def export(self, outfile, level, name_='XSDataResultISPyBStoreMotorPosition'):
        showIndent(outfile, level)
        outfile.write(unicode('<%s>\n' % name_))
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write(unicode('</%s>\n' % name_))
    def exportChildren(self, outfile, level, name_='XSDataResultISPyBStoreMotorPosition'):
        XSDataResult.exportChildren(self, outfile, level, name_)
        if self._motorPositionId is not None:
            self.motorPositionId.export(outfile, level, name_='motorPositionId')
        else:
            warnEmptyAttribute("motorPositionId", "XSDataInteger")
    def build(self, node_):
        for child_ in node_.childNodes:
            nodeName_ = child_.nodeName.split(':')[-1]
            self.buildChildren(child_, nodeName_)
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'motorPositionId':
            obj_ = XSDataInteger()
            obj_.build(child_)
            self.setMotorPositionId(obj_)
        XSDataResult.buildChildren(self, child_, nodeName_)
    #Method for marshalling an object
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
        self.export( oStreamString, 0, name_="XSDataResultISPyBStoreMotorPosition" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML
    #Only to export the entire XML tree to a file stream on disk
    def exportToFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write(unicode('<?xml version=\"1.0\" ?>\n'))
        self.export( outfile, 0, name_='XSDataResultISPyBStoreMotorPosition' )
        outfile.close()
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataResultISPyBStoreMotorPosition is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
        return XSDataResultISPyBStoreMotorPosition.parseString(self.marshal())
    #Static method for parsing a string
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultISPyBStoreMotorPosition()
        rootObj.build(rootNode)
        # Check that all minOccurs are obeyed by marshalling the created object
        oStreamString = StringIO()
        rootObj.export( oStreamString, 0, name_="XSDataResultISPyBStoreMotorPosition" )
        oStreamString.close()
        return rootObj
    parseString = staticmethod( parseString )
    #Static method for parsing a file
    def parseFile( _inFilePath ):
        ...
        return rootObj
    parseFile = staticmethod( parseFile )
# end class XSDataResultISPyBStoreMotorPosition
...
class XSDataResultISPyBStoreScreening(XSDataResult):
    def __init__(self, status=None, dataCollectionId=None, screeningId=None):
        ...
        if dataCollectionId is None:
            ...
            strMessage = "ERROR! XSDataResultISPyBStoreScreening constructor argument 'dataCollectionId' is not XSDataInteger but %s" % self._dataCollectionId.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'screeningId' attribute
    def getScreeningId(self): return self._screeningId
    def setScreeningId(self, screeningId):
    ...
    def setDataCollectionId(self, dataCollectionId):
        if dataCollectionId is None:
            ...
            strMessage = "ERROR! XSDataResultISPyBStoreScreening.setDataCollectionId argument is not XSDataInteger but %s" % dataCollectionId.__class__.__name__
            raise BaseException(strMessage)
    def delDataCollectionId(self): self._dataCollectionId = None
    dataCollectionId = property(getDataCollectionId, setDataCollectionId, delDataCollectionId, "Property for dataCollectionId")
...
class XSDataResultISPyBStoreWorkflow(XSDataResult):
    def __init__(self, status=None, workflowId=None):
        XSDataResult.__init__(self, status)
        if workflowId is None:
            self._workflowId = None
        elif workflowId.__class__.__name__ == "XSDataInteger":
            ...
            strMessage = "ERROR! XSDataResultISPyBStoreWorkflow constructor argument 'workflowId' is not XSDataInteger but %s" % self._workflowId.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'workflowId' attribute
    def getWorkflowId(self): return self._workflowId
    def setWorkflowId(self, workflowId):
        if workflowId is None:
            ...
            strMessage = "ERROR! XSDataResultISPyBStoreWorkflow.setWorkflowId argument is not XSDataInteger but %s" % workflowId.__class__.__name__
            raise BaseException(strMessage)
    def delWorkflowId(self): self._workflowId = None
    workflowId = property(getWorkflowId, setWorkflowId, delWorkflowId, "Property for workflowId")
    def export(self, outfile, level, name_='XSDataResultISPyBStoreWorkflow'):
        showIndent(outfile, level)
        outfile.write(unicode('<%s>\n' % name_))
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write(unicode('</%s>\n' % name_))
    def exportChildren(self, outfile, level, name_='XSDataResultISPyBStoreWorkflow'):
        XSDataResult.exportChildren(self, outfile, level, name_)
        if self._workflowId is not None:
            self.workflowId.export(outfile, level, name_='workflowId')
        else:
    ...
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
        self.export( oStreamString, 0, name_="XSDataResultISPyBStoreWorkflow" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML
    #Only to export the entire XML tree to a file stream on disk
    def exportToFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write(unicode('<?xml version=\"1.0\" ?>\n'))
        self.export( outfile, 0, name_='XSDataResultISPyBStoreWorkflow' )
        outfile.close()
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataResultISPyBStoreWorkflow is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
        return XSDataResultISPyBStoreWorkflow.parseString(self.marshal())
    #Static method for parsing a string
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultISPyBStoreWorkflow()
        rootObj.build(rootNode)
        # Check that all minOccurs are obeyed by marshalling the created object
        oStreamString = StringIO()
        rootObj.export( oStreamString, 0, name_="XSDataResultISPyBStoreWorkflow" )
        oStreamString.close()
        return rootObj
    parseString = staticmethod( parseString )
    #Static method for parsing a file
...
class XSDataResultISPyBStoreWorkflowMesh(XSDataResult):
    def __init__(self, status=None, workflowMeshId=None):
        XSDataResult.__init__(self, status)
        if workflowMeshId is None:
            self._workflowMeshId = None
        elif workflowMeshId.__class__.__name__ == "XSDataInteger":
            ...
            strMessage = "ERROR! XSDataResultISPyBStoreWorkflowMesh constructor argument 'workflowMeshId' is not XSDataInteger but %s" % self._workflowMeshId.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'workflowMeshId' attribute
    def getWorkflowMeshId(self): return self._workflowMeshId
    def setWorkflowMeshId(self, workflowMeshId):
        if workflowMeshId is None:
            ...
            strMessage = "ERROR! XSDataResultISPyBStoreWorkflowMesh.setWorkflowMeshId argument is not XSDataInteger but %s" % workflowMeshId.__class__.__name__
            raise BaseException(strMessage)
    def delWorkflowMeshId(self): self._workflowMeshId = None
    workflowMeshId = property(getWorkflowMeshId, setWorkflowMeshId, delWorkflowMeshId, "Property for workflowMeshId")
    def export(self, outfile, level, name_='XSDataResultISPyBStoreWorkflowMesh'):
        showIndent(outfile, level)
        outfile.write(unicode('<%s>\n' % name_))
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write(unicode('</%s>\n' % name_))
    def exportChildren(self, outfile, level, name_='XSDataResultISPyBStoreWorkflowMesh'):
        XSDataResult.exportChildren(self, outfile, level, name_)
        if self._workflowMeshId is not None:
            self.workflowMeshId.export(outfile, level, name_='workflowMeshId')
        else:
    ...
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
        self.export( oStreamString, 0, name_="XSDataResultISPyBStoreWorkflowMesh" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML
    #Only to export the entire XML tree to a file stream on disk
    def exportToFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write(unicode('<?xml version=\"1.0\" ?>\n'))
        self.export( outfile, 0, name_='XSDataResultISPyBStoreWorkflowMesh' )
        outfile.close()
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataResultISPyBStoreWorkflowMesh is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
        return XSDataResultISPyBStoreWorkflowMesh.parseString(self.marshal())
    #Static method for parsing a string
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultISPyBStoreWorkflowMesh()
        rootObj.build(rootNode)
        # Check that all minOccurs are obeyed by marshalling the created object
        oStreamString = StringIO()
        rootObj.export( oStreamString, 0, name_="XSDataResultISPyBStoreWorkflowMesh" )
        oStreamString.close()
        return rootObj
    parseString = staticmethod( parseString )
    #Static method for parsing a file
    def parseFile( _inFilePath ):
        ...
        return rootObj
    parseFile = staticmethod( parseFile )
# end class XSDataResultISPyBStoreWorkflowMesh
...
class XSDataResultISPyBUpdateWorkflowStatus(XSDataResult):
    def __init__(self, status=None, workflowId=None):
        XSDataResult.__init__(self, status)
        if workflowId is None:
            self._workflowId = None
            ...
            strMessage = "ERROR! XSDataResultISPyBUpdateWorkflowStatus constructor argument 'workflowId' is not XSDataInteger but %s" % self._workflowId.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'workflowId' attribute
    def getWorkflowId(self): return self._workflowId
    def setWorkflowId(self, workflowId):
        if workflowId is None:
            ...
            strMessage = "ERROR! XSDataResultISPyBUpdateWorkflowStatus.setWorkflowId argument is not XSDataInteger but %s" % workflowId.__class__.__name__
            raise BaseException(strMessage)
    def delWorkflowId(self): self._workflowId = None
    workflowId = property(getWorkflowId, setWorkflowId, delWorkflowId, "Property for workflowId")
    def export(self, outfile, level, name_='XSDataResultISPyBUpdateWorkflowStatus'):
        showIndent(outfile, level)
        outfile.write(unicode('<%s>\n' % name_))
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write(unicode('</%s>\n' % name_))
    def exportChildren(self, outfile, level, name_='XSDataResultISPyBUpdateWorkflowStatus'):
        XSDataResult.exportChildren(self, outfile, level, name_)
        if self._workflowId is not None:
            self.workflowId.export(outfile, level, name_='workflowId')
        else:
    ...
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
        self.export( oStreamString, 0, name_="XSDataResultISPyBUpdateWorkflowStatus" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML
    #Only to export the entire XML tree to a file stream on disk
    def exportToFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write(unicode('<?xml version=\"1.0\" ?>\n'))
        self.export( outfile, 0, name_='XSDataResultISPyBUpdateWorkflowStatus' )
        outfile.close()
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataResultISPyBUpdateWorkflowStatus is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
        return XSDataResultISPyBUpdateWorkflowStatus.parseString(self.marshal())
    #Static method for parsing a string
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultISPyBUpdateWorkflowStatus()
        rootObj.build(rootNode)
        # Check that all minOccurs are obeyed by marshalling the created object
        oStreamString = StringIO()
        rootObj.export( oStreamString, 0, name_="XSDataResultISPyBUpdateWorkflowStatus" )
        oStreamString.close()
        return rootObj
    parseString = staticmethod( parseString )
    #Static method for parsing a file
    def parseFile( _inFilePath ):
        ...
        return rootObj
    parseFile = staticmethod( parseFile )
# end class XSDataResultISPyBUpdateWorkflowStatus
...
class XSDataResultStoreListOfImageQualityIndicators(XSDataResult):
    def __init__(self, status=None, imageQualityIndicatorsId=None):
        XSDataResult.__init__(self, status)
        if imageQualityIndicatorsId is None:
            self._imageQualityIndicatorsId = []
        elif imageQualityIndicatorsId.__class__.__name__ == "list":
            self._imageQualityIndicatorsId = imageQualityIndicatorsId
        else:
            strMessage = "ERROR! XSDataResultStoreListOfImageQualityIndicators constructor argument 'imageQualityIndicatorsId' is not list but %s" % self._imageQualityIndicatorsId.__class__.__name__
            raise BaseException(strMessage)
    # Methods and properties for the 'imageQualityIndicatorsId' attribute
    def getImageQualityIndicatorsId(self): return self._imageQualityIndicatorsId
    def setImageQualityIndicatorsId(self, imageQualityIndicatorsId):
        if imageQualityIndicatorsId is None:
            ...
            strMessage = "ERROR! XSDataResultStoreListOfImageQualityIndicators.setImageQualityIndicatorsId argument is not list but %s" % imageQualityIndicatorsId.__class__.__name__
            raise BaseException(strMessage)
    def delImageQualityIndicatorsId(self): self._imageQualityIndicatorsId = None
    imageQualityIndicatorsId = property(getImageQualityIndicatorsId, setImageQualityIndicatorsId, delImageQualityIndicatorsId, "Property for imageQualityIndicatorsId")
    def addImageQualityIndicatorsId(self, value):
        if value is None:
            strMessage = "ERROR! XSDataResultStoreListOfImageQualityIndicators.addImageQualityIndicatorsId argument is None"
            raise BaseException(strMessage)            
        elif value.__class__.__name__ == "XSDataInteger":
            self._imageQualityIndicatorsId.append(value)
        else:
            strMessage = "ERROR! XSDataResultStoreListOfImageQualityIndicators.addImageQualityIndicatorsId argument is not XSDataInteger but %s" % value.__class__.__name__
            raise BaseException(strMessage)
    def insertImageQualityIndicatorsId(self, index, value):
        if index is None:
            strMessage = "ERROR! XSDataResultStoreListOfImageQualityIndicators.insertImageQualityIndicatorsId argument 'index' is None"
            raise BaseException(strMessage)            
        if value is None:
            strMessage = "ERROR! XSDataResultStoreListOfImageQualityIndicators.insertImageQualityIndicatorsId argument 'value' is None"
            raise BaseException(strMessage)            
        elif value.__class__.__name__ == "XSDataInteger":
            self._imageQualityIndicatorsId[index] = value
        else:
            strMessage = "ERROR! XSDataResultStoreListOfImageQualityIndicators.addImageQualityIndicatorsId argument is not XSDataInteger but %s" % value.__class__.__name__
            raise BaseException(strMessage)
    def export(self, outfile, level, name_='XSDataResultStoreListOfImageQualityIndicators'):
        showIndent(outfile, level)
        outfile.write(unicode('<%s>\n' % name_))
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write(unicode('</%s>\n' % name_))
    def exportChildren(self, outfile, level, name_='XSDataResultStoreListOfImageQualityIndicators'):
        XSDataResult.exportChildren(self, outfile, level, name_)
        for imageQualityIndicatorsId_ in self.getImageQualityIndicatorsId():
            imageQualityIndicatorsId_.export(outfile, level, name_='imageQualityIndicatorsId')
        if self.getImageQualityIndicatorsId() == []:
            warnEmptyAttribute("imageQualityIndicatorsId", "XSDataInteger")
    def build(self, node_):
        for child_ in node_.childNodes:
            nodeName_ = child_.nodeName.split(':')[-1]
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            obj_ = XSDataInteger()
            obj_.build(child_)
            self.imageQualityIndicatorsId.append(obj_)
        XSDataResult.buildChildren(self, child_, nodeName_)
    #Method for marshalling an object
    def marshal( self ):
        oStreamString = StringIO()
        oStreamString.write(unicode('<?xml version="1.0" ?>\n'))
        self.export( oStreamString, 0, name_="XSDataResultStoreListOfImageQualityIndicators" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML
    #Only to export the entire XML tree to a file stream on disk
    def exportToFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write(unicode('<?xml version=\"1.0\" ?>\n'))
        self.export( outfile, 0, name_='XSDataResultStoreListOfImageQualityIndicators' )
        outfile.close()
    #Deprecated method, replaced by exportToFile
    def outputFile( self, _outfileName ):
        print("WARNING: Method outputFile in class XSDataResultStoreListOfImageQualityIndicators is deprecated, please use instead exportToFile!")
        self.exportToFile(_outfileName)
    #Method for making a copy in a new instance
    def copy( self ):
        return XSDataResultStoreListOfImageQualityIndicators.parseString(self.marshal())
    #Static method for parsing a string
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultStoreListOfImageQualityIndicators()
        rootObj.build(rootNode)
        # Check that all minOccurs are obeyed by marshalling the created object
        oStreamString = StringIO()
        rootObj.export( oStreamString, 0, name_="XSDataResultStoreListOfImageQualityIndicators" )
        oStreamString.close()
        return rootObj
    parseString = staticmethod( parseString )
    #Static method for parsing a file
    def parseFile( _inFilePath ):
        ...
        return rootObj
    parseFile = staticmethod( parseFile )
# end class XSDataResultStoreListOfImageQualityIndicators
