...
class EDTestCasePluginExecuteISPyBStoreAutoProcv1_4_anom_data(EDTestCasePluginExecute):

    def __init__(self, _edStringTestName=None):
        """
        Sets config file + input and output reference files. 
        """
        EDTestCasePluginExecute.__init__(self, "EDPluginISPyBStoreAutoProcv1_4_anom_data")
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputStoreAutoProc_anom_data.xml"))
...
if __name__ == '__main__':
    edTestCasePluginExecuteISPyBStoreAutoProcv1_4_anom_data = EDTestCasePluginExecuteISPyBStoreAutoProcv1_4_anom_data("EDTestCasePluginExecuteISPyBStoreAutoProcv1_4_anom_data")
    edTestCasePluginExecuteISPyBStoreAutoProcv1_4_anom_data.execute()
