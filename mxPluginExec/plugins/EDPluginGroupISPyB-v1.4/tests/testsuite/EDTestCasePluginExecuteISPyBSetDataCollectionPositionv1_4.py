...
class EDTestCasePluginExecuteISPyBSetDataCollectionPositionv1_4(EDTestCasePluginExecute):
    ...
    def __init__(self, _edStringTestName=None):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputSetDataCollectionPosition_test.xml"))
