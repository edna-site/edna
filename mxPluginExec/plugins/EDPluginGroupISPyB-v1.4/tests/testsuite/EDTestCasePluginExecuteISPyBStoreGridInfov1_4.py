...
class EDTestCasePluginExecuteISPyBStoreGridInfov1_4(EDTestCasePluginExecute):

    def __init__(self, _edStringTestName=None):
        """
        Sets config file + input and output reference files. 
        """
        EDTestCasePluginExecute.__init__(self, "EDPluginISPyBStoreGridInfov1_4")
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputStoreGridInfo_test.xml"))
    ...
    def testExecute(self):
        ...
        EDAssert.equal(xsDataResult.gridInfoId is None, False, "Attribute gridInfoId in the result")
