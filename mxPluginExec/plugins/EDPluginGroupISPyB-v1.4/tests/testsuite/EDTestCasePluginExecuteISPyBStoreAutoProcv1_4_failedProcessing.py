...
class EDTestCasePluginExecuteISPyBStoreAutoProcv1_4_failedProcessing(EDTestCasePluginExecute):
    ...
    def testExecute(self):
        ...
        EDAssert.equal(False, bAttributeExists, "Attribute AutoProcId in the result")
...
if __name__ == '__main__':
    edTestCasePluginExecuteISPyBStoreAutoProcv1_4_failedProcessing = EDTestCasePluginExecuteISPyBStoreAutoProcv1_4_failedProcessing("EDTestCasePluginExecuteISPyBStoreAutoProcv1_4_failedProcessing")
    edTestCasePluginExecuteISPyBStoreAutoProcv1_4_failedProcessing.execute()
