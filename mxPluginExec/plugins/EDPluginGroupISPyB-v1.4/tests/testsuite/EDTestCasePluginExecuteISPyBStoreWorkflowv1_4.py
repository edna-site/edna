...
class EDTestCasePluginExecuteISPyBStoreWorkflowv1_4(EDTestCasePluginExecute):

    def __init__(self, _edStringTestName=None):
        """
        Sets config file + input and output reference files. 
        """
        EDTestCasePluginExecute.__init__(self, "EDPluginISPyBStoreWorkflowv1_4")
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputStoreWorkflow_test.xml"))
...
if __name__ == '__main__':
    edTestCasePluginExecuteISPyBStoreWorkflowv1_4 = EDTestCasePluginExecuteISPyBStoreWorkflowv1_4("EDTestCasePluginExecuteISPyBStoreWorkflowv1_4")
    edTestCasePluginExecuteISPyBStoreWorkflowv1_4.execute()
