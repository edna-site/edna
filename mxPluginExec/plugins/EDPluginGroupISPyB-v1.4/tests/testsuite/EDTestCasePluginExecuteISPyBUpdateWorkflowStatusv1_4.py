...
class EDTestCasePluginExecuteISPyBUpdateWorkflowStatusv1_4(EDTestCasePluginExecute):

    def __init__(self, _edStringTestName=None):
        """
        Sets config file + input and output reference files. 
        """
        EDTestCasePluginExecute.__init__(self, "EDPluginISPyBUpdateWorkflowStatusv1_4")
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputUpdateWorkflowStatus_test.xml"))
