...
class EDTestCasePluginExecuteISPyBRetrieveDataCollectionv1_4(EDTestCasePluginExecute):
...
if __name__ == '__main__':
    edTestCasePluginExecuteISPyBRetrieveDataCollectionv1_4 = EDTestCasePluginExecuteISPyBRetrieveDataCollectionv1_4("EDTestCasePluginExecuteISPyBRetrieveDataCollectionv1_4")
    edTestCasePluginExecuteISPyBRetrieveDataCollectionv1_4.execute()
