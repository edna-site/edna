...
class EDTestCasePluginExecuteISPyBSetDataCollectionsPositionsv1_4(EDTestCasePluginExecute):
    ...
    def __init__(self, _edStringTestName=None):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputSetDataCollectionsPositions_test.xml"))
