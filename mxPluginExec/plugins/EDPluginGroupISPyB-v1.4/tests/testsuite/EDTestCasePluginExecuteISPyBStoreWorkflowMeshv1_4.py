...
class EDTestCasePluginExecuteISPyBStoreWorkflowMeshv1_4(EDTestCasePluginExecute):

    def __init__(self, _edStringTestName=None):
        """
        Sets config file + input and output reference files. 
        """
        EDTestCasePluginExecute.__init__(self, "EDPluginISPyBStoreWorkflowMeshv1_4")
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputStoreWorkflowMesh_test.xml"))
    ...
    def testExecute(self):
        ...
        EDAssert.equal(xsDataResult.workflowMeshId is None, False, "Attribute workflowMeshId in the result")
