...
class EDTestCasePluginExecuteISPyBStoreAutoProcv1_4(EDTestCasePluginExecute):
...
if __name__ == '__main__':
    edTestCasePluginExecuteISPyBStoreAutoProcv1_4 = EDTestCasePluginExecuteISPyBStoreAutoProcv1_4("EDTestCasePluginExecuteISPyBStoreAutoProcv1_4")
    edTestCasePluginExecuteISPyBStoreAutoProcv1_4.execute()
