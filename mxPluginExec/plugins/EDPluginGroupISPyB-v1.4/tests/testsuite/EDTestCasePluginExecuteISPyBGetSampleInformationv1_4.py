...
class EDTestCasePluginExecuteISPyBGetSampleInformationv1_4(EDTestCasePluginExecute):

    def __init__(self, _edStringTestName=None):
        """
        Sets config file + input and output reference files. 
        """
        EDTestCasePluginExecute.__init__(self, "EDPluginISPyBGetSampleInformationv1_4")
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputGetSampleInformation_test.xml"))
    ...
    def testExecute(self):
        ...
        EDAssert.equal(xsDataResult.proteinAcronym.value, "bThiol", "Attribute proteinAcronym is 'iota'")
