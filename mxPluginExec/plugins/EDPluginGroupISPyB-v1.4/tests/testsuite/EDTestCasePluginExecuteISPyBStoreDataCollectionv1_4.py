...
class EDTestCasePluginExecuteISPyBStoreDataCollectionv1_4(EDTestCasePluginExecute):

    def __init__(self, _edStringTestName=None):
        """
        Sets config file + input and output reference files. 
        """
        EDTestCasePluginExecute.__init__(self, "EDPluginISPyBStoreDataCollectionv1_4")
...
#        self.setConfigurationFile(os.path.join(self.getPluginTestsDataHome(), "XSConfiguration_ESRF_testDataBase.xml"))
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputStoreDataCollection_test.xml"))
...
if __name__ == '__main__':
    edTestCasePluginExecuteISPyBStoreDataCollectionv1_4 = EDTestCasePluginExecuteISPyBStoreDataCollectionv1_4("EDTestCasePluginExecuteISPyBStoreDataCollectionv1_4")
    edTestCasePluginExecuteISPyBStoreDataCollectionv1_4.execute()
