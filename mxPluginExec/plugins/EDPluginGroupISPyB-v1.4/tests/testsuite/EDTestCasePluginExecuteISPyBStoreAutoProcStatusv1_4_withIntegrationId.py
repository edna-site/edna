...
class EDTestCasePluginExecuteISPyBStoreAutoProcStatusv1_4_withIntegrationId(EDTestCasePluginExecute):
    ...
    def __init__(self, _edStringTestName=None):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputStoreAutoProcStatus_withIntegrationId.xml"))
...
if __name__ == '__main__':
    edTestCasePluginExecuteISPyBStoreAutoProcStatusv1_4_withIntegrationId = EDTestCasePluginExecuteISPyBStoreAutoProcStatusv1_4_withIntegrationId("EDTestCasePluginExecuteISPyBStoreAutoProcStatusv1_4_withIntegrationId")
    edTestCasePluginExecuteISPyBStoreAutoProcStatusv1_4_withIntegrationId.execute()
