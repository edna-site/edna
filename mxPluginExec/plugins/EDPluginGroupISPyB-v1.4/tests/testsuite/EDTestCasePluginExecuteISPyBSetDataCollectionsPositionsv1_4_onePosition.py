...
class EDTestCasePluginExecuteISPyBSetDataCollectionsPositionsv1_4_onePosition(EDTestCasePluginExecute):

    def __init__(self, _edStringTestName=None):
        """
        Sets config file + input and output reference files. 
        """
        EDTestCasePluginExecute.__init__(self, "EDPluginISPyBSetDataCollectionsPositionsv1_4")
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputSetDataCollectionsPositions_onePosition.xml"))
    ...
    def testExecute(self):
        ...
        if xsDataResult.dataCollectionId is None:
