...
class EDTestCasePluginExecuteISPyBSetDataCollectionPositionv1_4_onePosition(EDTestCasePluginExecute):

    def __init__(self, _edStringTestName=None):
        """
        Sets config file + input and output reference files. 
        """
        EDTestCasePluginExecute.__init__(self, "EDPluginISPyBSetDataCollectionPositionv1_4")
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputSetDataCollectionPosition_onePosition.xml"))
