...
xsDataBaseName=XSDataMOSFLMv10
xsdHomeDir=${EDNA_HOME}/mxPluginExec/plugins/EDPluginGroupMOSFLM-v1.0/datamodel
pyHomeDir=${EDNA_HOME}/mxPluginExec/plugins/EDPluginGroupMOSFLM-v1.0/plugins
