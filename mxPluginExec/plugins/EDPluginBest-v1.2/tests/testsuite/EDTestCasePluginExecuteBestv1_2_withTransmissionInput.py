...
class EDTestCasePluginExecuteBestv1_2_withTransmissionInput(EDTestCasePluginExecuteBestv1_2):
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteBestv1_2_withTransmissionInput = EDTestCasePluginExecuteBestv1_2_withTransmissionInput("EDTestCasePluginExecuteBestv1_2_withTransmissionInput")
    edTestCasePluginExecuteBestv1_2_withTransmissionInput.execute()
