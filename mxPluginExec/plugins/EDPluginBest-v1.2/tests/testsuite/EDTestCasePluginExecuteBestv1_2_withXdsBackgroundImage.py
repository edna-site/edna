...
class EDTestCasePluginExecuteBestv1_2_withXdsBackgroundImage(EDTestCasePluginExecuteBestv1_2):
    ...
    def __init__(self, _oalStringTestName=None):
        ...
        self.setDataInputFile(EDUtilsPath.mergePath(self.getPluginTestsDataHome(), "XSDataInputBest_withXdsBackgroundImage.xml"))
        if (self.m_bRunOnIntel):
            self.setReferenceDataOutputFile(EDUtilsPath.mergePath(self.getPluginTestsDataHome(), "XSDataResultBest_withXdsBackgroundImageForIntel.xml"))
        else:
            self.setReferenceDataOutputFile(EDUtilsPath.mergePath(self.getPluginTestsDataHome(), "XSDataResultBest_withXdsBackgroundImage.xml"))
