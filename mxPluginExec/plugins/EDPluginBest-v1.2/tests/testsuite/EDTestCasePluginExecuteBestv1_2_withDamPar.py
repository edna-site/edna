...
class EDTestCasePluginExecuteBestv1_2_withDamPar(EDTestCasePluginExecuteBestv1_2):
    """
    """
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteBestv1_2_withDamPar = EDTestCasePluginExecuteBestv1_2_withDamPar("EDTestCasePluginExecuteBestv1_2_withDamPar")
    edTestCasePluginExecuteBestv1_2_withDamPar.execute()
