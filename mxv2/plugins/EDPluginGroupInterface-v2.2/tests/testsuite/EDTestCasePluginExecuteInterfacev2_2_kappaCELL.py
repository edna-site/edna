...
class EDTestCasePluginExecuteInterfacev2_2_kappaCELL(EDTestCasePluginExecute):
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteInterfacev2_2_kappaCELL = EDTestCasePluginExecuteInterfacev2_2_kappaCELL("EDTestCasePluginExecuteInterfacev2_2_kappaCELL")
    edTestCasePluginExecuteInterfacev2_2_kappaCELL.execute()
