...
class EDTestCasePluginExecuteExecSimpleHTMLPagev2_0_withMXv1AndQt3Render(EDTestCasePluginExecute):
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteExecSimpleHTMLPagev2_0_withQt3Render = EDTestCasePluginExecuteExecSimpleHTMLPagev2_0_withQt3Render("EDTestCasePluginExecuteExecSimpleHTMLPagev2_0_withQt3Render")
    edTestCasePluginExecuteExecSimpleHTMLPagev2_0_withQt3Render.execute()
