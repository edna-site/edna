...
class EDTestCasePluginExecuteControlCharForReorientationv2_0_KAPPA_Anomalous_singleXML(EDTestCasePluginExecute):
    ...
    def __init__(self, _strTestName=None):
        ...
        EDTestCasePluginExecute.__init__(self, "EDPluginControlCharForReorientationv2_0", "EDPluginControlCharForReorientation-v2.0", _strTestName)
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputCharacterisation2_0_reference_KAPPA_Anomalous.xml"))
...
if __name__ == '__main__':
    ...
    EDTestCasePluginExecuteControlCharForReorientationv2_0_KAPPA_Anomalous_singleXML = EDTestCasePluginExecuteControlCharForReorientationv2_0_KAPPA_Anomalous_singleXML("EDTestCasePluginExecuteControlCharForReorientationv2_0_KAPPA_Anomalous_singleXML")
    EDTestCasePluginExecuteControlCharForReorientationv2_0_KAPPA_Anomalous_singleXML.execute()
