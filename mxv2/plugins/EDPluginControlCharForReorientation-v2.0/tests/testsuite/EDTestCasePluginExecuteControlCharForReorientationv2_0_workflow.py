...
class EDTestCasePluginExecuteControlCharForReorientationv2_0_workflow(EDTestCasePluginExecute):
    ...
    def __init__(self, _strTestName=None):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputCharacterisation2_0_reference_workflow.xml"))



    def preProcess(self):
        EDTestCasePluginExecute.preProcess(self)
        self.loadTestImage([ "ref-testscale_1_0001.img", "ref-testscale_1_0002.img" ])
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteControlCharForReorientationv2_0_workflow = EDTestCasePluginExecuteControlCharForReorientationv2_0_workflow("EDTestCasePluginExecuteControlCharForReorientationv2_0_workflow")
    edTestCasePluginExecuteControlCharForReorientationv2_0_workflow.execute()
