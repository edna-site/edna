...
class EDTestCasePluginExecuteControlCharForReorientationv2_0_KAPPA_Anomalous(EDTestCasePluginExecute):
...
if __name__ == '__main__':
    ...
    EDTestCasePluginExecuteControlCharForReorientationv2_0_KAPPA_Anomalous = EDTestCasePluginExecuteControlCharForReorientationv2_0_KAPPA_Anomalous("EDTestCasePluginExecuteControlCharForReorientationv2_0_KAPPA_Anomalous")
    EDTestCasePluginExecuteControlCharForReorientationv2_0_KAPPA_Anomalous.execute()
