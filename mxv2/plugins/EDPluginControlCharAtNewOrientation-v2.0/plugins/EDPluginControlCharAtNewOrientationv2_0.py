...
#                            self.newpossibleOrientations.addPossible_orientation(Orients[i])
                    self.suggestedStrategy=EDHandlerXSDataMXv1v1_0.mergeStrategyToNewOrientation(self.getDataInput("mxv1ResultCharacterisation_Reference")[0].getStrategyResult(),self.mxv1InputCharacterisation.getDataCollection(),omega,kappa,phi)
