...
class EDTestCasePluginExecuteControlCharAtNewOrientationv2_0_noMoreChoice(EDTestCasePluginExecute):
    ...
    def __init__(self, _strTestName=None):
        ...
        EDTestCasePluginExecute.__init__(self, "EDPluginControlCharAtNewOrientationv2_0", "EDPluginControlCharAtNewOrientation-v2.0", _strTestName)
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputCharacterisation_reference_KAPPA_Anomalous.xml"), "mxv1InputCharacterisation" )
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "mxv2_XSDataCollection_reference.xml") , "mxv2DataCollection")
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "ControlCharForReorientationv2_0_dataOutput_betterResolution.xml") , "mxv1ResultCharacterisation_Reference")
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "mxv2_XSDataCollection_Orig_reference.xml") , "mxv2DataCollection_Reference")
        #no further possibilities are available
        #self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "STAC_DNA_kappa_alignment_response") , "possibleOrientations")
...
if __name__ == '__main__':
    ...
    EDTestCasePluginExecuteControlCharAtNewOrientationv2_0_noMoreChoice = EDTestCasePluginExecuteControlCharAtNewOrientationv2_0_noMoreChoice("EDTestCasePluginExecuteControlCharAtNewOrientationv2_0_noMoreChoice")
    EDTestCasePluginExecuteControlCharAtNewOrientationv2_0_noMoreChoice.execute()
