...
class EDTestCasePluginExecuteControlCharAtNewOrientationv2_0_loosingResolution(EDTestCasePluginExecute):
...
if __name__ == '__main__':
    ...
    EDTestCasePluginExecuteControlCharAtNewOrientationv2_0_loosingResolution = EDTestCasePluginExecuteControlCharAtNewOrientationv2_0_loosingResolution("EDTestCasePluginExecuteControlCharAtNewOrientationv2_0_loosingResolution")
    EDTestCasePluginExecuteControlCharAtNewOrientationv2_0_loosingResolution.execute()
