...
class EDTestCasePluginExecuteControlCharAtNewOrientationv2_0_test1(EDTestCasePluginExecute):
    ...
    def __init__(self, _strTestName=None):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "ControlCharForReorientationv2_0_dataOutput.xml") , "mxv1ResultCharacterisation_Reference")
...
if __name__ == '__main__':
    ...
    EDTestCasePluginExecuteControlCharAtNewOrientationv2_0_test1 = EDTestCasePluginExecuteControlCharAtNewOrientationv2_0_test1("EDTestCasePluginExecuteControlCharAtNewOrientationv2_0_test1")
    EDTestCasePluginExecuteControlCharAtNewOrientationv2_0_test1.execute()
