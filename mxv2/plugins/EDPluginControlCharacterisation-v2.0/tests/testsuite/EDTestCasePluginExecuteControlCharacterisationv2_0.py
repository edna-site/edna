...
class EDTestCasePluginExecuteControlCharacterisationv2_0(EDTestCasePluginExecute):
    ...
    def __init__(self, _strTestName=None):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataInputCharacterisation_reference.xml") , "mxv1InputCharacterisation")
...
if __name__ == '__main__':
    ...
    edTestCasePluginExecuteControlCharacterisationv2_0 = EDTestCasePluginExecuteControlCharacterisationv2_0("EDTestCasePluginExecuteControlCharacterisationv2_0")
    edTestCasePluginExecuteControlCharacterisationv2_0.execute()
