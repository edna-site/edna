...
class EDTestCasePluginExecuteExecMatrixInvertv1_0(EDTestCasePluginExecute):
    """
    Those are all execution tests for the EDNA Exec plugin MatrixInvertv1_0
    """

    def __init__(self, _strTestName=None):
        """
        """
        EDTestCasePluginExecute.__init__(self, "EDPluginExecMatrixInvertv1_0")
#        self.setConfigurationFile(os.path.join(self.getPluginTestsDataHome(),
#                                               "XSConfiguration_MatrixInvert.xml"))
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), \
                                           "XSDataInputMatrixInvert_reference.xml"))
        self.setReferenceDataOutputFile(os.path.join(self.getPluginTestsDataHome(), \
                                                     "XSDataResultMatrixInvert_reference.xml"))
...
if __name__ == '__main__':
    ...
    testMatrixInvertv1_0instance = EDTestCasePluginExecuteControlMatrixInvertv1_0("EDTestCasePluginExecuteExecMatrixInvertv1_0")
    testMatrixInvertv1_0instance.execute()
