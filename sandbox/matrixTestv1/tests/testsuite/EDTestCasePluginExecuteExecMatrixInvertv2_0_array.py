...
class EDTestCasePluginExecuteExecMatrixInvertv2_0_array(EDTestCasePluginExecute):
    """
...
#                                               "XSConfiguration_MatrixInvert.xml"))
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), \
                                           "XSDataInputMatrixInvertv2_array.xml"))
        self.setReferenceDataOutputFile(os.path.join(self.getPluginTestsDataHome(), \
                                                     "XSDataResultMatrixInvertv2_array.xml"))
...
if __name__ == '__main__':
    ...
    testMatrixInvertv2_0instance = EDTestCasePluginExecuteExecMatrixInvertv2_0_array("EDTestCasePluginExecuteExecMatrixInvertv2_0_array")
