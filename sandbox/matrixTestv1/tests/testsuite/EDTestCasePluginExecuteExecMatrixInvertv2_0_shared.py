...
class EDTestCasePluginExecuteExecMatrixInvertv2_0_shared(EDTestCasePluginExecute):
    """
...
#                                               "XSConfiguration_MatrixInvert.xml"))
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), \
                                           "XSDataInputMatrixInvertv2_reference.xml"))
    ...
    def preProcess(self):
        ...
        if not os.path.isdir(destDir):
            os.makedirs(destDir)
        EDShare[XSDataInputMatrixInvertv2.parseFile(self.getDataInputFile()).inputMatrix.shared.value] = fabio.open(os.path.join(self.getTestsDataImagesHome(), "test_region1_dark_1_0040.edf")).data
...
################################################################################
        ...
        output = EDShare[xsDataResultObtained.outputMatrix.shared.value]
...
if __name__ == '__main__':
    ...
    testMatrixInvertv2_0instance = EDTestCasePluginExecuteExecMatrixInvertv2_0_shared("EDTestCasePluginExecuteExecMatrixInvertv2_0_shared")
