...
class EDTestSuitePluginExecMatrixReadv1_0(EDTestSuite):
    """
...
if __name__ == '__main__':
    ...
    edTestSuitePluginExecMatrixReadv1_0 = EDTestSuitePluginExecMatrixReadv1_0("EDTestSuitePluginExecMatrixReadv1_0")
