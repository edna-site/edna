...
#
# Generated Mon Sep 27 17:39:10 2010 by EDGenerateDS.py.
#
...
class XSDataInputWriteMatrix(XSDataInput):
    subclass = None
    def __init__(self, inputMatrix=None, outputFile=None, configuration=None):
        XSDataInput.__init__(self, configuration)
        self.inputMatrix = inputMatrix
        self.outputFile = outputFile
    def factory(*args_, **kwargs_):
        if XSDataInputWriteMatrix.subclass:
            return XSDataInputWriteMatrix.subclass(*args_, **kwargs_)
        else:
            return XSDataInputWriteMatrix(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getInputMatrix(self): return self.inputMatrix
    def setInputMatrix(self, inputMatrix): self.inputMatrix = inputMatrix
    ...
    def export(self, outfile, level, name_='XSDataInputWriteMatrix'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputWriteMatrix'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputWriteMatrix')
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputWriteMatrix.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataInputWriteMatrix'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.inputMatrix:
            showIndent(outfile, level)
            outfile.write('inputMatrix=XSDataArray(\n')
            self.inputMatrix.exportLiteral(outfile, level, name_='inputMatrix')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.outputFile:
            showIndent(outfile, level)
...
class XSDataResultWriteMatrix(XSDataResult):
    ...
    def __init__(self, outputFile=None, status=None):
        ...
        self.outputFile = outputFile
    def factory(*args_, **kwargs_):
        if XSDataResultWriteMatrix.subclass:
            return XSDataResultWriteMatrix.subclass(*args_, **kwargs_)
        else:
            return XSDataResultWriteMatrix(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getOutputFile(self): return self.outputFile
    def setOutputFile(self, outputFile): self.outputFile = outputFile
    def export(self, outfile, level, name_='XSDataResultWriteMatrix'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultWriteMatrix'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultWriteMatrix')
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultWriteMatrix.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataResultWriteMatrix'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
...
class XSDataInputMatrixInvert(XSDataInput):
    subclass = None
    def __init__(self, inputMatrix=None, configuration=None):
        XSDataInput.__init__(self, configuration)
        self.inputMatrix = inputMatrix
    def factory(*args_, **kwargs_):
        if XSDataInputMatrixInvert.subclass:
            return XSDataInputMatrixInvert.subclass(*args_, **kwargs_)
        else:
            return XSDataInputMatrixInvert(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getInputMatrix(self): return self.inputMatrix
    def setInputMatrix(self, inputMatrix): self.inputMatrix = inputMatrix
    def export(self, outfile, level, name_='XSDataInputMatrixInvert'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputMatrixInvert'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputMatrixInvert')
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputMatrixInvert.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataInputMatrixInvert'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
...
class XSDataInputReadMatrix(XSDataInput):
    ...
    def factory(*args_, **kwargs_):
        if XSDataInputReadMatrix.subclass:
            return XSDataInputReadMatrix.subclass(*args_, **kwargs_)
        else:
            return XSDataInputReadMatrix(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def export(self, outfile, level, name_='XSDataInputReadMatrix'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputReadMatrix'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputReadMatrix')
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputReadMatrix.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataInputReadMatrix'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
...
class XSDataResultMatrixInvert(XSDataResult):
    subclass = None
    def __init__(self, outputMatrix=None, status=None):
        XSDataResult.__init__(self, status)
        self.outputMatrix = outputMatrix
    def factory(*args_, **kwargs_):
        if XSDataResultMatrixInvert.subclass:
            return XSDataResultMatrixInvert.subclass(*args_, **kwargs_)
        else:
            return XSDataResultMatrixInvert(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getOutputMatrix(self): return self.outputMatrix
    def setOutputMatrix(self, outputMatrix): self.outputMatrix = outputMatrix
    def export(self, outfile, level, name_='XSDataResultMatrixInvert'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultMatrixInvert'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultMatrixInvert')
    def exportChildren(self, outfile, level, name_='XSDataResultMatrixInvert'):
        if self.outputMatrix:
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultMatrixInvert.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataResultMatrixInvert'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.outputMatrix:
            showIndent(outfile, level)
            outfile.write('outputMatrix=XSDataArray(\n')
            self.outputMatrix.exportLiteral(outfile, level, name_='outputMatrix')
            showIndent(outfile, level)
            outfile.write('),\n')
        XSDataResult.exportLiteralChildren(self, outfile, level, name_)
    def build(self, node_):
...
class XSDataResultReadMatrix(XSDataResult):
    ...
    def __init__(self, outputMatrix=None, status=None):
        ...
        self.outputMatrix = outputMatrix
    def factory(*args_, **kwargs_):
        if XSDataResultReadMatrix.subclass:
            return XSDataResultReadMatrix.subclass(*args_, **kwargs_)
        else:
            return XSDataResultReadMatrix(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getOutputMatrix(self): return self.outputMatrix
    def setOutputMatrix(self, outputMatrix): self.outputMatrix = outputMatrix
    def export(self, outfile, level, name_='XSDataResultReadMatrix'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultReadMatrix'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultReadMatrix')
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultReadMatrix.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataResultReadMatrix'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
...
class XSDataInputMatrixInvertFile(XSDataInput):
    subclass = None
    def __init__(self, inputFile=None, outputFile=None, configuration=None):
        XSDataInput.__init__(self, configuration)
        self.inputFile = inputFile
        self.outputFile = outputFile
    def factory(*args_, **kwargs_):
        if XSDataInputMatrixInvertFile.subclass:
            return XSDataInputMatrixInvertFile.subclass(*args_, **kwargs_)
        else:
            return XSDataInputMatrixInvertFile(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getInputFile(self): return self.inputFile
    def setInputFile(self, inputFile): self.inputFile = inputFile
    def getOutputFile(self): return self.outputFile
    ...
    def export(self, outfile, level, name_='XSDataInputMatrixInvertFile'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputMatrixInvertFile'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputMatrixInvertFile')
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputMatrixInvertFile.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataInputMatrixInvertFile'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
...
class XSDataResultMatrixInvertFile(XSDataResult):
    ...
    def __init__(self, outputFile=None, status=None):
        ...
        self.outputFile = outputFile
    def factory(*args_, **kwargs_):
        if XSDataResultMatrixInvertFile.subclass:
            return XSDataResultMatrixInvertFile.subclass(*args_, **kwargs_)
        else:
            return XSDataResultMatrixInvertFile(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getOutputFile(self): return self.outputFile
    def setOutputFile(self, outputFile): self.outputFile = outputFile
    def export(self, outfile, level, name_='XSDataResultMatrixInvertFile'):
        ...
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultMatrixInvertFile'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultMatrixInvertFile')
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultMatrixInvertFile.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def exportLiteral(self, outfile, level, name_='XSDataResultMatrixInvertFile'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
...
class SaxXSDataDoubleHandler(handler.ContentHandler):
    ...
    def startElement(self, name, attrs):
        ...
        elif name == 'inputMatrix':
            obj = XSDataArray.factory()
            stackObj = SaxStackElement('inputMatrix', obj)
            self.stack.append(stackObj)
            done = 1
        ...
        elif name == 'outputMatrix':
            obj = XSDataArray.factory()
            stackObj = SaxStackElement('outputMatrix', obj)
            self.stack.append(stackObj)
            done = 1
        if not done:
    ...
    def endElement(self, name):
        ...
        if name == 'XSDataDouble':
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setInputMatrix(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'outputFile':
            if len(self.stack) >= 2:
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setOutputMatrix(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        if not done:
            self.reportError('"%s" element not allowed here.' % name)
