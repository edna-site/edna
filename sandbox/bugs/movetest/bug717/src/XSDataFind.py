...
#
# Generated Mon Dec 13 15:12:01 2010 by EDGenerateDS.py.
#
...
class XSDataInputFindPipeline(XSDataInput):
    subclass = None
    def __init__(self, searchPath=None, inputString1=None, inputString2=None, inputString3=None, configuration=None):
        XSDataInput.__init__(self, configuration)
        self.searchPath = searchPath
        self.inputString1 = inputString1
        self.inputString2 = inputString2
        self.inputString3 = inputString3
    def factory(*args_, **kwargs_):
        if XSDataInputFindPipeline.subclass:
            return XSDataInputFindPipeline.subclass(*args_, **kwargs_)
        else:
            return XSDataInputFindPipeline(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getSearchPath(self): return self.searchPath
    def setSearchPath(self, searchPath): self.searchPath = searchPath
    def getInputString1(self): return self.inputString1
    def setInputString1(self, inputString1): self.inputString1 = inputString1
    def getInputString2(self): return self.inputString2
    def setInputString2(self, inputString2): self.inputString2 = inputString2
    def getInputString3(self): return self.inputString3
    def setInputString3(self, inputString3): self.inputString3 = inputString3
    def export(self, outfile, level, name_='XSDataInputFindPipeline'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputFindPipeline'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputFindPipeline')
    def exportChildren(self, outfile, level, name_='XSDataInputFindPipeline'):
        if self.searchPath:
            self.searchPath.export(outfile, level, name_='searchPath')
        if self.inputString1:
            self.inputString1.export(outfile, level, name_='inputString1')
        if self.inputString2:
            self.inputString2.export(outfile, level, name_='inputString2')
        if self.inputString3:
            self.inputString3.export(outfile, level, name_='inputString3')
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataInputFindPipeline' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputFindPipeline.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataInputFindPipeline" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataInputFindPipeline'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.searchPath:
            showIndent(outfile, level)
            outfile.write('searchPath=XSDataFile(\n')
            self.searchPath.exportLiteral(outfile, level, name_='searchPath')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.inputString1:
            showIndent(outfile, level)
            outfile.write('inputString1=XSDataString(\n')
            self.inputString1.exportLiteral(outfile, level, name_='inputString1')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.inputString2:
            showIndent(outfile, level)
            outfile.write('inputString2=XSDataString(\n')
            self.inputString2.exportLiteral(outfile, level, name_='inputString2')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.inputString3:
            showIndent(outfile, level)
            outfile.write('inputString3=XSDataString(\n')
            self.inputString3.exportLiteral(outfile, level, name_='inputString3')
            showIndent(outfile, level)
            outfile.write('),\n')
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            obj_ = XSDataFile.factory()
            obj_.build(child_)
            self.setSearchPath(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'inputString1':
            obj_ = XSDataString.factory()
            obj_.build(child_)
            self.setInputString1(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'inputString2':
            obj_ = XSDataString.factory()
            obj_.build(child_)
            self.setInputString2(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'inputString3':
            obj_ = XSDataString.factory()
            obj_.build(child_)
            self.setInputString3(obj_)
        XSDataInput.buildChildren(self, child_, nodeName_)
# end class XSDataInputFindPipeline


class XSDataResultFindPipeline(XSDataResult):
    subclass = None
    def __init__(self, status=None, valueOf_=''):
        XSDataResult.__init__(self, status)
        self.valueOf_ = valueOf_
    def factory(*args_, **kwargs_):
        if XSDataResultFindPipeline.subclass:
            return XSDataResultFindPipeline.subclass(*args_, **kwargs_)
        else:
            return XSDataResultFindPipeline(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getValueOf_(self): return self.valueOf_
    def setValueOf_(self, valueOf_): self.valueOf_ = valueOf_
    def export(self, outfile, level, name_='XSDataResultFindPipeline'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultFindPipeline'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultFindPipeline')
    def exportChildren(self, outfile, level, name_='XSDataResultFindPipeline'):
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataResultFindPipeline' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultFindPipeline.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataResultFindPipeline" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataResultFindPipeline'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
...
# end class XSDataResultFindPipeline


class XSDataInputFind(XSDataInput):
    subclass = None
    def __init__(self, inputString=None, searchPath=None, configuration=None):
        XSDataInput.__init__(self, configuration)
        self.inputString = inputString
        self.searchPath = searchPath
    def factory(*args_, **kwargs_):
        if XSDataInputFind.subclass:
            return XSDataInputFind.subclass(*args_, **kwargs_)
        else:
            return XSDataInputFind(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getInputString(self): return self.inputString
    def setInputString(self, inputString): self.inputString = inputString
    def getSearchPath(self): return self.searchPath
    def setSearchPath(self, searchPath): self.searchPath = searchPath
    def export(self, outfile, level, name_='XSDataInputFind'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputFind'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputFind')
    def exportChildren(self, outfile, level, name_='XSDataInputFind'):
        if self.inputString:
            self.inputString.export(outfile, level, name_='inputString')
        if self.searchPath:
            self.searchPath.export(outfile, level, name_='searchPath')
        XSDataInput.exportChildren(self, outfile, level, name_)
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataInputFind' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputFind.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataInputFind" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataInputFind'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.inputString:
            showIndent(outfile, level)
            outfile.write('inputString=XSDataString(\n')
            self.inputString.exportLiteral(outfile, level, name_='inputString')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.searchPath:
            showIndent(outfile, level)
            outfile.write('searchPath=XSDataString(\n')
            self.searchPath.exportLiteral(outfile, level, name_='searchPath')
            showIndent(outfile, level)
            outfile.write('),\n')
        XSDataInput.exportLiteralChildren(self, outfile, level, name_)
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'inputString':
            obj_ = XSDataString.factory()
            obj_.build(child_)
            self.setInputString(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'searchPath':
            obj_ = XSDataString.factory()
            obj_.build(child_)
            self.setSearchPath(obj_)
        XSDataInput.buildChildren(self, child_, nodeName_)
# end class XSDataInputFind


class XSDataResultFind(XSDataResult):
    subclass = None
    def __init__(self, status=None, valueOf_=''):
        XSDataResult.__init__(self, status)
        self.valueOf_ = valueOf_
    def factory(*args_, **kwargs_):
        if XSDataResultFind.subclass:
            return XSDataResultFind.subclass(*args_, **kwargs_)
        else:
            return XSDataResultFind(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getValueOf_(self): return self.valueOf_
    def setValueOf_(self, valueOf_): self.valueOf_ = valueOf_
    def export(self, outfile, level, name_='XSDataResultFind'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultFind'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultFind')
    def exportChildren(self, outfile, level, name_='XSDataResultFind'):
        XSDataResult.exportChildren(self, outfile, level, name_)
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataResultFind' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultFind.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataResultFind" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataResultFind'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
...
class SaxXSDataDoubleHandler(handler.ContentHandler):
    ...
    def startElement(self, name, attrs):
        ...
        if name == 'XSDataDouble':
            ...
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('searchPath', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'inputString1':
            obj = XSDataString.factory()
            stackObj = SaxStackElement('inputString1', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'inputString2':
            obj = XSDataString.factory()
            stackObj = SaxStackElement('inputString2', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'inputString3':
            obj = XSDataString.factory()
            stackObj = SaxStackElement('inputString3', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'inputString':
            obj = XSDataString.factory()
            stackObj = SaxStackElement('inputString', obj)
            self.stack.append(stackObj)
            done = 1
        if not done:
    ...
    def endElement(self, name):
        ...
        if name == 'XSDataDouble':
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setSearchPath(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'inputString1':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setInputString1(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'inputString2':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setInputString2(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'inputString3':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setInputString3(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'inputString':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setInputString(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        if not done:
            self.reportError('"%s" element not allowed here.' % name)
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('from XSDataFind import *\n\n')
