...
xsDataBaseName=XSDataPyarchThumbnail
xsDataBaseDir=EDPluginPyarchThumbnail-v1.0
xsdHomeDir=${EDNA_HOME}/sandbox/${xsDataBaseDir}/datamodel
pyHomeDir=${EDNA_HOME}/sandbox/${xsDataBaseDir}/plugins
