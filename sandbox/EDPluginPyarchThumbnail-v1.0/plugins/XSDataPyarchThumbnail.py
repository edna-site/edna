...
#
# Generated Fri Dec 17 10:42:42 2010 by EDGenerateDS.py.
#
...
class XSDataInputPyarchThumbnail(XSDataInput):
    subclass = None
    def __init__(self, configuration=None, inputImagePath=None):
        XSDataInput.__init__(self, configuration)
        self.inputImagePath = inputImagePath
    def factory(*args_, **kwargs_):
        if XSDataInputPyarchThumbnail.subclass:
            return XSDataInputPyarchThumbnail.subclass(*args_, **kwargs_)
        else:
            return XSDataInputPyarchThumbnail(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def export(self, outfile, level, name_='XSDataInputPyarchThumbnail'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputPyarchThumbnail'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputPyarchThumbnail')
    def exportChildren(self, outfile, level, name_='XSDataInputPyarchThumbnail'):
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataInputPyarchThumbnail' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputPyarchThumbnail.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataInputPyarchThumbnail" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataInputPyarchThumbnail'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
...
# end class XSDataInputPyarchThumbnail


class XSDataResultPyarchThumbnail(XSDataResult):
    subclass = None
    def __init__(self, thumbnailPath=None):
        XSDataResult.__init__(self)
        self.thumbnailPath = thumbnailPath
    def factory(*args_, **kwargs_):
        if XSDataResultPyarchThumbnail.subclass:
            return XSDataResultPyarchThumbnail.subclass(*args_, **kwargs_)
        else:
            return XSDataResultPyarchThumbnail(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def export(self, outfile, level, name_='XSDataResultPyarchThumbnail'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultPyarchThumbnail'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultPyarchThumbnail')
    def exportChildren(self, outfile, level, name_='XSDataResultPyarchThumbnail'):
        if self.getThumbnailPath() != None :
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataResultPyarchThumbnail' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultPyarchThumbnail.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataResultPyarchThumbnail" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataResultPyarchThumbnail'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
...
# end class XSDataResultPyarchThumbnail
