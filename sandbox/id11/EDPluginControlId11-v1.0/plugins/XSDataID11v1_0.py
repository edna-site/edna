...
#
# Generated Wed Apr  6 15:34:33 2011 by EDGenerateDS.py.
#
...
class XSDataInputID11(XSDataInput):
    subclass = None
    def __init__(self, configuration=None, parameterFile=None, dataFile=None, outputdir=None, correctMask=None):
    ...
    def factory(*args_, **kwargs_):
        if XSDataInputID11.subclass:
            return XSDataInputID11.subclass(*args_, **kwargs_)
        else:
            return XSDataInputID11(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getParameterFile(self): return self.parameterFile
    def setParameterFile(self, parameterFile): self.parameterFile = parameterFile
    ...
    def setOutputdir(self, outputdir): self.outputdir = outputdir
    def getCorrectMask(self): return self.correctMask
    def setCorrectMask(self, correctMask): self.correctMask = correctMask
    def export(self, outfile, level, name_='XSDataInputID11'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataInputID11'):
        XSDataInput.exportAttributes(self, outfile, level, name_='XSDataInputID11')
    def exportChildren(self, outfile, level, name_='XSDataInputID11'):
        if self.parameterFile:
            self.parameterFile.export(outfile, level, name_='parameterFile')
        for dataFile_ in self.getDataFile():
            dataFile_.export(outfile, level, name_='dataFile')
        if self.getOutputdir() != None :
            if self.outputdir:
                self.outputdir.export(outfile, level, name_='outputdir')
        if self.getCorrectMask() != None :
            if self.correctMask:
                self.correctMask.export(outfile, level, name_='correctMask')
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataInputID11' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataInputID11.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataInputID11" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataInputID11'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.parameterFile:
            showIndent(outfile, level)
            outfile.write('parameterFile=XSDataFile(\n')
            self.parameterFile.exportLiteral(outfile, level, name_='parameterFile')
            showIndent(outfile, level)
            outfile.write('),\n')
        showIndent(outfile, level)
        ...
        if self.outputdir:
            showIndent(outfile, level)
            outfile.write('outputdir=XSDataFile(\n')
            self.outputdir.exportLiteral(outfile, level, name_='outputdir')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.correctMask:
            showIndent(outfile, level)
            outfile.write('correctMask=XSDataBoolean(\n')
            self.correctMask.exportLiteral(outfile, level, name_='correctMask')
            showIndent(outfile, level)
            outfile.write('),\n')
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'parameterFile':
            obj_ = XSDataFile.factory()
            obj_.build(child_)
            self.setParameterFile(obj_)
        elif child_.nodeType == Node.ELEMENT_NODE and \
            nodeName_ == 'dataFile':
            obj_ = XSDataFile.factory()
            obj_.build(child_)
            ...
            nodeName_ == 'correctMask':
            obj_ = XSDataBoolean.factory()
            obj_.build(child_)
            self.setCorrectMask(obj_)
        XSDataInput.buildChildren(self, child_, nodeName_)
# end class XSDataInputID11


class XSDataResultID11(XSDataResult):
    subclass = None
    def __init__(self, status=None, outputFile=None):
    ...
    def factory(*args_, **kwargs_):
        if XSDataResultID11.subclass:
            return XSDataResultID11.subclass(*args_, **kwargs_)
        else:
            return XSDataResultID11(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getOutputFile(self): return self.outputFile
    def setOutputFile(self, outputFile): self.outputFile = outputFile
    def addOutputFile(self, value): self.outputFile.append(value)
    def insertOutputFile(self, index, value): self.outputFile[index] = value
    def export(self, outfile, level, name_='XSDataResultID11'):
        showIndent(outfile, level)
        outfile.write('<%s>\n' % name_)
        self.exportChildren(outfile, level + 1, name_)
        showIndent(outfile, level)
        outfile.write('</%s>\n' % name_)
    def exportAttributes(self, outfile, level, name_='XSDataResultID11'):
        XSDataResult.exportAttributes(self, outfile, level, name_='XSDataResultID11')
    def exportChildren(self, outfile, level, name_='XSDataResultID11'):
        for outputFile_ in self.getOutputFile():
            outputFile_.export(outfile, level, name_='outputFile')
    ...
    def outputFile( self, _outfileName ):
        outfile = open( _outfileName, "w" )
        outfile.write("<?xml version=\"1.0\" ?>\n")
        self.export( outfile, 0, name_='XSDataResultID11' )
        outfile.close()
    ...
    def parseString( _inString ):
        doc = minidom.parseString(_inString)
        rootNode = doc.documentElement
        rootObj = XSDataResultID11.factory()
        rootObj.build(rootNode)
        return rootObj
    parseString = staticmethod( parseString ) 
    ...
    def marshal( self ):
        oStreamString = StringIO.StringIO()
        oStreamString.write('<?xml version="1.0" ?>\n')
        self.export( oStreamString, 0, name_="XSDataResultID11" )
        oStringXML = oStreamString.getvalue()
        oStreamString.close()
        return oStringXML

    def exportLiteral(self, outfile, level, name_='XSDataResultID11'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for outputFile in self.outputFile:
            showIndent(outfile, level)
            outfile.write('XSDataFile(\n')
            outputFile.exportLiteral(outfile, level, name_='outputFile')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
    ...
    def buildChildren(self, child_, nodeName_):
        if child_.nodeType == Node.ELEMENT_NODE and \
            ...
            obj_ = XSDataFile.factory()
            obj_.build(child_)
            self.outputFile.append(obj_)
        XSDataResult.buildChildren(self, child_, nodeName_)
# end class XSDataResultID11
...
class SaxXSConfigurationHandler(handler.ContentHandler):
    ...
    def startElement(self, name, attrs):
        ...
        if name == 'XSConfiguration':
        ...
        elif name == 'parameterFile':
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('parameterFile', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'dataFile':
            obj = XSDataFile.factory()
            ...
            obj = XSDataFile.factory()
            stackObj = SaxStackElement('outputdir', obj)
            self.stack.append(stackObj)
            done = 1
        elif name == 'correctMask':
            obj = XSDataBoolean.factory()
            stackObj = SaxStackElement('correctMask', obj)
            self.stack.append(stackObj)
            done = 1
    ...
    def endElement(self, name):
        ...
        if name == 'XSConfiguration':
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setParameterFile(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'dataFile':
            if len(self.stack) >= 2:
            ...
            if len(self.stack) >= 2:
                self.stack[-2].obj.setOutputdir(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'correctMask':
            if len(self.stack) >= 2:
                self.stack[-2].obj.setCorrectMask(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        elif name == 'outputFile':
            if len(self.stack) >= 2:
                self.stack[-2].obj.addOutputFile(self.stack[-1].obj)
                self.stack.pop()
                done = 1
        if not done:
            self.reportError('"%s" element not allowed here.' % name)
